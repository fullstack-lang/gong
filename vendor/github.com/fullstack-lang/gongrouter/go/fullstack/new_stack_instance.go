...
import (
	"github.com/fullstack-lang/gongrouter/go/controllers"
	...
	_ "github.com/fullstack-lang/gongrouter/ng/projects"
)
...
func NewStackInstance(
	...
	// add orchestration
	// insertion point
	models.SetOrchestratorOnAfterUpdate[models.Outlet](stage)
