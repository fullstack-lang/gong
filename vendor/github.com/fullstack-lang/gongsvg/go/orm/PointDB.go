...
// BackRepoPoint.ResetReversePointers commits all staged instances of Point to the BackRepo
// Phase Two is the update of instance with the field in the database
func (backRepoPoint *BackRepoPointStruct) ResetReversePointers(backRepo *BackRepoStruct) (Error error) {

	for idx, point := range backRepoPoint.Map_PointDBID_PointPtr {
		backRepoPoint.ResetReversePointersInstance(backRepo, idx, point)
	}

	return
}

func (backRepoPoint *BackRepoPointStruct) ResetReversePointersInstance(backRepo *BackRepoStruct, idx uint, astruct *models.Point) (Error error) {
