...
export class NodeDetailComponent implements OnInit {
	...
	IsNodeClickableFormControl: UntypedFormControl = new UntypedFormControl(false);
	...
	getNode(): void {
		...
		this.frontRepoService.pull(this.GONG__StackPath).subscribe(
			frontRepo => {
				...
				this.IsNodeClickableFormControl.setValue(this.node.IsNodeClickable)
			}
		)
	...
	save(): void {
		...
		this.node.IsNodeClickable = this.IsNodeClickableFormControl.value
