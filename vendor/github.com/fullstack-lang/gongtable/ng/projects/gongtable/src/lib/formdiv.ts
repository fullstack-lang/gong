...
export function CopyFormDivDBToFormDiv(formdivDB: FormDivDB, formdiv: FormDiv, frontRepo: FrontRepo) {
	...
	// insertion point for pointer fields encoding
	formdiv.FormEditAssocButton = frontRepo.FormEditAssocButtons.get(formdivDB.FormDivPointersEncoding.FormEditAssocButtonID.Int64)
	formdiv.FormSortAssocButton = frontRepo.FormSortAssocButtons.get(formdivDB.FormDivPointersEncoding.FormSortAssocButtonID.Int64)
