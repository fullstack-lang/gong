...
func (controller *Controller) onWebSocketRequestForCommitFromBackNb(c *gin.Context) {
	...
	// log.Println("Stack github.com/fullstack-lang/gongtable/go, onWebSocketRequestForCommitFromBackNb")
...
func (controller *Controller) onWebSocketRequestForBackRepoContent(c *gin.Context) {
	...
	// log.Println("Stack github.com/fullstack-lang/gongtable/go, onWebSocketRequestForBackRepoContent, first sent back repo of", stackPath)
	if err != nil {
		log.Println("github.com/fullstack-lang/gongtable/go:\n",
		"client no longer receiver web socket message, assuming it is no longer alive, closing websocket handler")
		fmt.Println(err)
	...
	for nbCommitBackRepo := range updateCommitBackRepoNbChannel {
		...
		// log.Println("Stack github.com/fullstack-lang/gongtable/go, onWebSocketRequestForBackRepoContent, sent back repo of", stackPath)
