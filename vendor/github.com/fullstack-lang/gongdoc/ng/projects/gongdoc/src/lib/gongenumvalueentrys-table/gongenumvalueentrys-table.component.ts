...
export class GongEnumValueEntrysTableComponent implements OnInit {
  ...
  // display gongenumvalueentry in router
  displayGongEnumValueEntryInRouter(gongenumvalueentryID: number) {
    this.router.navigate(["github_com_fullstack_lang_gongdoc_go-" + "gongenumvalueentry-display", gongenumvalueentryID])
  }
