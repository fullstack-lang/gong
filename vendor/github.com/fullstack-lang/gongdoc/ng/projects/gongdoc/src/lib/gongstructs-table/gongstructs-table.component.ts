...
export class GongStructsTableComponent implements OnInit {
  ...
  ngAfterViewInit() {
    ...
    this.matTableDataSource.sortingDataAccessor = (gongstructDB: GongStructDB, property: string) => {
      switch (property) {
        ...
        case 'NbInstances':
          return gongstructDB.NbInstances;
    ...
    this.matTableDataSource.filterPredicate = (gongstructDB: GongStructDB, filter: string) => {
      ...
      mergedContent += gongstructDB.NbInstances.toString()
  ...
  displayGongStructInRouter(gongstructID: number) {
    this.router.navigate(["github_com_fullstack_lang_gongdoc_go-" + "gongstruct-display", gongstructID])
  }
  ...
  setEditorRouterOutlet(gongstructID: number) {
    this.router.navigate([{
      outlets: {
        github_com_fullstack_lang_gongdoc_go_editor: ["github_com_fullstack_lang_gongdoc_go-" + "gongstruct-detail", gongstructID]
      }
    }]);
  }
  ...
  setPresentationRouterOutlet(gongstructID: number) {
    this.router.navigate([{
      outlets: {
        github_com_fullstack_lang_gongdoc_go_presentation: ["github_com_fullstack_lang_gongdoc_go-" + "gongstruct-presentation", gongstructID]
      }
    }]);
  }
