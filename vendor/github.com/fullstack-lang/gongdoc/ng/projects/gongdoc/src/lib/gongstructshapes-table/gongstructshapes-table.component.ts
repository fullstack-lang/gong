...
export class GongStructShapesTableComponent implements OnInit {
    ...
    this.frontRepoService.pull().subscribe(
      frontRepo => {
        ...
        if (this.mode == TableComponentMode.MANY_MANY_ASSOCIATION_MODE) {
          ...
          let sourceField = sourceInstance[this.dialogData.SourceField as keyof typeof sourceInstance]! as unknown as GongStructShapeDB[]
  ...
  deleteGongStructShape(gongstructshapeID: number, gongstructshape: GongStructShapeDB) {
    ...
    this.gongstructshapeService.deleteGongStructShape(gongstructshapeID).subscribe(
      gongstructshape => {
  ...
  setEditorRouterOutlet(gongstructshapeID: number) {
    this.router.navigate([{
      outlets: {
        github_com_fullstack_lang_gongdoc_go_editor: ["github_com_fullstack_lang_gongdoc_go-" + "gongstructshape-detail", gongstructshapeID]
      }
    }]);
  }

  // set presentation outlet
  setPresentationRouterOutlet(gongstructshapeID: number) {
    this.router.navigate([{
      outlets: {
        github_com_fullstack_lang_gongdoc_go_presentation: ["github_com_fullstack_lang_gongdoc_go-" + "gongstructshape-presentation", gongstructshapeID]
      }
    }]);
  }
