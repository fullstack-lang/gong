...
export const GongdocCommandTypeList: GongdocCommandTypeSelect[] = [ // insertion point	
	{ value: 'DIAGRAM_BASICFIELD_CREATE', viewValue: '"DIAGRAM_BASICFIELD_CREATE"' },
	{ value: 'DIAGRAM_BASICFIELD_DELETE', viewValue: '"DIAGRAM_BASICFIELD_DELETE"' },
	...
	{ value: 'DIAGRAM_GONGSTRUCT_CREATE', viewValue: '"DIAGRAM_GONGSTRUCT_CREATE"' },
	{ value: 'DIAGRAM_GONGSTRUCT_DELETE', viewValue: '"DIAGRAM_GONGSTRUCT_DELETE"' },
	{ value: 'DIAGRAM_POINTER_TO_GONGSTRUCT_CREATE', viewValue: '"DIAGRAM_POINTER_TO_GONGSTRUCT_CREATE"' },
	{ value: 'DIAGRAM_POINTER_TO_GONGSTRUCT_DELETE', viewValue: '"DIAGRAM_POINTER_TO_GONGSTRUCT_DELETE"' },
	{ value: 'DIAGRAM_SLICE_OF_POINTERS_TO_GONGSTRUCT_CREATE', viewValue: '"DIAGRAM_SLICE_OF_POINTERS_TO_GONGSTRUCT_CREATE"' },
	{ value: 'DIAGRAM_SLICE_OF_POINTERS_TO_GONGSTRUCT_DELETE', viewValue: '"DIAGRAM_SLICE_OF_POINTERS_TO_GONGSTRUCT_DELETE"' },
