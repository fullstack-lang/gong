// Package diagrams implements uml diagrams for documenting the stack models.
//
...
//
// Diagram go files should not be manualy edited but instead be generated by the gongdoc tool
