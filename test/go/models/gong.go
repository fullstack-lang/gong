	...
	case Astruct:
		return any(&Astruct{
			...
			AnonymousStructField1: struct {
				...
				TheName1:        "TheName1",
				TheName2:        "TheName2",
				Associationtob4: &Bstruct{Name: "AnonymousStructField1.Associationtob4"},
			},
