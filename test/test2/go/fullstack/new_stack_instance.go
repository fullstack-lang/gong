...
import (
	"github.com/fullstack-lang/gong/test/test2/go/controllers"
	...
	_ "github.com/fullstack-lang/gong/test/test2/ng-github.com-fullstack-lang-gong-test-test2"
)
...
func NewStackInstance(
	...
	models.SetOrchestratorOnAfterUpdateWithMouseEvent[models.A](stage)
	models.SetOrchestratorOnAfterUpdate[models.B](stage)
	models.SetOrchestratorOnAfterUpdateWithMouseEvent[models.B](stage)
