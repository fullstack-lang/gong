...
func executeServer() {
	...
	(&split.Title{Name: "test2"}).Stage(splitStage)
	(&split.FavIcon{Name: "test2",
	...
	stager := test2_models.NewStager(r, stack.Stage, splitStage)
	...
	err := test2_static.RunServer(r, ":" + strconv.Itoa(port))
	if err != nil {
