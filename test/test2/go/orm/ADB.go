...
func (backRepoA *BackRepoAStruct) GetStage() (stage *models.Stage) {
...
func (backRepoA *BackRepoAStruct) CommitPhaseOne(stage *models.Stage) (Error error) {
	...
	sort.Slice(as, func(i, j int) bool {
		return stage.A_stagedOrder[as[i]] < stage.A_stagedOrder[as[j]]
	})
...
func (aDB *ADB) DecodePointers(backRepo *BackRepoStruct, a *models.A) {
	...
	// B field	
	{
		id := aDB.BID.Int64
		if id != 0 {
			tmp, ok := backRepo.BackRepoB.Map_BDBID_BPtr[uint(id)]

			// if the pointer id is unknown, it is not a problem, maybe the target was removed from the front
			if !ok {
				log.Println("DecodePointers: a.B, unknown pointer id", id)
				a.B = nil
			} else {
