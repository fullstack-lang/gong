...
// go module version: v0.0.0-20260920161302-d4596dcf453a+dirty
/* to edit this file with the default probe, use the command
go run github.com/fullstack-lang/gong/lib/doc/go/models/probe/cmd/probe@v0.0.0-20260920161302-d4596dcf453a stage.go
*/
package diagrams
...
func _(stage *models.Stage) {
	...
	__AttributeShape__00000002_ := (&models.AttributeShape{Name: `Foo`}).Stage(stage)
	__AttributeShape__00000003_ := (&models.AttributeShape{Name: `Bar`}).Stage(stage)
	__AttributeShape__00000004_ := (&models.AttributeShape{Name: `Zorgh`}).Stage(stage)
	...
	__DiagramPackage__00000000_ := (&models.DiagramPackage{Name: `Diagram Package created the 2026-09-20T17:03:23Z`}).Stage(stage)
	...
	__AttributeShape__00000002_.Name = `Foo`
	__AttributeShape__00000002_.IdentifierMeta = ref_models.A{}.Foo
	__AttributeShape__00000002_.FieldTypeAsString = ``
	__AttributeShape__00000002_.Structname = `A`
	__AttributeShape__00000002_.Fieldtypename = `int`

	__AttributeShape__00000003_.Name = `Bar`
	__AttributeShape__00000003_.IdentifierMeta = ref_models.A{}.Bar
	__AttributeShape__00000003_.FieldTypeAsString = ``
	__AttributeShape__00000003_.Structname = `A`
	__AttributeShape__00000003_.Fieldtypename = `float64`

	__AttributeShape__00000004_.Name = `Zorgh`
	__AttributeShape__00000004_.IdentifierMeta = ref_models.A{}.Zorgh
	__AttributeShape__00000004_.FieldTypeAsString = ``
	__AttributeShape__00000004_.Structname = `A`
	__AttributeShape__00000004_.Fieldtypename = `string`

	__AttributeShape__00000005_.Name = `Name`
	__AttributeShape__00000005_.IdentifierMeta = ref_models.B{}.Name
	__AttributeShape__00000005_.FieldTypeAsString = ``
	__AttributeShape__00000005_.Structname = `B`
	...
	__DiagramPackage__00000000_.Name = `Diagram Package created the 2026-09-20T17:03:23Z`
	...
	__GongStructShape__00000000_.X = 166.000000
	__GongStructShape__00000000_.Y = 46.000000
	__GongStructShape__00000000_.Width = 240.000000
	__GongStructShape__00000000_.Height = 242.000000
	...
	__GongStructShape__00000001_.X = 647.000000
	__GongStructShape__00000001_.Y = 38.000000
	__GongStructShape__00000001_.Width = 240.000000
	__GongStructShape__00000001_.Height = 276.000000
	...
	__LinkShape__00000000_.X = 465.000000
	__LinkShape__00000000_.Y = 105.500000
	__LinkShape__00000000_.StartOrientation = models.ORIENTATION_HORIZONTAL
	__LinkShape__00000000_.StartRatio = 0.251768
	__LinkShape__00000000_.EndOrientation = models.ORIENTATION_HORIZONTAL
	__LinkShape__00000000_.EndRatio = 0.280956
	...
	__LinkShape__00000001_.X = 465.000000
	__LinkShape__00000001_.Y = 105.500000
	__LinkShape__00000001_.StartOrientation = models.ORIENTATION_HORIZONTAL
	__LinkShape__00000001_.StartRatio = 0.776459
	__LinkShape__00000001_.EndOrientation = models.ORIENTATION_HORIZONTAL
	__LinkShape__00000001_.EndRatio = 0.680956
