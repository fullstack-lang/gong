...
func (stage *Stage) GetInstancesByOrder[T PointerToGongstruct]() (res []T) {
	...
	case *Y:
		tmp := getStructInstancesByOrder(stage.Ys, stage.Y_stagedOrder)
...
func (stage *Stage) GetNamedStructNamesByOrder(namedStructName string) (res []string) {
	...
	// insertion point for case
	case "Y":
		res = GetNamedStructInstances(stage.Ys, stage.Y_stagedOrder)
	}
...
func (y *Y) CommitVoid(stage *Stage) {
	y.Commit(stage)
}
...
func (y *Y) GongSetFieldValue(fieldName string, value GongFieldValue, stage *Stage) error {
	switch fieldName {
	// insertion point for per field code
	case "Name":
		y.Name = value.GetValueString()
	default:
