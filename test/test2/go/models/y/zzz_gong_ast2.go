...
type YUnmarshaller struct{}

func (u *YUnmarshaller) Initialize(stage *Stage, identifier string, instanceName string, preserveOrder bool) (GongstructIF, error) {
	return GongInitialize(new(Y), stage, identifier, instanceName, preserveOrder)
}

func (u *YUnmarshaller) UnmarshallField(stage *Stage, i GongstructIF, fieldName string, valueExpr ast.Expr, identifierMap map[string]GongstructIF) error {
	instance := i.(*Y)
	_ = instance
	switch fieldName {
