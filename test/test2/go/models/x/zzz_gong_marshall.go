...
const GongIdentifiersDecls = `
	{{Identifier}} := (&x.{{GeneratedStructName}}{Name: {{GeneratedFieldNameValue}}}).Stage(stage)`
...
func (stage *Stage) MarshallFile(filename, modelsPackageName, packageName string) {
	...
	if stage.GetGongMarshallingMode() == GongMarshallingAppendCommit {
		...
		if stage.isSquashing {
			...
			const fnSig = "func _(stage *x.Stage) {"
		...
		emptyBody := stage.isSquashing ||
			strings.HasSuffix(trimmedContentBeforeBrace, "func _(stage *x.Stage) {") ||
...
func (stage *Stage) MarshallToString(modelsPackageName, packageName string) (res string, err error) {
	...
	gongMarshallInstances(stage, stage.Xs, &identifiersDecl, &initializerStatements, &pointersInitializesStatements)
...
func (x *X) GongMarshallField(stage *Stage, fieldName string) (res string) {
	ident := x.GongGetIdentifier(stage)
	_ = ident
	switch fieldName {
	case "Name":
		res = __gong__marshallString(ident, "Name", x.Name)
