...
func (stage *Stage) GetInstances() (res []GongstructIF) {
	// insertion point per named struct
	res = __gong__appendInstances(res, stage.SubModels)
...
// insertion point per named struct
func (submodel *SubModel) GongGetUUID(stage *Stage) string {
	return __gong__getUUID(stage, submodel)
}
...
func (stage *Stage) ComputeReferenceAndOrders() {
	// insertion point per named struct
	__gong__computeReferencePass1(stage, stage.SubModels, &stage.SubModels_reference, &stage.SubModels_referenceOrder, &stage.SubModels_instance)

	// insertion point per named struct
	__gong__computeReferencePass2(stage.SubModels, stage.SubModels_reference, stage)
...
func (submodel *SubModel) GongGetOrder(stage *Stage) uint {
	return __gong__getOrder(stage.SubModel_stagedOrder, stage.SubModels_referenceOrder, submodel, "SubModel")
}
...
func (submodel *SubModel) GongGetIdentifier(stage *Stage) string {
	return __gong__formatIdentifier(submodel, submodel.GongGetOrder(stage))
}

// GongGetReferenceIdentifier returns an identifier when it was staged (it may have been unstaged since)
func (submodel *SubModel) GongGetReferenceIdentifier(stage *Stage) string {
	return submodel.GongGetIdentifier(stage)
}

// MarshallIdentifier returns the code to instantiate the instance
// in a marshalling file
// insertion point per named struct
func (submodel *SubModel) GongMarshallIdentifier(stage *Stage) string {
	return __gong__marshallIdentifier(submodel.GongGetIdentifier(stage), "SubModel", submodel.Name)
}

// insertion point for unstaging
func (submodel *SubModel) GongMarshallUnstaging(stage *Stage) string {
	return __gong__marshallUnstaging(submodel.GongGetReferenceIdentifier(stage))
}
