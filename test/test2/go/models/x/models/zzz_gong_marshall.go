...
func (stage *Stage) MarshallToString(modelsPackageName, packageName string) (res string, err error) {
	...
	gongMarshallInstances(stage, stage.SubModels, &identifiersDecl, &initializerStatements, &pointersInitializesStatements)
...
func (submodel *SubModel) GongMarshallField(stage *Stage, fieldName string) (res string) {
	ident := submodel.GongGetIdentifier(stage)
	_ = ident
	switch fieldName {
	case "Name":
		res = __gong__marshallString(ident, "Name", submodel.Name)
