...
type Stage struct {
	...
	SubModels                map[*SubModel]struct{}
	SubModels_instance       map[*SubModel]*SubModel
	SubModels_mapString      map[string]*SubModel
	SubModelOrder            uint
	SubModel_stagedOrder     map[*SubModel]uint
	SubModel_orderStaged     map[uint]*SubModel
	SubModels_reference      map[*SubModel]*SubModel
	SubModels_referenceOrder map[*SubModel]uint
...
func NewStage(name string) (stage *Stage) {
	stage = &Stage{ // insertion point for array initiatialisation
		SubModels:           make(map[*SubModel]struct{}),
		SubModels_mapString: make(map[string]*SubModel),
		...
		SubModel_stagedOrder: make(map[*SubModel]uint),
		SubModel_orderStaged: make(map[uint]*SubModel),
		SubModels_reference:  make(map[*SubModel]*SubModel),

		// end of insertion point
		GongUnmarshallers: map[string]GongModelUnmarshaller{ // insertion point for unmarshallers
			"SubModel": &SubModelUnmarshaller{},
...
func (stage *Stage) GetInstanceFromOrder[Type GongstructPtr](order uint) (res Type) {
	...
	// insertion point for order map initialisations
	case *SubModel:
		return any(stage.SubModel_orderStaged[order]).(Type)
	default:
...
func (stage *Stage) ComputeInstancesNb() {
	...
	stage.Map_GongStructName_InstancesNb["SubModel"] = len(stage.SubModels)
}
...
// StagePreserveOrder puts submodel to the model stage, and if the astrtuct
...
func (submodel *SubModel) GetName() (res string) {
	return submodel.Name
}

// for satisfaction of GongStruct interface
func (submodel *SubModel) SetName(name string) {
	submodel.Name = name
}
...
func (stage *Stage) GetInstancesMapByName[Type GongstructIF]() map[string]Type {
	...
	case *SubModel:
		return any(stage.SubModels_mapString).(map[string]Type)
	default:
		return nil
	}
}
...
func (stage *Stage) GetInstancesSet[Type GongstructPtr]() *map[Type]struct{} {
	...
	// insertion point for generic get functions
	case *SubModel:
		return any(&stage.SubModels).(*map[Type]struct{})
	default:
		return nil
	}
}
...
func (stage *Stage) GetPointerReverseMap[Start, End Gongstruct](fieldname string) map[*End][]*Start {
	...
	// reverse maps of direct associations of SubModel
	case SubModel:
		switch fieldname {
...
func (submodel *SubModel) GongGetFieldHeaders() (res []GongFieldHeader) {
...
func (submodel *SubModel) GongGetFieldValue(fieldName string, stage *Stage) (res GongFieldValue) {
	switch fieldName {
	// string value of fields
	case "Name":
		res.valueString = submodel.Name
	}
	return
}
...
// insertion point for generic get gongstruct name
func (submodel *SubModel) GongGetGongstructName() string {
	return "SubModel"
}
