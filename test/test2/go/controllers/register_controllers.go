...
func (controller *Controller) onWebSocketRequestForCommitFromBackNb(c *gin.Context) {
	...
	// log.Println("Stack github.com/fullstack-lang/gong/test2/go, onWebSocketRequestForCommitFromBackNb")
	...
	if backRepo == nil {
		log.Panic("Stack github.com/fullstack-lang/gong/test2/go, Unkown stack", stackPath)
	}
...
func (controller *Controller) onWebSocketRequestForBackRepoContent(c *gin.Context) {
	...
	// log.Println("Stack github.com/fullstack-lang/gong/test2/go, onWebSocketRequestForBackRepoContent")
	...
	// log.Println("Stack github.com/fullstack-lang/gong/test2/go, onWebSocketRequestForBackRepoContent, first sent back repo of", stackPath)
	if err != nil {
		log.Println("client no longer receiver web socket message, assuming it is no longer alive, closing websocket handler")
		fmt.Println(err)
		return
	...
	for nbCommitBackRepo := range updateCommitBackRepoNbChannel {
		...
		// log.Println("Stack github.com/fullstack-lang/gong/test2/go, onWebSocketRequestForBackRepoContent, sent back repo of", stackPath)
