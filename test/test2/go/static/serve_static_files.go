...
import (
	...
	"github.com/fullstack-lang/gong/test/test2"
...
func ServeStaticFiles(logGINFlag bool) (r *gin.Engine) {
	...
	r.Use(static.Serve("/", EmbedFolder(test2.NgDistNg, "ng-github.com-fullstack-lang-gong-test-test2/dist/ng-github.com-fullstack-lang-gong-test-test2/browser")))
