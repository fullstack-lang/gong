...
export class BstructsTableComponent implements OnInit {
    ...
    this.frontRepoService.pull(this.GONG__StackPath).subscribe(
      frontRepo => {
        ...
        if (this.mode == TableComponentMode.MANY_MANY_ASSOCIATION_MODE) {
          ...
          // we associates on sourceInstance of type SourceStruct with a MANY MANY associations to BstructDB
          // the field name is sourceField
          let sourceFieldArray = sourceInstance[this.dialogData.SourceField as keyof typeof sourceInstance]! as unknown as BstructDB[]
  ...
  deleteBstruct(bstructID: number, bstruct: BstructDB) {
    ...
    this.bstructService.deleteBstruct(bstructID, this.GONG__StackPath).subscribe(
      bstruct => {
  ...
  setEditorRouterOutlet(bstructID: number) {
    ...
    let fullPath = this.routeService.getPathRoot() + "-" + "bstruct" + "-detail"

    let outletConf: any = {}
    outletConf[outletName] = [fullPath, bstructID, this.GONG__StackPath]
