...
export class AclassBclassUseDetailComponent implements OnInit {
	...
	save(): void {
		...
		if (this.aclassbclassuse.BclassID == undefined) {
			this.aclassbclassuse.BclassID = new NullInt64
		}
		if (this.aclassbclassuse.Bclass != undefined) {
			this.aclassbclassuse.BclassID.Int64 = this.aclassbclassuse.Bclass.ID
			this.aclassbclassuse.BclassID.Valid = true
		} else {
			this.aclassbclassuse.BclassID.Int64 = 0
			this.aclassbclassuse.BclassID.Valid = true
		}
