...
export class AstructBstruct2UsesTableComponent implements OnInit {
    ...
    this.frontRepoService.pull(this.GONG__StackPath).subscribe(
      frontRepo => {
        ...
        if (this.mode == TableComponentMode.MANY_MANY_ASSOCIATION_MODE) {
          ...
          // we associates on sourceInstance of type SourceStruct with a MANY MANY associations to AstructBstruct2UseDB
          // the field name is sourceField
          let sourceFieldArray = sourceInstance[this.dialogData.SourceField as keyof typeof sourceInstance]! as unknown as AstructBstruct2UseDB[]
  ...
  deleteAstructBstruct2Use(astructbstruct2useID: number, astructbstruct2use: AstructBstruct2UseDB) {
    ...
    this.astructbstruct2useService.deleteAstructBstruct2Use(astructbstruct2useID, this.GONG__StackPath).subscribe(
      astructbstruct2use => {
