...
export class AstructService {
  ...
  getAstructs(): Observable<AstructDB[]> {
    ...
    this.params = this.params.set('stack', "A");

    return this.http.get<AstructDB[]>(this.astructsUrl, { params: this.params })
      .pipe(
  ...
  getAstruct(id: number): Observable<AstructDB> {
    ...
    return this.http.get<AstructDB>(url, { params: this.params }).pipe(
  ...
  postAstruct(astructdb: AstructDB): Observable<AstructDB> {
    ...
    return this.http.post<AstructDB>(
      this.astructsUrl,
      astructdb,
      this.httpOptions,
    ).pipe(
