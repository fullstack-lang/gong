...
import (
	...
	"github.com/fullstack-lang/gong/test/test1"
...
func ServeStaticFiles(logGINFlag bool) (r *gin.Engine) {
	...
	r.Use(static.Serve("/", EmbedFolder(test1.NgDistNg, "ng-github.com-fullstack-lang-gong-test-test1/dist/ng-github.com-fullstack-lang-gong-test-test1/browser")))
