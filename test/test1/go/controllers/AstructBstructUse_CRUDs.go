...
func (controller *Controller) GetAstructBstructUses(w http.ResponseWriter, r *http.Request) {
	...
	if len(_values) == 1 {
		...
		if len(value) == 1 {
			stackPath = value[0]
			// log.Println("GetAstructBstructUses", "Name", stackPath)
		}
	}
	...
	writeJSON(w, http.StatusOK, astructbstructuseAPIs)
}
...
//	Responses:
//	  200: nodeDBResponse
func (controller *Controller) PostAstructBstructUse(w http.ResponseWriter, r *http.Request) {
	...
	if len(_values) == 1 {
		...
		if len(value) == 1 {
			stackPath = value[0]
			// log.Println("PostAstructBstructUses", "Name", stackPath)
		}
	}
	backRepo := controller.Map_BackRepos[stackPath]
	if backRepo == nil {
	...
	if astructbstructuse != nil {
		backRepo.GetStage().AfterCreateFromFront(astructbstructuse)
	}
...
//
//	200: astructbstructuseDBResponse
func (controller *Controller) GetAstructBstructUse(w http.ResponseWriter, r *http.Request) {
	...
	if len(_values) == 1 {
		...
		if len(value) == 1 {
			stackPath = value[0]
			// log.Println("GetAstructBstructUse", "Name", stackPath)
		}
	}
	backRepo := controller.Map_BackRepos[stackPath]
	if backRepo == nil {
	...
	if _, err := db.First(&astructbstructuseDB, r.PathValue("id")); err != nil {
		var returnError GenericError
		returnError.Body.Code = http.StatusBadRequest
		returnError.Body.Message = err.Error()
		log.Println(err.Error())
	...
	writeJSON(w, http.StatusOK, astructbstructuseAPI)
}
...
//
//	200: astructbstructuseDBResponse
func (controller *Controller) DeleteAstructBstructUse(w http.ResponseWriter, r *http.Request) {
	...
	if len(_values) == 1 {
		...
		if len(value) == 1 {
			stackPath = value[0]
			// log.Println("DeleteAstructBstructUse", "Name", stackPath)
		}
	}
	backRepo := controller.Map_BackRepos[stackPath]
	if backRepo == nil {
	...
	if astructbstructuseStaged != nil {
		backRepo.GetStage().AfterDeleteFromFront(astructbstructuseStaged, astructbstructuseDeleted)
	}
