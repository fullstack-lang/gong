...
func (controller *Controller) PostF0123456789012345678901234567890(w http.ResponseWriter, r *http.Request) {
	...
	if f0123456789012345678901234567890 != nil {
		backRepo.GetStage().AfterCreateFromFront(f0123456789012345678901234567890)
	}
...
func (controller *Controller) DeleteF0123456789012345678901234567890(w http.ResponseWriter, r *http.Request) {
	...
	if f0123456789012345678901234567890Staged != nil {
		backRepo.GetStage().AfterDeleteFromFront(f0123456789012345678901234567890Staged, f0123456789012345678901234567890Deleted)
	}
