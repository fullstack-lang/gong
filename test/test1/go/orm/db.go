...
import (
	...
	"github.com/fullstack-lang/gong/test/test1/go/db"
)
...
func (db *DBLite) Create(instanceDB any) (db.DBInterface, error) {
	if instanceDB == nil {
		return nil, errors.New("github.com/fullstack-lang/gong/test/test1/go, instanceDB cannot be nil")
	}
	...
	default:
		return nil, errors.New("github.com/fullstack-lang/gong/test/test1/go, unsupported type in Create")
	}
	return db, nil
}
...
func (db *DBLite) Delete(instanceDB any) (db.DBInterface, error) {
	...
	default:
		return nil, errors.New("github.com/fullstack-lang/gong/test/test1/go, unsupported type in Delete")
	}
	return db, nil
}
...
func (db *DBLite) Save(instanceDB any) (db.DBInterface, error) {
	...
	case *GstructDB:
		...
		return db, nil
	default:
		return nil, errors.New("github.com/fullstack-lang/gong/test/test1/go, Save: unsupported type")
	}
}
	...
	case *AstructDB:
		if existing, ok := db.astructDBs[v.ID]; ok {
			*existing = *v
			...
			return nil, errors.New("db Astruct github.com/fullstack-lang/gong/test/test1/go, record not found")
		}
	case *AstructBstruct2UseDB:
		if existing, ok := db.astructbstruct2useDBs[v.ID]; ok {
			*existing = *v
		} else {
			return nil, errors.New("db AstructBstruct2Use github.com/fullstack-lang/gong/test/test1/go, record not found")
		}
	case *AstructBstructUseDB:
		if existing, ok := db.astructbstructuseDBs[v.ID]; ok {
			*existing = *v
		} else {
			return nil, errors.New("db AstructBstructUse github.com/fullstack-lang/gong/test/test1/go, record not found")
		}
	case *BstructDB:
		if existing, ok := db.bstructDBs[v.ID]; ok {
			*existing = *v
		} else {
			return nil, errors.New("db Bstruct github.com/fullstack-lang/gong/test/test1/go, record not found")
		}
	case *DstructDB:
		if existing, ok := db.dstructDBs[v.ID]; ok {
			*existing = *v
		} else {
			return nil, errors.New("db Dstruct github.com/fullstack-lang/gong/test/test1/go, record not found")
		}
	case *F0123456789012345678901234567890DB:
		if existing, ok := db.f0123456789012345678901234567890DBs[v.ID]; ok {
			*existing = *v
		} else {
			return nil, errors.New("db F0123456789012345678901234567890 github.com/fullstack-lang/gong/test/test1/go, record not found")
		}
	case *GstructDB:
		if existing, ok := db.gstructDBs[v.ID]; ok {
			*existing = *v
		} else {
			return nil, errors.New("db Gstruct github.com/fullstack-lang/gong/test/test1/go, record not found")
		}
	default:
		return nil, errors.New("github.com/fullstack-lang/gong/test/test1/go, unsupported type in Updates")
	}
	return db, nil
}
...
func (db *DBLite) Find(instanceDBs any) (db.DBInterface, error) {
	...
	case *[]GstructDB:
		*ptr = make([]GstructDB, 0, len(db.gstructDBs))
		...
		return db, nil
	default:
		return nil, errors.New("github.com/fullstack-lang/gong/test/test1/go, Find: unsupported type")
	}
}
...
func (db *DBLite) First(instanceDB any, conds ...any) (db.DBInterface, error) {
	if len(conds) != 1 {
		return nil, errors.New("github.com/fullstack-lang/gong/test/test1/go, Do not process when conds is not a single parameter")
	}
	...
	case string:
		...
		if err != nil {
			return nil, errors.New("github.com/fullstack-lang/gong/test/test1/go, conds[0] is not a string number")
		}
	case uint64:
		i = cond
	case uint:
		i = uint64(cond)
	default:
		return nil, errors.New("github.com/fullstack-lang/gong/test/test1/go, conds[0] is not a string or uint64")
	}
	...
	default:
		return nil, errors.New("github.com/fullstack-lang/gong/test/test1/go, Unkown type")
	}
