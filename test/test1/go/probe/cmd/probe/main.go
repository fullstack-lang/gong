...
import (
	...
	"github.com/fullstack-lang/gong/test/test1/go/level1stack"
...
func executeServer() {
	...
	stack := level1stack.NewLevel1Stack("test1", unmarshallFromCode, marshallOnCommit, true, embeddedDiagrams)
