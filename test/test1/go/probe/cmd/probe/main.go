...
import (
	...
	"github.com/fullstack-lang/gong/test/test1/go/stack"
	"github.com/fullstack-lang/gong/test/test1/go/static"
...
func executeServer() {
	...
	stack := stack.NewStack(r, "test1", unmarshallFromCode, marshallOnCommit, "", embeddedDiagrams, true)
