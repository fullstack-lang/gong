...
export class AstructBstruct2UseService {
  ...
  constructor(
    ...
    this.astructbstruct2usesUrl = origin + '/api/github.com/fullstack-lang/gong/test/test1/go/v1/astructbstruct2uses';
  }
  ...
  postFront(astructbstruct2use: AstructBstruct2Use, Name: string): Observable<AstructBstruct2UseAPI> {
    ...
    return this.http.post<AstructBstruct2UseAPI>(this.astructbstruct2usesUrl, astructbstruct2useAPI, httpOptions).pipe(
      tap(_ => {
      }),
