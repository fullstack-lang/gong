...
export class BstructService {
  ...
  constructor(
    ...
    this.bstructsUrl = origin + '/api/github.com/fullstack-lang/gong/test/test1/go/v1/bstructs';
  }
  ...
  postFront(bstruct: Bstruct, Name: string): Observable<BstructAPI> {
    ...
    return this.http.post<BstructAPI>(this.bstructsUrl, bstructAPI, httpOptions).pipe(
      tap(_ => {
      }),
