...
export class AstructBstructUseService {
  ...
  constructor(
    ...
    this.astructbstructusesUrl = origin + '/api/github.com/fullstack-lang/gong/test/test1/go/v1/astructbstructuses';
  }
  ...
  postFront(astructbstructuse: AstructBstructUse, Name: string): Observable<AstructBstructUseAPI> {
    ...
    return this.http.post<AstructBstructUseAPI>(this.astructbstructusesUrl, astructbstructuseAPI, httpOptions).pipe(
      tap(_ => {
      }),
