...
export class GstructService {
  ...
  constructor(
    ...
    this.gstructsUrl = origin + '/api/github.com/fullstack-lang/gong/test/test1/go/v1/gstructs';
  }
  ...
  postFront(gstruct: Gstruct, Name: string): Observable<GstructAPI> {
    ...
    return this.http.post<GstructAPI>(this.gstructsUrl, gstructAPI, httpOptions).pipe(
      tap(_ => {
      }),
