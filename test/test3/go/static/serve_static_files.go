...
import (
	...
	"github.com/fullstack-lang/gong/test3"
...
func ServeStaticFiles(logGINFlag bool) (r *gin.Engine) {
	...
	r.Use(static.Serve("/", EmbedFolder(test3.NgDistNg, "ng-github.com-fullstack-lang-gong-test3/dist/ng-github.com-fullstack-lang-gong-test3/browser")))
