...
func (controller *Controller) PostA(c *gin.Context) {
	...
	backRepo := controller.Map_BackRepos[stackPath]
	if backRepo == nil {
		message := "Post Stack github.com/fullstack-lang/gong/test/test3/go, Unkown stack: \"" + stackPath + "\"\n"
...
func (controller *Controller) UpdateA(c *gin.Context) {
	...
	backRepo := controller.Map_BackRepos[stackPath]
	if backRepo == nil {
		message := "PATCH Stack github.com/fullstack-lang/gong/test/test3/go, Unkown stack: \"" + stackPath + "\"\n"
	...
	if aOld != nil {
		if !hasMouseEvent {
			models.OnAfterUpdateFromFront(backRepo.GetStage(), aOld, aNew, nil)
		} else {
			mouseEvent := &models.Gong__MouseEvent{
				ShiftKey: shiftKey,
			}
			models.OnAfterUpdateFromFront(backRepo.GetStage(), aOld, aNew, mouseEvent)
...
func (controller *Controller) DeleteA(c *gin.Context) {
	...
	backRepo := controller.Map_BackRepos[stackPath]
	if backRepo == nil {
		message := "DELETE Stack github.com/fullstack-lang/gong/test/test3/go, Unkown stack: \"" + stackPath + "\"\n"
