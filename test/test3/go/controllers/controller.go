...
import (
	...
	test3_orm "github.com/fullstack-lang/gong/test/test3/go/orm"
...
type Controller struct {
	...
	Map_BackRepos map[string]*test3_orm.BackRepoStruct
...
func GetController() *Controller {
	doControllerInitOnce.Do(func() {
		_controllerSingloton = &Controller{
			Map_BackRepos: make(map[string]*test3_orm.BackRepoStruct),
		}
	})
	return _controllerSingloton
}

func (controller *Controller) AddBackRepo(backRepo *test3_orm.BackRepoStruct, stackPath string) {
