...
import (
	...
	"github.com/fullstack-lang/gong/test/test3/go/models/probe"

	embeddedgo "github.com/fullstack-lang/gong/test/test3/go"
...
func (impl *BeforeCommitImplementation) BeforeCommit(stage *models.Stage) {
	...
	stage.MarshallFile(fmt.Sprintf("./%s", filename), "github.com/fullstack-lang/gong/test/test3/go/models", packageName)
}
