...
export const StackType = "github.com/fullstack-lang/gong/test/test3/go/models"
...
export class FrontRepoService {
	...
	public connectToWebSocket(Name: string): Observable<FrontRepo> {
		...
		let basePath = 'ws://localhost:8080/api/github.com/fullstack-lang/gong/test/test3/go/v1/ws/stage'
