...
import { Test3specificComponent } from '../../projects/test3specific/src/public-api'
...
export class AppComponent implements OnInit {
  ...
  test3 = 'Test3'
  probe = 'Test3 Data/Model'
  view = this.test3

  views: string[] = [this.test3, this.probe];
