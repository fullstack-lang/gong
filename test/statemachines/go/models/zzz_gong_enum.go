...
func (stacksnames *StacksNames) FromString(input string) (err error) {
	...
	// insertion code per enum code
	case "GongsvgStack":
		*stacksnames = GongsvgStack
		return
	case "Object tree":
		*stacksnames = ObjectTree
		return
	case "Diagram tree":
		*stacksnames = DiagramTree
		return
	case "Button Stack Name":
...
func (stacksnames StacksNames) Codes() (res []string) {
	...
	// insertion code per enum code
	res = append(res, "GongsvgStack")
	res = append(res, "ObjectTree")
	res = append(res, "DiagramTree")
...
func (stacksnames StacksNames) CodeValues() (res []string) {
	...
	// insertion code per enum code
	res = append(res, "GongsvgStack")
	res = append(res, "Object tree")
	res = append(res, "Diagram tree")
	res = append(res, "Button Stack Name")
