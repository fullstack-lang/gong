...
func registerControllers(r *gin.Engine) {
	v1 := r.Group("/api/github.com/fullstack-lang/gong/test/statemachines/go")
	{ // insertion point for registrations
		v1.GET("/v1/architectures", GetController().GetArchitectures)
		v1.GET("/v1/architectures/:id", GetController().GetArchitecture)
		v1.POST("/v1/architectures", GetController().PostArchitecture)
		v1.PATCH("/v1/architectures/:id", GetController().UpdateArchitecture)
		v1.PUT("/v1/architectures/:id", GetController().UpdateArchitecture)
		v1.DELETE("/v1/architectures/:id", GetController().DeleteArchitecture)
		...
		v1.GET("/v1/messagetypes", GetController().GetMessageTypes)
		v1.GET("/v1/messagetypes/:id", GetController().GetMessageType)
		v1.POST("/v1/messagetypes", GetController().PostMessageType)
		v1.PATCH("/v1/messagetypes/:id", GetController().UpdateMessageType)
		v1.PUT("/v1/messagetypes/:id", GetController().UpdateMessageType)
		v1.DELETE("/v1/messagetypes/:id", GetController().DeleteMessageType)
		...
		v1.GET("/v1/roles", GetController().GetRoles)
		v1.GET("/v1/roles/:id", GetController().GetRole)
		v1.POST("/v1/roles", GetController().PostRole)
		v1.PATCH("/v1/roles/:id", GetController().UpdateRole)
		v1.PUT("/v1/roles/:id", GetController().UpdateRole)
		v1.DELETE("/v1/roles/:id", GetController().DeleteRole)

		v1.GET("/v1/states", GetController().GetStates)
		v1.GET("/v1/states/:id", GetController().GetState)
		v1.POST("/v1/states", GetController().PostState)
		v1.PATCH("/v1/states/:id", GetController().UpdateState)
		v1.PUT("/v1/states/:id", GetController().UpdateState)
		v1.DELETE("/v1/states/:id", GetController().DeleteState)

		v1.GET("/v1/statemachines", GetController().GetStateMachines)
		v1.GET("/v1/statemachines/:id", GetController().GetStateMachine)
		v1.POST("/v1/statemachines", GetController().PostStateMachine)
		v1.PATCH("/v1/statemachines/:id", GetController().UpdateStateMachine)
		v1.PUT("/v1/statemachines/:id", GetController().UpdateStateMachine)
		v1.DELETE("/v1/statemachines/:id", GetController().DeleteStateMachine)

		v1.GET("/v1/stateshapes", GetController().GetStateShapes)
		v1.GET("/v1/stateshapes/:id", GetController().GetStateShape)
		v1.POST("/v1/stateshapes", GetController().PostStateShape)
		v1.PATCH("/v1/stateshapes/:id", GetController().UpdateStateShape)
		v1.PUT("/v1/stateshapes/:id", GetController().UpdateStateShape)
		v1.DELETE("/v1/stateshapes/:id", GetController().DeleteStateShape)

		v1.GET("/v1/transitions", GetController().GetTransitions)
		v1.GET("/v1/transitions/:id", GetController().GetTransition)
		v1.POST("/v1/transitions", GetController().PostTransition)
		v1.PATCH("/v1/transitions/:id", GetController().UpdateTransition)
		v1.PUT("/v1/transitions/:id", GetController().UpdateTransition)
		v1.DELETE("/v1/transitions/:id", GetController().DeleteTransition)

		v1.GET("/v1/transition_shapes", GetController().GetTransition_Shapes)
		v1.GET("/v1/transition_shapes/:id", GetController().GetTransition_Shape)
		v1.POST("/v1/transition_shapes", GetController().PostTransition_Shape)
		v1.PATCH("/v1/transition_shapes/:id", GetController().UpdateTransition_Shape)
		v1.PUT("/v1/transition_shapes/:id", GetController().UpdateTransition_Shape)
		v1.DELETE("/v1/transition_shapes/:id", GetController().DeleteTransition_Shape)
...
func (controller *Controller) onWebSocketRequestForBackRepoContent(c *gin.Context) {
	...
	// log.Println("Stack github.com/fullstack-lang/gong/test/statemachines/go, onWebSocketRequestForBackRepoContent")
	...
	if backRepo == nil {
		message := "WebSocket Connect, Stack github.com/fullstack-lang/gong/test/statemachines/go, Unkown stack: \"" + stackPath + "\"\n"
	...
	go func() {
		for {
			...
			if err != nil {
				log.Println("github.com/fullstack-lang/gong/test/statemachines/go", stackPath, "WS client disconnected:", err)
	...
	if err != nil {
		log.Println("github.com/fullstack-lang/gong/test/statemachines/go:\n",
		...
		parts := strings.Split("github.com/fullstack-lang/gong/test/statemachines/go", "/") // Assuming goFilePath holds the path
		component := "unknown"
		if len(parts) > 2 {
