...
import (
	...
	statemachines_orm "github.com/fullstack-lang/gong/test/statemachines/go/orm"
...
type Controller struct {
	...
	Map_BackRepos map[string]*statemachines_orm.BackRepoStruct
...
func GetController() *Controller {
	doControllerInitOnce.Do(func() {
		_controllerSingloton = &Controller{
			Map_BackRepos: make(map[string]*statemachines_orm.BackRepoStruct),
		}
	})
	return _controllerSingloton
}

func (controller *Controller) AddBackRepo(backRepo *statemachines_orm.BackRepoStruct, stackPath string) {
