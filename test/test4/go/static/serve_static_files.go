...
import (
	...
	"github.com/fullstack-lang/gong/test/test4"
...
func ServeStaticFiles(logGINFlag bool) (r *gin.Engine) {
	...
	r.Use(static.Serve("/", EmbedFolder(test4.NgDistNg, "ng-github.com-fullstack-lang-gong-test-test4/dist/ng-github.com-fullstack-lang-gong-test-test4/browser")))
