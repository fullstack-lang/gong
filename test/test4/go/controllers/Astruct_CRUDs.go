...
func (controller *Controller) PostAstruct(c *gin.Context) {
	...
	backRepo := controller.Map_BackRepos[stackPath]
	if backRepo == nil {
		message := "Post Stack github.com/fullstack-lang/gong/test/test4/go, Unkown stack: \"" + stackPath + "\"\n"
...
func (controller *Controller) UpdateAstruct(c *gin.Context) {
	...
	backRepo := controller.Map_BackRepos[stackPath]
	if backRepo == nil {
		message := "PATCH Stack github.com/fullstack-lang/gong/test/test4/go, Unkown stack: \"" + stackPath + "\"\n"
	...
	if astructOld != nil {
		models.OnAfterUpdateFromFront(backRepo.GetStage(), astructOld, astructNew)
	}
...
func (controller *Controller) DeleteAstruct(c *gin.Context) {
	...
	backRepo := controller.Map_BackRepos[stackPath]
	if backRepo == nil {
		message := "DELETE Stack github.com/fullstack-lang/gong/test/test4/go, Unkown stack: \"" + stackPath + "\"\n"
