...
import (
	...
	test4_orm "github.com/fullstack-lang/gong/test/test4/go/orm"
...
type Controller struct {
	...
	Map_BackRepos map[string]*test4_orm.BackRepoStruct
...
func GetController() *Controller {
	doControllerInitOnce.Do(func() {
		_controllerSingloton = &Controller{
			Map_BackRepos: make(map[string]*test4_orm.BackRepoStruct),
		}
	})
	return _controllerSingloton
}

func (controller *Controller) AddBackRepo(backRepo *test4_orm.BackRepoStruct, stackPath string) {
