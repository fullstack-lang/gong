...
func registerControllers(r *gin.Engine) {
	v1 := r.Group("/api/github.com/fullstack-lang/gong/test/test4/go")
...
func (controller *Controller) onWebSocketRequestForBackRepoContent(c *gin.Context) {
	...
	// log.Println("Stack github.com/fullstack-lang/gong/test/test4/go, onWebSocketRequestForBackRepoContent")
	...
	if backRepo == nil {
		message := "WebSocket Connect, Stack github.com/fullstack-lang/gong/test/test4/go, Unkown stack: \"" + stackPath + "\"\n"
	...
	go func() {
		for {
			...
			if err != nil {
				log.Println("github.com/fullstack-lang/gong/test/test4/go", stackPath, "WS client disconnected:", err)
	...
	if err != nil {
		log.Println("github.com/fullstack-lang/gong/test/test4/go:\n",
		...
		parts := strings.Split("github.com/fullstack-lang/gong/test/test4/go", "/") // Assuming goFilePath holds the path
		component := "unknown"
		if len(parts) > 2 {
...
func (controller *Controller) GetLastCommitFromBackNb(c *gin.Context) {
	...
	backRepo := controller.Map_BackRepos[stackPath]
	if backRepo == nil {
		message := "Stack github.com/fullstack-lang/gong/test/test4/go, Unkown stack: \"" + stackPath + "\"\n"
...
func (controller *Controller) GetLastPushFromFrontNb(c *gin.Context) {
	...
	backRepo := controller.Map_BackRepos[stackPath]
	if backRepo == nil {
		message := "GET Stack github.com/fullstack-lang/gong/test/test4/go, Unkown stack: \"" + stackPath + "\"\n"
