...
func _(stage *models.Stage) {
	...
	__GongStructShape__00000000_ := (&models.GongStructShape{Name: `Default-Astruct`}).Stage(stage)

	// insertion point for initialization of values

	__AttributeShape__00000000_.Name = `Name`
	__AttributeShape__00000000_.IdentifierMeta = ref_models.Astruct{}.Name
	__AttributeShape__00000000_.FieldTypeAsString = ``
	__AttributeShape__00000000_.Structname = `Astruct`
	...
	__Classdiagram__00000000_.NodeGongStructNodeExpansion = `[true]`
	...
	__GongStructShape__00000000_.Name = `Default-Astruct`
	__GongStructShape__00000000_.X = 68.000000
	__GongStructShape__00000000_.Y = 61.000000
	__GongStructShape__00000000_.IdentifierMeta = ref_models.Astruct{}
