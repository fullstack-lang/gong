...
import (
	...
	embeddedgo "github.com/fullstack-lang/gong/test/test4/go"
...
func (impl *BeforeCommitImplementation) BeforeCommit(stage *models.Stage) {
	...
	stage.MarshallFile(fmt.Sprintf("./%s", filename), "github.com/fullstack-lang/gong/test/test4/go/models", packageName)
}
