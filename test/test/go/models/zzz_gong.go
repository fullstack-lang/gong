...
func (stage *Stage) recomputeOrders() {
	...
	for _, order := range stage.Astruct_stagedOrder {
	...
	for _, order := range stage.AstructBstruct2Use_stagedOrder {
	...
	for _, order := range stage.AstructBstructUse_stagedOrder {
	...
	for _, order := range stage.Bstruct_stagedOrder {
	...
	for _, order := range stage.Dstruct_stagedOrder {
	...
	for _, order := range stage.F0123456789012345678901234567890_stagedOrder {
	...
	for _, order := range stage.Gstruct_stagedOrder {
...
func (stage *Stage) GetNamedStructNamesByOrder(namedStructName string) (res []string) {
	...
	// insertion point for case
	case "Astruct":
		res = GetNamedStructInstances(stage.Astructs, stage.Astruct_stagedOrder)
	case "AstructBstruct2Use":
		res = GetNamedStructInstances(stage.AstructBstruct2Uses, stage.AstructBstruct2Use_stagedOrder)
	case "AstructBstructUse":
		res = GetNamedStructInstances(stage.AstructBstructUses, stage.AstructBstructUse_stagedOrder)
	case "Bstruct":
		res = GetNamedStructInstances(stage.Bstructs, stage.Bstruct_stagedOrder)
	case "Dstruct":
		res = GetNamedStructInstances(stage.Dstructs, stage.Dstruct_stagedOrder)
	case "F0123456789012345678901234567890":
		res = GetNamedStructInstances(stage.F0123456789012345678901234567890s, stage.F0123456789012345678901234567890_stagedOrder)
	case "Gstruct":
		res = GetNamedStructInstances(stage.Gstructs, stage.Gstruct_stagedOrder)
	}
...
func GetOrder[Type Gongstruct](stage *Stage, instance *Type) uint {
	...
	// insertion point for order map initialisations
	case *Astruct:
		return stage.Astruct_stagedOrder[instance]
	case *AstructBstruct2Use:
		return stage.AstructBstruct2Use_stagedOrder[instance]
	case *AstructBstructUse:
		return stage.AstructBstructUse_stagedOrder[instance]
	case *Bstruct:
		return stage.Bstruct_stagedOrder[instance]
	case *Dstruct:
		return stage.Dstruct_stagedOrder[instance]
	case *F0123456789012345678901234567890:
		return stage.F0123456789012345678901234567890_stagedOrder[instance]
	case *Gstruct:
...
func (astruct *Astruct) Unstage(stage *Stage) *Astruct {
	...
	// issue1150
	// delete(stage.Astruct_stagedOrder, astruct)
...
func (astructbstruct2use *AstructBstruct2Use) Unstage(stage *Stage) *AstructBstruct2Use {
	...
	// issue1150
	// delete(stage.AstructBstruct2Use_stagedOrder, astructbstruct2use)
...
func (astructbstructuse *AstructBstructUse) Unstage(stage *Stage) *AstructBstructUse {
	...
	// issue1150
	// delete(stage.AstructBstructUse_stagedOrder, astructbstructuse)
...
func (bstruct *Bstruct) Unstage(stage *Stage) *Bstruct {
	...
	// issue1150
	// delete(stage.Bstruct_stagedOrder, bstruct)
...
func (dstruct *Dstruct) Unstage(stage *Stage) *Dstruct {
	...
	// issue1150
	// delete(stage.Dstruct_stagedOrder, dstruct)
...
func (f0123456789012345678901234567890 *F0123456789012345678901234567890) Unstage(stage *Stage) *F0123456789012345678901234567890 {
	...
	// issue1150
	// delete(stage.F0123456789012345678901234567890_stagedOrder, f0123456789012345678901234567890)
...
func (gstruct *Gstruct) Unstage(stage *Stage) *Gstruct {
	...
	// issue1150
	// delete(stage.Gstruct_stagedOrder, gstruct)
...
func (stage *Stage) Reset() { // insertion point for array reset
	...
	stage.Astruct_stagedOrder = make(map[*Astruct]uint)
	stage.AstructOrder = 0
	...
	stage.AstructBstruct2Use_stagedOrder = make(map[*AstructBstruct2Use]uint)
	stage.AstructBstruct2UseOrder = 0
	...
	stage.F0123456789012345678901234567890_stagedOrder = make(map[*F0123456789012345678901234567890]uint)
	stage.F0123456789012345678901234567890Order = 0

	stage.Gstructs = make(map[*Gstruct]struct{})
	stage.Gstructs_mapString = make(map[string]*Gstruct)
	stage.Gstruct_stagedOrder = make(map[*Gstruct]uint)
	stage.GstructOrder = 0
...
func (astruct *Astruct) GongGetFieldValue(fieldName string, stage *Stage) (res GongFieldValue) {
	...
	case "Associationtob":
		...
		if astruct.Associationtob != nil {
			...
			res.ids = GenerateReproducibleUUIDv4(GetGongstructNameFromPointer(astruct.Associationtob), uint64(GetOrderPointerGongstruct(stage, astruct.Associationtob)))
		}
	case "Anarrayofb":
	...
	case "Anotherassociationtob_2":
		...
		if astruct.Anotherassociationtob_2 != nil {
			...
			res.ids = GenerateReproducibleUUIDv4(GetGongstructNameFromPointer(astruct.Anotherassociationtob_2), uint64(GetOrderPointerGongstruct(stage, astruct.Anotherassociationtob_2)))
		}
	case "Date":
	...
	case "Bstruct":
		...
		if astruct.Bstruct != nil {
			...
			res.ids = GenerateReproducibleUUIDv4(GetGongstructNameFromPointer(astruct.Bstruct), uint64(GetOrderPointerGongstruct(stage, astruct.Bstruct)))
		}
	case "Bstruct2":
		res.GongFieldValueType = GongFieldValueTypePointer
		if astruct.Bstruct2 != nil {
			res.valueString = astruct.Bstruct2.Name
			res.ids = GenerateReproducibleUUIDv4(GetGongstructNameFromPointer(astruct.Bstruct2), uint64(GetOrderPointerGongstruct(stage, astruct.Bstruct2)))
		}
	case "Dstruct":
		res.GongFieldValueType = GongFieldValueTypePointer
		if astruct.Dstruct != nil {
			res.valueString = astruct.Dstruct.Name
			res.ids = GenerateReproducibleUUIDv4(GetGongstructNameFromPointer(astruct.Dstruct), uint64(GetOrderPointerGongstruct(stage, astruct.Dstruct)))
		}
	case "Dstruct2":
		res.GongFieldValueType = GongFieldValueTypePointer
		if astruct.Dstruct2 != nil {
			res.valueString = astruct.Dstruct2.Name
			res.ids = GenerateReproducibleUUIDv4(GetGongstructNameFromPointer(astruct.Dstruct2), uint64(GetOrderPointerGongstruct(stage, astruct.Dstruct2)))
		}
	case "Dstruct3":
		res.GongFieldValueType = GongFieldValueTypePointer
		if astruct.Dstruct3 != nil {
			res.valueString = astruct.Dstruct3.Name
			res.ids = GenerateReproducibleUUIDv4(GetGongstructNameFromPointer(astruct.Dstruct3), uint64(GetOrderPointerGongstruct(stage, astruct.Dstruct3)))
		}
	case "Dstruct4":
		res.GongFieldValueType = GongFieldValueTypePointer
		if astruct.Dstruct4 != nil {
			res.valueString = astruct.Dstruct4.Name
			res.ids = GenerateReproducibleUUIDv4(GetGongstructNameFromPointer(astruct.Dstruct4), uint64(GetOrderPointerGongstruct(stage, astruct.Dstruct4)))
		}
	case "Dstruct4s":
		res.GongFieldValueType = GongFieldValueTypeSliceOfPointers
	...
	case "AnAstruct":
		...
		if astruct.AnAstruct != nil {
			...
			res.ids = GenerateReproducibleUUIDv4(GetGongstructNameFromPointer(astruct.AnAstruct), uint64(GetOrderPointerGongstruct(stage, astruct.AnAstruct)))
		}
...
func (astructbstruct2use *AstructBstruct2Use) GongGetFieldValue(fieldName string, stage *Stage) (res GongFieldValue) {
	...
	case "Bstrcut2":
		...
		if astructbstruct2use.Bstrcut2 != nil {
			...
			res.ids = GenerateReproducibleUUIDv4(GetGongstructNameFromPointer(astructbstruct2use.Bstrcut2), uint64(GetOrderPointerGongstruct(stage, astructbstruct2use.Bstrcut2)))
		}
	}
	return
}
...
func (astructbstructuse *AstructBstructUse) GongGetFieldValue(fieldName string, stage *Stage) (res GongFieldValue) {
	...
	case "Bstruct2":
		...
		if astructbstructuse.Bstruct2 != nil {
			...
			res.ids = GenerateReproducibleUUIDv4(GetGongstructNameFromPointer(astructbstructuse.Bstruct2), uint64(GetOrderPointerGongstruct(stage, astructbstructuse.Bstruct2)))
		}
	}
	return
}
...
func (dstruct *Dstruct) GongGetFieldValue(fieldName string, stage *Stage) (res GongFieldValue) {
	...
	case "Gstruct":
		...
		if dstruct.Gstruct != nil {
			...
			res.ids = GenerateReproducibleUUIDv4(GetGongstructNameFromPointer(dstruct.Gstruct), uint64(GetOrderPointerGongstruct(stage, dstruct.Gstruct)))
		}
	case "Gstructs":
		res.GongFieldValueType = GongFieldValueTypeSliceOfPointers
