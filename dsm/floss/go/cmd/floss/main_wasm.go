...
import (
	...
	"github.com/fullstack-lang/gong/dsm/floss/go/level1stack"
...
func main() {
	...
	log.Println("Initializing floss WASM Backend...")
	...
	stack := level1stack.NewLevel1StackDelta("floss", unmarshallFromCode, marshallOnCommit, true, embeddedDiagrams, true)
