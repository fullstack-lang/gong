...
func FillUpForm(
	...
	case *models.DiagramFlossEquation:
		...
		BasicFieldtoForm("AreSubsystemsVisible", instanceWithInferedType.AreSubsystemsVisible, instanceWithInferedType, probe.formStage, formGroup,
			false, false, 0, false, 0, false)
		BasicFieldtoForm("AreCommonElementsHidden", instanceWithInferedType.AreCommonElementsHidden, instanceWithInferedType, probe.formStage, formGroup,
			false, false, 0, false, 0, false)
		BasicFieldtoForm("AreCPEArrowsVisible", instanceWithInferedType.AreCPEArrowsVisible, instanceWithInferedType, probe.formStage, formGroup,
			false, false, 0, false, 0, false)
		BasicFieldtoForm("AreColumnTitlesVisible", instanceWithInferedType.AreColumnTitlesVisible, instanceWithInferedType, probe.formStage, formGroup,
			false, false, 0, false, 0, false)
