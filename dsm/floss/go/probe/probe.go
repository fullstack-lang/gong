...
import (
	...
	embeddedgo "github.com/fullstack-lang/gong/dsm/floss/go"
)
...
func NewProbe(
	...
	stageOfInterest.MetaPackageImportPath = "github.com/fullstack-lang/gong/dsm/floss/go/models"
	...
	probe.docStager = prepare.Prepare(
		...
		"github.com/fullstack-lang/gong/dsm/floss/go"+":"+stageOfInterest.GetName(),
...
func (probe *Probe) ExportStageExcel() {
	...
	if probe.fileName == "" {
		probe.fileName = "floss-" + probe.stageOfInterest.GetName() + ".go"
	}
