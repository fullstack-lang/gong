...
import (
	...
	"github.com/fullstack-lang/gong/dsm/statemachines/go/probe"

	embeddedgo "github.com/fullstack-lang/gong/dsm/statemachines/go"
...
func (impl *BeforeCommitImplementation) BeforeCommit(stage *models.Stage) {
	...
	stage.MarshallFile(fmt.Sprintf("./%s", filename), "github.com/fullstack-lang/gong/dsm/statemachines/go/models", packageName)
}
...
func NewLevel1StackDelta(
	...
	models.SetOrchestratorOnAfterUpdate[models.NoteTransitionShape](stage)
