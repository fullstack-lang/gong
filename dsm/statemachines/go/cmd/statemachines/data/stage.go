...
// go module version: v0.0.0-20260907060356-47f679fcc797+dirty
/* to edit this file with the default probe, use the command
go run github.com/fullstack-lang/gong/dsm/statemachines/go/probe/cmd/probe@v0.0.0-20260907060356-47f679fcc797 stage.go
*/
package main
...
func _(stage *models.Stage) {
	...
	__State__00000010_ := (&models.State{Name: `On`}).Stage(stage)
	__State__00000011_ := (&models.State{Name: `Off`}).Stage(stage)
	...
	__StateShape__00000010_ := (&models.StateShape{Name: `On`}).Stage(stage)
	__StateShape__00000011_ := (&models.StateShape{Name: `Off`}).Stage(stage)
	...
	__StateShape__00000006_.X = 112.000000
	__StateShape__00000006_.Y = 157.000000
	...
	__StateShape__00000007_.X = 89.000000
	__StateShape__00000007_.Y = 41.000000
	...
	__StateShape__00000008_.X = 103.000000
	__StateShape__00000008_.Y = 320.000000
	...
	__StateShape__00000009_.X = 116.000000
	__StateShape__00000009_.Y = 497.000000
	__StateShape__00000009_.Width = 200.000000
	__StateShape__00000009_.Height = 80.000000
	__StateShape__00000009_.IsHidden = false

	__StateShape__00000010_.Name = `On`
	__StateShape__00000010_.X = 45.000000
	__StateShape__00000010_.Y = 110.000000
	__StateShape__00000010_.Width = 401.000000
	__StateShape__00000010_.Height = 493.000000
	__StateShape__00000010_.IsHidden = false

	__StateShape__00000011_.Name = `Off`
	__StateShape__00000011_.X = 501.000000
	__StateShape__00000011_.Y = 305.000000
