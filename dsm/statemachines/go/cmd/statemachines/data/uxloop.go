...
This diagram show the general principal of a DSM event loop.
 to Probe Form`}).Stage(stage)
	...
	__StateShape__00000013_ := (&models.StateShape{Name: `Probe Form`}).Stage(stage)
...
This diagram show the general principal of a DSM event loop.
 to Probe Form`
	...
	__StateShape__00000013_.X = 100.000000
	__StateShape__00000013_.Y = 100.000000
	__StateShape__00000013_.Width = 200.000000
	__StateShape__00000013_.Height = 80.000000
	__StateShape__00000013_.IsHidden = false
	...
	__StateMachine__00000000_.Diagrams = append(__StateMachine__00000000_.Diagrams, __Diagram__00000003_)
	...
	__StateShape__00000013_.State = __State__00000000_
