...
go run github.com/fullstack-lang/gong/dsm/statemachines/go/probe/cmd/probe@v0.0.0-20260813105116-73922d121b72 stage.go
*/
package main
...
This diagram show the general principal of a DSM event loop.
 to Probe Form`}).Stage(stage)
	...
	__State__00000010_ := (&models.State{Name: `Update UX 1 ?`}).Stage(stage)
	...
	__StateShape__00000010_ := (&models.StateShape{Name: `Update UX 1 ?`}).Stage(stage)
...
This diagram show the general principal of a DSM event loop.
 to Probe Form`
	...
	__State__00000010_.Name = `Update UX 1 ?`
	...
	__StateShape__00000003_.Y = 386.999985
	...
	__StateShape__00000008_.X = 40.000000
	__StateShape__00000008_.Y = 668.999984
	...
	__Transition_Shape__00000000_.EndRatio = 0.229683
	...
	__Transition_Shape__00000008_.CornerOffsetRatio = 1.472903
	...
	__Transition_Shape__00000009_.EndRatio = 0.277886
	...
	__Transition_Shape__00000011_.CornerOffsetRatio = 2.692139
