...
// go module version: v0.0.0-20260904023337-fa854a876ae5
/* to edit this file with the default probe, use the command
go run github.com/fullstack-lang/gong/dsm/statemachines/go/probe/cmd/probe@v0.0.0-20260904023337-fa854a876ae5 stage.go
*/
package main
...
`}).Stage(stage)
	...
	__Transition__00000000_ := (&models.Transition{Name: `transition`}).Stage(stage)
	__Transition__00000003_ := (&models.Transition{Name: ``}).Stage(stage)
	__Transition__00000004_ := (&models.Transition{Name: `transition name`}).Stage(stage)
	__Transition__00000005_ := (&models.Transition{Name: ``}).Stage(stage)
	__Transition__00000006_ := (&models.Transition{Name: `qsdqdqdqs`}).Stage(stage)
...
`
	...
	__StateShape__00000000_.X = 384.000000
	__StateShape__00000000_.Y = 119.000000
	__StateShape__00000000_.Width = 215.000000
...
`
	__StateShape__00000002_.X = 1065.000000
	__StateShape__00000002_.Y = 323.000000
...
`
	...
	__Transition__00000000_.Name = `transition`

	__Transition__00000003_.Name = ``

	__Transition__00000004_.Name = `transition name`

	__Transition__00000005_.Name = ``

	__Transition__00000006_.Name = `qsdqdqdqs`
	...
	__Transition_Shape__00000000_.EndRatio = 0.798224
	...
	__Transition_Shape__00000000_.CornerOffsetRatio = 1.041879
	...
	__Transition_Shape__00000003_.EndRatio = 0.500271
...
`
	...
	__Transition_Shape__00000004_.EndRatio = 0.303359
	...
	__Transition_Shape__00000004_.CornerOffsetRatio = -0.429980
	...
	__Transition_Shape__00000006_.Name = `-New Diagram`
	__Transition_Shape__00000006_.StartRatio = 0.601778
	__Transition_Shape__00000006_.EndRatio = 0.500000
	__Transition_Shape__00000006_.StartOrientation = models.ORIENTATION_HORIZONTAL
	__Transition_Shape__00000006_.EndOrientation = models.ORIENTATION_HORIZONTAL
	__Transition_Shape__00000006_.CornerOffsetRatio = 1.375020
	...
	__Transition__00000000_.Guard = __Guard__00000000_
	...
	__Transition__00000006_.Start = __State__00000002_
	__Transition__00000006_.End = __State__00000004_
	__Transition__00000006_.Guard = __Guard__00000000_
