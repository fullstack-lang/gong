...
go run github.com/fullstack-lang/gong/dsm/capture/go/probe/cmd/probe@v0.0.0-20260813105116-73922d121b72 stage.go
*/
package main
...
func _(stage *models.Stage) {
	...
	__Concern__00000000_ := (&models.Concern{Name: `Edit deliverables with MBSE tools`}).Stage(stage)
	__Concern__00000001_ := (&models.Concern{Name: `Consumes SE deliverables`}).Stage(stage)
	__Concern__00000002_ := (&models.Concern{Name: `Apply ISO 42010 & develop tools`}).Stage(stage)
	...
	__Deliverable__00000002_ := (&models.Deliverable{Name: `Tools for editing deliverables`}).Stage(stage)
...
- lack of standard for the graphical views.`}).Stage(stage)
	...
	__Stakeholder__00000000_ := (&models.Stakeholder{Name: `SE delivarables editor`}).Stage(stage)
	...
	__Concern__00000000_.Name = `Edit deliverables with MBSE tools`
	...
	__Concern__00000002_.Name = `Apply ISO 42010 & develop tools`
	...
	__Deliverable__00000002_.Name = `Tools for editing deliverables`
	...
	__Diagram__00000000_.Width = 26300.000000
	__Diagram__00000000_.Height = 26300.000000
...
- lack of standard for the graphical views.`
	...
	__Stakeholder__00000000_.Name = `SE delivarables editor`
