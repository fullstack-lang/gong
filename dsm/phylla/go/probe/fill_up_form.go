...
func FillUpForm(
	...
	case *models.Plant:
		...
		AssociationFieldToForm("StackOfPartiallyRotatedGrowthCurve2DRibbon", instanceWithInferedType.StackOfPartiallyRotatedGrowthCurve2DRibbon, formGroup, probe)
		formDivDivider := (&form.FormDiv{
			Name:       "",
			IsADivider: true,
		}).Stage(probe.formStage)
	...
	case *models.StackOfPartiallyRotatedGrowthCurve2DRibbon:
		...
		BasicFieldtoForm("Name", instanceWithInferedType.Name, instanceWithInferedType, probe.formStage, formGroup,
			false, false, 0, false, 0, false)
		AssociationSliceToForm("StackPartiallyRotatedGrowthCurve2DRibbonStartShapes", instanceWithInferedType, &instanceWithInferedType.StackPartiallyRotatedGrowthCurve2DRibbonStartShapes, formGroup, probe)
		AssociationSliceToForm("StackPartiallyRotatedGrowthCurve2DRibbonEndShapes", instanceWithInferedType, &instanceWithInferedType.StackPartiallyRotatedGrowthCurve2DRibbonEndShapes, formGroup, probe)
		formDivDivider := (&form.FormDiv{
			Name:       "",
			IsADivider: true,
		}).Stage(probe.formStage)
	...
	case *models.StackPartiallyRotatedGrowthCurve2DRibbonEndShape:
		...
		formGroup.FormDivs = append(formGroup.FormDivs, formDivDivider)
		{
			AssociationReverseSliceToForm[*models.StackOfPartiallyRotatedGrowthCurve2DRibbon, *models.StackPartiallyRotatedGrowthCurve2DRibbonEndShape](
				"StackOfPartiallyRotatedGrowthCurve2DRibbon",
				"StackPartiallyRotatedGrowthCurve2DRibbonEndShapes",
				instanceWithInferedType,
				formGroup,
				probe,
				func(owner *models.StackOfPartiallyRotatedGrowthCurve2DRibbon) []*models.StackPartiallyRotatedGrowthCurve2DRibbonEndShape {
					return owner.StackPartiallyRotatedGrowthCurve2DRibbonEndShapes
				})
		}
	...
	case *models.StackPartiallyRotatedGrowthCurve2DRibbonStartShape:
		...
		formGroup.FormDivs = append(formGroup.FormDivs, formDivDivider)
		{
			AssociationReverseSliceToForm[*models.StackOfPartiallyRotatedGrowthCurve2DRibbon, *models.StackPartiallyRotatedGrowthCurve2DRibbonStartShape](
				"StackOfPartiallyRotatedGrowthCurve2DRibbon",
				"StackPartiallyRotatedGrowthCurve2DRibbonStartShapes",
				instanceWithInferedType,
				formGroup,
				probe,
				func(owner *models.StackOfPartiallyRotatedGrowthCurve2DRibbon) []*models.StackPartiallyRotatedGrowthCurve2DRibbonStartShape {
					return owner.StackPartiallyRotatedGrowthCurve2DRibbonStartShapes
				})
		}
