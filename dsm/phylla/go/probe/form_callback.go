...
func (plantFormCallback *PlantFormCallback) OnSave() {
	...
	for _, formDiv := range plantFormCallback.formGroup.FormDivs {
		...
		case "StackOfPartiallyRotatedGrowthCurve2DRibbon":
			FormDivSelectFieldToField(&(plant_.StackOfPartiallyRotatedGrowthCurve2DRibbon), plantFormCallback.probe.stageOfInterest, formDiv)
		case "Library:Plants":
			// 1. Decode the AssociationStorage which contains the rowIDs of the Library instances
			rowIDs, err := DecodeStringToIntSlice(formDiv.FormEditAssocButton.AssociationStorage)
			if err != nil {
...
func __gong__New__StackOfPartiallyRotatedGrowthCurve2DRibbonFormCallback(
	stackofpartiallyrotatedgrowthcurve2dribbon *models.StackOfPartiallyRotatedGrowthCurve2DRibbon,
	probe *Probe,
	formGroup *form.FormGroup,
) (stackofpartiallyrotatedgrowthcurve2dribbonFormCallback *StackOfPartiallyRotatedGrowthCurve2DRibbonFormCallback) {
	stackofpartiallyrotatedgrowthcurve2dribbonFormCallback = new(StackOfPartiallyRotatedGrowthCurve2DRibbonFormCallback)
	stackofpartiallyrotatedgrowthcurve2dribbonFormCallback.probe = probe
	stackofpartiallyrotatedgrowthcurve2dribbonFormCallback.stackofpartiallyrotatedgrowthcurve2dribbon = stackofpartiallyrotatedgrowthcurve2dribbon
	stackofpartiallyrotatedgrowthcurve2dribbonFormCallback.formGroup = formGroup

	stackofpartiallyrotatedgrowthcurve2dribbonFormCallback.CreationMode = (stackofpartiallyrotatedgrowthcurve2dribbon == nil)

	return
}

type StackOfPartiallyRotatedGrowthCurve2DRibbonFormCallback struct {
	stackofpartiallyrotatedgrowthcurve2dribbon *models.StackOfPartiallyRotatedGrowthCurve2DRibbon
...
func (stackofpartiallyrotatedgrowthcurve2dribbonFormCallback *StackOfPartiallyRotatedGrowthCurve2DRibbonFormCallback) OnSave() {
	stackofpartiallyrotatedgrowthcurve2dribbonFormCallback.probe.stageOfInterest.Lock()
	defer stackofpartiallyrotatedgrowthcurve2dribbonFormCallback.probe.stageOfInterest.Unlock()

	// log.Println("StackOfPartiallyRotatedGrowthCurve2DRibbonFormCallback, OnSave")

	// checkout formStage to have the form group on the stage synchronized with the
	// back repo (and front repo)
	stackofpartiallyrotatedgrowthcurve2dribbonFormCallback.probe.formStage.Checkout()

	if stackofpartiallyrotatedgrowthcurve2dribbonFormCallback.stackofpartiallyrotatedgrowthcurve2dribbon == nil {
		stackofpartiallyrotatedgrowthcurve2dribbonFormCallback.stackofpartiallyrotatedgrowthcurve2dribbon = new(models.StackOfPartiallyRotatedGrowthCurve2DRibbon).Stage(stackofpartiallyrotatedgrowthcurve2dribbonFormCallback.probe.stageOfInterest)
	}
	stackofpartiallyrotatedgrowthcurve2dribbon_ := stackofpartiallyrotatedgrowthcurve2dribbonFormCallback.stackofpartiallyrotatedgrowthcurve2dribbon
	_ = stackofpartiallyrotatedgrowthcurve2dribbon_

	for _, formDiv := range stackofpartiallyrotatedgrowthcurve2dribbonFormCallback.formGroup.FormDivs {
		switch formDiv.Name {
		// insertion point per field
		case "Name":
			FormDivBasicFieldToField(&(stackofpartiallyrotatedgrowthcurve2dribbon_.Name), formDiv)
		case "StackPartiallyRotatedGrowthCurve2DRibbonStartShapes":
			instanceSet := *models.GetGongstructInstancesSetFromPointerType[*models.StackPartiallyRotatedGrowthCurve2DRibbonStartShape](stackofpartiallyrotatedgrowthcurve2dribbonFormCallback.probe.stageOfInterest)
			instanceSlice := make([]*models.StackPartiallyRotatedGrowthCurve2DRibbonStartShape, 0)

			// make a map of all instances by their ID
			map_id_instances := make(map[uint]*models.StackPartiallyRotatedGrowthCurve2DRibbonStartShape)

			for instance := range instanceSet {
				id := models.GetOrderPointerGongstruct(
					stackofpartiallyrotatedgrowthcurve2dribbonFormCallback.probe.stageOfInterest,
					instance,
				)
				map_id_instances[id] = instance
			}
			...
			map_RowID_ID := GetMap_RowID_ID[*models.StackPartiallyRotatedGrowthCurve2DRibbonStartShape](stackofpartiallyrotatedgrowthcurve2dribbonFormCallback.probe.stageOfInterest)
			...
			stackofpartiallyrotatedgrowthcurve2dribbon_.StackPartiallyRotatedGrowthCurve2DRibbonStartShapes = instanceSlice
			stackofpartiallyrotatedgrowthcurve2dribbonFormCallback.probe.UpdateSliceOfPointersCallback(stackofpartiallyrotatedgrowthcurve2dribbon_, "StackPartiallyRotatedGrowthCurve2DRibbonStartShapes", &stackofpartiallyrotatedgrowthcurve2dribbon_.StackPartiallyRotatedGrowthCurve2DRibbonStartShapes)

		case "StackPartiallyRotatedGrowthCurve2DRibbonEndShapes":
			instanceSet := *models.GetGongstructInstancesSetFromPointerType[*models.StackPartiallyRotatedGrowthCurve2DRibbonEndShape](stackofpartiallyrotatedgrowthcurve2dribbonFormCallback.probe.stageOfInterest)
			instanceSlice := make([]*models.StackPartiallyRotatedGrowthCurve2DRibbonEndShape, 0)

			// make a map of all instances by their ID
			map_id_instances := make(map[uint]*models.StackPartiallyRotatedGrowthCurve2DRibbonEndShape)
			...
			map_RowID_ID := GetMap_RowID_ID[*models.StackPartiallyRotatedGrowthCurve2DRibbonEndShape](stackofpartiallyrotatedgrowthcurve2dribbonFormCallback.probe.stageOfInterest)
			...
			stackofpartiallyrotatedgrowthcurve2dribbon_.StackPartiallyRotatedGrowthCurve2DRibbonEndShapes = instanceSlice
			stackofpartiallyrotatedgrowthcurve2dribbonFormCallback.probe.UpdateSliceOfPointersCallback(stackofpartiallyrotatedgrowthcurve2dribbon_, "StackPartiallyRotatedGrowthCurve2DRibbonEndShapes", &stackofpartiallyrotatedgrowthcurve2dribbon_.StackPartiallyRotatedGrowthCurve2DRibbonEndShapes)

		}
	}

	// manage the suppress operation
	if stackofpartiallyrotatedgrowthcurve2dribbonFormCallback.formGroup.HasSuppressButtonBeenPressed {
		stackofpartiallyrotatedgrowthcurve2dribbon_.Unstage(stackofpartiallyrotatedgrowthcurve2dribbonFormCallback.probe.stageOfInterest)
	}

	stackofpartiallyrotatedgrowthcurve2dribbonFormCallback.probe.stageOfInterest.Commit()
	updateProbeTable[*models.StackOfPartiallyRotatedGrowthCurve2DRibbon](
		stackofpartiallyrotatedgrowthcurve2dribbonFormCallback.probe,
	)

	// display a new form by reset the form stage
	if stackofpartiallyrotatedgrowthcurve2dribbonFormCallback.CreationMode || stackofpartiallyrotatedgrowthcurve2dribbonFormCallback.formGroup.HasSuppressButtonBeenPressed {
		stackofpartiallyrotatedgrowthcurve2dribbonFormCallback.probe.formStage.Reset()
		newFormGroup := (&form.FormGroup{
			Name: FormName,
		}).Stage(stackofpartiallyrotatedgrowthcurve2dribbonFormCallback.probe.formStage)
		newFormGroup.OnSave = __gong__New__StackOfPartiallyRotatedGrowthCurve2DRibbonFormCallback(
			nil,
			stackofpartiallyrotatedgrowthcurve2dribbonFormCallback.probe,
			newFormGroup,
		)
		stackofpartiallyrotatedgrowthcurve2dribbon := new(models.StackOfPartiallyRotatedGrowthCurve2DRibbon)
		FillUpForm(stackofpartiallyrotatedgrowthcurve2dribbon, newFormGroup, stackofpartiallyrotatedgrowthcurve2dribbonFormCallback.probe)
		stackofpartiallyrotatedgrowthcurve2dribbonFormCallback.probe.formStage.Commit()
	}

	stackofpartiallyrotatedgrowthcurve2dribbonFormCallback.probe.ux_tree()
}
...
func __gong__New__StackPartiallyRotatedGrowthCurve2DRibbonEndShapeFormCallback(
	stackpartiallyrotatedgrowthcurve2dribbonendshape *models.StackPartiallyRotatedGrowthCurve2DRibbonEndShape,
	probe *Probe,
	formGroup *form.FormGroup,
) (stackpartiallyrotatedgrowthcurve2dribbonendshapeFormCallback *StackPartiallyRotatedGrowthCurve2DRibbonEndShapeFormCallback) {
	stackpartiallyrotatedgrowthcurve2dribbonendshapeFormCallback = new(StackPartiallyRotatedGrowthCurve2DRibbonEndShapeFormCallback)
	stackpartiallyrotatedgrowthcurve2dribbonendshapeFormCallback.probe = probe
	stackpartiallyrotatedgrowthcurve2dribbonendshapeFormCallback.stackpartiallyrotatedgrowthcurve2dribbonendshape = stackpartiallyrotatedgrowthcurve2dribbonendshape
	stackpartiallyrotatedgrowthcurve2dribbonendshapeFormCallback.formGroup = formGroup

	stackpartiallyrotatedgrowthcurve2dribbonendshapeFormCallback.CreationMode = (stackpartiallyrotatedgrowthcurve2dribbonendshape == nil)

	return
}

type StackPartiallyRotatedGrowthCurve2DRibbonEndShapeFormCallback struct {
	stackpartiallyrotatedgrowthcurve2dribbonendshape *models.StackPartiallyRotatedGrowthCurve2DRibbonEndShape
...
func (stackpartiallyrotatedgrowthcurve2dribbonendshapeFormCallback *StackPartiallyRotatedGrowthCurve2DRibbonEndShapeFormCallback) OnSave() {
	stackpartiallyrotatedgrowthcurve2dribbonendshapeFormCallback.probe.stageOfInterest.Lock()
	defer stackpartiallyrotatedgrowthcurve2dribbonendshapeFormCallback.probe.stageOfInterest.Unlock()

	// log.Println("StackPartiallyRotatedGrowthCurve2DRibbonEndShapeFormCallback, OnSave")

	// checkout formStage to have the form group on the stage synchronized with the
	// back repo (and front repo)
	stackpartiallyrotatedgrowthcurve2dribbonendshapeFormCallback.probe.formStage.Checkout()

	if stackpartiallyrotatedgrowthcurve2dribbonendshapeFormCallback.stackpartiallyrotatedgrowthcurve2dribbonendshape == nil {
		stackpartiallyrotatedgrowthcurve2dribbonendshapeFormCallback.stackpartiallyrotatedgrowthcurve2dribbonendshape = new(models.StackPartiallyRotatedGrowthCurve2DRibbonEndShape).Stage(stackpartiallyrotatedgrowthcurve2dribbonendshapeFormCallback.probe.stageOfInterest)
	}
	stackpartiallyrotatedgrowthcurve2dribbonendshape_ := stackpartiallyrotatedgrowthcurve2dribbonendshapeFormCallback.stackpartiallyrotatedgrowthcurve2dribbonendshape
	_ = stackpartiallyrotatedgrowthcurve2dribbonendshape_

	for _, formDiv := range stackpartiallyrotatedgrowthcurve2dribbonendshapeFormCallback.formGroup.FormDivs {
		switch formDiv.Name {
		// insertion point per field
		case "Name":
			FormDivBasicFieldToField(&(stackpartiallyrotatedgrowthcurve2dribbonendshape_.Name), formDiv)
		case "BottomStartX":
			FormDivBasicFieldToField(&(stackpartiallyrotatedgrowthcurve2dribbonendshape_.BottomStartX), formDiv)
		case "BottomStartY":
			FormDivBasicFieldToField(&(stackpartiallyrotatedgrowthcurve2dribbonendshape_.BottomStartY), formDiv)
		case "BottomEndX":
			FormDivBasicFieldToField(&(stackpartiallyrotatedgrowthcurve2dribbonendshape_.BottomEndX), formDiv)
		case "BottomEndY":
			FormDivBasicFieldToField(&(stackpartiallyrotatedgrowthcurve2dribbonendshape_.BottomEndY), formDiv)
		case "BottomRadiusX":
			FormDivBasicFieldToField(&(stackpartiallyrotatedgrowthcurve2dribbonendshape_.BottomRadiusX), formDiv)
		case "BottomRadiusY":
			FormDivBasicFieldToField(&(stackpartiallyrotatedgrowthcurve2dribbonendshape_.BottomRadiusY), formDiv)
		case "BottomXAxisRotation":
			FormDivBasicFieldToField(&(stackpartiallyrotatedgrowthcurve2dribbonendshape_.BottomXAxisRotation), formDiv)
		case "BottomLargeArcFlag":
			FormDivBasicFieldToField(&(stackpartiallyrotatedgrowthcurve2dribbonendshape_.BottomLargeArcFlag), formDiv)
		case "BottomSweepFlag":
			FormDivBasicFieldToField(&(stackpartiallyrotatedgrowthcurve2dribbonendshape_.BottomSweepFlag), formDiv)
		case "TopStartX":
			FormDivBasicFieldToField(&(stackpartiallyrotatedgrowthcurve2dribbonendshape_.TopStartX), formDiv)
		case "TopStartY":
			FormDivBasicFieldToField(&(stackpartiallyrotatedgrowthcurve2dribbonendshape_.TopStartY), formDiv)
		case "TopEndX":
			FormDivBasicFieldToField(&(stackpartiallyrotatedgrowthcurve2dribbonendshape_.TopEndX), formDiv)
		case "TopEndY":
			FormDivBasicFieldToField(&(stackpartiallyrotatedgrowthcurve2dribbonendshape_.TopEndY), formDiv)
		case "TopRadiusX":
			FormDivBasicFieldToField(&(stackpartiallyrotatedgrowthcurve2dribbonendshape_.TopRadiusX), formDiv)
		case "TopRadiusY":
			FormDivBasicFieldToField(&(stackpartiallyrotatedgrowthcurve2dribbonendshape_.TopRadiusY), formDiv)
		case "TopXAxisRotation":
			FormDivBasicFieldToField(&(stackpartiallyrotatedgrowthcurve2dribbonendshape_.TopXAxisRotation), formDiv)
		case "TopLargeArcFlag":
			FormDivBasicFieldToField(&(stackpartiallyrotatedgrowthcurve2dribbonendshape_.TopLargeArcFlag), formDiv)
		case "TopSweepFlag":
			FormDivBasicFieldToField(&(stackpartiallyrotatedgrowthcurve2dribbonendshape_.TopSweepFlag), formDiv)
		case "StackOfPartiallyRotatedGrowthCurve2DRibbon:StackPartiallyRotatedGrowthCurve2DRibbonEndShapes":
			// 1. Decode the AssociationStorage which contains the rowIDs of the StackOfPartiallyRotatedGrowthCurve2DRibbon instances
			rowIDs, err := DecodeStringToIntSlice(formDiv.FormEditAssocButton.AssociationStorage)
			if err != nil {
				log.Panic("not a good storage", formDiv.FormEditAssocButton.AssociationStorage)
			}

			// 2. Build a map of target StackOfPartiallyRotatedGrowthCurve2DRibbon instances by their ID
			map_RowID_ID := GetMap_RowID_ID[*models.StackOfPartiallyRotatedGrowthCurve2DRibbon](stackpartiallyrotatedgrowthcurve2dribbonendshapeFormCallback.probe.stageOfInterest)
			targetStackOfPartiallyRotatedGrowthCurve2DRibbonIDs := make(map[uint]bool)
			for _, rowID := range rowIDs {
				if id, ok := map_RowID_ID[int(rowID)]; ok {
					targetStackOfPartiallyRotatedGrowthCurve2DRibbonIDs[id] = true
				} else {
					log.Panic("not a good storage", formDiv.FormEditAssocButton.AssociationStorage, "unknown row id", rowID)
				}
			}

			// 3. Iterate over all StackOfPartiallyRotatedGrowthCurve2DRibbon instances and update their StackPartiallyRotatedGrowthCurve2DRibbonEndShapes slice
			for _stackofpartiallyrotatedgrowthcurve2dribbon := range *models.GetGongstructInstancesSetFromPointerType[*models.StackOfPartiallyRotatedGrowthCurve2DRibbon](stackpartiallyrotatedgrowthcurve2dribbonendshapeFormCallback.probe.stageOfInterest) {
				id := models.GetOrderPointerGongstruct(stackpartiallyrotatedgrowthcurve2dribbonendshapeFormCallback.probe.stageOfInterest, _stackofpartiallyrotatedgrowthcurve2dribbon)
				
				// if StackOfPartiallyRotatedGrowthCurve2DRibbon is selected
				if targetStackOfPartiallyRotatedGrowthCurve2DRibbonIDs[id] {
					// ensure stackpartiallyrotatedgrowthcurve2dribbonendshape_ is in _stackofpartiallyrotatedgrowthcurve2dribbon.StackPartiallyRotatedGrowthCurve2DRibbonEndShapes
					found := false
					for _, _b := range _stackofpartiallyrotatedgrowthcurve2dribbon.StackPartiallyRotatedGrowthCurve2DRibbonEndShapes {
						if _b == stackpartiallyrotatedgrowthcurve2dribbonendshape_ {
							found = true
							break
						}
					}
					if !found {
						_stackofpartiallyrotatedgrowthcurve2dribbon.StackPartiallyRotatedGrowthCurve2DRibbonEndShapes = append(_stackofpartiallyrotatedgrowthcurve2dribbon.StackPartiallyRotatedGrowthCurve2DRibbonEndShapes, stackpartiallyrotatedgrowthcurve2dribbonendshape_)
						stackpartiallyrotatedgrowthcurve2dribbonendshapeFormCallback.probe.UpdateSliceOfPointersCallback(_stackofpartiallyrotatedgrowthcurve2dribbon, "StackPartiallyRotatedGrowthCurve2DRibbonEndShapes", &_stackofpartiallyrotatedgrowthcurve2dribbon.StackPartiallyRotatedGrowthCurve2DRibbonEndShapes)
					}
				} else {
					// ensure stackpartiallyrotatedgrowthcurve2dribbonendshape_ is NOT in _stackofpartiallyrotatedgrowthcurve2dribbon.StackPartiallyRotatedGrowthCurve2DRibbonEndShapes
					idx := slices.Index(_stackofpartiallyrotatedgrowthcurve2dribbon.StackPartiallyRotatedGrowthCurve2DRibbonEndShapes, stackpartiallyrotatedgrowthcurve2dribbonendshape_)
					if idx != -1 {
						_stackofpartiallyrotatedgrowthcurve2dribbon.StackPartiallyRotatedGrowthCurve2DRibbonEndShapes = slices.Delete(_stackofpartiallyrotatedgrowthcurve2dribbon.StackPartiallyRotatedGrowthCurve2DRibbonEndShapes, idx, idx+1)
						stackpartiallyrotatedgrowthcurve2dribbonendshapeFormCallback.probe.UpdateSliceOfPointersCallback(_stackofpartiallyrotatedgrowthcurve2dribbon, "StackPartiallyRotatedGrowthCurve2DRibbonEndShapes", &_stackofpartiallyrotatedgrowthcurve2dribbon.StackPartiallyRotatedGrowthCurve2DRibbonEndShapes)
					}
				}
			}
	...
	// manage the suppress operation
	if stackpartiallyrotatedgrowthcurve2dribbonendshapeFormCallback.formGroup.HasSuppressButtonBeenPressed {
		stackpartiallyrotatedgrowthcurve2dribbonendshape_.Unstage(stackpartiallyrotatedgrowthcurve2dribbonendshapeFormCallback.probe.stageOfInterest)
	}

	stackpartiallyrotatedgrowthcurve2dribbonendshapeFormCallback.probe.stageOfInterest.Commit()
	updateProbeTable[*models.StackPartiallyRotatedGrowthCurve2DRibbonEndShape](
		stackpartiallyrotatedgrowthcurve2dribbonendshapeFormCallback.probe,
	)

	// display a new form by reset the form stage
	if stackpartiallyrotatedgrowthcurve2dribbonendshapeFormCallback.CreationMode || stackpartiallyrotatedgrowthcurve2dribbonendshapeFormCallback.formGroup.HasSuppressButtonBeenPressed {
		stackpartiallyrotatedgrowthcurve2dribbonendshapeFormCallback.probe.formStage.Reset()
		newFormGroup := (&form.FormGroup{
			Name: FormName,
		}).Stage(stackpartiallyrotatedgrowthcurve2dribbonendshapeFormCallback.probe.formStage)
		newFormGroup.OnSave = __gong__New__StackPartiallyRotatedGrowthCurve2DRibbonEndShapeFormCallback(
			nil,
			stackpartiallyrotatedgrowthcurve2dribbonendshapeFormCallback.probe,
			newFormGroup,
		)
		stackpartiallyrotatedgrowthcurve2dribbonendshape := new(models.StackPartiallyRotatedGrowthCurve2DRibbonEndShape)
		FillUpForm(stackpartiallyrotatedgrowthcurve2dribbonendshape, newFormGroup, stackpartiallyrotatedgrowthcurve2dribbonendshapeFormCallback.probe)
		stackpartiallyrotatedgrowthcurve2dribbonendshapeFormCallback.probe.formStage.Commit()
	}

	stackpartiallyrotatedgrowthcurve2dribbonendshapeFormCallback.probe.ux_tree()
}
func __gong__New__StackPartiallyRotatedGrowthCurve2DRibbonStartShapeFormCallback(
	stackpartiallyrotatedgrowthcurve2dribbonstartshape *models.StackPartiallyRotatedGrowthCurve2DRibbonStartShape,
	probe *Probe,
	formGroup *form.FormGroup,
) (stackpartiallyrotatedgrowthcurve2dribbonstartshapeFormCallback *StackPartiallyRotatedGrowthCurve2DRibbonStartShapeFormCallback) {
	stackpartiallyrotatedgrowthcurve2dribbonstartshapeFormCallback = new(StackPartiallyRotatedGrowthCurve2DRibbonStartShapeFormCallback)
	stackpartiallyrotatedgrowthcurve2dribbonstartshapeFormCallback.probe = probe
	stackpartiallyrotatedgrowthcurve2dribbonstartshapeFormCallback.stackpartiallyrotatedgrowthcurve2dribbonstartshape = stackpartiallyrotatedgrowthcurve2dribbonstartshape
	stackpartiallyrotatedgrowthcurve2dribbonstartshapeFormCallback.formGroup = formGroup

	stackpartiallyrotatedgrowthcurve2dribbonstartshapeFormCallback.CreationMode = (stackpartiallyrotatedgrowthcurve2dribbonstartshape == nil)

	return
}

type StackPartiallyRotatedGrowthCurve2DRibbonStartShapeFormCallback struct {
	stackpartiallyrotatedgrowthcurve2dribbonstartshape *models.StackPartiallyRotatedGrowthCurve2DRibbonStartShape
...
func (stackpartiallyrotatedgrowthcurve2dribbonstartshapeFormCallback *StackPartiallyRotatedGrowthCurve2DRibbonStartShapeFormCallback) OnSave() {
	stackpartiallyrotatedgrowthcurve2dribbonstartshapeFormCallback.probe.stageOfInterest.Lock()
	defer stackpartiallyrotatedgrowthcurve2dribbonstartshapeFormCallback.probe.stageOfInterest.Unlock()

	// log.Println("StackPartiallyRotatedGrowthCurve2DRibbonStartShapeFormCallback, OnSave")

	// checkout formStage to have the form group on the stage synchronized with the
	// back repo (and front repo)
	stackpartiallyrotatedgrowthcurve2dribbonstartshapeFormCallback.probe.formStage.Checkout()

	if stackpartiallyrotatedgrowthcurve2dribbonstartshapeFormCallback.stackpartiallyrotatedgrowthcurve2dribbonstartshape == nil {
		stackpartiallyrotatedgrowthcurve2dribbonstartshapeFormCallback.stackpartiallyrotatedgrowthcurve2dribbonstartshape = new(models.StackPartiallyRotatedGrowthCurve2DRibbonStartShape).Stage(stackpartiallyrotatedgrowthcurve2dribbonstartshapeFormCallback.probe.stageOfInterest)
	}
	stackpartiallyrotatedgrowthcurve2dribbonstartshape_ := stackpartiallyrotatedgrowthcurve2dribbonstartshapeFormCallback.stackpartiallyrotatedgrowthcurve2dribbonstartshape
	_ = stackpartiallyrotatedgrowthcurve2dribbonstartshape_

	for _, formDiv := range stackpartiallyrotatedgrowthcurve2dribbonstartshapeFormCallback.formGroup.FormDivs {
		switch formDiv.Name {
		// insertion point per field
		case "Name":
			FormDivBasicFieldToField(&(stackpartiallyrotatedgrowthcurve2dribbonstartshape_.Name), formDiv)
		case "BottomStartX":
			FormDivBasicFieldToField(&(stackpartiallyrotatedgrowthcurve2dribbonstartshape_.BottomStartX), formDiv)
		case "BottomStartY":
			FormDivBasicFieldToField(&(stackpartiallyrotatedgrowthcurve2dribbonstartshape_.BottomStartY), formDiv)
		case "BottomEndX":
			FormDivBasicFieldToField(&(stackpartiallyrotatedgrowthcurve2dribbonstartshape_.BottomEndX), formDiv)
		case "BottomEndY":
			FormDivBasicFieldToField(&(stackpartiallyrotatedgrowthcurve2dribbonstartshape_.BottomEndY), formDiv)
		case "BottomRadiusX":
			FormDivBasicFieldToField(&(stackpartiallyrotatedgrowthcurve2dribbonstartshape_.BottomRadiusX), formDiv)
		case "BottomRadiusY":
			FormDivBasicFieldToField(&(stackpartiallyrotatedgrowthcurve2dribbonstartshape_.BottomRadiusY), formDiv)
		case "BottomXAxisRotation":
			FormDivBasicFieldToField(&(stackpartiallyrotatedgrowthcurve2dribbonstartshape_.BottomXAxisRotation), formDiv)
		case "BottomLargeArcFlag":
			FormDivBasicFieldToField(&(stackpartiallyrotatedgrowthcurve2dribbonstartshape_.BottomLargeArcFlag), formDiv)
		case "BottomSweepFlag":
			FormDivBasicFieldToField(&(stackpartiallyrotatedgrowthcurve2dribbonstartshape_.BottomSweepFlag), formDiv)
		case "TopStartX":
			FormDivBasicFieldToField(&(stackpartiallyrotatedgrowthcurve2dribbonstartshape_.TopStartX), formDiv)
		case "TopStartY":
			FormDivBasicFieldToField(&(stackpartiallyrotatedgrowthcurve2dribbonstartshape_.TopStartY), formDiv)
		case "TopEndX":
			FormDivBasicFieldToField(&(stackpartiallyrotatedgrowthcurve2dribbonstartshape_.TopEndX), formDiv)
		case "TopEndY":
			FormDivBasicFieldToField(&(stackpartiallyrotatedgrowthcurve2dribbonstartshape_.TopEndY), formDiv)
		case "TopRadiusX":
			FormDivBasicFieldToField(&(stackpartiallyrotatedgrowthcurve2dribbonstartshape_.TopRadiusX), formDiv)
		case "TopRadiusY":
			FormDivBasicFieldToField(&(stackpartiallyrotatedgrowthcurve2dribbonstartshape_.TopRadiusY), formDiv)
		case "TopXAxisRotation":
			FormDivBasicFieldToField(&(stackpartiallyrotatedgrowthcurve2dribbonstartshape_.TopXAxisRotation), formDiv)
		case "TopLargeArcFlag":
			FormDivBasicFieldToField(&(stackpartiallyrotatedgrowthcurve2dribbonstartshape_.TopLargeArcFlag), formDiv)
		case "TopSweepFlag":
			FormDivBasicFieldToField(&(stackpartiallyrotatedgrowthcurve2dribbonstartshape_.TopSweepFlag), formDiv)
		case "StackOfPartiallyRotatedGrowthCurve2DRibbon:StackPartiallyRotatedGrowthCurve2DRibbonStartShapes":
			// 1. Decode the AssociationStorage which contains the rowIDs of the StackOfPartiallyRotatedGrowthCurve2DRibbon instances
			rowIDs, err := DecodeStringToIntSlice(formDiv.FormEditAssocButton.AssociationStorage)
			if err != nil {
				log.Panic("not a good storage", formDiv.FormEditAssocButton.AssociationStorage)
			...
			// 2. Build a map of target StackOfPartiallyRotatedGrowthCurve2DRibbon instances by their ID
			map_RowID_ID := GetMap_RowID_ID[*models.StackOfPartiallyRotatedGrowthCurve2DRibbon](stackpartiallyrotatedgrowthcurve2dribbonstartshapeFormCallback.probe.stageOfInterest)
			targetStackOfPartiallyRotatedGrowthCurve2DRibbonIDs := make(map[uint]bool)
			for _, rowID := range rowIDs {
				if id, ok := map_RowID_ID[int(rowID)]; ok {
					targetStackOfPartiallyRotatedGrowthCurve2DRibbonIDs[id] = true
			...
			// 3. Iterate over all StackOfPartiallyRotatedGrowthCurve2DRibbon instances and update their StackPartiallyRotatedGrowthCurve2DRibbonStartShapes slice
			for _stackofpartiallyrotatedgrowthcurve2dribbon := range *models.GetGongstructInstancesSetFromPointerType[*models.StackOfPartiallyRotatedGrowthCurve2DRibbon](stackpartiallyrotatedgrowthcurve2dribbonstartshapeFormCallback.probe.stageOfInterest) {
				id := models.GetOrderPointerGongstruct(stackpartiallyrotatedgrowthcurve2dribbonstartshapeFormCallback.probe.stageOfInterest, _stackofpartiallyrotatedgrowthcurve2dribbon)
				
				// if StackOfPartiallyRotatedGrowthCurve2DRibbon is selected
				if targetStackOfPartiallyRotatedGrowthCurve2DRibbonIDs[id] {
					// ensure stackpartiallyrotatedgrowthcurve2dribbonstartshape_ is in _stackofpartiallyrotatedgrowthcurve2dribbon.StackPartiallyRotatedGrowthCurve2DRibbonStartShapes
					found := false
					for _, _b := range _stackofpartiallyrotatedgrowthcurve2dribbon.StackPartiallyRotatedGrowthCurve2DRibbonStartShapes {
						if _b == stackpartiallyrotatedgrowthcurve2dribbonstartshape_ {
							found = true
							break
						}
					}
					if !found {
						_stackofpartiallyrotatedgrowthcurve2dribbon.StackPartiallyRotatedGrowthCurve2DRibbonStartShapes = append(_stackofpartiallyrotatedgrowthcurve2dribbon.StackPartiallyRotatedGrowthCurve2DRibbonStartShapes, stackpartiallyrotatedgrowthcurve2dribbonstartshape_)
						stackpartiallyrotatedgrowthcurve2dribbonstartshapeFormCallback.probe.UpdateSliceOfPointersCallback(_stackofpartiallyrotatedgrowthcurve2dribbon, "StackPartiallyRotatedGrowthCurve2DRibbonStartShapes", &_stackofpartiallyrotatedgrowthcurve2dribbon.StackPartiallyRotatedGrowthCurve2DRibbonStartShapes)
					}
				} else {
					// ensure stackpartiallyrotatedgrowthcurve2dribbonstartshape_ is NOT in _stackofpartiallyrotatedgrowthcurve2dribbon.StackPartiallyRotatedGrowthCurve2DRibbonStartShapes
					idx := slices.Index(_stackofpartiallyrotatedgrowthcurve2dribbon.StackPartiallyRotatedGrowthCurve2DRibbonStartShapes, stackpartiallyrotatedgrowthcurve2dribbonstartshape_)
					if idx != -1 {
						_stackofpartiallyrotatedgrowthcurve2dribbon.StackPartiallyRotatedGrowthCurve2DRibbonStartShapes = slices.Delete(_stackofpartiallyrotatedgrowthcurve2dribbon.StackPartiallyRotatedGrowthCurve2DRibbonStartShapes, idx, idx+1)
						stackpartiallyrotatedgrowthcurve2dribbonstartshapeFormCallback.probe.UpdateSliceOfPointersCallback(_stackofpartiallyrotatedgrowthcurve2dribbon, "StackPartiallyRotatedGrowthCurve2DRibbonStartShapes", &_stackofpartiallyrotatedgrowthcurve2dribbon.StackPartiallyRotatedGrowthCurve2DRibbonStartShapes)
					}
				}
			}
	...
	// manage the suppress operation
	if stackpartiallyrotatedgrowthcurve2dribbonstartshapeFormCallback.formGroup.HasSuppressButtonBeenPressed {
		stackpartiallyrotatedgrowthcurve2dribbonstartshape_.Unstage(stackpartiallyrotatedgrowthcurve2dribbonstartshapeFormCallback.probe.stageOfInterest)
	}

	stackpartiallyrotatedgrowthcurve2dribbonstartshapeFormCallback.probe.stageOfInterest.Commit()
	updateProbeTable[*models.StackPartiallyRotatedGrowthCurve2DRibbonStartShape](
		stackpartiallyrotatedgrowthcurve2dribbonstartshapeFormCallback.probe,
	)

	// display a new form by reset the form stage
	if stackpartiallyrotatedgrowthcurve2dribbonstartshapeFormCallback.CreationMode || stackpartiallyrotatedgrowthcurve2dribbonstartshapeFormCallback.formGroup.HasSuppressButtonBeenPressed {
		stackpartiallyrotatedgrowthcurve2dribbonstartshapeFormCallback.probe.formStage.Reset()
		newFormGroup := (&form.FormGroup{
			Name: FormName,
		}).Stage(stackpartiallyrotatedgrowthcurve2dribbonstartshapeFormCallback.probe.formStage)
		newFormGroup.OnSave = __gong__New__StackPartiallyRotatedGrowthCurve2DRibbonStartShapeFormCallback(
			nil,
			stackpartiallyrotatedgrowthcurve2dribbonstartshapeFormCallback.probe,
			newFormGroup,
		)
		stackpartiallyrotatedgrowthcurve2dribbonstartshape := new(models.StackPartiallyRotatedGrowthCurve2DRibbonStartShape)
		FillUpForm(stackpartiallyrotatedgrowthcurve2dribbonstartshape, newFormGroup, stackpartiallyrotatedgrowthcurve2dribbonstartshapeFormCallback.probe)
		stackpartiallyrotatedgrowthcurve2dribbonstartshapeFormCallback.probe.formStage.Commit()
	}

	stackpartiallyrotatedgrowthcurve2dribbonstartshapeFormCallback.probe.ux_tree()
}
