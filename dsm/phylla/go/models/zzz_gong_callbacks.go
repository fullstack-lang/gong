...
func AfterReadFromFront[Type Gongstruct](stage *Stage, instance *Type) {
	...
	case *Circumference3DShape:
		if stage.OnAfterCircumference3DShapeReadCallback != nil {
			stage.OnAfterCircumference3DShapeReadCallback.OnAfterRead(stage, target)
		}
	case *Clock2DDiagram:
		if stage.OnAfterClock2DDiagramReadCallback != nil {
			stage.OnAfterClock2DDiagramReadCallback.OnAfterRead(stage, target)
		}
	case *Clock3DDiagram:
		if stage.OnAfterClock3DDiagramReadCallback != nil {
			stage.OnAfterClock3DDiagramReadCallback.OnAfterRead(stage, target)
		}
	case *ClockAbstract:
	...
	case *CutLine3DShape:
		if stage.OnAfterCutLine3DShapeReadCallback != nil {
			stage.OnAfterCutLine3DShapeReadCallback.OnAfterRead(stage, target)
		}
	case *EndArcShape:
	...
	case *Eye3DShape:
		if stage.OnAfterEye3DShapeReadCallback != nil {
			stage.OnAfterEye3DShapeReadCallback.OnAfterRead(stage, target)
		}
	case *EyeCornersSampledPoints3DShape:
	...
	case *ParastichyMCurves3DShape:
		if stage.OnAfterParastichyMCurves3DShapeReadCallback != nil {
			stage.OnAfterParastichyMCurves3DShapeReadCallback.OnAfterRead(stage, target)
		}
	case *ParastichyNCurves3DShape:
		if stage.OnAfterParastichyNCurves3DShapeReadCallback != nil {
			stage.OnAfterParastichyNCurves3DShapeReadCallback.OnAfterRead(stage, target)
		}
	case *PartiallyGrowthCurve2DRibbon:
	...
	case *PartiallyRotatedSeatBottomCurveShape:
		if stage.OnAfterPartiallyRotatedSeatBottomCurveShapeReadCallback != nil {
			stage.OnAfterPartiallyRotatedSeatBottomCurveShapeReadCallback.OnAfterRead(stage, target)
		}
	case *PartiallyRotatedSeatTopCurveShape:
	...
	case *Plant2DDiagram:
		if stage.OnAfterPlant2DDiagramReadCallback != nil {
			stage.OnAfterPlant2DDiagramReadCallback.OnAfterRead(stage, target)
		}
	case *Plant3DDiagram:
		if stage.OnAfterPlant3DDiagramReadCallback != nil {
			stage.OnAfterPlant3DDiagramReadCallback.OnAfterRead(stage, target)
		}
	case *PlantAbstract:
		if stage.OnAfterPlantAbstractReadCallback != nil {
			stage.OnAfterPlantAbstractReadCallback.OnAfterRead(stage, target)
		}
	case *PlantCircumferenceShape:
	...
	case *SeatBottomCurveShape:
		if stage.OnAfterSeatBottomCurveShapeReadCallback != nil {
			stage.OnAfterSeatBottomCurveShapeReadCallback.OnAfterRead(stage, target)
		}
	case *SeatTopCurveShape:
		if stage.OnAfterSeatTopCurveShapeReadCallback != nil {
			stage.OnAfterSeatTopCurveShapeReadCallback.OnAfterRead(stage, target)
		}
	case *ShiftedBottomTopStartArcShape:
	...
	case *ShiftedLeftGrowthCurve2DRibbon:
		if stage.OnAfterShiftedLeftGrowthCurve2DRibbonReadCallback != nil {
			stage.OnAfterShiftedLeftGrowthCurve2DRibbonReadCallback.OnAfterRead(stage, target)
		}
	case *ShiftedLeftGrowthCurve2DRibbonEndShape:
		if stage.OnAfterShiftedLeftGrowthCurve2DRibbonEndShapeReadCallback != nil {
			stage.OnAfterShiftedLeftGrowthCurve2DRibbonEndShapeReadCallback.OnAfterRead(stage, target)
		}
	case *ShiftedLeftGrowthCurve2DRibbonStartShape:
		if stage.OnAfterShiftedLeftGrowthCurve2DRibbonStartShapeReadCallback != nil {
			stage.OnAfterShiftedLeftGrowthCurve2DRibbonStartShapeReadCallback.OnAfterRead(stage, target)
		}
	case *ShiftedLeftPartiallyGrowthCurve2DRibbon:
		if stage.OnAfterShiftedLeftPartiallyGrowthCurve2DRibbonReadCallback != nil {
			stage.OnAfterShiftedLeftPartiallyGrowthCurve2DRibbonReadCallback.OnAfterRead(stage, target)
		}
	case *ShiftedLeftPartiallyGrowthCurve2DRibbonEndShape:
		if stage.OnAfterShiftedLeftPartiallyGrowthCurve2DRibbonEndShapeReadCallback != nil {
			stage.OnAfterShiftedLeftPartiallyGrowthCurve2DRibbonEndShapeReadCallback.OnAfterRead(stage, target)
		}
	case *ShiftedLeftPartiallyGrowthCurve2DRibbonStartShape:
		if stage.OnAfterShiftedLeftPartiallyGrowthCurve2DRibbonStartShapeReadCallback != nil {
			stage.OnAfterShiftedLeftPartiallyGrowthCurve2DRibbonStartShapeReadCallback.OnAfterRead(stage, target)
		}
	case *ShiftedLeftStackGrowthCurveEndArcShape:
	...
	case *StackOfGrowthCurve2DByGrowthVector:
		if stage.OnAfterStackOfGrowthCurve2DByGrowthVectorReadCallback != nil {
			stage.OnAfterStackOfGrowthCurve2DByGrowthVectorReadCallback.OnAfterRead(stage, target)
		}
	case *StackOfGrowthCurve2DRibbon:
	...
	case *StemCylinder3DShape:
		if stage.OnAfterStemCylinder3DShapeReadCallback != nil {
			stage.OnAfterStemCylinder3DShapeReadCallback.OnAfterRead(stage, target)
		}
	case *Stool2DDiagram:
		if stage.OnAfterStool2DDiagramReadCallback != nil {
			stage.OnAfterStool2DDiagramReadCallback.OnAfterRead(stage, target)
		}
	case *Stool3DDiagram:
		if stage.OnAfterStool3DDiagramReadCallback != nil {
			stage.OnAfterStool3DDiagramReadCallback.OnAfterRead(stage, target)
		}
	case *StoolAbstract:
		if stage.OnAfterStoolAbstractReadCallback != nil {
			stage.OnAfterStoolAbstractReadCallback.OnAfterRead(stage, target)
		}
	case *TiledFloor3DShape:
	...
	case *Vase2DDiagram:
		if stage.OnAfterVase2DDiagramReadCallback != nil {
			stage.OnAfterVase2DDiagramReadCallback.OnAfterRead(stage, target)
		}
	case *Vase3DDiagram:
		if stage.OnAfterVase3DDiagramReadCallback != nil {
			stage.OnAfterVase3DDiagramReadCallback.OnAfterRead(stage, target)
		}
	case *VaseAbstract:
...
func SetCallbackAfterUpdateFromFront[Type Gongstruct](stage *Stage, callback OnAfterUpdateInterface[Type]) {
	...
	case *Circumference3DShape:
		stage.OnAfterCircumference3DShapeUpdateCallback = any(callback).(OnAfterUpdateInterface[Circumference3DShape])
	case *Clock2DDiagram:
		stage.OnAfterClock2DDiagramUpdateCallback = any(callback).(OnAfterUpdateInterface[Clock2DDiagram])
	case *Clock3DDiagram:
		stage.OnAfterClock3DDiagramUpdateCallback = any(callback).(OnAfterUpdateInterface[Clock3DDiagram])
	case *ClockAbstract:
	...
	case *CutLine3DShape:
		stage.OnAfterCutLine3DShapeUpdateCallback = any(callback).(OnAfterUpdateInterface[CutLine3DShape])
	case *EndArcShape:
	...
	case *Eye3DShape:
		stage.OnAfterEye3DShapeUpdateCallback = any(callback).(OnAfterUpdateInterface[Eye3DShape])
	case *EyeCornersSampledPoints3DShape:
	...
	case *ParastichyMCurves3DShape:
		stage.OnAfterParastichyMCurves3DShapeUpdateCallback = any(callback).(OnAfterUpdateInterface[ParastichyMCurves3DShape])
	case *ParastichyNCurves3DShape:
		stage.OnAfterParastichyNCurves3DShapeUpdateCallback = any(callback).(OnAfterUpdateInterface[ParastichyNCurves3DShape])
	case *PartiallyGrowthCurve2DRibbon:
	...
	case *PartiallyRotatedSeatBottomCurveShape:
		stage.OnAfterPartiallyRotatedSeatBottomCurveShapeUpdateCallback = any(callback).(OnAfterUpdateInterface[PartiallyRotatedSeatBottomCurveShape])
	case *PartiallyRotatedSeatTopCurveShape:
	...
	case *Plant2DDiagram:
		stage.OnAfterPlant2DDiagramUpdateCallback = any(callback).(OnAfterUpdateInterface[Plant2DDiagram])
	case *Plant3DDiagram:
		stage.OnAfterPlant3DDiagramUpdateCallback = any(callback).(OnAfterUpdateInterface[Plant3DDiagram])
	case *PlantAbstract:
		stage.OnAfterPlantAbstractUpdateCallback = any(callback).(OnAfterUpdateInterface[PlantAbstract])
	case *PlantCircumferenceShape:
	...
	case *SeatTopCurveShape:
		stage.OnAfterSeatTopCurveShapeUpdateCallback = any(callback).(OnAfterUpdateInterface[SeatTopCurveShape])
	case *ShiftedBottomTopStartArcShape:
	...
	case *ShiftedLeftGrowthCurve2DRibbon:
		stage.OnAfterShiftedLeftGrowthCurve2DRibbonUpdateCallback = any(callback).(OnAfterUpdateInterface[ShiftedLeftGrowthCurve2DRibbon])
	case *ShiftedLeftGrowthCurve2DRibbonEndShape:
		stage.OnAfterShiftedLeftGrowthCurve2DRibbonEndShapeUpdateCallback = any(callback).(OnAfterUpdateInterface[ShiftedLeftGrowthCurve2DRibbonEndShape])
	case *ShiftedLeftGrowthCurve2DRibbonStartShape:
		stage.OnAfterShiftedLeftGrowthCurve2DRibbonStartShapeUpdateCallback = any(callback).(OnAfterUpdateInterface[ShiftedLeftGrowthCurve2DRibbonStartShape])
	case *ShiftedLeftPartiallyGrowthCurve2DRibbon:
		stage.OnAfterShiftedLeftPartiallyGrowthCurve2DRibbonUpdateCallback = any(callback).(OnAfterUpdateInterface[ShiftedLeftPartiallyGrowthCurve2DRibbon])
	case *ShiftedLeftPartiallyGrowthCurve2DRibbonEndShape:
		stage.OnAfterShiftedLeftPartiallyGrowthCurve2DRibbonEndShapeUpdateCallback = any(callback).(OnAfterUpdateInterface[ShiftedLeftPartiallyGrowthCurve2DRibbonEndShape])
	case *ShiftedLeftPartiallyGrowthCurve2DRibbonStartShape:
		stage.OnAfterShiftedLeftPartiallyGrowthCurve2DRibbonStartShapeUpdateCallback = any(callback).(OnAfterUpdateInterface[ShiftedLeftPartiallyGrowthCurve2DRibbonStartShape])
	case *ShiftedLeftStackGrowthCurveEndArcShape:
	...
	case *StackOfGrowthCurve2DByGrowthVector:
		stage.OnAfterStackOfGrowthCurve2DByGrowthVectorUpdateCallback = any(callback).(OnAfterUpdateInterface[StackOfGrowthCurve2DByGrowthVector])
	case *StackOfGrowthCurve2DRibbon:
	...
	case *StemCylinder3DShape:
		stage.OnAfterStemCylinder3DShapeUpdateCallback = any(callback).(OnAfterUpdateInterface[StemCylinder3DShape])
	case *Stool2DDiagram:
		stage.OnAfterStool2DDiagramUpdateCallback = any(callback).(OnAfterUpdateInterface[Stool2DDiagram])
	case *Stool3DDiagram:
		stage.OnAfterStool3DDiagramUpdateCallback = any(callback).(OnAfterUpdateInterface[Stool3DDiagram])
	case *StoolAbstract:
	...
	case *Vase2DDiagram:
		stage.OnAfterVase2DDiagramUpdateCallback = any(callback).(OnAfterUpdateInterface[Vase2DDiagram])
	case *Vase3DDiagram:
		stage.OnAfterVase3DDiagramUpdateCallback = any(callback).(OnAfterUpdateInterface[Vase3DDiagram])
	case *VaseAbstract:
...
func SetCallbackAfterCreateFromFront[Type Gongstruct](stage *Stage, callback OnAfterCreateInterface[Type]) {
	...
	case *Circumference3DShape:
		stage.OnAfterCircumference3DShapeCreateCallback = any(callback).(OnAfterCreateInterface[Circumference3DShape])
	case *Clock2DDiagram:
		stage.OnAfterClock2DDiagramCreateCallback = any(callback).(OnAfterCreateInterface[Clock2DDiagram])
	case *Clock3DDiagram:
		stage.OnAfterClock3DDiagramCreateCallback = any(callback).(OnAfterCreateInterface[Clock3DDiagram])
	case *ClockAbstract:
	...
	case *CutLine3DShape:
		stage.OnAfterCutLine3DShapeCreateCallback = any(callback).(OnAfterCreateInterface[CutLine3DShape])
	case *EndArcShape:
	...
	case *Eye3DShape:
		stage.OnAfterEye3DShapeCreateCallback = any(callback).(OnAfterCreateInterface[Eye3DShape])
	case *EyeCornersSampledPoints3DShape:
	...
	case *ParastichyMCurves3DShape:
		stage.OnAfterParastichyMCurves3DShapeCreateCallback = any(callback).(OnAfterCreateInterface[ParastichyMCurves3DShape])
	case *ParastichyNCurves3DShape:
		stage.OnAfterParastichyNCurves3DShapeCreateCallback = any(callback).(OnAfterCreateInterface[ParastichyNCurves3DShape])
	case *PartiallyGrowthCurve2DRibbon:
	...
	case *PartiallyRotatedSeatBottomCurveShape:
		stage.OnAfterPartiallyRotatedSeatBottomCurveShapeCreateCallback = any(callback).(OnAfterCreateInterface[PartiallyRotatedSeatBottomCurveShape])
	case *PartiallyRotatedSeatTopCurveShape:
	...
	case *Plant2DDiagram:
		stage.OnAfterPlant2DDiagramCreateCallback = any(callback).(OnAfterCreateInterface[Plant2DDiagram])
	case *Plant3DDiagram:
		stage.OnAfterPlant3DDiagramCreateCallback = any(callback).(OnAfterCreateInterface[Plant3DDiagram])
	case *PlantAbstract:
		stage.OnAfterPlantAbstractCreateCallback = any(callback).(OnAfterCreateInterface[PlantAbstract])
	case *PlantCircumferenceShape:
	...
	case *SeatTopCurveShape:
		stage.OnAfterSeatTopCurveShapeCreateCallback = any(callback).(OnAfterCreateInterface[SeatTopCurveShape])
	case *ShiftedBottomTopStartArcShape:
	...
	case *ShiftedLeftGrowthCurve2DRibbon:
		stage.OnAfterShiftedLeftGrowthCurve2DRibbonCreateCallback = any(callback).(OnAfterCreateInterface[ShiftedLeftGrowthCurve2DRibbon])
	case *ShiftedLeftGrowthCurve2DRibbonEndShape:
		stage.OnAfterShiftedLeftGrowthCurve2DRibbonEndShapeCreateCallback = any(callback).(OnAfterCreateInterface[ShiftedLeftGrowthCurve2DRibbonEndShape])
	case *ShiftedLeftGrowthCurve2DRibbonStartShape:
		stage.OnAfterShiftedLeftGrowthCurve2DRibbonStartShapeCreateCallback = any(callback).(OnAfterCreateInterface[ShiftedLeftGrowthCurve2DRibbonStartShape])
	case *ShiftedLeftPartiallyGrowthCurve2DRibbon:
		stage.OnAfterShiftedLeftPartiallyGrowthCurve2DRibbonCreateCallback = any(callback).(OnAfterCreateInterface[ShiftedLeftPartiallyGrowthCurve2DRibbon])
	case *ShiftedLeftPartiallyGrowthCurve2DRibbonEndShape:
		stage.OnAfterShiftedLeftPartiallyGrowthCurve2DRibbonEndShapeCreateCallback = any(callback).(OnAfterCreateInterface[ShiftedLeftPartiallyGrowthCurve2DRibbonEndShape])
	case *ShiftedLeftPartiallyGrowthCurve2DRibbonStartShape:
		stage.OnAfterShiftedLeftPartiallyGrowthCurve2DRibbonStartShapeCreateCallback = any(callback).(OnAfterCreateInterface[ShiftedLeftPartiallyGrowthCurve2DRibbonStartShape])
	case *ShiftedLeftStackGrowthCurveEndArcShape:
	...
	case *StackOfGrowthCurve2DByGrowthVector:
		stage.OnAfterStackOfGrowthCurve2DByGrowthVectorCreateCallback = any(callback).(OnAfterCreateInterface[StackOfGrowthCurve2DByGrowthVector])
	case *StackOfGrowthCurve2DRibbon:
	...
	case *StemCylinder3DShape:
		stage.OnAfterStemCylinder3DShapeCreateCallback = any(callback).(OnAfterCreateInterface[StemCylinder3DShape])
	case *Stool2DDiagram:
		stage.OnAfterStool2DDiagramCreateCallback = any(callback).(OnAfterCreateInterface[Stool2DDiagram])
	case *Stool3DDiagram:
		stage.OnAfterStool3DDiagramCreateCallback = any(callback).(OnAfterCreateInterface[Stool3DDiagram])
	case *StoolAbstract:
	...
	case *Vase2DDiagram:
		stage.OnAfterVase2DDiagramCreateCallback = any(callback).(OnAfterCreateInterface[Vase2DDiagram])
	case *Vase3DDiagram:
		stage.OnAfterVase3DDiagramCreateCallback = any(callback).(OnAfterCreateInterface[Vase3DDiagram])
	case *VaseAbstract:
...
func SetCallbackAfterDeleteFromFront[Type Gongstruct](stage *Stage, callback OnAfterDeleteInterface[Type]) {
	...
	case *Circumference3DShape:
		stage.OnAfterCircumference3DShapeDeleteCallback = any(callback).(OnAfterDeleteInterface[Circumference3DShape])
	case *Clock2DDiagram:
		stage.OnAfterClock2DDiagramDeleteCallback = any(callback).(OnAfterDeleteInterface[Clock2DDiagram])
	case *Clock3DDiagram:
		stage.OnAfterClock3DDiagramDeleteCallback = any(callback).(OnAfterDeleteInterface[Clock3DDiagram])
	case *ClockAbstract:
	...
	case *CutLine3DShape:
		stage.OnAfterCutLine3DShapeDeleteCallback = any(callback).(OnAfterDeleteInterface[CutLine3DShape])
	case *EndArcShape:
	...
	case *Eye3DShape:
		stage.OnAfterEye3DShapeDeleteCallback = any(callback).(OnAfterDeleteInterface[Eye3DShape])
	case *EyeCornersSampledPoints3DShape:
	...
	case *ParastichyMCurves3DShape:
		stage.OnAfterParastichyMCurves3DShapeDeleteCallback = any(callback).(OnAfterDeleteInterface[ParastichyMCurves3DShape])
	case *ParastichyNCurves3DShape:
		stage.OnAfterParastichyNCurves3DShapeDeleteCallback = any(callback).(OnAfterDeleteInterface[ParastichyNCurves3DShape])
	case *PartiallyGrowthCurve2DRibbon:
	...
	case *PartiallyRotatedSeatBottomCurveShape:
		stage.OnAfterPartiallyRotatedSeatBottomCurveShapeDeleteCallback = any(callback).(OnAfterDeleteInterface[PartiallyRotatedSeatBottomCurveShape])
	case *PartiallyRotatedSeatTopCurveShape:
	...
	case *Plant2DDiagram:
		stage.OnAfterPlant2DDiagramDeleteCallback = any(callback).(OnAfterDeleteInterface[Plant2DDiagram])
	case *Plant3DDiagram:
		stage.OnAfterPlant3DDiagramDeleteCallback = any(callback).(OnAfterDeleteInterface[Plant3DDiagram])
	case *PlantAbstract:
		stage.OnAfterPlantAbstractDeleteCallback = any(callback).(OnAfterDeleteInterface[PlantAbstract])
	case *PlantCircumferenceShape:
	...
	case *SeatTopCurveShape:
		stage.OnAfterSeatTopCurveShapeDeleteCallback = any(callback).(OnAfterDeleteInterface[SeatTopCurveShape])
	case *ShiftedBottomTopStartArcShape:
	...
	case *ShiftedLeftGrowthCurve2DRibbon:
		stage.OnAfterShiftedLeftGrowthCurve2DRibbonDeleteCallback = any(callback).(OnAfterDeleteInterface[ShiftedLeftGrowthCurve2DRibbon])
	case *ShiftedLeftGrowthCurve2DRibbonEndShape:
		stage.OnAfterShiftedLeftGrowthCurve2DRibbonEndShapeDeleteCallback = any(callback).(OnAfterDeleteInterface[ShiftedLeftGrowthCurve2DRibbonEndShape])
	case *ShiftedLeftGrowthCurve2DRibbonStartShape:
		stage.OnAfterShiftedLeftGrowthCurve2DRibbonStartShapeDeleteCallback = any(callback).(OnAfterDeleteInterface[ShiftedLeftGrowthCurve2DRibbonStartShape])
	case *ShiftedLeftPartiallyGrowthCurve2DRibbon:
		stage.OnAfterShiftedLeftPartiallyGrowthCurve2DRibbonDeleteCallback = any(callback).(OnAfterDeleteInterface[ShiftedLeftPartiallyGrowthCurve2DRibbon])
	case *ShiftedLeftPartiallyGrowthCurve2DRibbonEndShape:
		stage.OnAfterShiftedLeftPartiallyGrowthCurve2DRibbonEndShapeDeleteCallback = any(callback).(OnAfterDeleteInterface[ShiftedLeftPartiallyGrowthCurve2DRibbonEndShape])
	case *ShiftedLeftPartiallyGrowthCurve2DRibbonStartShape:
		stage.OnAfterShiftedLeftPartiallyGrowthCurve2DRibbonStartShapeDeleteCallback = any(callback).(OnAfterDeleteInterface[ShiftedLeftPartiallyGrowthCurve2DRibbonStartShape])
	case *ShiftedLeftStackGrowthCurveEndArcShape:
	...
	case *StackOfGrowthCurve2DByGrowthVector:
		stage.OnAfterStackOfGrowthCurve2DByGrowthVectorDeleteCallback = any(callback).(OnAfterDeleteInterface[StackOfGrowthCurve2DByGrowthVector])
	case *StackOfGrowthCurve2DRibbon:
	...
	case *StemCylinder3DShape:
		stage.OnAfterStemCylinder3DShapeDeleteCallback = any(callback).(OnAfterDeleteInterface[StemCylinder3DShape])
	case *Stool2DDiagram:
		stage.OnAfterStool2DDiagramDeleteCallback = any(callback).(OnAfterDeleteInterface[Stool2DDiagram])
	case *Stool3DDiagram:
		stage.OnAfterStool3DDiagramDeleteCallback = any(callback).(OnAfterDeleteInterface[Stool3DDiagram])
	case *StoolAbstract:
	...
	case *Vase2DDiagram:
		stage.OnAfterVase2DDiagramDeleteCallback = any(callback).(OnAfterDeleteInterface[Vase2DDiagram])
	case *Vase3DDiagram:
		stage.OnAfterVase3DDiagramDeleteCallback = any(callback).(OnAfterDeleteInterface[Vase3DDiagram])
	case *VaseAbstract:
...
func SetCallbackAfterReadFromFront[Type Gongstruct](stage *Stage, callback OnAfterReadInterface[Type]) {
	...
	case *Circumference3DShape:
		stage.OnAfterCircumference3DShapeReadCallback = any(callback).(OnAfterReadInterface[Circumference3DShape])
	case *Clock2DDiagram:
		stage.OnAfterClock2DDiagramReadCallback = any(callback).(OnAfterReadInterface[Clock2DDiagram])
	case *Clock3DDiagram:
		stage.OnAfterClock3DDiagramReadCallback = any(callback).(OnAfterReadInterface[Clock3DDiagram])
	case *ClockAbstract:
	...
	case *CutLine3DShape:
		stage.OnAfterCutLine3DShapeReadCallback = any(callback).(OnAfterReadInterface[CutLine3DShape])
	case *EndArcShape:
	...
	case *Eye3DShape:
		stage.OnAfterEye3DShapeReadCallback = any(callback).(OnAfterReadInterface[Eye3DShape])
	case *EyeCornersSampledPoints3DShape:
	...
	case *ParastichyMCurves3DShape:
		stage.OnAfterParastichyMCurves3DShapeReadCallback = any(callback).(OnAfterReadInterface[ParastichyMCurves3DShape])
	case *ParastichyNCurves3DShape:
		stage.OnAfterParastichyNCurves3DShapeReadCallback = any(callback).(OnAfterReadInterface[ParastichyNCurves3DShape])
	case *PartiallyGrowthCurve2DRibbon:
	...
	case *PartiallyRotatedSeatBottomCurveShape:
		stage.OnAfterPartiallyRotatedSeatBottomCurveShapeReadCallback = any(callback).(OnAfterReadInterface[PartiallyRotatedSeatBottomCurveShape])
	case *PartiallyRotatedSeatTopCurveShape:
	...
	case *Plant2DDiagram:
		stage.OnAfterPlant2DDiagramReadCallback = any(callback).(OnAfterReadInterface[Plant2DDiagram])
	case *Plant3DDiagram:
		stage.OnAfterPlant3DDiagramReadCallback = any(callback).(OnAfterReadInterface[Plant3DDiagram])
	case *PlantAbstract:
		stage.OnAfterPlantAbstractReadCallback = any(callback).(OnAfterReadInterface[PlantAbstract])
	case *PlantCircumferenceShape:
	...
	case *SeatTopCurveShape:
		stage.OnAfterSeatTopCurveShapeReadCallback = any(callback).(OnAfterReadInterface[SeatTopCurveShape])
	case *ShiftedBottomTopStartArcShape:
	...
	case *ShiftedLeftGrowthCurve2DRibbon:
		stage.OnAfterShiftedLeftGrowthCurve2DRibbonReadCallback = any(callback).(OnAfterReadInterface[ShiftedLeftGrowthCurve2DRibbon])
	case *ShiftedLeftGrowthCurve2DRibbonEndShape:
		stage.OnAfterShiftedLeftGrowthCurve2DRibbonEndShapeReadCallback = any(callback).(OnAfterReadInterface[ShiftedLeftGrowthCurve2DRibbonEndShape])
	case *ShiftedLeftGrowthCurve2DRibbonStartShape:
		stage.OnAfterShiftedLeftGrowthCurve2DRibbonStartShapeReadCallback = any(callback).(OnAfterReadInterface[ShiftedLeftGrowthCurve2DRibbonStartShape])
	case *ShiftedLeftPartiallyGrowthCurve2DRibbon:
		stage.OnAfterShiftedLeftPartiallyGrowthCurve2DRibbonReadCallback = any(callback).(OnAfterReadInterface[ShiftedLeftPartiallyGrowthCurve2DRibbon])
	case *ShiftedLeftPartiallyGrowthCurve2DRibbonEndShape:
		stage.OnAfterShiftedLeftPartiallyGrowthCurve2DRibbonEndShapeReadCallback = any(callback).(OnAfterReadInterface[ShiftedLeftPartiallyGrowthCurve2DRibbonEndShape])
	case *ShiftedLeftPartiallyGrowthCurve2DRibbonStartShape:
		stage.OnAfterShiftedLeftPartiallyGrowthCurve2DRibbonStartShapeReadCallback = any(callback).(OnAfterReadInterface[ShiftedLeftPartiallyGrowthCurve2DRibbonStartShape])
	case *ShiftedLeftStackGrowthCurveEndArcShape:
	...
	case *StackOfGrowthCurve2DByGrowthVector:
		stage.OnAfterStackOfGrowthCurve2DByGrowthVectorReadCallback = any(callback).(OnAfterReadInterface[StackOfGrowthCurve2DByGrowthVector])
	case *StackOfGrowthCurve2DRibbon:
	...
	case *StemCylinder3DShape:
		stage.OnAfterStemCylinder3DShapeReadCallback = any(callback).(OnAfterReadInterface[StemCylinder3DShape])
	case *Stool2DDiagram:
		stage.OnAfterStool2DDiagramReadCallback = any(callback).(OnAfterReadInterface[Stool2DDiagram])
	case *Stool3DDiagram:
		stage.OnAfterStool3DDiagramReadCallback = any(callback).(OnAfterReadInterface[Stool3DDiagram])
	case *StoolAbstract:
	...
	case *Vase2DDiagram:
		stage.OnAfterVase2DDiagramReadCallback = any(callback).(OnAfterReadInterface[Vase2DDiagram])
	case *Vase3DDiagram:
		stage.OnAfterVase3DDiagramReadCallback = any(callback).(OnAfterReadInterface[Vase3DDiagram])
	case *VaseAbstract:
