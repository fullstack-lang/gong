...
func (stageSet *StageSet) MarshallToString(packageName string) (res string, err error) {
	...
	if stageSet.Stage != nil {
		...
		for _, clockabstract := range clockabstractOrdered {
			...
			clockabstractIdent := "__clock" + clockabstract.GongGetIdentifier(stageSet.Stage)
			declarations.WriteString(fmt.Sprintf("\n\t%s := (&clock.ClockAbstract{Name: %s}).Stage(stageSet.Stage)", clockabstractIdent, __gong__toRawStringLiteral(clockabstract.Name)))
...
func _(stageSet *clock.StageSet) {
