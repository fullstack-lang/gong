...
func (stage *Stage) Squash() {
	...
	__gong__clearReferences(&stage.ClockAbstracts_reference, &stage.ClockAbstracts_instance, &stage.ClockAbstracts_referenceOrder)
...
func (stage *Stage) recomputeOrders() {
	// insertion point for max order recomputation
	stage.ClockAbstractOrder = __gong__recomputeOrder(stage.ClockAbstract_stagedOrder)
...
func (stage *Stage) GetInstancesByOrder[T GongstructPtr]() (res []T) {
	...
	case *ClockAbstract:
		return __gong__castSlice[T](__gong__getStructInstancesByOrder(stage.ClockAbstracts, stage.ClockAbstract_stagedOrder))
...
func (clockabstract *ClockAbstract) Stage(stage *Stage) *ClockAbstract {
	__gong__stage(stage.ClockAbstracts, stage.ClockAbstract_stagedOrder, stage.ClockAbstract_orderStaged, &stage.ClockAbstractOrder, stage.ClockAbstracts_mapString, clockabstract, clockabstract.Name)
...
func (clockabstract *ClockAbstract) StagePreserveOrder(stage *Stage, order uint) {
	__gong__stagePreserveOrder(stage.ClockAbstracts, stage.ClockAbstract_stagedOrder, stage.ClockAbstract_orderStaged, &stage.ClockAbstractOrder, stage.ClockAbstracts_mapString, clockabstract, order, clockabstract.Name)
}

// Unstage removes clockabstract off the model stage
func (clockabstract *ClockAbstract) Unstage(stage *Stage) *ClockAbstract {
	__gong__unstage(stage.ClockAbstracts, stage.ClockAbstracts_mapString, clockabstract, clockabstract.Name)
	return clockabstract
}
...
func (stage *Stage) Reset() { // insertion point for array reset
	__gong__resetStageType(&stage.ClockAbstracts, &stage.ClockAbstracts_mapString, &stage.ClockAbstract_stagedOrder, &stage.ClockAbstractOrder)
...
func (stage *Stage) ResetMapStrings() {
	// insertion point for generic get gongstruct name
	__gong__rebuildMapString(stage.ClockAbstracts, &stage.ClockAbstracts_mapString)
