...
// StackOfPartiallyRotatedGrowthCurve2DRibbon of a plant,
type StackOfPartiallyRotatedGrowthCurve2DRibbon struct {
	Name string

	StackPartiallyRotatedGrowthCurve2DRibbonStartShapes []*StackPartiallyRotatedGrowthCurve2DRibbonStartShape
	StackPartiallyRotatedGrowthCurve2DRibbonEndShapes   []*StackPartiallyRotatedGrowthCurve2DRibbonEndShape
}

type StackPartiallyRotatedGrowthCurve2DRibbonStartShape struct {
	Name string
...
type StackPartiallyRotatedGrowthCurve2DRibbonEndShape struct {
	Name string
