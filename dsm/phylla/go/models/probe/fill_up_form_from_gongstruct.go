...
func FillUpNamedFormFromGongstruct(instance any, probe *Probe, formStage *form.Stage, formName string) {
	...
	case *models.Circumference3DShape:
		formGroup := (&form.FormGroup{
			Name:      formName,
			Label:     instancesTyped.GetName(),
			TypeLabel: "Circumference3DShape",
		}).Stage(formStage)
	...
	case *models.OriginalPoints3DShape:
		formGroup := (&form.FormGroup{
			Name:      formName,
			Label:     instancesTyped.GetName(),
			TypeLabel: "OriginalPoints3DShape",
		}).Stage(formStage)
	...
	case *models.ParastichyMCurves3DShape:
		formGroup := (&form.FormGroup{
			Name:      formName,
			Label:     instancesTyped.GetName(),
			TypeLabel: "ParastichyMCurves3DShape",
		}).Stage(formStage)
	...
	case *models.ParastichyNCurves3DShape:
		formGroup := (&form.FormGroup{
			Name:      formName,
			Label:     instancesTyped.GetName(),
			TypeLabel: "ParastichyNCurves3DShape",
		}).Stage(formStage)
	...
	case *models.PointsAndLines3DShape:
		formGroup := (&form.FormGroup{
			Name:      formName,
			Label:     instancesTyped.GetName(),
			TypeLabel: "PointsAndLines3DShape",
		}).Stage(formStage)
	...
	case *models.ShiftedLeftGrowthCurve2DRibbon:
		formGroup := (&form.FormGroup{
			Name:      formName,
			Label:     instancesTyped.GetName(),
			TypeLabel: "ShiftedLeftGrowthCurve2DRibbon",
		}).Stage(formStage)
	...
	case *models.ShiftedLeftGrowthCurve2DRibbonEndShape:
		formGroup := (&form.FormGroup{
			Name:      formName,
			Label:     instancesTyped.GetName(),
			TypeLabel: "ShiftedLeftGrowthCurve2DRibbonEndShape",
		}).Stage(formStage)
	...
	case *models.ShiftedLeftGrowthCurve2DRibbonStartShape:
		formGroup := (&form.FormGroup{
			Name:      formName,
			Label:     instancesTyped.GetName(),
			TypeLabel: "ShiftedLeftGrowthCurve2DRibbonStartShape",
		}).Stage(formStage)
	...
	case *models.ShiftedLeftPartiallyGrowthCurve2DRibbon:
		formGroup := (&form.FormGroup{
			Name:      formName,
			Label:     instancesTyped.GetName(),
			TypeLabel: "ShiftedLeftPartiallyGrowthCurve2DRibbon",
		}).Stage(formStage)
	...
	case *models.ShiftedLeftPartiallyGrowthCurve2DRibbonEndShape:
		formGroup := (&form.FormGroup{
			Name:      formName,
			Label:     instancesTyped.GetName(),
			TypeLabel: "ShiftedLeftPartiallyGrowthCurve2DRibbonEndShape",
		}).Stage(formStage)
	...
	case *models.ShiftedLeftPartiallyGrowthCurve2DRibbonStartShape:
		formGroup := (&form.FormGroup{
			Name:      formName,
			Label:     instancesTyped.GetName(),
			TypeLabel: "ShiftedLeftPartiallyGrowthCurve2DRibbonStartShape",
		}).Stage(formStage)
	...
	case *models.StackOfRotatedVaseTrapezeRingsShape:
		formGroup := (&form.FormGroup{
			Name:      formName,
			Label:     instancesTyped.GetName(),
			TypeLabel: "StackOfRotatedVaseTrapezeRingsShape",
		}).Stage(formStage)
	...
	case *models.StackOfVaseTrapezeRingsShape:
		formGroup := (&form.FormGroup{
			Name:      formName,
			Label:     instancesTyped.GetName(),
			TypeLabel: "StackOfVaseTrapezeRingsShape",
		}).Stage(formStage)
	...
	case *models.VaseTrapezeRingShape:
		formGroup := (&form.FormGroup{
			Name:      formName,
			Label:     instancesTyped.GetName(),
			TypeLabel: "VaseTrapezeRingShape",
		}).Stage(formStage)
