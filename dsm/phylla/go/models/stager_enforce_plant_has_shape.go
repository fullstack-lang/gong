...
func (stager *Stager) enforcePlantHasRotatedShapes() (needCommit bool) {
	...
	n20 := enforcePlantHasShape[*StackOfRotatedGrowthCurve2DRibbon](
		...
		func(p *Plant) *StackOfRotatedGrowthCurve2DRibbon { return p.StackOfRotatedGrowthCurve2DRibbon },
		func(p *Plant, shape *StackOfRotatedGrowthCurve2DRibbon) { p.StackOfRotatedGrowthCurve2DRibbon = shape },
		func(p *Plant, shape *StackOfRotatedGrowthCurve2DRibbon) bool {
	...
	n21_traj := enforcePlantHasShape[*PartiallyGrowthCurve2DTrajectory](
		...
		func(p *Plant) *PartiallyGrowthCurve2DTrajectory { return p.PartiallyGrowthCurve2DTrajectory },
		func(p *Plant, shape *PartiallyGrowthCurve2DTrajectory) { p.PartiallyGrowthCurve2DTrajectory = shape },
		func(p *Plant, shape *PartiallyGrowthCurve2DTrajectory) bool {
	...
	n21_trajP1P2 := enforcePlantHasShape[*PartiallyGrowthCurve2DTrajectoryP1P2](
		...
		func(p *Plant) *PartiallyGrowthCurve2DTrajectoryP1P2 { return p.PartiallyGrowthCurve2DTrajectoryP1P2 },
		func(p *Plant, shape *PartiallyGrowthCurve2DTrajectoryP1P2) { p.PartiallyGrowthCurve2DTrajectoryP1P2 = shape },
		func(p *Plant, shape *PartiallyGrowthCurve2DTrajectoryP1P2) bool {
	...
	n21_px := enforcePlantHasShape[*PxShape](
		...
		func(p *Plant) *PxShape { return p.PxShape },
		func(p *Plant, shape *PxShape) { p.PxShape = shape },
		func(p *Plant, shape *PxShape) bool {
	...
	n24 := enforcePlantHasShape[*ShiftedLeftGrowthCurve2DRibbon](
		...
		func(p *Plant) *ShiftedLeftGrowthCurve2DRibbon { return p.ShiftedLeftGrowthCurve2DRibbon },
		func(p *Plant, shape *ShiftedLeftGrowthCurve2DRibbon) { p.ShiftedLeftGrowthCurve2DRibbon = shape },
		func(p *Plant, shape *ShiftedLeftGrowthCurve2DRibbon) bool {
