...
func (stage *Stage) ComputeReverseMaps() {
	...
	// insertion point per field
	stage.GrowthCurve2DRibbon_GrowthCurve2DRibbonStartShapes_reverseMap = make(map[*GrowthCurve2DRibbonStartShape]*GrowthCurve2DRibbon)
	for growthcurve2dribbon := range stage.GrowthCurve2DRibbons {
		_ = growthcurve2dribbon
		for _, _growthcurve2dribbonstartshape := range growthcurve2dribbon.GrowthCurve2DRibbonStartShapes {
			stage.GrowthCurve2DRibbon_GrowthCurve2DRibbonStartShapes_reverseMap[_growthcurve2dribbonstartshape] = growthcurve2dribbon
		}
	}
	stage.GrowthCurve2DRibbon_GrowthCurve2DRibbonEndShapes_reverseMap = make(map[*GrowthCurve2DRibbonEndShape]*GrowthCurve2DRibbon)
	for growthcurve2dribbon := range stage.GrowthCurve2DRibbons {
		_ = growthcurve2dribbon
		for _, _growthcurve2dribbonendshape := range growthcurve2dribbon.GrowthCurve2DRibbonEndShapes {
			stage.GrowthCurve2DRibbon_GrowthCurve2DRibbonEndShapes_reverseMap[_growthcurve2dribbonendshape] = growthcurve2dribbon
		}
	}
	...
	// insertion point per field
	stage.ShiftedRightGrowthCurve2DRibbon_ShiftedRightGrowthCurve2DRibbonStartShapes_reverseMap = make(map[*ShiftedRightGrowthCurve2DRibbonStartShape]*ShiftedRightGrowthCurve2DRibbon)
	for shiftedrightgrowthcurve2dribbon := range stage.ShiftedRightGrowthCurve2DRibbons {
		_ = shiftedrightgrowthcurve2dribbon
		for _, _shiftedrightgrowthcurve2dribbonstartshape := range shiftedrightgrowthcurve2dribbon.ShiftedRightGrowthCurve2DRibbonStartShapes {
			stage.ShiftedRightGrowthCurve2DRibbon_ShiftedRightGrowthCurve2DRibbonStartShapes_reverseMap[_shiftedrightgrowthcurve2dribbonstartshape] = shiftedrightgrowthcurve2dribbon
		}
	}
	stage.ShiftedRightGrowthCurve2DRibbon_ShiftedRightGrowthCurve2DRibbonEndShapes_reverseMap = make(map[*ShiftedRightGrowthCurve2DRibbonEndShape]*ShiftedRightGrowthCurve2DRibbon)
	for shiftedrightgrowthcurve2dribbon := range stage.ShiftedRightGrowthCurve2DRibbons {
		_ = shiftedrightgrowthcurve2dribbon
		for _, _shiftedrightgrowthcurve2dribbonendshape := range shiftedrightgrowthcurve2dribbon.ShiftedRightGrowthCurve2DRibbonEndShapes {
			stage.ShiftedRightGrowthCurve2DRibbon_ShiftedRightGrowthCurve2DRibbonEndShapes_reverseMap[_shiftedrightgrowthcurve2dribbonendshape] = shiftedrightgrowthcurve2dribbon
		}
	}
...
func (stage *Stage) ComputeForwardAndBackwardCommits() {
	...
	var growthcurve2dribbons_newInstances []*GrowthCurve2DRibbon
	var growthcurve2dribbons_deletedInstances []*GrowthCurve2DRibbon

	// parse all staged instances and check if they have a reference
	for growthcurve2dribbon := range stage.GrowthCurve2DRibbons {
		if ref, ok := stage.GrowthCurve2DRibbons_reference[growthcurve2dribbon]; !ok {
			growthcurve2dribbons_newInstances = append(growthcurve2dribbons_newInstances, growthcurve2dribbon)
			newInstancesSlice = append(newInstancesSlice, growthcurve2dribbon.GongMarshallIdentifier(stage))
			if stage.GrowthCurve2DRibbons_referenceOrder == nil {
				stage.GrowthCurve2DRibbons_referenceOrder = make(map[*GrowthCurve2DRibbon]uint)
			}
			stage.GrowthCurve2DRibbons_referenceOrder[growthcurve2dribbon] = stage.GrowthCurve2DRibbon_stagedOrder[growthcurve2dribbon]
			newInstancesReverseSlice = append(newInstancesReverseSlice, growthcurve2dribbon.GongMarshallUnstaging(stage))
			// delete(stage.GrowthCurve2DRibbons_referenceOrder, growthcurve2dribbon)
			fieldInitializers, pointersInitializations := growthcurve2dribbon.GongMarshallAllFields(stage)
			fieldsEditSlice = append(fieldsEditSlice, fieldInitializers+pointersInitializations)
		} else {
			stage.GrowthCurve2DRibbon_stagedOrder[ref] = stage.GrowthCurve2DRibbon_stagedOrder[growthcurve2dribbon]
			ref.GongReconstructPointersFromInstances(stage) // reconstruct ref with pointers from the stage
			diffs := growthcurve2dribbon.GongDiff(stage, ref)
			reverseDiffs := ref.GongDiff(stage, growthcurve2dribbon)
			// delete(stage.GrowthCurve2DRibbon_stagedOrder, ref)
			if len(diffs) > 0 {
				var fieldsEdit string
				if growthcurve2dribbon.GetName() != "" {
					fieldsEdit += fmt.Sprintf("\n\t// %s", growthcurve2dribbon.GetName())
				} else {
					fieldsEdit += "\n\t//"
				}
				for _, diff := range diffs {
	...
	// parse all reference instances and check if they are still staged
	for _, ref := range stage.GrowthCurve2DRibbons_reference {
		instance := stage.GrowthCurve2DRibbons_instance[ref]    // get the instance corresponding to the reference
		if _, ok := stage.GrowthCurve2DRibbons[instance]; !ok { // if the instance is not staged anymore,  it means it has been unstaged
			growthcurve2dribbons_deletedInstances = append(growthcurve2dribbons_deletedInstances, ref)
			deletedInstancesSlice = append(deletedInstancesSlice, ref.GongMarshallUnstaging(stage))
			deletedInstancesReverseSlice = append(deletedInstancesReverseSlice, ref.GongMarshallIdentifier(stage))
			fieldInitializers, pointersInitializations := ref.GongMarshallAllFields(stage)
			fieldsEditReverseSlice = append(fieldsEditReverseSlice, fieldInitializers+pointersInitializations)
	...
	lenNewInstances += len(growthcurve2dribbons_newInstances)
	lenDeletedInstances += len(growthcurve2dribbons_deletedInstances)
	var growthcurve2dribbonendshapes_newInstances []*GrowthCurve2DRibbonEndShape
	var growthcurve2dribbonendshapes_deletedInstances []*GrowthCurve2DRibbonEndShape

	// parse all staged instances and check if they have a reference
	for growthcurve2dribbonendshape := range stage.GrowthCurve2DRibbonEndShapes {
		if ref, ok := stage.GrowthCurve2DRibbonEndShapes_reference[growthcurve2dribbonendshape]; !ok {
			growthcurve2dribbonendshapes_newInstances = append(growthcurve2dribbonendshapes_newInstances, growthcurve2dribbonendshape)
			newInstancesSlice = append(newInstancesSlice, growthcurve2dribbonendshape.GongMarshallIdentifier(stage))
			if stage.GrowthCurve2DRibbonEndShapes_referenceOrder == nil {
				stage.GrowthCurve2DRibbonEndShapes_referenceOrder = make(map[*GrowthCurve2DRibbonEndShape]uint)
			}
			stage.GrowthCurve2DRibbonEndShapes_referenceOrder[growthcurve2dribbonendshape] = stage.GrowthCurve2DRibbonEndShape_stagedOrder[growthcurve2dribbonendshape]
			newInstancesReverseSlice = append(newInstancesReverseSlice, growthcurve2dribbonendshape.GongMarshallUnstaging(stage))
			// delete(stage.GrowthCurve2DRibbonEndShapes_referenceOrder, growthcurve2dribbonendshape)
			fieldInitializers, pointersInitializations := growthcurve2dribbonendshape.GongMarshallAllFields(stage)
			fieldsEditSlice = append(fieldsEditSlice, fieldInitializers+pointersInitializations)
		} else {
			stage.GrowthCurve2DRibbonEndShape_stagedOrder[ref] = stage.GrowthCurve2DRibbonEndShape_stagedOrder[growthcurve2dribbonendshape]
			ref.GongReconstructPointersFromInstances(stage) // reconstruct ref with pointers from the stage
			diffs := growthcurve2dribbonendshape.GongDiff(stage, ref)
			reverseDiffs := ref.GongDiff(stage, growthcurve2dribbonendshape)
			// delete(stage.GrowthCurve2DRibbonEndShape_stagedOrder, ref)
			if len(diffs) > 0 {
				var fieldsEdit string
				if growthcurve2dribbonendshape.GetName() != "" {
					fieldsEdit += fmt.Sprintf("\n\t// %s", growthcurve2dribbonendshape.GetName())
				} else {
					fieldsEdit += "\n\t//"
				}
				for _, diff := range diffs {
	...
	// parse all reference instances and check if they are still staged
	for _, ref := range stage.GrowthCurve2DRibbonEndShapes_reference {
		instance := stage.GrowthCurve2DRibbonEndShapes_instance[ref]    // get the instance corresponding to the reference
		if _, ok := stage.GrowthCurve2DRibbonEndShapes[instance]; !ok { // if the instance is not staged anymore,  it means it has been unstaged
			growthcurve2dribbonendshapes_deletedInstances = append(growthcurve2dribbonendshapes_deletedInstances, ref)
			deletedInstancesSlice = append(deletedInstancesSlice, ref.GongMarshallUnstaging(stage))
			deletedInstancesReverseSlice = append(deletedInstancesReverseSlice, ref.GongMarshallIdentifier(stage))
			fieldInitializers, pointersInitializations := ref.GongMarshallAllFields(stage)
			fieldsEditReverseSlice = append(fieldsEditReverseSlice, fieldInitializers+pointersInitializations)
	...
	lenNewInstances += len(growthcurve2dribbonendshapes_newInstances)
	lenDeletedInstances += len(growthcurve2dribbonendshapes_deletedInstances)
	var growthcurve2dribbonstartshapes_newInstances []*GrowthCurve2DRibbonStartShape
	var growthcurve2dribbonstartshapes_deletedInstances []*GrowthCurve2DRibbonStartShape

	// parse all staged instances and check if they have a reference
	for growthcurve2dribbonstartshape := range stage.GrowthCurve2DRibbonStartShapes {
		if ref, ok := stage.GrowthCurve2DRibbonStartShapes_reference[growthcurve2dribbonstartshape]; !ok {
			growthcurve2dribbonstartshapes_newInstances = append(growthcurve2dribbonstartshapes_newInstances, growthcurve2dribbonstartshape)
			newInstancesSlice = append(newInstancesSlice, growthcurve2dribbonstartshape.GongMarshallIdentifier(stage))
			if stage.GrowthCurve2DRibbonStartShapes_referenceOrder == nil {
				stage.GrowthCurve2DRibbonStartShapes_referenceOrder = make(map[*GrowthCurve2DRibbonStartShape]uint)
			}
			stage.GrowthCurve2DRibbonStartShapes_referenceOrder[growthcurve2dribbonstartshape] = stage.GrowthCurve2DRibbonStartShape_stagedOrder[growthcurve2dribbonstartshape]
			newInstancesReverseSlice = append(newInstancesReverseSlice, growthcurve2dribbonstartshape.GongMarshallUnstaging(stage))
			// delete(stage.GrowthCurve2DRibbonStartShapes_referenceOrder, growthcurve2dribbonstartshape)
			fieldInitializers, pointersInitializations := growthcurve2dribbonstartshape.GongMarshallAllFields(stage)
			fieldsEditSlice = append(fieldsEditSlice, fieldInitializers+pointersInitializations)
		} else {
			stage.GrowthCurve2DRibbonStartShape_stagedOrder[ref] = stage.GrowthCurve2DRibbonStartShape_stagedOrder[growthcurve2dribbonstartshape]
			ref.GongReconstructPointersFromInstances(stage) // reconstruct ref with pointers from the stage
			diffs := growthcurve2dribbonstartshape.GongDiff(stage, ref)
			reverseDiffs := ref.GongDiff(stage, growthcurve2dribbonstartshape)
			// delete(stage.GrowthCurve2DRibbonStartShape_stagedOrder, ref)
			if len(diffs) > 0 {
				var fieldsEdit string
				if growthcurve2dribbonstartshape.GetName() != "" {
					fieldsEdit += fmt.Sprintf("\n\t// %s", growthcurve2dribbonstartshape.GetName())
				} else {
					fieldsEdit += "\n\t//"
				}
				for _, diff := range diffs {
	...
	// parse all reference instances and check if they are still staged
	for _, ref := range stage.GrowthCurve2DRibbonStartShapes_reference {
		instance := stage.GrowthCurve2DRibbonStartShapes_instance[ref]    // get the instance corresponding to the reference
		if _, ok := stage.GrowthCurve2DRibbonStartShapes[instance]; !ok { // if the instance is not staged anymore,  it means it has been unstaged
			growthcurve2dribbonstartshapes_deletedInstances = append(growthcurve2dribbonstartshapes_deletedInstances, ref)
			deletedInstancesSlice = append(deletedInstancesSlice, ref.GongMarshallUnstaging(stage))
			deletedInstancesReverseSlice = append(deletedInstancesReverseSlice, ref.GongMarshallIdentifier(stage))
			fieldInitializers, pointersInitializations := ref.GongMarshallAllFields(stage)
			fieldsEditReverseSlice = append(fieldsEditReverseSlice, fieldInitializers+pointersInitializations)
	...
	lenNewInstances += len(growthcurve2dribbonstartshapes_newInstances)
	lenDeletedInstances += len(growthcurve2dribbonstartshapes_deletedInstances)
	...
	var shiftedrightgrowthcurve2dribbons_newInstances []*ShiftedRightGrowthCurve2DRibbon
	var shiftedrightgrowthcurve2dribbons_deletedInstances []*ShiftedRightGrowthCurve2DRibbon

	// parse all staged instances and check if they have a reference
	for shiftedrightgrowthcurve2dribbon := range stage.ShiftedRightGrowthCurve2DRibbons {
		if ref, ok := stage.ShiftedRightGrowthCurve2DRibbons_reference[shiftedrightgrowthcurve2dribbon]; !ok {
			shiftedrightgrowthcurve2dribbons_newInstances = append(shiftedrightgrowthcurve2dribbons_newInstances, shiftedrightgrowthcurve2dribbon)
			newInstancesSlice = append(newInstancesSlice, shiftedrightgrowthcurve2dribbon.GongMarshallIdentifier(stage))
			if stage.ShiftedRightGrowthCurve2DRibbons_referenceOrder == nil {
				stage.ShiftedRightGrowthCurve2DRibbons_referenceOrder = make(map[*ShiftedRightGrowthCurve2DRibbon]uint)
			}
			stage.ShiftedRightGrowthCurve2DRibbons_referenceOrder[shiftedrightgrowthcurve2dribbon] = stage.ShiftedRightGrowthCurve2DRibbon_stagedOrder[shiftedrightgrowthcurve2dribbon]
			newInstancesReverseSlice = append(newInstancesReverseSlice, shiftedrightgrowthcurve2dribbon.GongMarshallUnstaging(stage))
			// delete(stage.ShiftedRightGrowthCurve2DRibbons_referenceOrder, shiftedrightgrowthcurve2dribbon)
			fieldInitializers, pointersInitializations := shiftedrightgrowthcurve2dribbon.GongMarshallAllFields(stage)
			fieldsEditSlice = append(fieldsEditSlice, fieldInitializers+pointersInitializations)
		} else {
			stage.ShiftedRightGrowthCurve2DRibbon_stagedOrder[ref] = stage.ShiftedRightGrowthCurve2DRibbon_stagedOrder[shiftedrightgrowthcurve2dribbon]
			ref.GongReconstructPointersFromInstances(stage) // reconstruct ref with pointers from the stage
			diffs := shiftedrightgrowthcurve2dribbon.GongDiff(stage, ref)
			reverseDiffs := ref.GongDiff(stage, shiftedrightgrowthcurve2dribbon)
			// delete(stage.ShiftedRightGrowthCurve2DRibbon_stagedOrder, ref)
			if len(diffs) > 0 {
				var fieldsEdit string
				if shiftedrightgrowthcurve2dribbon.GetName() != "" {
					fieldsEdit += fmt.Sprintf("\n\t// %s", shiftedrightgrowthcurve2dribbon.GetName())
				} else {
					fieldsEdit += "\n\t//"
				}
				for _, diff := range diffs {
	...
	// parse all reference instances and check if they are still staged
	for _, ref := range stage.ShiftedRightGrowthCurve2DRibbons_reference {
		instance := stage.ShiftedRightGrowthCurve2DRibbons_instance[ref]    // get the instance corresponding to the reference
		if _, ok := stage.ShiftedRightGrowthCurve2DRibbons[instance]; !ok { // if the instance is not staged anymore,  it means it has been unstaged
			shiftedrightgrowthcurve2dribbons_deletedInstances = append(shiftedrightgrowthcurve2dribbons_deletedInstances, ref)
			deletedInstancesSlice = append(deletedInstancesSlice, ref.GongMarshallUnstaging(stage))
			deletedInstancesReverseSlice = append(deletedInstancesReverseSlice, ref.GongMarshallIdentifier(stage))
			fieldInitializers, pointersInitializations := ref.GongMarshallAllFields(stage)
			fieldsEditReverseSlice = append(fieldsEditReverseSlice, fieldInitializers+pointersInitializations)
	...
	lenNewInstances += len(shiftedrightgrowthcurve2dribbons_newInstances)
	lenDeletedInstances += len(shiftedrightgrowthcurve2dribbons_deletedInstances)
	var shiftedrightgrowthcurve2dribbonendshapes_newInstances []*ShiftedRightGrowthCurve2DRibbonEndShape
	var shiftedrightgrowthcurve2dribbonendshapes_deletedInstances []*ShiftedRightGrowthCurve2DRibbonEndShape

	// parse all staged instances and check if they have a reference
	for shiftedrightgrowthcurve2dribbonendshape := range stage.ShiftedRightGrowthCurve2DRibbonEndShapes {
		if ref, ok := stage.ShiftedRightGrowthCurve2DRibbonEndShapes_reference[shiftedrightgrowthcurve2dribbonendshape]; !ok {
			shiftedrightgrowthcurve2dribbonendshapes_newInstances = append(shiftedrightgrowthcurve2dribbonendshapes_newInstances, shiftedrightgrowthcurve2dribbonendshape)
			newInstancesSlice = append(newInstancesSlice, shiftedrightgrowthcurve2dribbonendshape.GongMarshallIdentifier(stage))
			if stage.ShiftedRightGrowthCurve2DRibbonEndShapes_referenceOrder == nil {
				stage.ShiftedRightGrowthCurve2DRibbonEndShapes_referenceOrder = make(map[*ShiftedRightGrowthCurve2DRibbonEndShape]uint)
			}
			stage.ShiftedRightGrowthCurve2DRibbonEndShapes_referenceOrder[shiftedrightgrowthcurve2dribbonendshape] = stage.ShiftedRightGrowthCurve2DRibbonEndShape_stagedOrder[shiftedrightgrowthcurve2dribbonendshape]
			newInstancesReverseSlice = append(newInstancesReverseSlice, shiftedrightgrowthcurve2dribbonendshape.GongMarshallUnstaging(stage))
			// delete(stage.ShiftedRightGrowthCurve2DRibbonEndShapes_referenceOrder, shiftedrightgrowthcurve2dribbonendshape)
			fieldInitializers, pointersInitializations := shiftedrightgrowthcurve2dribbonendshape.GongMarshallAllFields(stage)
			fieldsEditSlice = append(fieldsEditSlice, fieldInitializers+pointersInitializations)
		} else {
			stage.ShiftedRightGrowthCurve2DRibbonEndShape_stagedOrder[ref] = stage.ShiftedRightGrowthCurve2DRibbonEndShape_stagedOrder[shiftedrightgrowthcurve2dribbonendshape]
			ref.GongReconstructPointersFromInstances(stage) // reconstruct ref with pointers from the stage
			diffs := shiftedrightgrowthcurve2dribbonendshape.GongDiff(stage, ref)
			reverseDiffs := ref.GongDiff(stage, shiftedrightgrowthcurve2dribbonendshape)
			// delete(stage.ShiftedRightGrowthCurve2DRibbonEndShape_stagedOrder, ref)
			if len(diffs) > 0 {
				var fieldsEdit string
				if shiftedrightgrowthcurve2dribbonendshape.GetName() != "" {
					fieldsEdit += fmt.Sprintf("\n\t// %s", shiftedrightgrowthcurve2dribbonendshape.GetName())
				} else {
					fieldsEdit += "\n\t//"
				}
				for _, diff := range diffs {
	...
	// parse all reference instances and check if they are still staged
	for _, ref := range stage.ShiftedRightGrowthCurve2DRibbonEndShapes_reference {
		instance := stage.ShiftedRightGrowthCurve2DRibbonEndShapes_instance[ref]    // get the instance corresponding to the reference
		if _, ok := stage.ShiftedRightGrowthCurve2DRibbonEndShapes[instance]; !ok { // if the instance is not staged anymore,  it means it has been unstaged
			shiftedrightgrowthcurve2dribbonendshapes_deletedInstances = append(shiftedrightgrowthcurve2dribbonendshapes_deletedInstances, ref)
			deletedInstancesSlice = append(deletedInstancesSlice, ref.GongMarshallUnstaging(stage))
			deletedInstancesReverseSlice = append(deletedInstancesReverseSlice, ref.GongMarshallIdentifier(stage))
			fieldInitializers, pointersInitializations := ref.GongMarshallAllFields(stage)
			fieldsEditReverseSlice = append(fieldsEditReverseSlice, fieldInitializers+pointersInitializations)
	...
	lenNewInstances += len(shiftedrightgrowthcurve2dribbonendshapes_newInstances)
	lenDeletedInstances += len(shiftedrightgrowthcurve2dribbonendshapes_deletedInstances)
	var shiftedrightgrowthcurve2dribbonstartshapes_newInstances []*ShiftedRightGrowthCurve2DRibbonStartShape
	var shiftedrightgrowthcurve2dribbonstartshapes_deletedInstances []*ShiftedRightGrowthCurve2DRibbonStartShape

	// parse all staged instances and check if they have a reference
	for shiftedrightgrowthcurve2dribbonstartshape := range stage.ShiftedRightGrowthCurve2DRibbonStartShapes {
		if ref, ok := stage.ShiftedRightGrowthCurve2DRibbonStartShapes_reference[shiftedrightgrowthcurve2dribbonstartshape]; !ok {
			shiftedrightgrowthcurve2dribbonstartshapes_newInstances = append(shiftedrightgrowthcurve2dribbonstartshapes_newInstances, shiftedrightgrowthcurve2dribbonstartshape)
			newInstancesSlice = append(newInstancesSlice, shiftedrightgrowthcurve2dribbonstartshape.GongMarshallIdentifier(stage))
			if stage.ShiftedRightGrowthCurve2DRibbonStartShapes_referenceOrder == nil {
				stage.ShiftedRightGrowthCurve2DRibbonStartShapes_referenceOrder = make(map[*ShiftedRightGrowthCurve2DRibbonStartShape]uint)
			}
			stage.ShiftedRightGrowthCurve2DRibbonStartShapes_referenceOrder[shiftedrightgrowthcurve2dribbonstartshape] = stage.ShiftedRightGrowthCurve2DRibbonStartShape_stagedOrder[shiftedrightgrowthcurve2dribbonstartshape]
			newInstancesReverseSlice = append(newInstancesReverseSlice, shiftedrightgrowthcurve2dribbonstartshape.GongMarshallUnstaging(stage))
			// delete(stage.ShiftedRightGrowthCurve2DRibbonStartShapes_referenceOrder, shiftedrightgrowthcurve2dribbonstartshape)
			fieldInitializers, pointersInitializations := shiftedrightgrowthcurve2dribbonstartshape.GongMarshallAllFields(stage)
			fieldsEditSlice = append(fieldsEditSlice, fieldInitializers+pointersInitializations)
		} else {
			stage.ShiftedRightGrowthCurve2DRibbonStartShape_stagedOrder[ref] = stage.ShiftedRightGrowthCurve2DRibbonStartShape_stagedOrder[shiftedrightgrowthcurve2dribbonstartshape]
			ref.GongReconstructPointersFromInstances(stage) // reconstruct ref with pointers from the stage
			diffs := shiftedrightgrowthcurve2dribbonstartshape.GongDiff(stage, ref)
			reverseDiffs := ref.GongDiff(stage, shiftedrightgrowthcurve2dribbonstartshape)
			// delete(stage.ShiftedRightGrowthCurve2DRibbonStartShape_stagedOrder, ref)
			if len(diffs) > 0 {
				var fieldsEdit string
				if shiftedrightgrowthcurve2dribbonstartshape.GetName() != "" {
					fieldsEdit += fmt.Sprintf("\n\t// %s", shiftedrightgrowthcurve2dribbonstartshape.GetName())
				} else {
					fieldsEdit += "\n\t//"
				}
				for _, diff := range diffs {
	...
	// parse all reference instances and check if they are still staged
	for _, ref := range stage.ShiftedRightGrowthCurve2DRibbonStartShapes_reference {
		instance := stage.ShiftedRightGrowthCurve2DRibbonStartShapes_instance[ref]    // get the instance corresponding to the reference
		if _, ok := stage.ShiftedRightGrowthCurve2DRibbonStartShapes[instance]; !ok { // if the instance is not staged anymore,  it means it has been unstaged
			shiftedrightgrowthcurve2dribbonstartshapes_deletedInstances = append(shiftedrightgrowthcurve2dribbonstartshapes_deletedInstances, ref)
			deletedInstancesSlice = append(deletedInstancesSlice, ref.GongMarshallUnstaging(stage))
			deletedInstancesReverseSlice = append(deletedInstancesReverseSlice, ref.GongMarshallIdentifier(stage))
			fieldInitializers, pointersInitializations := ref.GongMarshallAllFields(stage)
			fieldsEditReverseSlice = append(fieldsEditReverseSlice, fieldInitializers+pointersInitializations)
	...
	lenNewInstances += len(shiftedrightgrowthcurve2dribbonstartshapes_newInstances)
	lenDeletedInstances += len(shiftedrightgrowthcurve2dribbonstartshapes_deletedInstances)
	...
	var stackofpartiallyrotatedtorusshapes_newInstances []*StackOfPartiallyRotatedTorusShape
	var stackofpartiallyrotatedtorusshapes_deletedInstances []*StackOfPartiallyRotatedTorusShape

	// parse all staged instances and check if they have a reference
	for stackofpartiallyrotatedtorusshape := range stage.StackOfPartiallyRotatedTorusShapes {
		if ref, ok := stage.StackOfPartiallyRotatedTorusShapes_reference[stackofpartiallyrotatedtorusshape]; !ok {
			stackofpartiallyrotatedtorusshapes_newInstances = append(stackofpartiallyrotatedtorusshapes_newInstances, stackofpartiallyrotatedtorusshape)
			newInstancesSlice = append(newInstancesSlice, stackofpartiallyrotatedtorusshape.GongMarshallIdentifier(stage))
			if stage.StackOfPartiallyRotatedTorusShapes_referenceOrder == nil {
				stage.StackOfPartiallyRotatedTorusShapes_referenceOrder = make(map[*StackOfPartiallyRotatedTorusShape]uint)
			}
			stage.StackOfPartiallyRotatedTorusShapes_referenceOrder[stackofpartiallyrotatedtorusshape] = stage.StackOfPartiallyRotatedTorusShape_stagedOrder[stackofpartiallyrotatedtorusshape]
			newInstancesReverseSlice = append(newInstancesReverseSlice, stackofpartiallyrotatedtorusshape.GongMarshallUnstaging(stage))
			// delete(stage.StackOfPartiallyRotatedTorusShapes_referenceOrder, stackofpartiallyrotatedtorusshape)
			fieldInitializers, pointersInitializations := stackofpartiallyrotatedtorusshape.GongMarshallAllFields(stage)
			fieldsEditSlice = append(fieldsEditSlice, fieldInitializers+pointersInitializations)
		} else {
			stage.StackOfPartiallyRotatedTorusShape_stagedOrder[ref] = stage.StackOfPartiallyRotatedTorusShape_stagedOrder[stackofpartiallyrotatedtorusshape]
			ref.GongReconstructPointersFromInstances(stage) // reconstruct ref with pointers from the stage
			diffs := stackofpartiallyrotatedtorusshape.GongDiff(stage, ref)
			reverseDiffs := ref.GongDiff(stage, stackofpartiallyrotatedtorusshape)
			// delete(stage.StackOfPartiallyRotatedTorusShape_stagedOrder, ref)
			if len(diffs) > 0 {
				var fieldsEdit string
				if stackofpartiallyrotatedtorusshape.GetName() != "" {
					fieldsEdit += fmt.Sprintf("\n\t// %s", stackofpartiallyrotatedtorusshape.GetName())
				} else {
					fieldsEdit += "\n\t//"
				}
				for _, diff := range diffs {
	...
	// parse all reference instances and check if they are still staged
	for _, ref := range stage.StackOfPartiallyRotatedTorusShapes_reference {
		instance := stage.StackOfPartiallyRotatedTorusShapes_instance[ref]    // get the instance corresponding to the reference
		if _, ok := stage.StackOfPartiallyRotatedTorusShapes[instance]; !ok { // if the instance is not staged anymore,  it means it has been unstaged
			stackofpartiallyrotatedtorusshapes_deletedInstances = append(stackofpartiallyrotatedtorusshapes_deletedInstances, ref)
			deletedInstancesSlice = append(deletedInstancesSlice, ref.GongMarshallUnstaging(stage))
			deletedInstancesReverseSlice = append(deletedInstancesReverseSlice, ref.GongMarshallIdentifier(stage))
			fieldInitializers, pointersInitializations := ref.GongMarshallAllFields(stage)
			fieldsEditReverseSlice = append(fieldsEditReverseSlice, fieldInitializers+pointersInitializations)
	...
	lenNewInstances += len(stackofpartiallyrotatedtorusshapes_newInstances)
	lenDeletedInstances += len(stackofpartiallyrotatedtorusshapes_deletedInstances)
