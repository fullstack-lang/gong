...
func buildExcelizeFile(stage *Stage, addIDs bool) *excelize.File {
	f := excelize.NewFile()
	{
		...
		SerializeExcelizePointerToGongstruct2[*BottomEndArcShape](stage, f, addIDs)
		SerializeExcelizePointerToGongstruct2[*BottomEndArcShapeGrid](stage, f, addIDs)
		SerializeExcelizePointerToGongstruct2[*BottomStackGrowthCurveEndArcShape](stage, f, addIDs)
		SerializeExcelizePointerToGongstruct2[*BottomStackGrowthCurveStartArcShape](stage, f, addIDs)
		SerializeExcelizePointerToGongstruct2[*BottomStackOfGrowthCurve](stage, f, addIDs)
		SerializeExcelizePointerToGongstruct2[*BottomStartArcShape](stage, f, addIDs)
		SerializeExcelizePointerToGongstruct2[*BottomStartArcShapeGrid](stage, f, addIDs)
