...
func buildExcelizeFile(stage *Stage, addIDs bool) *excelize.File {
	f := excelize.NewFile()
	{
		...
		SerializeExcelizePointerToGongstruct2[*BottomEndArcShapeV2](stage, f, addIDs)
		SerializeExcelizePointerToGongstruct2[*BottomEndArcShapeV2Grid](stage, f, addIDs)
		SerializeExcelizePointerToGongstruct2[*BottomStackGrowthCurveEndArcShapeV2](stage, f, addIDs)
		SerializeExcelizePointerToGongstruct2[*BottomStackGrowthCurveStartArcShapeV2](stage, f, addIDs)
		SerializeExcelizePointerToGongstruct2[*BottomStackOfGrowthCurveV2](stage, f, addIDs)
		SerializeExcelizePointerToGongstruct2[*BottomStartArcShapeV2](stage, f, addIDs)
		SerializeExcelizePointerToGongstruct2[*BottomStartArcShapeV2Grid](stage, f, addIDs)
		...
		SerializeExcelizePointerToGongstruct2[*StackGrowthCurveEndArcShapeV2](stage, f, addIDs)
		SerializeExcelizePointerToGongstruct2[*StackGrowthCurveStartArcShapeV2](stage, f, addIDs)
		SerializeExcelizePointerToGongstruct2[*StackOfGrowthCurve](stage, f, addIDs)
		SerializeExcelizePointerToGongstruct2[*StackOfGrowthCurveV2](stage, f, addIDs)
		...
		SerializeExcelizePointerToGongstruct2[*TopStackGrowthCurveEndArcShapeV2](stage, f, addIDs)
		SerializeExcelizePointerToGongstruct2[*TopStackGrowthCurveStartArcShapeV2](stage, f, addIDs)
		SerializeExcelizePointerToGongstruct2[*TopStackOfGrowthCurveV2](stage, f, addIDs)
