...
func buildExcelizeFile(stage *Stage, addIDs bool) *excelize.File {
	f := excelize.NewFile()
	{
		...
		SerializeExcelizePointerToGongstruct2[*DiscreteTorusShape](stage, f, addIDs)
		SerializeExcelizePointerToGongstruct2[*DiscreteTorusStackShape](stage, f, addIDs)
		...
		SerializeExcelizePointerToGongstruct2[*StackGrowthCurveEndArcShape](stage, f, addIDs)
		SerializeExcelizePointerToGongstruct2[*StackGrowthCurveStartArcShape](stage, f, addIDs)
		...
		SerializeExcelizePointerToGongstruct2[*TopStackGrowthCurveEndArcShape](stage, f, addIDs)
		SerializeExcelizePointerToGongstruct2[*TopStackGrowthCurveStartArcShape](stage, f, addIDs)
