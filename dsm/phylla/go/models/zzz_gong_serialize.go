...
func buildExcelizeFile(stage *Stage, addIDs bool) *excelize.File {
	f := excelize.NewFile()
	{
		...
		SerializeExcelizePointerToGongstruct2[*ClockDiagram](stage, f, addIDs)
		...
		SerializeExcelizePointerToGongstruct2[*StoolDiagram](stage, f, addIDs)
		...
		SerializeExcelizePointerToGongstruct2[*VaseDiagram](stage, f, addIDs)
