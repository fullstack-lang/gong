...
func buildExcelizeFile(stage *Stage, addIDs bool) *excelize.File {
	f := excelize.NewFile()
	{
		...
		SerializeExcelizePointerToGongstruct2[*StackOfPartiallyRotatedGrowthCurve2DRibbon](stage, f, addIDs)
		...
		SerializeExcelizePointerToGongstruct2[*StackPartiallyRotatedGrowthCurve2DRibbonEndShape](stage, f, addIDs)
		SerializeExcelizePointerToGongstruct2[*StackPartiallyRotatedGrowthCurve2DRibbonStartShape](stage, f, addIDs)
