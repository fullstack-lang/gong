...
func (stager *Stager) createViews() {
	...
	var isPlant2DChecked, isPlant3DChecked, isVase2DChecked, isTubeVase3DChecked, isStool2DChecked, isStool3DChecked, isClock2DChecked, isClock3DChecked, isMusicScoreChecked bool
	if plant != nil {
