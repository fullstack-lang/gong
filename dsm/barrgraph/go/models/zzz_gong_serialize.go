...
func (stage *Stage) __gong__buildExcelizeFile(addIDs bool) *excelize.File {
	f := excelize.NewFile()
	{
		// insertion point
		{
			...
			stage.SerializeExcelize(f, "ArtefactType", instances, (*ArtefactType)(nil).GongGetFieldHeaders(), addIDs)
		}
		{
			var instances []GongstructIF
			...
			stage.SerializeExcelize(f, "ArtefactTypeShape", instances, (*ArtefactTypeShape)(nil).GongGetFieldHeaders(), addIDs)
		}
		{
			var instances []GongstructIF
			...
			stage.SerializeExcelize(f, "Artist", instances, (*Artist)(nil).GongGetFieldHeaders(), addIDs)
		}
		{
			var instances []GongstructIF
			...
			stage.SerializeExcelize(f, "ArtistShape", instances, (*ArtistShape)(nil).GongGetFieldHeaders(), addIDs)
		}
		{
			var instances []GongstructIF
		...
		}
		{
			...
			stage.SerializeExcelize(f, "Desk", instances, (*Desk)(nil).GongGetFieldHeaders(), addIDs)
		}
		{
			var instances []GongstructIF
		...
		}
		{
			...
			stage.SerializeExcelize(f, "Influence", instances, (*Influence)(nil).GongGetFieldHeaders(), addIDs)
		}
		{
			var instances []GongstructIF
			...
			stage.SerializeExcelize(f, "InfluenceShape", instances, (*InfluenceShape)(nil).GongGetFieldHeaders(), addIDs)
		}
		{
			var instances []GongstructIF
		...
		}
		{
			...
			stage.SerializeExcelize(f, "Movement", instances, (*Movement)(nil).GongGetFieldHeaders(), addIDs)
		}
		{
			var instances []GongstructIF
			...
			stage.SerializeExcelize(f, "MovementShape", instances, (*MovementShape)(nil).GongGetFieldHeaders(), addIDs)
		}
		{
			var instances []GongstructIF
			...
			stage.SerializeExcelize(f, "Place", instances, (*Place)(nil).GongGetFieldHeaders(), addIDs)
		}
	}
