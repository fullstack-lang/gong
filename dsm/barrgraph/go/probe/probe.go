...
import (
	...
	embeddedgo "github.com/fullstack-lang/gong/dsm/barrgraph/go"
)
...
func NewProbe(
	...
	stageOfInterest.MetaPackageImportPath = "github.com/fullstack-lang/gong/dsm/barrgraph/go/models"
	...
	probe.docStager = prepare.Prepare(
		...
		"github.com/fullstack-lang/gong/dsm/barrgraph/go"+":"+stageOfInterest.GetName(),
...
func (probe *Probe) ExportStageExcel() {
	...
	if probe.fileName == "" {
		probe.fileName = "barrgraph-" + probe.stageOfInterest.GetName() + ".go"
	}
