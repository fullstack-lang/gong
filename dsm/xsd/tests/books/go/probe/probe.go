...
import (
	...
	embeddedgo "github.com/fullstack-lang/gong/dsm/xsd/tests/books/go"
)
...
func NewProbe(
	...
	stageOfInterest.MetaPackageImportPath = "github.com/fullstack-lang/gong/dsm/xsd/tests/books/go/models"
	...
	probe.docStager = prepare.Prepare(
		...
		"github.com/fullstack-lang/gong/dsm/xsd/tests/books/go"+":"+stageOfInterest.GetName(),
...
func (probe *Probe) ExportStageExcel() {
	...
	if probe.fileName == "" {
		probe.fileName = "books-" + probe.stageOfInterest.GetName() + ".go"
	}
