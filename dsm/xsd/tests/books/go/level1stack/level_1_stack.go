...
import (
	...
	"github.com/fullstack-lang/gong/dsm/xsd/tests/books/go/probe"
...
func (impl *BeforeCommitImplementation) BeforeCommit(stage *models.Stage) {
	...
	stage.MarshallFile(fmt.Sprintf("./%s", filename), "github.com/fullstack-lang/gong/dsm/xsd/tests/books/go/models", packageName)
}
