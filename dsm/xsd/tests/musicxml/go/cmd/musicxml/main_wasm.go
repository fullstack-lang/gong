...
import (
	...
	"github.com/fullstack-lang/gong/dsm/xsd/tests/musicxml/go/level1stack"
...
func main() {
	...
	log.Println("Initializing musicxml WASM Backend...")
	...
	stack := level1stack.NewLevel1StackDelta("musicxml", unmarshallFromCode, marshallOnCommit, true, embeddedDiagrams, true)
