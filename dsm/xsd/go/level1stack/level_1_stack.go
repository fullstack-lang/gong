...
import (
	...
	"github.com/fullstack-lang/gong/dsm/xsd/go/probe"

	xsd_go "github.com/fullstack-lang/gong/dsm/xsd/go"
...
func (impl *BeforeCommitImplementation) BeforeCommit(stage *models.Stage) {
	...
	stage.MarshallFile(fmt.Sprintf("./%s", filename), "github.com/fullstack-lang/gong/dsm/xsd/go/models", packageName)
}
