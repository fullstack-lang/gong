...
import (
	...
	"github.com/fullstack-lang/gong/dsm/scenario/go/level1stack"
...
func main() {
	...
	log.Println("Initializing scenario WASM Backend...")
	...
	stack := level1stack.NewLevel1StackDelta("scenario", unmarshallFromCode, marshallOnCommit, true, embeddedDiagrams, true)
