...
import (
	...
	embeddedgo "github.com/fullstack-lang/gong/dsm/reqif/go"
)
...
func NewProbe(
	...
	stageOfInterest.MetaPackageImportPath = "github.com/fullstack-lang/gong/dsm/reqif/go/models"
	...
	probe.docStager = prepare.Prepare(
		...
		"github.com/fullstack-lang/gong/dsm/reqif/go"+":"+stageOfInterest.GetName(),
