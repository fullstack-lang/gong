...
func (probe *Probe) ux_form() {
	...
	if formGroup != nil {
		...
		case *ATTRIBUTE_DEFINITION_BOOLEAN_RenderingFormCallback:
			if onSave.CreationMode {
				FillUpFormFromGongstructName(probe, "ATTRIBUTE_DEFINITION_BOOLEAN_Rendering", true)
			} else {
				FillUpFormFromGongstruct(onSave.attribute_definition_boolean_rendering, probe)
			}
		...
		case *ATTRIBUTE_DEFINITION_DATE_RenderingFormCallback:
			if onSave.CreationMode {
				FillUpFormFromGongstructName(probe, "ATTRIBUTE_DEFINITION_DATE_Rendering", true)
			} else {
				FillUpFormFromGongstruct(onSave.attribute_definition_date_rendering, probe)
			}
		...
		case *ATTRIBUTE_DEFINITION_ENUMERATION_RenderingFormCallback:
			if onSave.CreationMode {
				FillUpFormFromGongstructName(probe, "ATTRIBUTE_DEFINITION_ENUMERATION_Rendering", true)
			} else {
				FillUpFormFromGongstruct(onSave.attribute_definition_enumeration_rendering, probe)
			}
		...
		case *ATTRIBUTE_DEFINITION_INTEGER_RenderingFormCallback:
			if onSave.CreationMode {
				FillUpFormFromGongstructName(probe, "ATTRIBUTE_DEFINITION_INTEGER_Rendering", true)
			} else {
				FillUpFormFromGongstruct(onSave.attribute_definition_integer_rendering, probe)
			}
		...
		case *ATTRIBUTE_DEFINITION_REAL_RenderingFormCallback:
			if onSave.CreationMode {
				FillUpFormFromGongstructName(probe, "ATTRIBUTE_DEFINITION_REAL_Rendering", true)
			} else {
				FillUpFormFromGongstruct(onSave.attribute_definition_real_rendering, probe)
			}
		case *ATTRIBUTE_DEFINITION_RenderingFormCallback:
			if onSave.CreationMode {
				FillUpFormFromGongstructName(probe, "ATTRIBUTE_DEFINITION_Rendering", true)
			} else {
				FillUpFormFromGongstruct(onSave.attribute_definition_rendering, probe)
			}
		...
		case *ATTRIBUTE_DEFINITION_STRING_RenderingFormCallback:
			if onSave.CreationMode {
				FillUpFormFromGongstructName(probe, "ATTRIBUTE_DEFINITION_STRING_Rendering", true)
			} else {
				FillUpFormFromGongstruct(onSave.attribute_definition_string_rendering, probe)
			}
		...
		case *ATTRIBUTE_DEFINITION_XHTML_RenderingFormCallback:
			if onSave.CreationMode {
				FillUpFormFromGongstructName(probe, "ATTRIBUTE_DEFINITION_XHTML_Rendering", true)
			} else {
				FillUpFormFromGongstruct(onSave.attribute_definition_xhtml_rendering, probe)
			}
		...
		case *EmbeddedJpgImageFormCallback:
			if onSave.CreationMode {
				FillUpFormFromGongstructName(probe, "EmbeddedJpgImage", true)
			} else {
				FillUpFormFromGongstruct(onSave.embeddedjpgimage, probe)
			}
		case *EmbeddedPngImageFormCallback:
			if onSave.CreationMode {
				FillUpFormFromGongstructName(probe, "EmbeddedPngImage", true)
			} else {
				FillUpFormFromGongstruct(onSave.embeddedpngimage, probe)
			}
		case *EmbeddedSvgImageFormCallback:
			if onSave.CreationMode {
				FillUpFormFromGongstructName(probe, "EmbeddedSvgImage", true)
			} else {
				FillUpFormFromGongstruct(onSave.embeddedsvgimage, probe)
			}
		...
		case *Map_identifier_boolFormCallback:
			if onSave.CreationMode {
				FillUpFormFromGongstructName(probe, "Map_identifier_bool", true)
			} else {
				FillUpFormFromGongstruct(onSave.map_identifier_bool, probe)
			}
		...
		case *SPECIFICATION_RenderingFormCallback:
			if onSave.CreationMode {
				FillUpFormFromGongstructName(probe, "SPECIFICATION_Rendering", true)
			} else {
				FillUpFormFromGongstruct(onSave.specification_rendering, probe)
			}
		...
		case *SPEC_OBJECT_TYPE_RenderingFormCallback:
			if onSave.CreationMode {
				FillUpFormFromGongstructName(probe, "SPEC_OBJECT_TYPE_Rendering", true)
			} else {
				FillUpFormFromGongstruct(onSave.spec_object_type_rendering, probe)
			}
		...
		case *StaticWebSiteFormCallback:
			if onSave.CreationMode {
				FillUpFormFromGongstructName(probe, "StaticWebSite", true)
			} else {
				FillUpFormFromGongstruct(onSave.staticwebsite, probe)
			}
		case *StaticWebSiteChapterFormCallback:
			if onSave.CreationMode {
				FillUpFormFromGongstructName(probe, "StaticWebSiteChapter", true)
			} else {
				FillUpFormFromGongstruct(onSave.staticwebsitechapter, probe)
			}
		case *StaticWebSiteGeneratedImageFormCallback:
			if onSave.CreationMode {
				FillUpFormFromGongstructName(probe, "StaticWebSiteGeneratedImage", true)
			} else {
				FillUpFormFromGongstruct(onSave.staticwebsitegeneratedimage, probe)
			}
		case *StaticWebSiteImageFormCallback:
			if onSave.CreationMode {
				FillUpFormFromGongstructName(probe, "StaticWebSiteImage", true)
			} else {
				FillUpFormFromGongstruct(onSave.staticwebsiteimage, probe)
			}
		case *StaticWebSiteParagraphFormCallback:
			if onSave.CreationMode {
				FillUpFormFromGongstructName(probe, "StaticWebSiteParagraph", true)
			} else {
				FillUpFormFromGongstruct(onSave.staticwebsiteparagraph, probe)
			}
...
func FillUpFormFromGongstructName(
	...
	case "ATTRIBUTE_DEFINITION_BOOLEAN_Rendering":
		formGroup := (&form.FormGroup{
			Name:  FormName,
			Label: prefix + "ATTRIBUTE_DEFINITION_BOOLEAN_Rendering Form",
		}).Stage(formStage)
		...
		formGroup.HasSuppressButton = !isNewInstance
		FillUpForm(attribute_definition_boolean_rendering, formGroup, probe)
	...
	case "ATTRIBUTE_DEFINITION_DATE_Rendering":
		formGroup := (&form.FormGroup{
			Name:  FormName,
			Label: prefix + "ATTRIBUTE_DEFINITION_DATE_Rendering Form",
		}).Stage(formStage)
		...
		formGroup.HasSuppressButton = !isNewInstance
		FillUpForm(attribute_definition_date_rendering, formGroup, probe)
	...
	case "ATTRIBUTE_DEFINITION_ENUMERATION_Rendering":
		formGroup := (&form.FormGroup{
			Name:  FormName,
			Label: prefix + "ATTRIBUTE_DEFINITION_ENUMERATION_Rendering Form",
		}).Stage(formStage)
		...
		formGroup.HasSuppressButton = !isNewInstance
		FillUpForm(attribute_definition_enumeration_rendering, formGroup, probe)
	...
	case "ATTRIBUTE_DEFINITION_INTEGER_Rendering":
		formGroup := (&form.FormGroup{
			Name:  FormName,
			Label: prefix + "ATTRIBUTE_DEFINITION_INTEGER_Rendering Form",
		}).Stage(formStage)
		...
		formGroup.HasSuppressButton = !isNewInstance
		FillUpForm(attribute_definition_integer_rendering, formGroup, probe)
	...
	case "ATTRIBUTE_DEFINITION_REAL_Rendering":
		formGroup := (&form.FormGroup{
			Name:  FormName,
			Label: prefix + "ATTRIBUTE_DEFINITION_REAL_Rendering Form",
		}).Stage(formStage)
		...
		formGroup.HasSuppressButton = !isNewInstance
		FillUpForm(attribute_definition_real_rendering, formGroup, probe)
	...
	case "ATTRIBUTE_DEFINITION_STRING_Rendering":
		formGroup := (&form.FormGroup{
			Name:  FormName,
			Label: prefix + "ATTRIBUTE_DEFINITION_STRING_Rendering Form",
		}).Stage(formStage)
		...
		formGroup.HasSuppressButton = !isNewInstance
		FillUpForm(attribute_definition_string_rendering, formGroup, probe)
	...
	case "ATTRIBUTE_DEFINITION_XHTML_Rendering":
		formGroup := (&form.FormGroup{
			Name:  FormName,
			Label: prefix + "ATTRIBUTE_DEFINITION_XHTML_Rendering Form",
		}).Stage(formStage)
		...
		formGroup.HasSuppressButton = !isNewInstance
		FillUpForm(attribute_definition_xhtml_rendering, formGroup, probe)
	...
	case "Map_identifier_bool":
		formGroup := (&form.FormGroup{
			Name:  FormName,
			Label: prefix + "Map_identifier_bool Form",
		}).Stage(formStage)
		...
		formGroup.HasSuppressButton = !isNewInstance
		FillUpForm(map_identifier_bool, formGroup, probe)
	case "RELATION_GROUP":
		formGroup := (&form.FormGroup{
			Name:  FormName,
	...
	case "StaticWebSite":
		formGroup := (&form.FormGroup{
			Name:  FormName,
			Label: prefix + "StaticWebSite Form",
		}).Stage(formStage)
		...
		formGroup.HasSuppressButton = !isNewInstance
		FillUpForm(staticwebsite, formGroup, probe)
	case "StaticWebSiteChapter":
		formGroup := (&form.FormGroup{
			Name:  FormName,
			Label: prefix + "StaticWebSiteChapter Form",
		}).Stage(formStage)
