...
func (stage *Stage) __gong__buildExcelizeFile(addIDs bool) *excelize.File {
	f := excelize.NewFile()
	{
		...
		}
		{
			...
			stage.SerializeExcelize(f, "NoteProductShape", instances, (*NoteProductShape)(nil).GongGetFieldHeaders(), addIDs)
		}
		{
			var instances []GongstructIF
			...
			stage.SerializeExcelize(f, "NoteResourceShape", instances, (*NoteResourceShape)(nil).GongGetFieldHeaders(), addIDs)
		}
		{
			var instances []GongstructIF
		...
		}
		{
			...
			stage.SerializeExcelize(f, "Product", instances, (*Product)(nil).GongGetFieldHeaders(), addIDs)
		}
		{
			var instances []GongstructIF
			...
			stage.SerializeExcelize(f, "ProductCompositionShape", instances, (*ProductCompositionShape)(nil).GongGetFieldHeaders(), addIDs)
		}
		{
			var instances []GongstructIF
			...
			stage.SerializeExcelize(f, "ProductShape", instances, (*ProductShape)(nil).GongGetFieldHeaders(), addIDs)
		}
		{
			var instances []GongstructIF
		...
		}
		{
			...
			stage.SerializeExcelize(f, "ResourceCompositionShape", instances, (*ResourceCompositionShape)(nil).GongGetFieldHeaders(), addIDs)
		}
		{
			var instances []GongstructIF
			...
			stage.SerializeExcelize(f, "ResourceShape", instances, (*ResourceShape)(nil).GongGetFieldHeaders(), addIDs)
		}
		{
			var instances []GongstructIF
			...
			stage.SerializeExcelize(f, "ResourceTaskShape", instances, (*ResourceTaskShape)(nil).GongGetFieldHeaders(), addIDs)
		}
		{
			var instances []GongstructIF
			...
			stage.SerializeExcelize(f, "Task", instances, (*Task)(nil).GongGetFieldHeaders(), addIDs)
		}
		{
			var instances []GongstructIF
			...
			stage.SerializeExcelize(f, "TaskCompositionShape", instances, (*TaskCompositionShape)(nil).GongGetFieldHeaders(), addIDs)
		}
		{
			var instances []GongstructIF
			...
			stage.SerializeExcelize(f, "TaskGroup", instances, (*TaskGroup)(nil).GongGetFieldHeaders(), addIDs)
		}
		{
			var instances []GongstructIF
			...
			stage.SerializeExcelize(f, "TaskGroupShape", instances, (*TaskGroupShape)(nil).GongGetFieldHeaders(), addIDs)
		}
		{
			var instances []GongstructIF
			...
			stage.SerializeExcelize(f, "TaskInputShape", instances, (*TaskInputShape)(nil).GongGetFieldHeaders(), addIDs)
		}
		{
			var instances []GongstructIF
			...
			stage.SerializeExcelize(f, "TaskOutputShape", instances, (*TaskOutputShape)(nil).GongGetFieldHeaders(), addIDs)
		}
		{
			var instances []GongstructIF
			...
			stage.SerializeExcelize(f, "TaskPredecessorShape", instances, (*TaskPredecessorShape)(nil).GongGetFieldHeaders(), addIDs)
		}
		{
			var instances []GongstructIF
			...
			stage.SerializeExcelize(f, "TaskShape", instances, (*TaskShape)(nil).GongGetFieldHeaders(), addIDs)
		}
	}
