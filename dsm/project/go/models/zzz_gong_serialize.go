...
func buildExcelizeFile(stage *Stage, addIDs bool) *excelize.File {
	f := excelize.NewFile()
	{
		...
		stage.SerializeExcelizePointer2[*NoteProductShape](f, addIDs)
		stage.SerializeExcelizePointer2[*NoteResourceShape](f, addIDs)
		stage.SerializeExcelizePointer2[*NoteShape](f, addIDs)
		stage.SerializeExcelizePointer2[*NoteTaskShape](f, addIDs)
		stage.SerializeExcelizePointer2[*Product](f, addIDs)
		stage.SerializeExcelizePointer2[*ProductCompositionShape](f, addIDs)
		stage.SerializeExcelizePointer2[*ProductShape](f, addIDs)
		stage.SerializeExcelizePointer2[*Resource](f, addIDs)
		stage.SerializeExcelizePointer2[*ResourceCompositionShape](f, addIDs)
		stage.SerializeExcelizePointer2[*ResourceShape](f, addIDs)
		stage.SerializeExcelizePointer2[*ResourceTaskShape](f, addIDs)
		stage.SerializeExcelizePointer2[*Task](f, addIDs)
		stage.SerializeExcelizePointer2[*TaskCompositionShape](f, addIDs)
		stage.SerializeExcelizePointer2[*TaskGroup](f, addIDs)
		stage.SerializeExcelizePointer2[*TaskGroupShape](f, addIDs)
		stage.SerializeExcelizePointer2[*TaskInputShape](f, addIDs)
		stage.SerializeExcelizePointer2[*TaskOutputShape](f, addIDs)
		stage.SerializeExcelizePointer2[*TaskPredecessorShape](f, addIDs)
		stage.SerializeExcelizePointer2[*TaskShape](f, addIDs)
	}
