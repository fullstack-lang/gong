...
func buildExcelizeFile(stage *Stage, addIDs bool) *excelize.File {
	...
	{
		// insertion point
		SerializeExcelizePointerToGongstruct2[*DiagramHierarchy](stage, f, addIDs)
		SerializeExcelizePointerToGongstruct2[*Library](stage, f, addIDs)
		SerializeExcelizePointerToGongstruct2[*Milestone](stage, f, addIDs)
		SerializeExcelizePointerToGongstruct2[*MilestoneShape](stage, f, addIDs)
		SerializeExcelizePointerToGongstruct2[*Note](stage, f, addIDs)
		SerializeExcelizePointerToGongstruct2[*NoteProductShape](stage, f, addIDs)
		SerializeExcelizePointerToGongstruct2[*NoteResourceShape](stage, f, addIDs)
		SerializeExcelizePointerToGongstruct2[*NoteShape](stage, f, addIDs)
		SerializeExcelizePointerToGongstruct2[*NoteTaskShape](stage, f, addIDs)
		...
		SerializeExcelizePointerToGongstruct2[*TaskGroup](stage, f, addIDs)
		SerializeExcelizePointerToGongstruct2[*TaskGroupShape](stage, f, addIDs)
		SerializeExcelizePointerToGongstruct2[*TaskInputShape](stage, f, addIDs)
		SerializeExcelizePointerToGongstruct2[*TaskOutputShape](stage, f, addIDs)
