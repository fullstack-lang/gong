...
// go module version: v0.0.0-20260921202054-74dd8294f330+dirty
/* to edit this file with the default probe, use the command
go run github.com/fullstack-lang/gong/dsm/project/go/models/probe/cmd/probe@v0.0.0-20260921202054-74dd8294f330 stage.go
*/
package main
...
func _(stage *models.Stage) {
	...
	__ProductShape__00000010_.X = 350.000000
