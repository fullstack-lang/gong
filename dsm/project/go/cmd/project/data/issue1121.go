...
// go module version: v0.0.0-20260917222725-9deeed0fdd10+dirty
/* to edit this file with the default probe, use the command
go run github.com/fullstack-lang/gong/dsm/project/go/models/probe/cmd/probe@v0.0.0-20260917222725-9deeed0fdd10 stage.go
*/
package main
