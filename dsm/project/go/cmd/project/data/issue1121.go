...
// go module version: v0.0.0-20260904023809-4a2c55a73d38+dirty
/* to edit this file with the default probe, use the command
go run github.com/fullstack-lang/gong/dsm/project/go/probe/cmd/probe@v0.0.0-20260904023809-4a2c55a73d38 stage.go
*/
package main
