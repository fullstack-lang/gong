...
// go module version: v0.0.0-20260917231654-74b83c6c6cd2+dirty
/* to edit this file with the default probe, use the command
go run github.com/fullstack-lang/gong/dsm/project/go/models/probe/cmd/probe@v0.0.0-20260917231654-74b83c6c6cd2 stage.go
*/
package main
