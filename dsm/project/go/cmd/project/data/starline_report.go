...
Organizational Factor 2: Mischaracterization of Risk in thruster Qual Gaps leads to Flawed Flight Rationale. The thermal risk for Starliner’s SM RCS thrusters was mischaracterized due to reliance on simple models and inadequate qualification testing that failed to replicate mission-representative conditions. Despite clear evidence of thermal soakback and temperature exceedances, risk acceptance proceeded without resolving key environment and duty cycle concerns.`}).Stage(stage)
	...
	__NoteProductShape__00000000_ := (&models.NoteProductShape{Name: `PIT focus-A thorough review of the STAR report is advised (p14)
- Starliner Tests and Anomalies Review (STAR) Investigation Report`}).Stage(stage)
	__NoteProductShape__00000001_ := (&models.NoteProductShape{Name: `PBS-NASA utilized a firm fixed price contracting type for CCtCap. 

This was a significant shift from the cost-plus contracting for traditional NASA builds of developmental vehicles. These shifts signified that CCP was not only positioned to be an innovative, first-of-its kind program for NASA, but how it interacted with new and traditional space flight industry providers was setup to be significantly distinct and different.  -Commercial Crew Transportation Capability (CCtCap).`}).Stage(stage)
	__NoteProductShape__00000002_ := (&models.NoteProductShape{Name: `PIT Report-The CCP 1100 series of requirements were deliberately written at a higher-level, leaving room for provider innovation but there was also room for incorrect/inadequate interpretation by the providers. -CCP Requirements`}).Stage(stage)
	__NoteProductShape__00000003_ := (&models.NoteProductShape{Name: `PIT Report-The Commercial Provider focused on meeting contractual requirement language resulting in insufficient demonstration across the components/system and ground/flight. -CCP Requirements`}).Stage(stage)
	__NoteProductShape__00000004_ := (&models.NoteProductShape{Name: `RCS PBS-Suppliers’ build quality/variability issues can be hard to exonerate for service modules, which is hardware that is disposed of during re-entry. -12 CM RCS Thrusters (1200 lbf)`}).Stage(stage)
	__NoteProductShape__00000005_ := (&models.NoteProductShape{Name: `RCS PBS-Suppliers’ build quality/variability issues can be hard to exonerate for service modules, which is hardware that is disposed of during re-entry. -28 SM RCS Thrusters (2800 lbf)`}).Stage(stage)
	__NoteProductShape__00000006_ := (&models.NoteProductShape{Name: `RCS PBS-The Aerojet Rocketdyne (AR) thermal model included the effects of jet firings, but these effects were not validated by ground testing.

Boeing thermal model did not include the effects of jet firings before CFT. -28 SM RCS Thrusters (2800 lbf)`}).Stage(stage)
	__NoteProductShape__00000007_ := (&models.NoteProductShape{Name: `RCS PBS-The thruster performance from OFT1 & OFT2 experienced greater than expected temperatures and continuing to operate lead to a false sense of security of the thruster capability/performance. -28 SM RCS Thrusters (2800 lbf)`}).Stage(stage)
	__NoteProductShape__00000008_ := (&models.NoteProductShape{Name: `RCS PBS-Flight instrumentation locations for thermal sensors were limited and in different locations than the locations for RCS Thruster ground firings. -Thermal Sensors`}).Stage(stage)
	__NoteProductShape__00000009_ := (&models.NoteProductShape{Name: `RCS PBS-Flight instrumentation locations for thermal sensors were limited and in different locations than the locations for RCS Thruster ground firings. -28 SM RCS Thrusters (2800 lbf)`}).Stage(stage)
	__NoteProductShape__00000010_ := (&models.NoteProductShape{Name: `RCS PBS-Flight instrumentation locations for thermal sensors were limited and in different locations than the locations for RCS Thruster ground firings. -12 CM RCS Thrusters (1200 lbf)`}).Stage(stage)
	__NoteProductShape__00000011_ := (&models.NoteProductShape{Name: `RCS PBS-OFT1 & OFT2 investigations did not include RCS/OMAC thruster firings and fault trees were not validated through subsequent ground testing. -28 SM RCS Thrusters (2800 lbf)`}).Stage(stage)
	__NoteProductShape__00000012_ := (&models.NoteProductShape{Name: `RCS PBS-For OFT2, NASA/Boeing did not have tools to measure thruster degradation, simply treated the thruster as failed/operational. -28 SM RCS Thrusters (2800 lbf)`}).Stage(stage)
	__NoteProductShape__00000013_ := (&models.NoteProductShape{Name: `RCS PBS-Pc (Chamber Pressure).To know if a thruster is actually firing, the spacecraft's computer looks at the pressure sensor inside the combustion chamber (the Pc telemetry). If the pressure shoots up to the expected level, it means combustion is happening and the thruster is pushing. If the pressure stays low or at zero, it assumes the thruster failed.-12 CM RCS Thrusters (1200 lbf)`}).Stage(stage)
	__NoteProductShape__00000014_ := (&models.NoteProductShape{Name: `RCS PBS-Pc (Chamber Pressure).To know if a thruster is actually firing, the spacecraft's computer looks at the pressure sensor inside the combustion chamber (the Pc telemetry). If the pressure shoots up to the expected level, it means combustion is happening and the thruster is pushing. If the pressure stays low or at zero, it assumes the thruster failed.-Transducer / pressure sensor (Pc)`}).Stage(stage)
	__NoteProductShape__00000015_ := (&models.NoteProductShape{Name: `RCS PBS-Pc transducer failed but the engine was able to restart. Boing confidence in the harxware robustness-Transducer / pressure sensor (Pc)`}).Stage(stage)
	__NoteProductShape__00000016_ := (&models.NoteProductShape{Name: `PIT Report-The leading theory for the proximate cause of the CM RCS failure during the CFT is the formulation of carbazic acid, which corrodes stainless steel. The reaction between carbazic acid and stainless steel creates corrosion particulates in the thruster propellant valve, preventing it from opening. -4.4   Analysis: CM RCS Jet Failure`}).Stage(stage)
	__NoteProductShape__00000017_ := (&models.NoteProductShape{Name: `PIT Report-Thruster health is monitored via chamber pressure and Fuel/Oxydizer injector temperatures-4.4   Analysis: CM RCS Jet Failure`}).Stage(stage)
	__NoteProductShape__00000018_ := (&models.NoteProductShape{Name: `PIT Report-Commanded pulse lengths are neither recorded nor downlinked near real time with telemetry

This complicates efforts to understand what went wrong with SM RCS jets when data suggests that pulse length is correlated to observed soakback temperatures.  -4.5.1 Description of the system`}).Stage(stage)
	__NoteProductShape__00000019_ := (&models.NoteProductShape{Name: `PIT Report-At the conclusion of the hotfire, when thruster is demonstrated, a jet is reenabled with jet-fail FDIR inhibited. Through this sequence, four of five jets were recovered. Spacecraft 6DOF control was reestablished in all axes. T

he spacecraft was moded back to auto and the rendezvous/dock was completed.  While the flight rules allow an SM RCS thruster to be used with jet-fail off FDIR inhibited, doing so removes a hazard control.

Whaou.-4.5.2   Description of Events and Timeline `}).Stage(stage)
	__NoteProductShape__00000020_ := (&models.NoteProductShape{Name: `PIT Report-Many thruster pulses are less  FDIR in the  The FMCs see chamber pressure over a data bus from the  but the chamber pressure is only sent to the ground with a sample rate for recording every  limiting insight into thruster performance. This does not meet Nyquist Criterion for capturing the chamber pressure signal. As a result, aliasing effects may occur for pulses shorter than  where high-frequency components of the pressure signal are misrepresented or lost, further complicating accurate reconstruction of thruster behavior.  -4.5.2   Description of Events and Timeline `}).Stage(stage)
	__NoteProductShape__00000021_ := (&models.NoteProductShape{Name: `PIT Report- degraded performance was still observed. This testing demonstrated the issue was not purely transient.

It should have been done before ?!

 In addition to demonstrating transient degradation during high heating, the test program demonstrated an unrecoverable cumulative degradation that was potentially indicative of the observed performance of CFT. -4.5.4   Starliner Engine Testing at White Sands Test Facility (WSTF) during CFT`}).Stage(stage)
	__NoteProductShape__00000022_ := (&models.NoteProductShape{Name: `PIT Report-B1.3.3.1.1.1 Heat identifies that excessive heating could cause the poppet to extrude, reducing flow. Poppet extrusion was observed in the post-test tear down of the WSTF (White Sands Test Facility) thruster unit.

The initial heating was caused by the internal doghouse temperatures (addressed in C4.1 Thermal) and the follow-on heating induced by B1.3.3.1.4.2 RCS Thermal Soakback. This caused excessive temperatures beyond the capability of the thruster softgoods, causing the Teflon poppet to extrude. The evidence supports this being a contributor to the thruster fail-offs.-4.5.5 Fault Tree`}).Stage(stage)
	__NoteProductShape__00000023_ := (&models.NoteProductShape{Name: `PIT Report-B1.3.3.1.4.2 RCS Thermal Soakback identifies the possibility that structure of the RCS thruster
retains heat, and the heat is unable to be dissipated from the firings of the thrusters, causing the
propellants to heat rapidly. -4.5.5 Fault Tree`}).Stage(stage)
	__NoteProductShape__00000024_ := (&models.NoteProductShape{Name: `PIT Report-Intermediate Cause 5: Inadequate Thruster Thermal Models
...
There was no thermal model available to adequately understand the full impacts of the thermal
environment upon the RCS thrusters, specifically the aft thrusters with the longest feed line tube,
and very close proximity to the OMAC thrusters-Intermediate Cause 5: Inadequate Thruster Thermal Models Inadequate thermal modelling caused insufficient scrutiny for the thermal environment, leading to excessive heating from RCS thermal soakback and integrated heating from OMACs.`}).Stage(stage)
	__NoteProductShape__00000025_ := (&models.NoteProductShape{Name: `PIT Report-Intermediate Cause 6: Insufficient Thruster Qualification

SM RCS Thruster Qualification did not cover the flight envelope for temperature and duty cycle (TLYF).-Intermediate Cause 5: Inadequate Thruster Thermal Models Inadequate thermal modelling caused insufficient scrutiny for the thermal environment, leading to excessive heating from RCS thermal soakback and integrated heating from OMACs.`}).Stage(stage)
	__NoteProductShape__00000026_ := (&models.NoteProductShape{Name: `PIT Report-Multiple groups, prior to CTF, discussed the lack of mission representative operational duty cycle testing for SM RCS engines.. This concern is one that has been tracked since prior to OFT1 and is specifically reviewed in this intermediate cause because it is widely accepted that operational duty cycle is a primary driver of hardware temperature. NASA Engineering and the CCP Spacecraft Office have consistently identified this qualification gap and recommended additional testing, however it was not incorporated into the pursued plans for risk assessments between flights.
...
The OFT-2 IFA related to valve/injector assembly temperature measurements exceeding qualification limits, which were categorized as an Unexplained Anomaly (UA). The directive acknowledged that these exceedances were attributed to specific operational duty cycles. Consequently, the thermal risk was accepted as a 2x5 risk for potential jet failure. Despite this, engineering teams and the Engineering Review Board (ERB-23-0045-R2) emphasized the importance of testing SM RCS thrusters using flight-like duty cycles.-Intermediate Cause 5: Inadequate Thruster Thermal Models Inadequate thermal modelling caused insufficient scrutiny for the thermal environment, leading to excessive heating from RCS thermal soakback and integrated heating from OMACs.`}).Stage(stage)

	__NoteShape__00000001_ := (&models.NoteShape{Name: `PIT focus-A thorough review of the STAR report is advised (p14)
`}).Stage(stage)
	__NoteShape__00000002_ := (&models.NoteShape{Name: `PBS-NASA utilized a firm fixed price contracting type for CCtCap. 

This was a significant shift from the cost-plus contracting for traditional NASA builds of developmental vehicles. These shifts signified that CCP was not only positioned to be an innovative, first-of-its kind program for NASA, but how it interacted with new and traditional space flight industry providers was setup to be significantly distinct and different.  `}).Stage(stage)
	__NoteShape__00000003_ := (&models.NoteShape{Name: `PIT Report-The CCP 1100 series of requirements were deliberately written at a higher-level, leaving room for provider innovation but there was also room for incorrect/inadequate interpretation by the providers. `}).Stage(stage)
	__NoteShape__00000004_ := (&models.NoteShape{Name: `PIT Report-The Commercial Provider focused on meeting contractual requirement language resulting in insufficient demonstration across the components/system and ground/flight. `}).Stage(stage)
	__NoteShape__00000005_ := (&models.NoteShape{Name: `RCS PBS-Suppliers’ build quality/variability issues can be hard to exonerate for service modules, which is hardware that is disposed of during re-entry. `}).Stage(stage)
	__NoteShape__00000006_ := (&models.NoteShape{Name: `RCS PBS-The Aerojet Rocketdyne (AR) thermal model included the effects of jet firings, but these effects were not validated by ground testing.

Boeing thermal model did not include the effects of jet firings before CFT. `}).Stage(stage)
	__NoteShape__00000007_ := (&models.NoteShape{Name: `RCS PBS-The thruster performance from OFT1 & OFT2 experienced greater than expected temperatures and continuing to operate lead to a false sense of security of the thruster capability/performance. `}).Stage(stage)
	__NoteShape__00000008_ := (&models.NoteShape{Name: `RCS PBS-Flight instrumentation locations for thermal sensors were limited and in different locations than the locations for RCS Thruster ground firings. `}).Stage(stage)
	__NoteShape__00000009_ := (&models.NoteShape{Name: `RCS PBS-OFT1 & OFT2 investigations did not include RCS/OMAC thruster firings and fault trees were not validated through subsequent ground testing. `}).Stage(stage)
	__NoteShape__00000010_ := (&models.NoteShape{Name: `RCS PBS-For OFT2, NASA/Boeing did not have tools to measure thruster degradation, simply treated the thruster as failed/operational. `}).Stage(stage)
	__NoteShape__00000011_ := (&models.NoteShape{Name: `RCS PBS-Pc (Chamber Pressure).To know if a thruster is actually firing, the spacecraft's computer looks at the pressure sensor inside the combustion chamber (the Pc telemetry). If the pressure shoots up to the expected level, it means combustion is happening and the thruster is pushing. If the pressure stays low or at zero, it assumes the thruster failed.`}).Stage(stage)
	__NoteShape__00000012_ := (&models.NoteShape{Name: `RCS PBS-Pc transducer failed but the engine was able to restart. Boing confidence in the harxware robustness`}).Stage(stage)
	__NoteShape__00000013_ := (&models.NoteShape{Name: `PIT Report-The leading theory for the proximate cause of the CM RCS failure during the CFT is the formulation of carbazic acid, which corrodes stainless steel. The reaction between carbazic acid and stainless steel creates corrosion particulates in the thruster propellant valve, preventing it from opening. `}).Stage(stage)
	__NoteShape__00000014_ := (&models.NoteShape{Name: `PIT Report-Thruster health is monitored via chamber pressure and Fuel/Oxydizer injector temperatures`}).Stage(stage)
	__NoteShape__00000015_ := (&models.NoteShape{Name: `PIT Report-Commanded pulse lengths are neither recorded nor downlinked near real time with telemetry

This complicates efforts to understand what went wrong with SM RCS jets when data suggests that pulse length is correlated to observed soakback temperatures.  `}).Stage(stage)
	__NoteShape__00000016_ := (&models.NoteShape{Name: `PIT Report-Many thruster pulses are less  FDIR in the  The FMCs see chamber pressure over a data bus from the  but the chamber pressure is only sent to the ground with a sample rate for recording every  limiting insight into thruster performance. This does not meet Nyquist Criterion for capturing the chamber pressure signal. As a result, aliasing effects may occur for pulses shorter than  where high-frequency components of the pressure signal are misrepresented or lost, further complicating accurate reconstruction of thruster behavior.  `}).Stage(stage)
	__NoteShape__00000017_ := (&models.NoteShape{Name: `WBS- S2A2 failed at 9050 m (GMT 14:00) and B1A3 failed at 526m (GMT 14:57).`}).Stage(stage)
	__NoteShape__00000018_ := (&models.NoteShape{Name: `PIT Report-At the conclusion of the hotfire, when thruster is demonstrated, a jet is reenabled with jet-fail FDIR inhibited. Through this sequence, four of five jets were recovered. Spacecraft 6DOF control was reestablished in all axes. T

he spacecraft was moded back to auto and the rendezvous/dock was completed.  While the flight rules allow an SM RCS thruster to be used with jet-fail off FDIR inhibited, doing so removes a hazard control.

Whaou.`}).Stage(stage)
	__NoteShape__00000019_ := (&models.NoteShape{Name: `PIT Report- degraded performance was still observed. This testing demonstrated the issue was not purely transient.

It should have been done before ?!

 In addition to demonstrating transient degradation during high heating, the test program demonstrated an unrecoverable cumulative degradation that was potentially indicative of the observed performance of CFT. `}).Stage(stage)
	__NoteShape__00000020_ := (&models.NoteShape{Name: `PIT Report-B1.3.3.1.1.1 Heat identifies that excessive heating could cause the poppet to extrude, reducing flow. Poppet extrusion was observed in the post-test tear down of the WSTF (White Sands Test Facility) thruster unit.

The initial heating was caused by the internal doghouse temperatures (addressed in C4.1 Thermal) and the follow-on heating induced by B1.3.3.1.4.2 RCS Thermal Soakback. This caused excessive temperatures beyond the capability of the thruster softgoods, causing the Teflon poppet to extrude. The evidence supports this being a contributor to the thruster fail-offs.`}).Stage(stage)
	__NoteShape__00000021_ := (&models.NoteShape{Name: `PIT Report-B1.3.3.1.4.2 RCS Thermal Soakback identifies the possibility that structure of the RCS thruster
retains heat, and the heat is unable to be dissipated from the firings of the thrusters, causing the
propellants to heat rapidly. `}).Stage(stage)
	__NoteShape__00000022_ := (&models.NoteShape{Name: `PIT Report-Intermediate Cause 5: Inadequate Thruster Thermal Models
...
environment upon the RCS thrusters, specifically the aft thrusters with the longest feed line tube,
and very close proximity to the OMAC thrusters`}).Stage(stage)
	__NoteShape__00000023_ := (&models.NoteShape{Name: `PIT Report-Intermediate Cause 6: Insufficient Thruster Qualification

SM RCS Thruster Qualification did not cover the flight envelope for temperature and duty cycle (TLYF).`}).Stage(stage)
	__NoteShape__00000024_ := (&models.NoteShape{Name: `PIT Report-Multiple groups, prior to CTF, discussed the lack of mission representative operational duty cycle testing for SM RCS engines.. This concern is one that has been tracked since prior to OFT1 and is specifically reviewed in this intermediate cause because it is widely accepted that operational duty cycle is a primary driver of hardware temperature. NASA Engineering and the CCP Spacecraft Office have consistently identified this qualification gap and recommended additional testing, however it was not incorporated into the pursued plans for risk assessments between flights.
...
The OFT-2 IFA related to valve/injector assembly temperature measurements exceeding qualification limits, which were categorized as an Unexplained Anomaly (UA). The directive acknowledged that these exceedances were attributed to specific operational duty cycles. Consequently, the thermal risk was accepted as a 2x5 risk for potential jet failure. Despite this, engineering teams and the Engineering Review Board (ERB-23-0045-R2) emphasized the importance of testing SM RCS thrusters using flight-like duty cycles.`}).Stage(stage)
	__NoteShape__00000025_ := (&models.NoteShape{Name: `PIT Report-Organizational Factor 1: Insufficient Anomaly Resolution Process Multiple RCS thruster failures occurred on OFT 1 and OFT 2. While fault trees were developed, due diligence to reach direct and root cause was not performed and adequate block closure rationale was often incomplete.

Note : Anomaly Reports (AR) were closed.

Organizational Factor 2: Mischaracterization of Risk in thruster Qual Gaps leads to Flawed Flight Rationale. The thermal risk for Starliner’s SM RCS thrusters was mischaracterized due to reliance on simple models and inadequate qualification testing that failed to replicate mission-representative conditions. Despite clear evidence of thermal soakback and temperature exceedances, risk acceptance proceeded without resolving key environment and duty cycle concerns.`}).Stage(stage)

	__NoteTaskShape__00000001_ := (&models.NoteTaskShape{Name: `WBS- S2A2 failed at 9050 m (GMT 14:00) and B1A3 failed at 526m (GMT 14:57).-ISS Approach`}).Stage(stage)
	...
	__ProductCompositionShape__00000000_ := (&models.ProductCompositionShape{Name: `PBS-Reports- Starliner Tests and Anomalies Review (STAR) Investigation Report`}).Stage(stage)
	__ProductCompositionShape__00000002_ := (&models.ProductCompositionShape{Name: `PBS-Commercial Crew Transportation Capability (CCtCap).-CST-100 Starliner`}).Stage(stage)
	__ProductCompositionShape__00000003_ := (&models.ProductCompositionShape{Name: `PBS-Commercial Crew Transportation Capability (CCtCap).-Dragon`}).Stage(stage)
	__ProductCompositionShape__00000004_ := (&models.ProductCompositionShape{Name: `PBS-NASA Assets/Capabities-Commercial Crew Transportation Capability (CCtCap).`}).Stage(stage)
	__ProductCompositionShape__00000005_ := (&models.ProductCompositionShape{Name: `PBS-NASA Assets/Capabities-ISS`}).Stage(stage)
	__ProductCompositionShape__00000006_ := (&models.ProductCompositionShape{Name: `PIT Report-Program Investigation Team (PIT) Reports-3 Commercial Crew Program (CCP) Background`}).Stage(stage)
	__ProductCompositionShape__00000007_ := (&models.ProductCompositionShape{Name: `RCS PBS-Crew Module (CM)-CM Reaction Control System (RCS)`}).Stage(stage)
	__ProductCompositionShape__00000008_ := (&models.ProductCompositionShape{Name: `RCS PBS-CM Reaction Control System (RCS)-12 CM RCS Thrusters (1200 lbf)`}).Stage(stage)
	__ProductCompositionShape__00000009_ := (&models.ProductCompositionShape{Name: `RCS PBS-CST-100 Starliner-Crew Module (CM)`}).Stage(stage)
	__ProductCompositionShape__00000010_ := (&models.ProductCompositionShape{Name: `RCS PBS-CST-100 Starliner-Service Module (SM)`}).Stage(stage)
	__ProductCompositionShape__00000011_ := (&models.ProductCompositionShape{Name: `RCS PBS-Service Module (SM)-SM Reaction Control System (SM RCS)`}).Stage(stage)
	__ProductCompositionShape__00000012_ := (&models.ProductCompositionShape{Name: `RCS PBS-SM Reaction Control System (SM RCS)-28 SM RCS Thrusters (2800 lbf)`}).Stage(stage)
	__ProductCompositionShape__00000013_ := (&models.ProductCompositionShape{Name: `PIT Report-Program Investigation Team (PIT) Reports-2 Additional Investigations `}).Stage(stage)
	__ProductCompositionShape__00000014_ := (&models.ProductCompositionShape{Name: `PIT Report-2 Additional Investigations -STAR Report Summary and Findings `}).Stage(stage)
	__ProductCompositionShape__00000016_ := (&models.ProductCompositionShape{Name: `RCS PBS-12 CM RCS Thrusters (1200 lbf)-Dog House`}).Stage(stage)
	__ProductCompositionShape__00000018_ := (&models.ProductCompositionShape{Name: `PBS-Reports-Boeing’s Enterprise Root Cause/Corrective Actions (eRCCA)`}).Stage(stage)
	__ProductCompositionShape__00000019_ := (&models.ProductCompositionShape{Name: `PIT Report-3 Commercial Crew Program (CCP) Background-3.1   Orbital Flight Test (OFT) Summary`}).Stage(stage)
	__ProductCompositionShape__00000020_ := (&models.ProductCompositionShape{Name: `PIT Report-3 Commercial Crew Program (CCP) Background-3.2   Orbital Flight Test 2 (OFT-2) Summary`}).Stage(stage)
	__ProductCompositionShape__00000021_ := (&models.ProductCompositionShape{Name: `RCS PBS-CST-100 Starliner-Flight Software (FSW)`}).Stage(stage)
	__ProductCompositionShape__00000022_ := (&models.ProductCompositionShape{Name: `RCS PBS-CST-100 Starliner-Fault Detection, Isolation, and Recovery (FDIR)`}).Stage(stage)
	__ProductCompositionShape__00000023_ := (&models.ProductCompositionShape{Name: `PIT Report-3 Commercial Crew Program (CCP) Background-3.3 Comparing SM RCS Thrusters Triggering Fail-Off FDIR on OFT1/OFT2`}).Stage(stage)
	__ProductCompositionShape__00000024_ := (&models.ProductCompositionShape{Name: `RCS PBS-12 CM RCS Thrusters (1200 lbf)-Transducer / pressure sensor (Pc)`}).Stage(stage)
	__ProductCompositionShape__00000025_ := (&models.ProductCompositionShape{Name: `PIT Report-Program Investigation Team (PIT) Reports-4     Technical Root Cause Analysis (RCA) and Findings`}).Stage(stage)
	__ProductCompositionShape__00000026_ := (&models.ProductCompositionShape{Name: `PIT Report-4     Technical Root Cause Analysis (RCA) and Findings-4.1   Objectives and Approach `}).Stage(stage)
	__ProductCompositionShape__00000027_ := (&models.ProductCompositionShape{Name: `PIT Report-4     Technical Root Cause Analysis (RCA) and Findings-4.2 Definitions`}).Stage(stage)
	__ProductCompositionShape__00000028_ := (&models.ProductCompositionShape{Name: `PIT Report-4     Technical Root Cause Analysis (RCA) and Findings-4.3 Fault Tree`}).Stage(stage)
	__ProductCompositionShape__00000029_ := (&models.ProductCompositionShape{Name: `RCS PBS-CST-100 Starliner-Guidance, Navigation, and Control (GNC)`}).Stage(stage)
	__ProductCompositionShape__00000030_ := (&models.ProductCompositionShape{Name: `PIT Report-4     Technical Root Cause Analysis (RCA) and Findings-4.4   Analysis: CM RCS Jet Failure`}).Stage(stage)
	__ProductCompositionShape__00000031_ := (&models.ProductCompositionShape{Name: `PIT Report-4     Technical Root Cause Analysis (RCA) and Findings-4.5   Analysis: Loss of 6DOF Control - SM RCS Jet Failures`}).Stage(stage)
	__ProductCompositionShape__00000032_ := (&models.ProductCompositionShape{Name: `PIT Report-4.5   Analysis: Loss of 6DOF Control - SM RCS Jet Failures-4.5.1 Description of the system`}).Stage(stage)
	__ProductCompositionShape__00000033_ := (&models.ProductCompositionShape{Name: `PIT Report-4     Technical Root Cause Analysis (RCA) and Findings-`}).Stage(stage)
	__ProductCompositionShape__00000034_ := (&models.ProductCompositionShape{Name: `RCS PBS-Guidance, Navigation, and Control (GNC)-Inertial Measurement Unit (IMU) `}).Stage(stage)
	__ProductCompositionShape__00000035_ := (&models.ProductCompositionShape{Name: `RCS PBS-CST-100 Starliner-Orbital Maneuvering and Attitude Control (OMAC), 30 000 lbf`}).Stage(stage)
	__ProductCompositionShape__00000036_ := (&models.ProductCompositionShape{Name: `PIT Report-4.5   Analysis: Loss of 6DOF Control - SM RCS Jet Failures-4.5.2   Description of Events and Timeline `}).Stage(stage)
	__ProductCompositionShape__00000037_ := (&models.ProductCompositionShape{Name: `PIT Report-4.5   Analysis: Loss of 6DOF Control - SM RCS Jet Failures-B1A3 Thruster failure`}).Stage(stage)
	__ProductCompositionShape__00000038_ := (&models.ProductCompositionShape{Name: `PIT Report-4.5   Analysis: Loss of 6DOF Control - SM RCS Jet Failures-4.5.4   Starliner Engine Testing at White Sands Test Facility (WSTF) during CFT`}).Stage(stage)
	__ProductCompositionShape__00000039_ := (&models.ProductCompositionShape{Name: `PIT Report-4.5   Analysis: Loss of 6DOF Control - SM RCS Jet Failures-4.5.5 Fault Tree`}).Stage(stage)
	__ProductCompositionShape__00000040_ := (&models.ProductCompositionShape{Name: `PIT Report-4.5   Analysis: Loss of 6DOF Control - SM RCS Jet Failures-4.5.6 Most Probable Proximate Cause`}).Stage(stage)
	__ProductCompositionShape__00000041_ := (&models.ProductCompositionShape{Name: `PIT Report-4.5.6 Most Probable Proximate Cause-Intermediate Cause 5: Inadequate Thruster Thermal Models Inadequate thermal modelling caused insufficient scrutiny for the thermal environment, leading to excessive heating from RCS thermal soakback and integrated heating from OMACs.`}).Stage(stage)
	__ProductCompositionShape__00000042_ := (&models.ProductCompositionShape{Name: `PIT Report-4.5   Analysis: Loss of 6DOF Control - SM RCS Jet Failures-4.6 Analysis: Helium Leak`}).Stage(stage)
	__ProductCompositionShape__00000043_ := (&models.ProductCompositionShape{Name: `PIT Report-4.6 Analysis: Helium Leak-4.6.1 Description of the system`}).Stage(stage)
	__ProductCompositionShape__00000044_ := (&models.ProductCompositionShape{Name: `PBS-Reports-Program Investigation Team (PIT) Reports`}).Stage(stage)

	__ProductShape__00000002_ := (&models.ProductShape{Name: `PBS-Dragon`}).Stage(stage)
	__ProductShape__00000003_ := (&models.ProductShape{Name: `PBS-CST-100 Starliner`}).Stage(stage)
	__ProductShape__00000004_ := (&models.ProductShape{Name: `PBS-Reports`}).Stage(stage)
	__ProductShape__00000005_ := (&models.ProductShape{Name: `PBS- Starliner Tests and Anomalies Review (STAR) Investigation Report`}).Stage(stage)
	__ProductShape__00000006_ := (&models.ProductShape{Name: `PBS-Program Investigation Team (PIT) Reports`}).Stage(stage)
	__ProductShape__00000007_ := (&models.ProductShape{Name: `PIT focus-Program Investigation Team (PIT) Reports`}).Stage(stage)
	__ProductShape__00000008_ := (&models.ProductShape{Name: `PIT focus- Starliner Tests and Anomalies Review (STAR) Investigation Report`}).Stage(stage)
	__ProductShape__00000009_ := (&models.ProductShape{Name: `PBS-Commercial Crew Transportation Capability (CCtCap).`}).Stage(stage)
	__ProductShape__00000010_ := (&models.ProductShape{Name: `PBS-NASA Assets/Capabities`}).Stage(stage)
	__ProductShape__00000011_ := (&models.ProductShape{Name: `PBS-ISS`}).Stage(stage)
	__ProductShape__00000012_ := (&models.ProductShape{Name: `PIT Report-Program Investigation Team (PIT) Reports`}).Stage(stage)
	__ProductShape__00000013_ := (&models.ProductShape{Name: `PIT Report-3 Commercial Crew Program (CCP) Background`}).Stage(stage)
	__ProductShape__00000014_ := (&models.ProductShape{Name: `PIT Report-CCP Requirements`}).Stage(stage)
	__ProductShape__00000015_ := (&models.ProductShape{Name: `RCS PBS-Crew Module (CM)`}).Stage(stage)
	__ProductShape__00000016_ := (&models.ProductShape{Name: `RCS PBS-CM Reaction Control System (RCS)`}).Stage(stage)
	__ProductShape__00000017_ := (&models.ProductShape{Name: `RCS PBS-12 CM RCS Thrusters (1200 lbf)`}).Stage(stage)
	__ProductShape__00000018_ := (&models.ProductShape{Name: `RCS PBS-CST-100 Starliner`}).Stage(stage)
	__ProductShape__00000019_ := (&models.ProductShape{Name: `RCS PBS-Service Module (SM)`}).Stage(stage)
	__ProductShape__00000020_ := (&models.ProductShape{Name: `RCS PBS-SM Reaction Control System (SM RCS)`}).Stage(stage)
	__ProductShape__00000021_ := (&models.ProductShape{Name: `RCS PBS-28 SM RCS Thrusters (2800 lbf)`}).Stage(stage)
	__ProductShape__00000022_ := (&models.ProductShape{Name: `PIT Report-2 Additional Investigations `}).Stage(stage)
	__ProductShape__00000023_ := (&models.ProductShape{Name: `PIT Report-STAR Report Summary and Findings `}).Stage(stage)
	__ProductShape__00000024_ := (&models.ProductShape{Name: `RCS PBS-Thermal Sensors`}).Stage(stage)
	__ProductShape__00000025_ := (&models.ProductShape{Name: `RCS PBS-Dog House`}).Stage(stage)
	__ProductShape__00000027_ := (&models.ProductShape{Name: `PBS-Boeing’s Enterprise Root Cause/Corrective Actions (eRCCA)`}).Stage(stage)
	__ProductShape__00000028_ := (&models.ProductShape{Name: `PIT Report-3.1   Orbital Flight Test (OFT) Summary`}).Stage(stage)
	__ProductShape__00000029_ := (&models.ProductShape{Name: `PIT Report-3.2   Orbital Flight Test 2 (OFT-2) Summary`}).Stage(stage)
	__ProductShape__00000030_ := (&models.ProductShape{Name: `RCS PBS-Flight Software (FSW)`}).Stage(stage)
	__ProductShape__00000031_ := (&models.ProductShape{Name: `RCS PBS-Fault Detection, Isolation, and Recovery (FDIR)`}).Stage(stage)
	__ProductShape__00000032_ := (&models.ProductShape{Name: `PIT Report-3.3 Comparing SM RCS Thrusters Triggering Fail-Off FDIR on OFT1/OFT2`}).Stage(stage)
	__ProductShape__00000033_ := (&models.ProductShape{Name: `RCS PBS-Transducer / pressure sensor (Pc)`}).Stage(stage)
	__ProductShape__00000034_ := (&models.ProductShape{Name: `PIT Report-4     Technical Root Cause Analysis (RCA) and Findings`}).Stage(stage)
	__ProductShape__00000035_ := (&models.ProductShape{Name: `PIT Report-4.1   Objectives and Approach `}).Stage(stage)
	__ProductShape__00000036_ := (&models.ProductShape{Name: `PIT Report-4.2 Definitions`}).Stage(stage)
	__ProductShape__00000037_ := (&models.ProductShape{Name: `PIT Report-4.3 Fault Tree`}).Stage(stage)
	__ProductShape__00000038_ := (&models.ProductShape{Name: `RCS PBS-Guidance, Navigation, and Control (GNC)`}).Stage(stage)
	__ProductShape__00000039_ := (&models.ProductShape{Name: `PIT Report-4.4   Analysis: CM RCS Jet Failure`}).Stage(stage)
	__ProductShape__00000040_ := (&models.ProductShape{Name: `PIT Report-4.5   Analysis: Loss of 6DOF Control - SM RCS Jet Failures`}).Stage(stage)
	__ProductShape__00000041_ := (&models.ProductShape{Name: `PIT Report-4.5.1 Description of the system`}).Stage(stage)
	__ProductShape__00000042_ := (&models.ProductShape{Name: `PIT Report-`}).Stage(stage)
	__ProductShape__00000043_ := (&models.ProductShape{Name: `RCS PBS-Inertial Measurement Unit (IMU) `}).Stage(stage)
	__ProductShape__00000044_ := (&models.ProductShape{Name: `RCS PBS-Orbital Maneuvering and Attitude Control (OMAC), 30 000 lbf`}).Stage(stage)
	__ProductShape__00000045_ := (&models.ProductShape{Name: `PIT Report-4.5.2   Description of Events and Timeline `}).Stage(stage)
	__ProductShape__00000046_ := (&models.ProductShape{Name: `PIT Report-B1A3 Thruster failure`}).Stage(stage)
	__ProductShape__00000047_ := (&models.ProductShape{Name: `PIT Report-4.5.4   Starliner Engine Testing at White Sands Test Facility (WSTF) during CFT`}).Stage(stage)
	__ProductShape__00000048_ := (&models.ProductShape{Name: `PIT Report-4.5.5 Fault Tree`}).Stage(stage)
	__ProductShape__00000049_ := (&models.ProductShape{Name: `PIT Report-4.5.6 Most Probable Proximate Cause`}).Stage(stage)
	__ProductShape__00000050_ := (&models.ProductShape{Name: `PIT Report-Intermediate Cause 5: Inadequate Thruster Thermal Models Inadequate thermal modelling caused insufficient scrutiny for the thermal environment, leading to excessive heating from RCS thermal soakback and integrated heating from OMACs.`}).Stage(stage)
	__ProductShape__00000051_ := (&models.ProductShape{Name: `PIT Report-4.6 Analysis: Helium Leak`}).Stage(stage)
	__ProductShape__00000052_ := (&models.ProductShape{Name: `PIT Report-4.6.1 Description of the system`}).Stage(stage)
	...
	__ResourceCompositionShape__00000000_ := (&models.ResourceCompositionShape{Name: `RBS-NASA-Crew Commercial Program (CPP2)`}).Stage(stage)
	__ResourceCompositionShape__00000001_ := (&models.ResourceCompositionShape{Name: `RBS-Crew Commercial Program (CPP2)-Crews`}).Stage(stage)
	__ResourceCompositionShape__00000002_ := (&models.ResourceCompositionShape{Name: `RBS-Crews-Barry "Butch" Wilmore`}).Stage(stage)
	__ResourceCompositionShape__00000003_ := (&models.ResourceCompositionShape{Name: `RBS-Crews-Sunita "Suni" Williams`}).Stage(stage)
	__ResourceCompositionShape__00000004_ := (&models.ResourceCompositionShape{Name: `RBS-NASA-Program Investigation Team (PIT)`}).Stage(stage)
	__ResourceCompositionShape__00000005_ := (&models.ResourceCompositionShape{Name: `RBS-Boeing-`}).Stage(stage)
	__ResourceCompositionShape__00000007_ := (&models.ResourceCompositionShape{Name: `RBS-Crew Commercial Program (CPP2)- Starliner Tests and Anomalies Review (STAR) Investigation Team`}).Stage(stage)
	__ResourceCompositionShape__00000008_ := (&models.ResourceCompositionShape{Name: `RBS-Crew Commercial Program (CPP2)-Flight Control Team (FCT)`}).Stage(stage)
	...
	__ResourceShape__00000003_ := (&models.ResourceShape{Name: `RBS-NASA`}).Stage(stage)
	__ResourceShape__00000004_ := (&models.ResourceShape{Name: `RBS-Crew Commercial Program (CPP2)`}).Stage(stage)
	__ResourceShape__00000005_ := (&models.ResourceShape{Name: `RBS-Crews`}).Stage(stage)
	__ResourceShape__00000006_ := (&models.ResourceShape{Name: `RBS-Barry "Butch" Wilmore`}).Stage(stage)
	__ResourceShape__00000007_ := (&models.ResourceShape{Name: `RBS-Sunita "Suni" Williams`}).Stage(stage)
	__ResourceShape__00000008_ := (&models.ResourceShape{Name: `RBS-Program Investigation Team (PIT)`}).Stage(stage)
	__ResourceShape__00000009_ := (&models.ResourceShape{Name: `RBS-Boeing`}).Stage(stage)
	__ResourceShape__00000010_ := (&models.ResourceShape{Name: `RBS-`}).Stage(stage)
	__ResourceShape__00000012_ := (&models.ResourceShape{Name: `RBS- Starliner Tests and Anomalies Review (STAR) Investigation Team`}).Stage(stage)
	__ResourceShape__00000013_ := (&models.ResourceShape{Name: `PBS-Program Investigation Team (PIT)`}).Stage(stage)
	__ResourceShape__00000014_ := (&models.ResourceShape{Name: `PIT focus-Program Investigation Team (PIT)`}).Stage(stage)
	__ResourceShape__00000015_ := (&models.ResourceShape{Name: `RBS-Flight Control Team (FCT)`}).Stage(stage)
	...
	__TaskCompositionShape__00000001_ := (&models.TaskCompositionShape{Name: `WBS-Commercial Crew Program (CCP),-Starliner Crewed Flight Test (CFT)`}).Stage(stage)
	__TaskCompositionShape__00000002_ := (&models.TaskCompositionShape{Name: `WBS-Mishap investigations-Program Investigation Team (PIT) Report`}).Stage(stage)
	__TaskCompositionShape__00000003_ := (&models.TaskCompositionShape{Name: `WBS-Commercial Crew Program (CCP),-Orbital Flight Test-1 (OFT-1)`}).Stage(stage)
	__TaskCompositionShape__00000004_ := (&models.TaskCompositionShape{Name: `WBS-Commercial Crew Program (CCP),-Orbital Flight Test-2 (OFT-2)`}).Stage(stage)
	__TaskCompositionShape__00000005_ := (&models.TaskCompositionShape{Name: `WBS-Starliner Crewed Flight Test (CFT)-ISS Approach`}).Stage(stage)

	__TaskInputShape__00000000_ := (&models.TaskInputShape{Name: `PIT focus- Starliner Tests and Anomalies Review (STAR) Investigation Report-Program Investigation Team (PIT) Report`}).Stage(stage)

	__TaskOutputShape__00000000_ := (&models.TaskOutputShape{Name: `PIT focus-Program Investigation Team (PIT) Report-Program Investigation Team (PIT) Reports`}).Stage(stage)

	__TaskShape__00000003_ := (&models.TaskShape{Name: `WBS-Mishap investigations`}).Stage(stage)
	__TaskShape__00000004_ := (&models.TaskShape{Name: `WBS-Commercial Crew Program (CCP),`}).Stage(stage)
	__TaskShape__00000005_ := (&models.TaskShape{Name: `WBS-Starliner Crewed Flight Test (CFT)`}).Stage(stage)
	__TaskShape__00000006_ := (&models.TaskShape{Name: `WBS- Commercial ReSupply (CRS) `}).Stage(stage)
	__TaskShape__00000007_ := (&models.TaskShape{Name: `PBS-Mishap investigations`}).Stage(stage)
	__TaskShape__00000008_ := (&models.TaskShape{Name: `WBS-Program Investigation Team (PIT) Report`}).Stage(stage)
	__TaskShape__00000009_ := (&models.TaskShape{Name: `PIT focus-Program Investigation Team (PIT) Report`}).Stage(stage)
	__TaskShape__00000010_ := (&models.TaskShape{Name: `WBS-Orbital Flight Test-1 (OFT-1)`}).Stage(stage)
	__TaskShape__00000011_ := (&models.TaskShape{Name: `WBS-Orbital Flight Test-2 (OFT-2)`}).Stage(stage)
	__TaskShape__00000012_ := (&models.TaskShape{Name: `WBS-ISS Approach`}).Stage(stage)
...
- Starliner Tests and Anomalies Review (STAR) Investigation Report`
	...
	__NoteProductShape__00000001_.Name = `PBS-NASA utilized a firm fixed price contracting type for CCtCap. 
...
This was a significant shift from the cost-plus contracting for traditional NASA builds of developmental vehicles. These shifts signified that CCP was not only positioned to be an innovative, first-of-its kind program for NASA, but how it interacted with new and traditional space flight industry providers was setup to be significantly distinct and different.  -Commercial Crew Transportation Capability (CCtCap).`
	...
	__NoteProductShape__00000002_.Name = `PIT Report-The CCP 1100 series of requirements were deliberately written at a higher-level, leaving room for provider innovation but there was also room for incorrect/inadequate interpretation by the providers. -CCP Requirements`
	...
	__NoteProductShape__00000003_.Name = `PIT Report-The Commercial Provider focused on meeting contractual requirement language resulting in insufficient demonstration across the components/system and ground/flight. -CCP Requirements`
	...
	__NoteProductShape__00000004_.Name = `RCS PBS-Suppliers’ build quality/variability issues can be hard to exonerate for service modules, which is hardware that is disposed of during re-entry. -12 CM RCS Thrusters (1200 lbf)`
	...
	__NoteProductShape__00000005_.Name = `RCS PBS-Suppliers’ build quality/variability issues can be hard to exonerate for service modules, which is hardware that is disposed of during re-entry. -28 SM RCS Thrusters (2800 lbf)`
	...
	__NoteProductShape__00000006_.Name = `RCS PBS-The Aerojet Rocketdyne (AR) thermal model included the effects of jet firings, but these effects were not validated by ground testing.

Boeing thermal model did not include the effects of jet firings before CFT. -28 SM RCS Thrusters (2800 lbf)`
	...
	__NoteProductShape__00000007_.Name = `RCS PBS-The thruster performance from OFT1 & OFT2 experienced greater than expected temperatures and continuing to operate lead to a false sense of security of the thruster capability/performance. -28 SM RCS Thrusters (2800 lbf)`
	...
	__NoteProductShape__00000008_.Name = `RCS PBS-Flight instrumentation locations for thermal sensors were limited and in different locations than the locations for RCS Thruster ground firings. -Thermal Sensors`
	...
	__NoteProductShape__00000009_.Name = `RCS PBS-Flight instrumentation locations for thermal sensors were limited and in different locations than the locations for RCS Thruster ground firings. -28 SM RCS Thrusters (2800 lbf)`
	...
	__NoteProductShape__00000010_.Name = `RCS PBS-Flight instrumentation locations for thermal sensors were limited and in different locations than the locations for RCS Thruster ground firings. -12 CM RCS Thrusters (1200 lbf)`
	...
	__NoteProductShape__00000011_.Name = `RCS PBS-OFT1 & OFT2 investigations did not include RCS/OMAC thruster firings and fault trees were not validated through subsequent ground testing. -28 SM RCS Thrusters (2800 lbf)`
	...
	__NoteProductShape__00000012_.Name = `RCS PBS-For OFT2, NASA/Boeing did not have tools to measure thruster degradation, simply treated the thruster as failed/operational. -28 SM RCS Thrusters (2800 lbf)`
	...
	__NoteProductShape__00000013_.Name = `RCS PBS-Pc (Chamber Pressure).To know if a thruster is actually firing, the spacecraft's computer looks at the pressure sensor inside the combustion chamber (the Pc telemetry). If the pressure shoots up to the expected level, it means combustion is happening and the thruster is pushing. If the pressure stays low or at zero, it assumes the thruster failed.-12 CM RCS Thrusters (1200 lbf)`
	...
	__NoteProductShape__00000014_.Name = `RCS PBS-Pc (Chamber Pressure).To know if a thruster is actually firing, the spacecraft's computer looks at the pressure sensor inside the combustion chamber (the Pc telemetry). If the pressure shoots up to the expected level, it means combustion is happening and the thruster is pushing. If the pressure stays low or at zero, it assumes the thruster failed.-Transducer / pressure sensor (Pc)`
	...
	__NoteProductShape__00000015_.Name = `RCS PBS-Pc transducer failed but the engine was able to restart. Boing confidence in the harxware robustness-Transducer / pressure sensor (Pc)`
	...
	__NoteProductShape__00000016_.Name = `PIT Report-The leading theory for the proximate cause of the CM RCS failure during the CFT is the formulation of carbazic acid, which corrodes stainless steel. The reaction between carbazic acid and stainless steel creates corrosion particulates in the thruster propellant valve, preventing it from opening. -4.4   Analysis: CM RCS Jet Failure`
	...
	__NoteProductShape__00000017_.Name = `PIT Report-Thruster health is monitored via chamber pressure and Fuel/Oxydizer injector temperatures-4.4   Analysis: CM RCS Jet Failure`
	...
	__NoteProductShape__00000018_.Name = `PIT Report-Commanded pulse lengths are neither recorded nor downlinked near real time with telemetry

This complicates efforts to understand what went wrong with SM RCS jets when data suggests that pulse length is correlated to observed soakback temperatures.  -4.5.1 Description of the system`
	...
	__NoteProductShape__00000019_.Name = `PIT Report-At the conclusion of the hotfire, when thruster is demonstrated, a jet is reenabled with jet-fail FDIR inhibited. Through this sequence, four of five jets were recovered. Spacecraft 6DOF control was reestablished in all axes. T

he spacecraft was moded back to auto and the rendezvous/dock was completed.  While the flight rules allow an SM RCS thruster to be used with jet-fail off FDIR inhibited, doing so removes a hazard control.

Whaou.-4.5.2   Description of Events and Timeline `
	...
	__NoteProductShape__00000020_.Name = `PIT Report-Many thruster pulses are less  FDIR in the  The FMCs see chamber pressure over a data bus from the  but the chamber pressure is only sent to the ground with a sample rate for recording every  limiting insight into thruster performance. This does not meet Nyquist Criterion for capturing the chamber pressure signal. As a result, aliasing effects may occur for pulses shorter than  where high-frequency components of the pressure signal are misrepresented or lost, further complicating accurate reconstruction of thruster behavior.  -4.5.2   Description of Events and Timeline `
	...
	__NoteProductShape__00000021_.Name = `PIT Report- degraded performance was still observed. This testing demonstrated the issue was not purely transient.

It should have been done before ?!

 In addition to demonstrating transient degradation during high heating, the test program demonstrated an unrecoverable cumulative degradation that was potentially indicative of the observed performance of CFT. -4.5.4   Starliner Engine Testing at White Sands Test Facility (WSTF) during CFT`
	...
	__NoteProductShape__00000022_.Name = `PIT Report-B1.3.3.1.1.1 Heat identifies that excessive heating could cause the poppet to extrude, reducing flow. Poppet extrusion was observed in the post-test tear down of the WSTF (White Sands Test Facility) thruster unit.

The initial heating was caused by the internal doghouse temperatures (addressed in C4.1 Thermal) and the follow-on heating induced by B1.3.3.1.4.2 RCS Thermal Soakback. This caused excessive temperatures beyond the capability of the thruster softgoods, causing the Teflon poppet to extrude. The evidence supports this being a contributor to the thruster fail-offs.-4.5.5 Fault Tree`
	...
	__NoteProductShape__00000023_.Name = `PIT Report-B1.3.3.1.4.2 RCS Thermal Soakback identifies the possibility that structure of the RCS thruster
retains heat, and the heat is unable to be dissipated from the firings of the thrusters, causing the
propellants to heat rapidly. -4.5.5 Fault Tree`
	...
	__NoteProductShape__00000024_.Name = `PIT Report-Intermediate Cause 5: Inadequate Thruster Thermal Models
...
There was no thermal model available to adequately understand the full impacts of the thermal
environment upon the RCS thrusters, specifically the aft thrusters with the longest feed line tube,
and very close proximity to the OMAC thrusters-Intermediate Cause 5: Inadequate Thruster Thermal Models Inadequate thermal modelling caused insufficient scrutiny for the thermal environment, leading to excessive heating from RCS thermal soakback and integrated heating from OMACs.`
	...
	__NoteProductShape__00000025_.Name = `PIT Report-Intermediate Cause 6: Insufficient Thruster Qualification

SM RCS Thruster Qualification did not cover the flight envelope for temperature and duty cycle (TLYF).-Intermediate Cause 5: Inadequate Thruster Thermal Models Inadequate thermal modelling caused insufficient scrutiny for the thermal environment, leading to excessive heating from RCS thermal soakback and integrated heating from OMACs.`
	...
	__NoteProductShape__00000026_.Name = `PIT Report-Multiple groups, prior to CTF, discussed the lack of mission representative operational duty cycle testing for SM RCS engines.. This concern is one that has been tracked since prior to OFT1 and is specifically reviewed in this intermediate cause because it is widely accepted that operational duty cycle is a primary driver of hardware temperature. NASA Engineering and the CCP Spacecraft Office have consistently identified this qualification gap and recommended additional testing, however it was not incorporated into the pursued plans for risk assessments between flights.
...
The OFT-2 IFA related to valve/injector assembly temperature measurements exceeding qualification limits, which were categorized as an Unexplained Anomaly (UA). The directive acknowledged that these exceedances were attributed to specific operational duty cycles. Consequently, the thermal risk was accepted as a 2x5 risk for potential jet failure. Despite this, engineering teams and the Engineering Review Board (ERB-23-0045-R2) emphasized the importance of testing SM RCS thrusters using flight-like duty cycles.-Intermediate Cause 5: Inadequate Thruster Thermal Models Inadequate thermal modelling caused insufficient scrutiny for the thermal environment, leading to excessive heating from RCS thermal soakback and integrated heating from OMACs.`
...
This complicates efforts to understand what went wrong with SM RCS jets when data suggests that pulse length is correlated to observed soakback temperatures.  `
	...
	__NoteShape__00000018_.Name = `PIT Report-At the conclusion of the hotfire, when thruster is demonstrated, a jet is reenabled with jet-fail FDIR inhibited. Through this sequence, four of five jets were recovered. Spacecraft 6DOF control was reestablished in all axes. T
...
Whaou.`
	...
	__NoteShape__00000019_.Name = `PIT Report- degraded performance was still observed. This testing demonstrated the issue was not purely transient.
...
propellants to heat rapidly. `
	...
	__NoteShape__00000022_.Name = `PIT Report-Intermediate Cause 5: Inadequate Thruster Thermal Models
...
SM RCS Thruster Qualification did not cover the flight envelope for temperature and duty cycle (TLYF).`
	...
	__NoteShape__00000024_.Name = `PIT Report-Multiple groups, prior to CTF, discussed the lack of mission representative operational duty cycle testing for SM RCS engines.. This concern is one that has been tracked since prior to OFT1 and is specifically reviewed in this intermediate cause because it is widely accepted that operational duty cycle is a primary driver of hardware temperature. NASA Engineering and the CCP Spacecraft Office have consistently identified this qualification gap and recommended additional testing, however it was not incorporated into the pursued plans for risk assessments between flights.
...
The OFT-2 IFA related to valve/injector assembly temperature measurements exceeding qualification limits, which were categorized as an Unexplained Anomaly (UA). The directive acknowledged that these exceedances were attributed to specific operational duty cycles. Consequently, the thermal risk was accepted as a 2x5 risk for potential jet failure. Despite this, engineering teams and the Engineering Review Board (ERB-23-0045-R2) emphasized the importance of testing SM RCS thrusters using flight-like duty cycles.`
	...
	__NoteShape__00000025_.Name = `PIT Report-Organizational Factor 1: Insufficient Anomaly Resolution Process Multiple RCS thruster failures occurred on OFT 1 and OFT 2. While fault trees were developed, due diligence to reach direct and root cause was not performed and adequate block closure rationale was often incomplete.
...
Organizational Factor 2: Mischaracterization of Risk in thruster Qual Gaps leads to Flawed Flight Rationale. The thermal risk for Starliner’s SM RCS thrusters was mischaracterized due to reliance on simple models and inadequate qualification testing that failed to replicate mission-representative conditions. Despite clear evidence of thermal soakback and temperature exceedances, risk acceptance proceeded without resolving key environment and duty cycle concerns.`
	...
	__NoteTaskShape__00000001_.Name = `WBS- S2A2 failed at 9050 m (GMT 14:00) and B1A3 failed at 526m (GMT 14:57).-ISS Approach`
	...
	__ProductCompositionShape__00000000_.Name = `PBS-Reports- Starliner Tests and Anomalies Review (STAR) Investigation Report`
	...
	__ProductCompositionShape__00000002_.Name = `PBS-Commercial Crew Transportation Capability (CCtCap).-CST-100 Starliner`
	...
	__ProductCompositionShape__00000003_.Name = `PBS-Commercial Crew Transportation Capability (CCtCap).-Dragon`
	...
	__ProductCompositionShape__00000004_.Name = `PBS-NASA Assets/Capabities-Commercial Crew Transportation Capability (CCtCap).`
	...
	__ProductCompositionShape__00000005_.Name = `PBS-NASA Assets/Capabities-ISS`
	...
	__ProductCompositionShape__00000006_.Name = `PIT Report-Program Investigation Team (PIT) Reports-3 Commercial Crew Program (CCP) Background`
	...
	__ProductCompositionShape__00000007_.Name = `RCS PBS-Crew Module (CM)-CM Reaction Control System (RCS)`
	...
	__ProductCompositionShape__00000008_.Name = `RCS PBS-CM Reaction Control System (RCS)-12 CM RCS Thrusters (1200 lbf)`
	...
	__ProductCompositionShape__00000009_.Name = `RCS PBS-CST-100 Starliner-Crew Module (CM)`
	...
	__ProductCompositionShape__00000010_.Name = `RCS PBS-CST-100 Starliner-Service Module (SM)`
	...
	__ProductCompositionShape__00000011_.Name = `RCS PBS-Service Module (SM)-SM Reaction Control System (SM RCS)`
	...
	__ProductCompositionShape__00000012_.Name = `RCS PBS-SM Reaction Control System (SM RCS)-28 SM RCS Thrusters (2800 lbf)`
	...
	__ProductCompositionShape__00000013_.Name = `PIT Report-Program Investigation Team (PIT) Reports-2 Additional Investigations `
	...
	__ProductCompositionShape__00000014_.Name = `PIT Report-2 Additional Investigations -STAR Report Summary and Findings `
	...
	__ProductCompositionShape__00000016_.Name = `RCS PBS-12 CM RCS Thrusters (1200 lbf)-Dog House`
	...
	__ProductCompositionShape__00000018_.Name = `PBS-Reports-Boeing’s Enterprise Root Cause/Corrective Actions (eRCCA)`
	...
	__ProductCompositionShape__00000019_.Name = `PIT Report-3 Commercial Crew Program (CCP) Background-3.1   Orbital Flight Test (OFT) Summary`
	...
	__ProductCompositionShape__00000020_.Name = `PIT Report-3 Commercial Crew Program (CCP) Background-3.2   Orbital Flight Test 2 (OFT-2) Summary`
	...
	__ProductCompositionShape__00000021_.Name = `RCS PBS-CST-100 Starliner-Flight Software (FSW)`
	...
	__ProductCompositionShape__00000022_.Name = `RCS PBS-CST-100 Starliner-Fault Detection, Isolation, and Recovery (FDIR)`
	...
	__ProductCompositionShape__00000023_.Name = `PIT Report-3 Commercial Crew Program (CCP) Background-3.3 Comparing SM RCS Thrusters Triggering Fail-Off FDIR on OFT1/OFT2`
	...
	__ProductCompositionShape__00000024_.Name = `RCS PBS-12 CM RCS Thrusters (1200 lbf)-Transducer / pressure sensor (Pc)`
	...
	__ProductCompositionShape__00000025_.Name = `PIT Report-Program Investigation Team (PIT) Reports-4     Technical Root Cause Analysis (RCA) and Findings`
	...
	__ProductCompositionShape__00000026_.Name = `PIT Report-4     Technical Root Cause Analysis (RCA) and Findings-4.1   Objectives and Approach `
	...
	__ProductCompositionShape__00000027_.Name = `PIT Report-4     Technical Root Cause Analysis (RCA) and Findings-4.2 Definitions`
	...
	__ProductCompositionShape__00000028_.Name = `PIT Report-4     Technical Root Cause Analysis (RCA) and Findings-4.3 Fault Tree`
	...
	__ProductCompositionShape__00000029_.Name = `RCS PBS-CST-100 Starliner-Guidance, Navigation, and Control (GNC)`
	...
	__ProductCompositionShape__00000030_.Name = `PIT Report-4     Technical Root Cause Analysis (RCA) and Findings-4.4   Analysis: CM RCS Jet Failure`
	...
	__ProductCompositionShape__00000031_.Name = `PIT Report-4     Technical Root Cause Analysis (RCA) and Findings-4.5   Analysis: Loss of 6DOF Control - SM RCS Jet Failures`
	...
	__ProductCompositionShape__00000032_.Name = `PIT Report-4.5   Analysis: Loss of 6DOF Control - SM RCS Jet Failures-4.5.1 Description of the system`
	...
	__ProductCompositionShape__00000033_.Name = `PIT Report-4     Technical Root Cause Analysis (RCA) and Findings-`
	...
	__ProductCompositionShape__00000034_.Name = `RCS PBS-Guidance, Navigation, and Control (GNC)-Inertial Measurement Unit (IMU) `
	...
	__ProductCompositionShape__00000035_.Name = `RCS PBS-CST-100 Starliner-Orbital Maneuvering and Attitude Control (OMAC), 30 000 lbf`
	...
	__ProductCompositionShape__00000036_.Name = `PIT Report-4.5   Analysis: Loss of 6DOF Control - SM RCS Jet Failures-4.5.2   Description of Events and Timeline `
	...
	__ProductCompositionShape__00000037_.Name = `PIT Report-4.5   Analysis: Loss of 6DOF Control - SM RCS Jet Failures-B1A3 Thruster failure`
	...
	__ProductCompositionShape__00000038_.Name = `PIT Report-4.5   Analysis: Loss of 6DOF Control - SM RCS Jet Failures-4.5.4   Starliner Engine Testing at White Sands Test Facility (WSTF) during CFT`
	...
	__ProductCompositionShape__00000039_.Name = `PIT Report-4.5   Analysis: Loss of 6DOF Control - SM RCS Jet Failures-4.5.5 Fault Tree`
	...
	__ProductCompositionShape__00000040_.Name = `PIT Report-4.5   Analysis: Loss of 6DOF Control - SM RCS Jet Failures-4.5.6 Most Probable Proximate Cause`
	...
	__ProductCompositionShape__00000041_.Name = `PIT Report-4.5.6 Most Probable Proximate Cause-Intermediate Cause 5: Inadequate Thruster Thermal Models Inadequate thermal modelling caused insufficient scrutiny for the thermal environment, leading to excessive heating from RCS thermal soakback and integrated heating from OMACs.`
	...
	__ProductCompositionShape__00000042_.Name = `PIT Report-4.5   Analysis: Loss of 6DOF Control - SM RCS Jet Failures-4.6 Analysis: Helium Leak`
	...
	__ProductCompositionShape__00000043_.Name = `PIT Report-4.6 Analysis: Helium Leak-4.6.1 Description of the system`
	...
	__ProductCompositionShape__00000044_.Name = `PBS-Reports-Program Investigation Team (PIT) Reports`
	...
	__Resource__00000002_.LayoutDirection = models.Vertical
	...
	__Resource__00000003_.LayoutDirection = models.Vertical
	...
	__Resource__00000004_.LayoutDirection = models.Vertical
	...
	__Resource__00000005_.LayoutDirection = models.Vertical
	...
	__Resource__00000006_.LayoutDirection = models.Vertical
	...
	__Resource__00000007_.LayoutDirection = models.Vertical
	...
	__Resource__00000009_.LayoutDirection = models.Vertical
	...
	__Resource__00000010_.LayoutDirection = models.Vertical
	__Resource__00000010_.IsImport = false

	__ResourceCompositionShape__00000000_.Name = `RBS-NASA-Crew Commercial Program (CPP2)`
	...
	__ResourceCompositionShape__00000001_.Name = `RBS-Crew Commercial Program (CPP2)-Crews`
	...
	__ResourceCompositionShape__00000002_.Name = `RBS-Crews-Barry "Butch" Wilmore`
	...
	__ResourceCompositionShape__00000003_.Name = `RBS-Crews-Sunita "Suni" Williams`
	...
	__ResourceCompositionShape__00000004_.Name = `RBS-NASA-Program Investigation Team (PIT)`
	...
	__ResourceCompositionShape__00000005_.Name = `RBS-Boeing-`
	...
	__ResourceCompositionShape__00000007_.Name = `RBS-Crew Commercial Program (CPP2)- Starliner Tests and Anomalies Review (STAR) Investigation Team`
	...
	__ResourceCompositionShape__00000008_.Name = `RBS-Crew Commercial Program (CPP2)-Flight Control Team (FCT)`
	...
	__TaskCompositionShape__00000001_.Name = `WBS-Commercial Crew Program (CCP),-Starliner Crewed Flight Test (CFT)`
	...
	__TaskCompositionShape__00000002_.Name = `WBS-Mishap investigations-Program Investigation Team (PIT) Report`
	...
	__TaskCompositionShape__00000003_.Name = `WBS-Commercial Crew Program (CCP),-Orbital Flight Test-1 (OFT-1)`
	...
	__TaskCompositionShape__00000004_.Name = `WBS-Commercial Crew Program (CCP),-Orbital Flight Test-2 (OFT-2)`
	...
	__TaskCompositionShape__00000005_.Name = `WBS-Starliner Crewed Flight Test (CFT)-ISS Approach`
	...
	__TaskInputShape__00000000_.Name = `PIT focus- Starliner Tests and Anomalies Review (STAR) Investigation Report-Program Investigation Team (PIT) Report`
	...
	__TaskOutputShape__00000000_.Name = `PIT focus-Program Investigation Team (PIT) Report-Program Investigation Team (PIT) Reports`
