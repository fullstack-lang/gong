...
import (
	...
	"github.com/fullstack-lang/gong/dsm/project/go/models/probe"

	embeddedgo "github.com/fullstack-lang/gong/dsm/project/go"
...
func (impl *BeforeCommitImplementation) BeforeCommit(stage *models.Stage) {
	...
	stage.MarshallFile(fmt.Sprintf("./%s", filename), "github.com/fullstack-lang/gong/dsm/project/go/models", packageName)
}
...
func NewLevel1StackDelta(
	...
	models.SetOrchestratorOnAfterUpdate[models.ResourceTaskShape](stage)
	...
	models.SetOrchestratorOnAfterUpdate[models.TaskGroup](stage)
	models.SetOrchestratorOnAfterUpdate[models.TaskGroupShape](stage)
	...
	models.SetOrchestratorOnAfterUpdate[models.TaskPredecessorShape](stage)
