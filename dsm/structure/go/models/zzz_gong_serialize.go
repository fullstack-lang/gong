...
func buildExcelizeFile(stage *Stage, addIDs bool) *excelize.File {
	...
	{
		// insertion point
		stage.SerializeExcelizePointer2[*AllocatedResourceShape](f, addIDs)
		stage.SerializeExcelizePointer2[*AllocatedSystemShape](f, addIDs)
		stage.SerializeExcelizePointer2[*ControlFlow](f, addIDs)
		stage.SerializeExcelizePointer2[*ControlFlowShape](f, addIDs)
		stage.SerializeExcelizePointer2[*Data](f, addIDs)
		stage.SerializeExcelizePointer2[*DataFlow](f, addIDs)
		stage.SerializeExcelizePointer2[*DataFlowShape](f, addIDs)
		stage.SerializeExcelizePointer2[*DataShape](f, addIDs)
		stage.SerializeExcelizePointer2[*DiagramLayerState](f, addIDs)
		stage.SerializeExcelizePointer2[*DiagramStructure](f, addIDs)
		stage.SerializeExcelizePointer2[*ExternalPartShape](f, addIDs)
		stage.SerializeExcelizePointer2[*LayerDefinition](f, addIDs)
		stage.SerializeExcelizePointer2[*Library](f, addIDs)
		stage.SerializeExcelizePointer2[*Note](f, addIDs)
		stage.SerializeExcelizePointer2[*NotePartShape](f, addIDs)
		stage.SerializeExcelizePointer2[*NotePortShape](f, addIDs)
		stage.SerializeExcelizePointer2[*NoteShape](f, addIDs)
		stage.SerializeExcelizePointer2[*Part](f, addIDs)
		stage.SerializeExcelizePointer2[*PartAnchoredPath](f, addIDs)
		stage.SerializeExcelizePointer2[*PartShape](f, addIDs)
		stage.SerializeExcelizePointer2[*Port](f, addIDs)
		stage.SerializeExcelizePointer2[*PortShape](f, addIDs)
		stage.SerializeExcelizePointer2[*Resource](f, addIDs)
		stage.SerializeExcelizePointer2[*SemanticTag](f, addIDs)
		stage.SerializeExcelizePointer2[*System](f, addIDs)
		stage.SerializeExcelizePointer2[*SystemShape](f, addIDs)
	}
