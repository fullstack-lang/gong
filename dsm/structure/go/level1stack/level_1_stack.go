...
import (
	...
	"github.com/fullstack-lang/gong/dsm/structure/go/models/probe"
...
func (impl *BeforeCommitImplementation) BeforeCommit(stage *models.Stage) {
	...
	stage.MarshallFile(fmt.Sprintf("./%s", filename), "github.com/fullstack-lang/gong/dsm/structure/go/models", packageName)
}
