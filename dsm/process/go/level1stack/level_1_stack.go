...
func (impl *BeforeCommitImplementation) BeforeCommit(stage *models.Stage) {
	...
	stage.MarshallFile(fmt.Sprintf("./%s", filename), "github.com/fullstack-lang/gong/dsm/process/go/models", packageName)
}
...
func NewLevel1StackDelta(
	...
	models.SetOrchestratorOnAfterUpdate[models.ProcessCompositionShape](stage)
