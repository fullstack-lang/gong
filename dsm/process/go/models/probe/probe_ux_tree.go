...
func (probe *Probe) ux_tree() {
	...
	for _, gongStruct := range sliceOfGongStructsSorted {
		...
		case "AllocatedProcessShape":
			...
			set := *probe.stageOfInterest.GetInstancesSet[*models.AllocatedProcessShape]()
			count := 0
			for _allocatedprocessshape := range set {
				...
				nodeInstance := &tree_models.Node{
					Name:            _allocatedprocessshape.GetName(),
					IsNodeClickable: true,
					OnClick: func(frontNode *tree_models.Node) {
						FillUpFormFromGongstruct(_allocatedprocessshape, probe)
					},
				}
		...
		case "DiagramProcess":
			nodeGongstruct.Name = name
			set := *probe.stageOfInterest.GetInstancesSet[*models.DiagramProcess]()
			count := 0
		...
		case "ExternalParticipantShape":
			nodeGongstruct.Name = name
			set := *probe.stageOfInterest.GetInstancesSet[*models.ExternalParticipantShape]()
			count := 0
		...
		case "Participant":
			nodeGongstruct.Name = name
			set := *probe.stageOfInterest.GetInstancesSet[*models.Participant]()
			count := 0
		...
		case "ParticipantShape":
			nodeGongstruct.Name = name
			set := *probe.stageOfInterest.GetInstancesSet[*models.ParticipantShape]()
			count := 0
		...
		case "Process":
			nodeGongstruct.Name = name
			set := *probe.stageOfInterest.GetInstancesSet[*models.Process]()
			count := 0
		...
		case "ProcessShape":
			nodeGongstruct.Name = name
			set := *probe.stageOfInterest.GetInstancesSet[*models.ProcessShape]()
			count := 0
