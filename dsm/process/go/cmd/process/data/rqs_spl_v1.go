...
func _(stage *models.Stage) {
	...
	__DataFlow__00000000_ := (&models.DataFlow{Name: `"Transmits RQS" to "Validates and Routes RQS"`}).Stage(stage)
	__DataFlow__00000001_ := (&models.DataFlow{Name: `"Validates and Routes RQS" to "Compiles and Transmits SPL"`}).Stage(stage)
	__DataFlow__00000002_ := (&models.DataFlow{Name: `"Compiles and Transmits SPL" to "Validates and Routes SPL"`}).Stage(stage)
	__DataFlow__00000003_ := (&models.DataFlow{Name: `"Validates and Routes SPL" to "Receives SPL"`}).Stage(stage)

	__DataFlowShape__00000004_ := (&models.DataFlowShape{Name: `"Transmits RQS" to "Validates and Routes RQS"`}).Stage(stage)
	__DataFlowShape__00000005_ := (&models.DataFlowShape{Name: `"Validates and Routes SPL" to "Receives SPL"`}).Stage(stage)
	__DataFlowShape__00000006_ := (&models.DataFlowShape{Name: `"Validates and Routes RQS" to "Compiles and Transmits SPL"`}).Stage(stage)
	__DataFlowShape__00000007_ := (&models.DataFlowShape{Name: `"Compiles and Transmits SPL" to "Validates and Routes SPL"`}).Stage(stage)
	...
	__DiagramProcess__00000000_ := (&models.DiagramProcess{Name: `RQS SPL, AO in the loop`}).Stage(stage)
	...
	__Participant__00000002_ := (&models.Participant{Name: `Aircraft Operator`}).Stage(stage)
	...
	__ParticipantShape__00000002_ := (&models.ParticipantShape{Name: `Aircraft Operator-DiagramProcess`}).Stage(stage)

	__Process__00000000_ := (&models.Process{Name: `RQS/SPL Exchange`}).Stage(stage)
	...
	__Task__00000001_ := (&models.Task{Name: `Validates and Routes RQS`}).Stage(stage)
	__Task__00000002_ := (&models.Task{Name: `Compiles and Transmits SPL`}).Stage(stage)
	__Task__00000003_ := (&models.Task{Name: `Validates and Routes SPL`}).Stage(stage)
	...
	__TaskShape__00000002_ := (&models.TaskShape{Name: `Compiles and Transmits SPL-DiagramProcess`}).Stage(stage)
	__TaskShape__00000003_ := (&models.TaskShape{Name: `Validates and Routes SPL-DiagramProcess`}).Stage(stage)
	...
	__DataFlow__00000000_.Name = `"Transmits RQS" to "Validates and Routes RQS"`
	...
	__DataFlow__00000001_.Name = `"Validates and Routes RQS" to "Compiles and Transmits SPL"`
	...
	__DataFlow__00000002_.Name = `"Compiles and Transmits SPL" to "Validates and Routes SPL"`
	...
	__DataFlow__00000003_.Name = `"Validates and Routes SPL" to "Receives SPL"`
	...
	__DataFlowShape__00000004_.Name = `"Transmits RQS" to "Validates and Routes RQS"`
	...
	__DataFlowShape__00000004_.CornerOffsetRatio = 1.204805
	__DataFlowShape__00000004_.IsHidden = false

	__DataFlowShape__00000005_.Name = `"Validates and Routes SPL" to "Receives SPL"`
	...
	__DataFlowShape__00000005_.CornerOffsetRatio = -0.420195
	__DataFlowShape__00000005_.IsHidden = false

	__DataFlowShape__00000006_.Name = `"Validates and Routes RQS" to "Compiles and Transmits SPL"`
	__DataFlowShape__00000006_.StartRatio = 0.500000
	__DataFlowShape__00000006_.EndRatio = 0.262453
	...
	__DataFlowShape__00000006_.CornerOffsetRatio = 1.100000
	__DataFlowShape__00000006_.IsHidden = false

	__DataFlowShape__00000007_.Name = `"Compiles and Transmits SPL" to "Validates and Routes SPL"`
	__DataFlowShape__00000007_.StartRatio = 0.907843
	...
	__DataFlowShape__00000007_.CornerOffsetRatio = -0.585195
	...
	__DiagramProcess__00000000_.Name = `RQS SPL, AO in the loop`
	...
	__DiagramProcess__00000000_.Width = 1387.000000
	__DiagramProcess__00000000_.Height = 1254.000000
	...
	__Participant__00000002_.Name = `Aircraft Operator`
	__Participant__00000002_.IsProcessResource = false
	__Participant__00000002_.Description = `Aircraft Operator or automated dispatch`
	...
	__ParticipantShape__00000002_.Name = `Aircraft Operator-DiagramProcess`
	__ParticipantShape__00000002_.IsExpanded = false
	__ParticipantShape__00000002_.X = 800.000000
	__ParticipantShape__00000002_.Y = 100.000000
	...
	__Process__00000000_.Name = `RQS/SPL Exchange`
	...
	__ProcessShape__00000000_.X = 37.000000
	__ProcessShape__00000000_.Y = 54.000000
	__ProcessShape__00000000_.Width = 1050.000000
	...
	__Task__00000001_.Name = `Validates and Routes RQS`
	...
	__Task__00000002_.Name = `Compiles and Transmits SPL`
	...
	__Task__00000003_.Name = `Validates and Routes SPL`
	...
	__TaskShape__00000000_.X = 112.000000
	__TaskShape__00000000_.Y = 314.000000
	...
	__TaskShape__00000001_.X = 462.000000
	__TaskShape__00000001_.Y = 414.000000
	__TaskShape__00000001_.Width = 200.000000
	__TaskShape__00000001_.Height = 60.000000
	__TaskShape__00000001_.IsHidden = false

	__TaskShape__00000002_.Name = `Compiles and Transmits SPL-DiagramProcess`
	__TaskShape__00000002_.IsExpanded = false
	__TaskShape__00000002_.X = 814.000000
	__TaskShape__00000002_.Y = 451.000000
	__TaskShape__00000002_.Width = 200.000000
	__TaskShape__00000002_.Height = 141.000000
	__TaskShape__00000002_.IsHidden = false

	__TaskShape__00000003_.Name = `Validates and Routes SPL-DiagramProcess`
	__TaskShape__00000003_.IsExpanded = false
	__TaskShape__00000003_.X = 462.000000
	__TaskShape__00000003_.Y = 614.000000
	__TaskShape__00000003_.Width = 200.000000
	__TaskShape__00000003_.Height = 60.000000
	...
	__TaskShape__00000004_.X = 113.000000
	__TaskShape__00000004_.Y = 662.000000
	...
	__TaskShape__00000005_.X = 167.000000
	__TaskShape__00000005_.Y = 214.000000
	...
	__TaskShape__00000006_.X = 182.000000
	__TaskShape__00000006_.Y = 849.000000
	...
	__DataFlow__00000002_.EndTask = __Task__00000003_
	...
	__DataFlow__00000003_.StartTask = __Task__00000003_
	...
	__DataFlowShape__00000006_.DataFlow = __DataFlow__00000001_
	__DataFlowShape__00000007_.DataFlow = __DataFlow__00000002_
	...
	__DiagramProcess__00000000_.DataFlow_Shapes = append(__DiagramProcess__00000000_.DataFlow_Shapes, __DataFlowShape__00000007_)
	...
	__Participant__00000001_.TaskWhoseInDataFlowsNodeIsExpanded = append(__Participant__00000001_.TaskWhoseInDataFlowsNodeIsExpanded, __Task__00000003_)
