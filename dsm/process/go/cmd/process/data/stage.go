...
func _(stage *models.Stage) {
	...
	__Note__00000000_ := (&models.Note{Name: `Note on the diagram with A B C`}).Stage(stage)
	...
	__Note__00000000_.Name = `Note on the diagram with A B C`
	...
	__NoteShape__00000000_.X = 75.261263
	__NoteShape__00000000_.Y = 132.057359
	__NoteShape__00000000_.Width = 231.000000
