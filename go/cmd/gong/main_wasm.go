...
import (
	...
	"github.com/fullstack-lang/gong/go/level1stack"
...
func main() {
	...
	log.Println("Initializing gong WASM Backend...")
	...
	stack := level1stack.NewLevel1StackDelta("gong", unmarshallFromCode, marshallOnCommit, true, embeddedDiagrams, true)
