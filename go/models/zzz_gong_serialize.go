...
func SerializeStage2(stage *Stage, filename string, addIDs bool) {
	...
	{
		// insertion point
		SerializeExcelizePointerToGongstruct2[*GongBasicField](stage, f, addIDs)
		SerializeExcelizePointerToGongstruct2[*GongEnum](stage, f, addIDs)
		SerializeExcelizePointerToGongstruct2[*GongEnumValue](stage, f, addIDs)
		SerializeExcelizePointerToGongstruct2[*GongLink](stage, f, addIDs)
		SerializeExcelizePointerToGongstruct2[*GongNote](stage, f, addIDs)
		SerializeExcelizePointerToGongstruct2[*GongStruct](stage, f, addIDs)
		SerializeExcelizePointerToGongstruct2[*GongTimeField](stage, f, addIDs)
		SerializeExcelizePointerToGongstruct2[*MetaReference](stage, f, addIDs)
		SerializeExcelizePointerToGongstruct2[*ModelPkg](stage, f, addIDs)
		SerializeExcelizePointerToGongstruct2[*PointerToGongStructField](stage, f, addIDs)
		SerializeExcelizePointerToGongstruct2[*SliceOfPointerToGongStructField](stage, f, addIDs)
	}
