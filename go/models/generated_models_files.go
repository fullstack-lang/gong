...
var GeneratedModelFiles = []string{
	...
	string(LegacyGeneratedGongCoderGoFilePath),
	string(LegacyGeneratedGongAstGoFilePath),
	string(LegacyGeneratedGongSerializeGoFilePath),
	string(LegacyGeneratedGongSlicesGoFilePath),
	string(LegacyGeneratedGongMarshallGoFilePath),
	string(LegacyGeneratedGongGraphGoFilePath),
	string(LegacyGeneratedGongEnumGoFilePath),
	string(LegacyGeneratedGongCallbacksGoFilePath),
	string(LegacyGeneratedGongReverseGoFilePath),
	string(LegacyGeneratedGongOrchestratorGoFilePath),
	string(LegacyGeneratedGongWopGoFilePath),
}

type GeneratedGoFilePath string

const (
	LegacyGeneratedGongGoFilePath             GeneratedGoFilePath = "gong.go"
	LegacyGeneratedGongEnumGoFilePath         GeneratedGoFilePath = "gong_enum.go"
	LegacyGeneratedGongMarshallGoFilePath     GeneratedGoFilePath = "gong_marshall.go"
	LegacyGeneratedGongGraphGoFilePath        GeneratedGoFilePath = "gong_graph.go"
	LegacyGeneratedGongSlicesGoFilePath       GeneratedGoFilePath = "gong_slices.go"
	LegacyGeneratedGongCoderGoFilePath        GeneratedGoFilePath = "gong_coder.go"
	LegacyGeneratedGongAstGoFilePath          GeneratedGoFilePath = "gong_ast.go"
	LegacyGeneratedGongCallbacksGoFilePath    GeneratedGoFilePath = "gong_callbacks.go"
	LegacyGeneratedGongOrchestratorGoFilePath GeneratedGoFilePath = "gong_orchestrator.go"
	LegacyGeneratedGongReverseGoFilePath      GeneratedGoFilePath = "gong_reverse.go"
