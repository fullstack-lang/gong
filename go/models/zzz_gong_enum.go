...
func (generatedgofilepath GeneratedGoFilePath) ToString() (res string) {
	...
	case GeneratedGongAstGoFilePath:
		res = "zzz_gong_ast.go"
	case GeneratedGongAstGo2FilePath:
		res = "zzz_gong_ast2.go"
	...
	case GeneratedGongDiffGoFilePath:
		res = "zzz_gong_diff.go"
	...
	case GeneratedGongProbeGoFilePath:
		res = "zzz_gong_probe.go"
	...
	case GeneratedGongStageSetGoFilePath:
		res = "zzz_gong_stageset.go"
...
func (generatedgofilepath *GeneratedGoFilePath) FromString(input string) (err error) {
	...
	case "zzz_gong_ast.go":
		*generatedgofilepath = GeneratedGongAstGoFilePath
		return
	case "zzz_gong_ast2.go":
		*generatedgofilepath = GeneratedGongAstGo2FilePath
		return
	...
	case "zzz_gong_coder.go":
		*generatedgofilepath = GeneratedGongCoderGoFilePath
		return
	case "zzz_gong_diff.go":
		*generatedgofilepath = GeneratedGongDiffGoFilePath
		return
	...
	case "zzz_gong_orchestrator_wme.go":
		*generatedgofilepath = GeneratedGongOrchestratorWMEGoFilePath
		return
	case "zzz_gong_probe.go":
		*generatedgofilepath = GeneratedGongProbeGoFilePath
		return
	...
	case "zzz_gong_slices.go":
		*generatedgofilepath = GeneratedGongSlicesGoFilePath
		return
	case "zzz_gong_stageset.go":
		*generatedgofilepath = GeneratedGongStageSetGoFilePath
		return
...
func (generatedgofilepath *GeneratedGoFilePath) ToCodeString() (res string) {
	...
	case GeneratedGongAstGo2FilePath:
		res = "GeneratedGongAstGo2FilePath"
	case GeneratedGongCallbacksGoFilePath:
	...
	case GeneratedGongDiffGoFilePath:
		res = "GeneratedGongDiffGoFilePath"
	case GeneratedGongEnumGoFilePath:
	...
	case GeneratedGongProbeGoFilePath:
		res = "GeneratedGongProbeGoFilePath"
	case GeneratedGongReverseGoFilePath:
	...
	case GeneratedGongStageSetGoFilePath:
		res = "GeneratedGongStageSetGoFilePath"
	case GeneratedGongWopGoFilePath:
...
func (generatedgofilepath GeneratedGoFilePath) Codes() (res []string) {
	...
	res = append(res, "GeneratedGongAstGo2FilePath")
	...
	res = append(res, "GeneratedGongProbeGoFilePath")
	...
	res = append(res, "GeneratedGongStageSetGoFilePath")
...
func (generatedgofilepath GeneratedGoFilePath) CodeValues() (res []string) {
	...
	res = append(res, "zzz_gong_ast2.go")
