...
`,
	...
	{ path: '{{PkgPathRootWithoutSlashes}}-{{structname}}s', component: {{Structname}}sTableComponent, outlet: '{{PkgPathRootWithoutSlashes}}table' },
	{ path: '{{PkgPathRootWithoutSlashes}}-{{structname}}-adder', component: {{Structname}}DetailComponent, outlet: '{{PkgPathRootWithoutSlashes}}editor' },
	{ path: '{{PkgPathRootWithoutSlashes}}-{{structname}}-adder/:id/:association', component: {{Structname}}DetailComponent, outlet: '{{PkgPathRootWithoutSlashes}}editor' },
	{ path: '{{PkgPathRootWithoutSlashes}}-{{structname}}-detail/:id', component: {{Structname}}DetailComponent, outlet: '{{PkgPathRootWithoutSlashes}}editor' },
	{ path: '{{PkgPathRootWithoutSlashes}}-{{structname}}-presentation/:id', component: {{Structname}}PresentationComponent, outlet: '{{PkgPathRootWithoutSlashes}}presentation' },
