...
func SerializeStage(stage *StageStruct, filename string) {
	...
	{
		// insertion point
		SerializeExcelizePointerToGongstruct[*GongBasicField](stage, f)
		SerializeExcelizePointerToGongstruct[*GongEnum](stage, f)
		SerializeExcelizePointerToGongstruct[*GongEnumValue](stage, f)
		SerializeExcelizePointerToGongstruct[*GongLink](stage, f)
		...
		SerializeExcelizePointerToGongstruct[*SliceOfPointerToGongStructField](stage, f)
	}
