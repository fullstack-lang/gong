...
const NgServiceTmpl = `// generated code, do not edit
...
export class {{Structname}}Service {
  ...
  postFront({{structname}}: {{Structname}}, Name: string): Observable<{{Structname}}API> {
    ...
    return this.http.post<{{Structname}}API>(this.{{structname}}sUrl, {{structname}}API, httpOptions).pipe(
      tap(_ => {
      }),
...
const NgServiceUpdateOnlyTmpl = `// generated code, do not edit
// generated by ng_file_service_ts
import { Injectable, Component, Inject, DOCUMENT } from '@angular/core';
import { HttpParams } from '@angular/common/http';
import { HttpClient, HttpHeaders } from '@angular/common/http';
...
var NgServiceSubTemplateCode map[NgServiceTsSubTemplate]string = map[NgServiceTsSubTemplate]string{
	NgServiceTSPointerToGongStructImports: `
import { {{AssocStructName}}API } from './{{assocStructName}}-api'`,
}

type NgServiceTsSubTemplate int

const (
	NgServiceTSPointerToGongStructImports NgServiceTsSubTemplate = iota
)
