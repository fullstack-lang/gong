	...
	for _, _struct := range mdlPkg.GongStructs {
		...
		for _, field := range _struct.Fields {
			...
			case *models.GongBasicField:
				...
				if field.GongEnum != nil {
					...
					var importToInsert = models.Replace1(
					...
					var declarationToInsert = models.Replace1(
					...
					var initsToInsert = models.Replace1(
				...
				if field.GetBasicKind() == types.Bool {
					TSinsertions[NgDetailTsInsertionPerStructDeclarations] += models.Replace1(
						NgDetailSubTemplateCode[NgDetailTSBooleanDeclarations],
						"{{FieldName}}", field.Name)

					TSinsertions[NgDetailTsInsertionPerStructRecoveries] += models.Replace1(
						NgDetailSubTemplateCode[NgDetailTSBooleanRecoveries],
						"{{FieldName}}", field.Name)

					TSinsertions[NgDetailTsInsertionPerStructSaves] += models.Replace1(
		...
		for _, field := range _struct.Fields {
			...
			case *models.GongBasicField:
				...
				if field.GongEnum != nil {
					...
					HtmlInsertions[NgDetailHtmlInsertionPerStructFields] +=
						models.Replace2(NgDetailHtmlSubTemplateCode[NgDetailHtmlEnum],
							"{{FieldName}}", field.Name,
							"{{EnumName}}", field.GongEnum.Name)
				...
				} else // basic field (not enum)
				{
					if field.GetBasicKind() == types.Bool {
						HtmlInsertions[NgDetailHtmlInsertionPerStructFields] +=
							models.Replace1(NgDetailHtmlSubTemplateCode[NgDetailHtmlBool],
								"{{FieldName}}", field.Name)
						...
						case types.Int, types.Int64, types.Float64:
							...
							HtmlInsertions[NgDetailHtmlInsertionPerStructFields] +=
								models.Replace2(NgDetailHtmlSubTemplateCode[NgDetailHtmlBasicField],
									"{{FieldName}}", field.Name,
									"{{TypeInput}}", TypeInput)
						case types.String:
							TypeInput = "name=\"\" [ngModelOptions]=\"{standalone: true}\""
							HtmlInsertions[NgDetailHtmlInsertionPerStructFields] +=
								models.Replace2(NgDetailHtmlSubTemplateCode[NgDetailHtmlBasicStringField],
									"{{FieldName}}", field.Name,
									"{{TypeInput}}", TypeInput)
						}
						...
						HtmlInsertions[NgDetailHtmlInsertionPerStructFields] +=
							models.Replace1(NgDetailHtmlSubTemplateCode[NgDetailHtmlTimeDuration],
								"{{FieldName}}", field.Name)
					}
				}
			case *models.GongTimeField:
				...
				HtmlInsertions[NgDetailHtmlInsertionPerStructFields] +=
					models.Replace1(NgDetailHtmlSubTemplateCode[NgDetailHtmlTimeField],
						"{{FieldName}}", field.Name)

			case *models.PointerToGongStructField:

				HtmlInsertions[NgDetailHtmlInsertionPerStructFields] +=
					models.Replace3(NgDetailHtmlSubTemplateCode[NgDetailPointerToStructHtmlFormField],
						"{{FieldName}}", field.Name,
						"{{AssocStructName}}", field.GongStruct.Name,
						"{{assocStructName}}", strings.ToLower(field.GongStruct.Name))
			case *models.SliceOfPointerToGongStructField:

				htmlCodeForField := models.Replace3(NgDetailHtmlSubTemplateCode[NgDetailSliceOfPointerToStructHtml],
					"{{FieldName}}", field.Name,
					"{{AssocStructName}}", field.GongStruct.Name,
					"{{assocStructName}}", strings.ToLower(field.GongStruct.Name))
				...
				if strings.HasSuffix(field.Name, "Use") {
					...
					case *models.PointerToGongStructField:
						...
						addedHtmlCode := models.Replace5(NgDetailHtmlSubTemplateCode[NgDetailSliceOfPointerToStructManyManyHtml],
							"{{FieldName}}", field.Name,
							"{{AssocStructName}}", field.GongStruct.Name,
							"{{assocStructName}}", strings.ToLower(field.GongStruct.Name),
			...
			for _, field := range __struct.Fields {
				...
				case *models.SliceOfPointerToGongStructField:
					...
					if field.GongStruct == _struct {
						var importToInsert = models.Replace2(
						...
						TSinsertions[NgDetailTsInsertionPerStructEnumFieldDeclarations] +=
							models.Replace2(NgDetailSubTemplateCode[NgDetailTSReversePointerToSliceOfGongStructStateEnumDeclaration],
								"{{FieldName}}", field.Name,
								"{{AssocStructName}}", __struct.Name)

						TSinsertions[NgDetailTsInsertionPerStructCaseInitFieldDeclarations] +=
							models.Replace2(NgDetailSubTemplateCode[NgDetailTSReversePointerToSliceOfGongStructStateCaseComputation],
								"{{FieldName}}", field.Name,
								"{{AssocStructName}}", __struct.Name)

						TSinsertions[NgDetailTsInsertionPerStructCaseSetField] +=
							models.Replace2(NgDetailSubTemplateCode[NgDetailTSReversePointerToSliceOfGongStructStateCaseSetField],
								"{{FieldName}}", field.Name,
								"{{AssocStructName}}", __struct.Name)

						TSinsertions[NgDetailTsInsertionPerStructReversePointerSaveWhenUpdate] +=
							models.Replace2(NgDetailSubTemplateCode[NgDetailTSReversePointerToSliceOfGongStructSavesWhenUpdate],
								"{{FieldName}}", field.Name,
								"{{AssocStructName}}", __struct.Name)

						HtmlInsertions[NgDetailHtmlInsertionPerStructFields] +=
							models.Replace3(NgDetailHtmlSubTemplateCode[NgDetailSliceOfPointerToStructReverseHtml],
								"{{FieldName}}", field.Name,
								"{{AssocStructName}}", __struct.Name,
								"{{assocStructName}}", strings.ToLower(__struct.Name))
					}
