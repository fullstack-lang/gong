...
func (backRepoStruct *BackRepoStruct) broadcastNbCommitToBack() {
	...
	log.Println("{{PkgPathRoot}}, begin of broadcastNbCommitToBack", backRepoStruct.CommitFromBackNb)
	...
	log.Println("{{PkgPathRoot}}, end of broadcastNbCommitToBack", backRepoStruct.CommitFromBackNb)
