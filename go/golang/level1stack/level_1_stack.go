...
const Level1StackInstanceSplitliteTemplate = `// do not modify, generated file
package level1stack
...
func (impl *BeforeCommitImplementation) BeforeCommit(stage *models.Stage) {
` + stackInstanceTemplateSplitliteEpilogue

const stackInstanceTemplateSplitliteEpilogue = `
