...
const PackageMainWasmLevel1Stack = `//go:build js && wasm
...
func main() {
	...
	stack := level1stack.NewLevel1StackDelta("{{pkgname}}", unmarshallFromCode, marshallOnCommit, true, embeddedDiagrams, true)
