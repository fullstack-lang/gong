...
func (stage *Stage) Squash() {
	...
	// insertion point for clear references{{` + string(rune(ModelGongStructInsertionClearReferences)) + `}}
	stage.ComputeInstancesNb()
	if stage.OnInitCommitCallback != nil {
		stage.OnInitCommitCallback.BeforeCommit(stage)
	}
...
func (stage *Stage) recomputeOrders() {
	// insertion point for max order recomputation{{` + string(rune(ModelGongStructResetHard)) + `}}
...
func NewStage(name string) (stage *Stage) {
	stage = &Stage{ // insertion point for array initiatialisation{{` + string(rune(ModelGongStructInsertionArrayInitialisation)) + `}}
		// end of insertion point
		...
		// end of insertion point
		GongUnmarshallers: map[string]ModelUnmarshaller{ // insertion point for unmarshallers{{` + string(rune(ModelGongNamedStructsUnmarshallers)) + `}}
			// end of insertion point
		},
...
func (stage *Stage) GetInstancesSet[Type PointerToGongstruct]() {{mapReturnType}} {
	var ret Type
...
func GetGongstructInstancesSetFromPointerType[Type PointerToGongstruct](stage *Stage) {{mapReturnType}} {
