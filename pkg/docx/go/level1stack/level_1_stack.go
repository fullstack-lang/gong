...
import (
	...
	embeddedgo "github.com/fullstack-lang/gong/pkg/docx/go"
...
func (impl *BeforeCommitImplementation) BeforeCommit(stage *models.Stage) {
	...
	stage.MarshallFile(fmt.Sprintf("./%s", filename), "github.com/fullstack-lang/gong/pkg/docx/go/models", packageName)
}
