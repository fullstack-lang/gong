...
func (controller *Controller) GetLogoOnTheRights(w http.ResponseWriter, r *http.Request) {
	...
	writeJSON(w, http.StatusOK, logoontherightAPIs)
}
...
//	Responses:
//	  200: nodeDBResponse
func (controller *Controller) PostLogoOnTheRight(w http.ResponseWriter, r *http.Request) {
...
//
//	200: logoontherightDBResponse
func (controller *Controller) GetLogoOnTheRight(w http.ResponseWriter, r *http.Request) {
	...
	if _, err := db.First(&logoontherightDB, r.PathValue("id")); err != nil {
		var returnError GenericError
		returnError.Body.Code = http.StatusBadRequest
		returnError.Body.Message = err.Error()
		log.Println(err.Error())
	...
	writeJSON(w, http.StatusOK, logoontherightAPI)
}
...
//
//	200: logoontherightDBResponse
func (controller *Controller) DeleteLogoOnTheRight(w http.ResponseWriter, r *http.Request) {
