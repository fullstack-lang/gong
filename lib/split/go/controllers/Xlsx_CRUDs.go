...
//
//	200: xlsxDBResponse
func (controller *Controller) GetXlsxs(w http.ResponseWriter, r *http.Request) {
	...
	writeJSON(w, http.StatusOK, xlsxAPIs)
}
...
//	Responses:
//	  200: nodeDBResponse
func (controller *Controller) PostXlsx(w http.ResponseWriter, r *http.Request) {
...
//
//	200: xlsxDBResponse
func (controller *Controller) GetXlsx(w http.ResponseWriter, r *http.Request) {
	...
	if _, err := db.First(&xlsxDB, r.PathValue("id")); err != nil {
		var returnError GenericError
		returnError.Body.Code = http.StatusBadRequest
		returnError.Body.Message = err.Error()
		log.Println(err.Error())
	...
	writeJSON(w, http.StatusOK, xlsxAPI)
}
...
//
//	200: xlsxDBResponse
func (controller *Controller) DeleteXlsx(w http.ResponseWriter, r *http.Request) {
