...
func (controller *Controller) GetMarkdowns(w http.ResponseWriter, r *http.Request) {
	...
	writeJSON(w, http.StatusOK, markdownAPIs)
}
...
//	Responses:
//	  200: nodeDBResponse
func (controller *Controller) PostMarkdown(w http.ResponseWriter, r *http.Request) {
...
//
//	200: markdownDBResponse
func (controller *Controller) GetMarkdown(w http.ResponseWriter, r *http.Request) {
	...
	if _, err := db.First(&markdownDB, r.PathValue("id")); err != nil {
		var returnError GenericError
		returnError.Body.Code = http.StatusBadRequest
		returnError.Body.Message = err.Error()
		log.Println(err.Error())
	...
	writeJSON(w, http.StatusOK, markdownAPI)
}
...
//
//	200: markdownDBResponse
func (controller *Controller) DeleteMarkdown(w http.ResponseWriter, r *http.Request) {
