...
func updateAndCommitTablePointerToGongstruct[T models.PointerToGongstruct](
	...
	// insertion point
	case *models.AsSplit:
		updateAndCommitTable[models.AsSplit](probe)
	case *models.AsSplitArea:
		updateAndCommitTable[models.AsSplitArea](probe)
	case *models.Button:
	...
	case *models.Logo:
		updateAndCommitTable[models.Logo](probe)
	case *models.Slider:
		updateAndCommitTable[models.Slider](probe)
	case *models.Split:
		updateAndCommitTable[models.Split](probe)
	case *models.Svg:
	...
	case *models.View:
		updateAndCommitTable[models.View](probe)
	case *models.Xlsx:
		updateAndCommitTable[models.Xlsx](probe)
	default:
