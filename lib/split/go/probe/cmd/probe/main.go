...
import (
	...
	"github.com/fullstack-lang/gong/lib/split/go/level1stack"
...
func executeServer() {
	...
	stack := level1stack.NewLevel1Stack("split", unmarshallFromCode, marshallOnCommit, true, embeddedDiagrams)
