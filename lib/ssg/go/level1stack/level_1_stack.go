...
import (
	...
	"github.com/fullstack-lang/gong/lib/ssg/go/models/probe"
...
func (impl *BeforeCommitImplementation) BeforeCommit(stage *models.Stage) {
	...
	stage.MarshallFile(fmt.Sprintf("./%s", filename), "github.com/fullstack-lang/gong/lib/ssg/go/models", packageName)
}
