...
func _(stage *models.Stage) {
	...
	const __write__local_time = "2025-07-25 08:37:34.268305 CEST"
	const __write__utc_time__ = "2025-07-25 06:37:34.268305 UTC"
	...
	__Chapter__000002_Third_Chapter_ := (&models.Chapter{}).Stage(stage)

	__Content__000000_The_Vera_C_Rubin_Observatory_ := (&models.Content{}).Stage(stage)
...
Site construction began on 14 April 2015 with the ceremonial laying of the first stone.[13][14] The first on-sky observations with the engineering camera occurred on 24 October 2024,[15] while system first light images were released 23 June 2025. Full survey operations are planned to begin later in 2025, due to COVID-related schedule delays.[16] Data is scheduled to become fully public after two years.[17]`
	__Content__000000_The_Vera_C_Rubin_Observatory_.ContentPath = `content`
	__Content__000000_The_Vera_C_Rubin_Observatory_.OutputPath = `public`
	__Content__000000_The_Vera_C_Rubin_Observatory_.LayoutPath = `../../defaults/layouts`
	__Content__000000_The_Vera_C_Rubin_Observatory_.StaticPath = `../../defaults/static`
	__Content__000000_The_Vera_C_Rubin_Observatory_.Target = models.FILE
...
Legend of the table`
	...
	__Content__000000_The_Vera_C_Rubin_Observatory_.Chapters = append(__Content__000000_The_Vera_C_Rubin_Observatory_.Chapters, __Chapter__000000_Getting_Started)
	__Content__000000_The_Vera_C_Rubin_Observatory_.Chapters = append(__Content__000000_The_Vera_C_Rubin_Observatory_.Chapters, __Chapter__000001_Advanced_Topics)
	__Content__000000_The_Vera_C_Rubin_Observatory_.Chapters = append(__Content__000000_The_Vera_C_Rubin_Observatory_.Chapters, __Chapter__000002_Third_Chapter_)
