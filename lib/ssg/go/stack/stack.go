...
import (
	...
	"github.com/fullstack-lang/gong/lib/ssg/go/fullstack"
...
func (impl *BeforeCommitImplementation) BeforeCommit(stage *models.Stage) {
	...
	stage.Checkout()
	stage.Marshall(file, "github.com/fullstack-lang/gong/lib/ssg/go/models", "main")
}
...
func NewStack(
	...
	if withProbe {
		stack.Probe = probe.NewProbe(r, ssg_go.GoModelsDir, ssg_go.GoDiagramsDir,
