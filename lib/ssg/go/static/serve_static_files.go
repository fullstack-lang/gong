...
import (
	...
	"github.com/fullstack-lang/gong/lib/ssg"
...
func ServeStaticFiles(logGINFlag bool) (r *gin.Engine) {
	...
	r.Use(static.Serve("/", EmbedFolder(ssg.NgDistNg, "ng-github.com-fullstack-lang-gong-lib-ssg/dist/ng-github.com-fullstack-lang-gong-lib-ssg/browser")))
