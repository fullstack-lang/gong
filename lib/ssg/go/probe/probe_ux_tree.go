...
func (probe *Probe) ux_tree() {
	...
	for _, gongStruct := range sliceOfGongStructsSorted {
		...
		case "DownloadableFile":
			nodeGongstruct.Name = name
			set := *models.GetGongstructInstancesSetFromPointerType[*models.DownloadableFile](probe.stageOfInterest)
			count := 0
		...
		case "Section":
			nodeGongstruct.Name = name
			set := *models.GetGongstructInstancesSetFromPointerType[*models.Section](probe.stageOfInterest)
			count := 0
