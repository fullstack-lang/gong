...
import (
	...
	"github.com/fullstack-lang/gong/lib/button/go/fullstack"
	"github.com/fullstack-lang/gong/lib/button/go/models"
	"github.com/fullstack-lang/gong/lib/button/go/orm"
	"github.com/fullstack-lang/gong/lib/button/go/probe"
...
func (impl *BeforeCommitImplementation) BeforeCommit(stage *models.StageStruct) {
	...
	stage.Checkout()
	stage.Marshall(file, "github.com/fullstack-lang/gong/lib/button/go/models", "main")
}
...
func NewStack(
	...
	if withProbe {
		stack.Probe = probe.NewProbe(r, button_go.GoModelsDir, button_go.GoDiagramsDir,
