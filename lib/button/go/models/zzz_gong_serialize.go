...
func buildExcelizeFile(stage *Stage, addIDs bool) *excelize.File {
	f := excelize.NewFile()
	{
		...
		stage.SerializeExcelizePointer2[*ButtonToggle](f, addIDs)
		stage.SerializeExcelizePointer2[*Group](f, addIDs)
		stage.SerializeExcelizePointer2[*GroupToogle](f, addIDs)
		stage.SerializeExcelizePointer2[*Layout](f, addIDs)
	}
