...
func (stage *Stage) __gong__buildExcelizeFile(addIDs bool) *excelize.File {
	f := excelize.NewFile()
	{
		...
		}
		{
			...
			stage.SerializeExcelize(f, "ButtonToggle", instances, (*ButtonToggle)(nil).GongGetFieldHeaders(), addIDs)
		}
		{
			var instances []GongstructIF
		...
		}
		{
			...
			stage.SerializeExcelize(f, "GroupToogle", instances, (*GroupToogle)(nil).GongGetFieldHeaders(), addIDs)
		}
		{
			var instances []GongstructIF
			...
			stage.SerializeExcelize(f, "Layout", instances, (*Layout)(nil).GongGetFieldHeaders(), addIDs)
		}
	}
