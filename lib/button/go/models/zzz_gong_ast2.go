...
func (u *ButtonUnmarshaller) UnmarshallField(stage *Stage, i GongstructIF, fieldName string, valueExpr ast.Expr, identifierMap map[string]GongstructIF) error {
	...
	case "Color":
		GongUnmarshallEnum(&instance.Color, valueExpr)
	case "MatButtonType":
...
func (u *ButtonToggleUnmarshaller) Initialize(stage *Stage, instanceName string, preserveOrder bool) (GongstructIF, error) {
	instance := new(ButtonToggle)
	instance.Name = instanceName
	if !preserveOrder {
		instance.Stage(stage)
	} else {
...
func (u *GroupUnmarshaller) UnmarshallField(stage *Stage, i GongstructIF, fieldName string, valueExpr ast.Expr, identifierMap map[string]GongstructIF) error {
	...
	case "NbColumns":
		instance.NbColumns = GongExtractInt(valueExpr)
	}
	return nil
}
...
func (u *GroupToogleUnmarshaller) Initialize(stage *Stage, instanceName string, preserveOrder bool) (GongstructIF, error) {
	instance := new(GroupToogle)
	instance.Name = instanceName
	if !preserveOrder {
		instance.Stage(stage)
	} else {
...
func (u *GroupToogleUnmarshaller) UnmarshallField(stage *Stage, i GongstructIF, fieldName string, valueExpr ast.Expr, identifierMap map[string]GongstructIF) error {
	...
	case "Percentage":
		instance.Percentage = GongExtractFloat(valueExpr)
	case "ButtonToggles":
		GongUnmarshallSliceOfPointers(&instance.ButtonToggles, valueExpr, identifierMap)
	case "IsSingleSelector":
		instance.IsSingleSelector = GongExtractBool(valueExpr)
	}
	return nil
}
...
func (u *LayoutUnmarshaller) UnmarshallField(stage *Stage, i GongstructIF, fieldName string, valueExpr ast.Expr, identifierMap map[string]GongstructIF) error {
	...
	case "GroupToogles":
		GongUnmarshallSliceOfPointers(&instance.GroupToogles, valueExpr, identifierMap)
	}
	return nil
}
