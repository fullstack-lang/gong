...
import (
	...
	"github.com/fullstack-lang/gong/lib/button/go/stack"
	"github.com/fullstack-lang/gong/lib/button/go/static"
...
func executeServer() {
	...
	stack := stack.NewStack(r, "button", unmarshallFromCode, marshallOnCommit, "", embeddedDiagrams, true)
