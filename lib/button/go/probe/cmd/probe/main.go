...
import (
	...
	"github.com/fullstack-lang/gong/lib/button/go/level1stack"
...
func executeServer() {
	...
	stack := level1stack.NewLevel1Stack("button", unmarshallFromCode, marshallOnCommit, true, embeddedDiagrams)
