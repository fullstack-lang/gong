...
func (nodeImplGongstruct *TreeNodeImplGongstruct) OnAfterUpdate(
	...
	if nodeImplGongstruct.gongStruct.GetName() == "ButtonToggle" {
		updateProbeTable[*models.ButtonToggle](nodeImplGongstruct.probe)
	}
	...
	if nodeImplGongstruct.gongStruct.GetName() == "GroupToogle" {
		updateProbeTable[*models.GroupToogle](nodeImplGongstruct.probe)
	}
	if nodeImplGongstruct.gongStruct.GetName() == "Layout" {
		updateProbeTable[*models.Layout](nodeImplGongstruct.probe)
	}
