...
import (
	...
	"github.com/fullstack-lang/gong/lib/button"
...
func ServeStaticFiles(logGINFlag bool) (r *gin.Engine) {
	...
	r.Use(static.Serve("/", EmbedFolder(button.NgDistNg, "ng-github.com-fullstack-lang-gong-lib-button/dist/ng-github.com-fullstack-lang-gong-lib-button/browser")))
