...
export class LayoutService {
  ...
  constructor(
    ...
    this.layoutsUrl = origin + '/api/github.com/fullstack-lang/gong/lib/button/go/v1/layouts';
  }
  ...
  postFront(layout: Layout, Name: string): Observable<LayoutAPI> {
    ...
    return this.http.post<LayoutAPI>(this.layoutsUrl, layoutAPI, httpOptions).pipe(
      tap(_ => {
      }),
