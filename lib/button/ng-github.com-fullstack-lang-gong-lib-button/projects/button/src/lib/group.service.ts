...
export class GroupService {
  ...
  constructor(
    ...
    this.groupsUrl = origin + '/api/github.com/fullstack-lang/gong/lib/button/go/v1/groups';
  }
  ...
  postFront(group: Group, Name: string): Observable<GroupAPI> {
    ...
    return this.http.post<GroupAPI>(this.groupsUrl, groupAPI, httpOptions).pipe(
      tap(_ => {
      }),
