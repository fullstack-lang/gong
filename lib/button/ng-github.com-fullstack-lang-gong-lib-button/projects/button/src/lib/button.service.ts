...
export class ButtonService {
  ...
  constructor(
    ...
    this.buttonsUrl = origin + '/api/github.com/fullstack-lang/gong/lib/button/go/v1/buttons';
  }
  ...
  postFront(button: Button, Name: string): Observable<ButtonAPI> {
    ...
    return this.http.post<ButtonAPI>(this.buttonsUrl, buttonAPI, httpOptions).pipe(
      tap(_ => {
      }),
