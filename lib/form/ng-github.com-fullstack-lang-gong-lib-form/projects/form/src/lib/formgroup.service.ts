...
export class FormGroupService {
  ...
  constructor(
    ...
    this.formgroupsUrl = origin + '/api/github.com/fullstack-lang/gong/lib/form/go/v1/formgroups';
  }
  ...
  postFront(formgroup: FormGroup, Name: string): Observable<FormGroupAPI> {
    ...
    return this.http.post<FormGroupAPI>(this.formgroupsUrl, formgroupAPI, httpOptions).pipe(
      tap(_ => {
      }),
