...
export class OptionService {
  ...
  constructor(
    ...
    this.optionsUrl = origin + '/api/github.com/fullstack-lang/gong/lib/form/go/v1/options';
  }
  ...
  postFront(option: Option, Name: string): Observable<OptionAPI> {
    ...
    return this.http.post<OptionAPI>(this.optionsUrl, optionAPI, httpOptions).pipe(
      tap(_ => {
      }),
