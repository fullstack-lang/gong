...
export class FormSortAssocButtonService {
  ...
  constructor(
    ...
    this.formsortassocbuttonsUrl = origin + '/api/github.com/fullstack-lang/gong/lib/form/go/v1/formsortassocbuttons';
  }
  ...
  postFront(formsortassocbutton: FormSortAssocButton, Name: string): Observable<FormSortAssocButtonAPI> {
    ...
    return this.http.post<FormSortAssocButtonAPI>(this.formsortassocbuttonsUrl, formsortassocbuttonAPI, httpOptions).pipe(
      tap(_ => {
      }),
