...
export class FormFieldIntService {
  ...
  constructor(
    ...
    this.formfieldintsUrl = origin + '/api/github.com/fullstack-lang/gong/lib/form/go/v1/formfieldints';
  }
  ...
  postFront(formfieldint: FormFieldInt, Name: string): Observable<FormFieldIntAPI> {
    ...
    return this.http.post<FormFieldIntAPI>(this.formfieldintsUrl, formfieldintAPI, httpOptions).pipe(
      tap(_ => {
      }),
