...
export class FormFieldDateService {
  ...
  constructor(
    ...
    this.formfielddatesUrl = origin + '/api/github.com/fullstack-lang/gong/lib/form/go/v1/formfielddates';
  }
  ...
  postFront(formfielddate: FormFieldDate, Name: string): Observable<FormFieldDateAPI> {
    ...
    return this.http.post<FormFieldDateAPI>(this.formfielddatesUrl, formfielddateAPI, httpOptions).pipe(
      tap(_ => {
      }),
