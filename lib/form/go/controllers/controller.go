...
import (
	...
	form_orm "github.com/fullstack-lang/gong/lib/form/go/orm"
...
type Controller struct {
	...
	Map_BackRepos map[string]*form_orm.BackRepoStruct
...
func GetController() *Controller {
	doControllerInitOnce.Do(func() {
		_controllerSingloton = &Controller{
			Map_BackRepos: make(map[string]*form_orm.BackRepoStruct),
		}
	})
	return _controllerSingloton
}

func (controller *Controller) AddBackRepo(backRepo *form_orm.BackRepoStruct, stackPath string) {
