...
func (controller *Controller) GetFormFieldStrings(w http.ResponseWriter, r *http.Request) {
	...
	if len(_values) == 1 {
		...
		if len(value) == 1 {
			stackPath = value[0]
			// log.Println("GetFormFieldStrings", "Name", stackPath)
		}
	}
	...
	writeJSON(w, http.StatusOK, formfieldstringAPIs)
}
...
//	Responses:
//	  200: nodeDBResponse
func (controller *Controller) PostFormFieldString(w http.ResponseWriter, r *http.Request) {
	...
	if len(_values) == 1 {
		...
		if len(value) == 1 {
			stackPath = value[0]
			// log.Println("PostFormFieldStrings", "Name", stackPath)
		}
	}
	backRepo := controller.Map_BackRepos[stackPath]
	if backRepo == nil {
	...
	if formfieldstring != nil {
		backRepo.GetStage().AfterCreateFromFront(formfieldstring)
	}
...
//
//	200: formfieldstringDBResponse
func (controller *Controller) GetFormFieldString(w http.ResponseWriter, r *http.Request) {
	...
	if len(_values) == 1 {
		...
		if len(value) == 1 {
			stackPath = value[0]
			// log.Println("GetFormFieldString", "Name", stackPath)
		}
	}
	backRepo := controller.Map_BackRepos[stackPath]
	if backRepo == nil {
	...
	if _, err := db.First(&formfieldstringDB, r.PathValue("id")); err != nil {
		var returnError GenericError
		returnError.Body.Code = http.StatusBadRequest
		returnError.Body.Message = err.Error()
		log.Println(err.Error())
	...
	writeJSON(w, http.StatusOK, formfieldstringAPI)
}
...
//
//	200: formfieldstringDBResponse
func (controller *Controller) DeleteFormFieldString(w http.ResponseWriter, r *http.Request) {
	...
	if len(_values) == 1 {
		...
		if len(value) == 1 {
			stackPath = value[0]
			// log.Println("DeleteFormFieldString", "Name", stackPath)
		}
	}
	backRepo := controller.Map_BackRepos[stackPath]
	if backRepo == nil {
	...
	if formfieldstringStaged != nil {
		backRepo.GetStage().AfterDeleteFromFront(formfieldstringStaged, formfieldstringDeleted)
	}
