...
func (controller *Controller) GetFormEditAssocButtons(w http.ResponseWriter, r *http.Request) {
	...
	if len(_values) == 1 {
		...
		if len(value) == 1 {
			stackPath = value[0]
			// log.Println("GetFormEditAssocButtons", "Name", stackPath)
		}
	}
	...
	writeJSON(w, http.StatusOK, formeditassocbuttonAPIs)
}
...
//	Responses:
//	  200: nodeDBResponse
func (controller *Controller) PostFormEditAssocButton(w http.ResponseWriter, r *http.Request) {
	...
	if len(_values) == 1 {
		...
		if len(value) == 1 {
			stackPath = value[0]
			// log.Println("PostFormEditAssocButtons", "Name", stackPath)
		}
	}
	backRepo := controller.Map_BackRepos[stackPath]
	if backRepo == nil {
...
//
//	200: formeditassocbuttonDBResponse
func (controller *Controller) GetFormEditAssocButton(w http.ResponseWriter, r *http.Request) {
	...
	if len(_values) == 1 {
		...
		if len(value) == 1 {
			stackPath = value[0]
			// log.Println("GetFormEditAssocButton", "Name", stackPath)
		}
	}
	backRepo := controller.Map_BackRepos[stackPath]
	if backRepo == nil {
	...
	if _, err := db.First(&formeditassocbuttonDB, r.PathValue("id")); err != nil {
		var returnError GenericError
		returnError.Body.Code = http.StatusBadRequest
		returnError.Body.Message = err.Error()
		log.Println(err.Error())
	...
	writeJSON(w, http.StatusOK, formeditassocbuttonAPI)
}
...
//
//	200: formeditassocbuttonDBResponse
func (controller *Controller) DeleteFormEditAssocButton(w http.ResponseWriter, r *http.Request) {
	...
	if len(_values) == 1 {
		...
		if len(value) == 1 {
			stackPath = value[0]
			// log.Println("DeleteFormEditAssocButton", "Name", stackPath)
		}
	}
	backRepo := controller.Map_BackRepos[stackPath]
	if backRepo == nil {
