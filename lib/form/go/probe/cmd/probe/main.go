...
import (
	...
	"github.com/fullstack-lang/gong/lib/form/go/stack"
	"github.com/fullstack-lang/gong/lib/form/go/static"
...
func executeServer() {
	...
	stack := stack.NewStack(r, "form", unmarshallFromCode, marshallOnCommit, "", embeddedDiagrams, true)
