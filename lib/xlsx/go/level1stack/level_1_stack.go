...
import (
	...
	"github.com/fullstack-lang/gong/lib/xlsx/go/models/probe"

	embeddedgo "github.com/fullstack-lang/gong/lib/xlsx/go"
...
func (impl *BeforeCommitImplementation) BeforeCommit(stage *models.Stage) {
	...
	stage.MarshallFile(fmt.Sprintf("./%s", filename), "github.com/fullstack-lang/gong/lib/xlsx/go/models", packageName)
}
