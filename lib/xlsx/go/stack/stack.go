...
import (
	...
	"github.com/fullstack-lang/gong/lib/xlsx/go/fullstack"
	"github.com/fullstack-lang/gong/lib/xlsx/go/models"
	"github.com/fullstack-lang/gong/lib/xlsx/go/orm"
	"github.com/fullstack-lang/gong/lib/xlsx/go/probe"
...
func (impl *BeforeCommitImplementation) BeforeCommit(stage *models.Stage) {
	...
	stage.Checkout()
	stage.Marshall(file, "github.com/fullstack-lang/gong/lib/xlsx/go/models", packageName)
}
...
func NewStack(
	...
	if withProbe {
		stack.Probe = probe.NewProbe(r, xlsx_go.GoModelsDir, xlsx_go.GoDiagramsDir,
