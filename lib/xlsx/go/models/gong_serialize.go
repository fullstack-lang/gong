...
func SerializeStage(stage *StageStruct, filename string) {
	...
	{
		// insertion point
		SerializeExcelizePointerToGongstruct[*DisplaySelection](stage, f)
		SerializeExcelizePointerToGongstruct[*XLCell](stage, f)
		SerializeExcelizePointerToGongstruct[*XLFile](stage, f)
		SerializeExcelizePointerToGongstruct[*XLRow](stage, f)
		SerializeExcelizePointerToGongstruct[*XLSheet](stage, f)
	}
