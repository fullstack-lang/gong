...
func (u *DisplaySelectionUnmarshaller) Initialize(stage *Stage, instanceName string, preserveOrder bool) (GongstructIF, error) {
...
func (u *XLCellUnmarshaller) Initialize(stage *Stage, instanceName string, preserveOrder bool) (GongstructIF, error) {
	instance := new(XLCell)
	instance.Name = instanceName
	if !preserveOrder {
		instance.Stage(stage)
...
func (u *XLFileUnmarshaller) Initialize(stage *Stage, instanceName string, preserveOrder bool) (GongstructIF, error) {
	instance := new(XLFile)
	instance.Name = instanceName
	if !preserveOrder {
		instance.Stage(stage)
...
func (u *XLRowUnmarshaller) Initialize(stage *Stage, instanceName string, preserveOrder bool) (GongstructIF, error) {
	instance := new(XLRow)
	instance.Name = instanceName
	if !preserveOrder {
		instance.Stage(stage)
...
func (u *XLSheetUnmarshaller) Initialize(stage *Stage, instanceName string, preserveOrder bool) (GongstructIF, error) {
