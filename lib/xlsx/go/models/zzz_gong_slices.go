...
func (displayselection *DisplaySelection) GongMarshallIdentifier(stage *Stage) (decl string) {
	...
	decl = strings.ReplaceAll(decl, "{{GeneratedFieldNameValue}}", fmt.Sprintf("%q", displayselection.Name))
	return
}
...
func (xlcell *XLCell) GongMarshallIdentifier(stage *Stage) (decl string) {
	...
	decl = strings.ReplaceAll(decl, "{{GeneratedFieldNameValue}}", fmt.Sprintf("%q", xlcell.Name))
	return
}
...
func (xlfile *XLFile) GongMarshallIdentifier(stage *Stage) (decl string) {
	...
	decl = strings.ReplaceAll(decl, "{{GeneratedFieldNameValue}}", fmt.Sprintf("%q", xlfile.Name))
	return
}
...
func (xlrow *XLRow) GongMarshallIdentifier(stage *Stage) (decl string) {
	...
	decl = strings.ReplaceAll(decl, "{{GeneratedFieldNameValue}}", fmt.Sprintf("%q", xlrow.Name))
	return
}
...
func (xlsheet *XLSheet) GongMarshallIdentifier(stage *Stage) (decl string) {
	...
	decl = strings.ReplaceAll(decl, "{{GeneratedFieldNameValue}}", fmt.Sprintf("%q", xlsheet.Name))
	return
}
