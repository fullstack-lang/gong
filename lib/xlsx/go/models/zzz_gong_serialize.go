...
func SerializeStage2(stage *Stage, filename string, addIDs bool) {
	...
	{
		// insertion point
		SerializeExcelizePointerToGongstruct2[*DisplaySelection](stage, f, addIDs)
		SerializeExcelizePointerToGongstruct2[*XLCell](stage, f, addIDs)
		SerializeExcelizePointerToGongstruct2[*XLFile](stage, f, addIDs)
		SerializeExcelizePointerToGongstruct2[*XLRow](stage, f, addIDs)
		SerializeExcelizePointerToGongstruct2[*XLSheet](stage, f, addIDs)
	}
