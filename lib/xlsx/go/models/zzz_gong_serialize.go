...
func (stage *Stage) __gong__buildExcelizeFile(addIDs bool) *excelize.File {
	f := excelize.NewFile()
	{
		// insertion point
		{
			...
			stage.SerializeExcelize(f, "DisplaySelection", instances, (*DisplaySelection)(nil).GongGetFieldHeaders(), addIDs)
		}
		{
			var instances []GongstructIF
			...
			stage.SerializeExcelize(f, "XLCell", instances, (*XLCell)(nil).GongGetFieldHeaders(), addIDs)
		}
		{
			var instances []GongstructIF
			...
			stage.SerializeExcelize(f, "XLFile", instances, (*XLFile)(nil).GongGetFieldHeaders(), addIDs)
		}
		{
			var instances []GongstructIF
			...
			stage.SerializeExcelize(f, "XLRow", instances, (*XLRow)(nil).GongGetFieldHeaders(), addIDs)
		}
		{
			var instances []GongstructIF
			...
			stage.SerializeExcelize(f, "XLSheet", instances, (*XLSheet)(nil).GongGetFieldHeaders(), addIDs)
		}
	}
