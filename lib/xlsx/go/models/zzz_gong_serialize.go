...
func buildExcelizeFile(stage *Stage, addIDs bool) *excelize.File {
	...
	{
		// insertion point
		stage.SerializeExcelizePointer2[*DisplaySelection](f, addIDs)
		stage.SerializeExcelizePointer2[*XLCell](f, addIDs)
		stage.SerializeExcelizePointer2[*XLFile](f, addIDs)
		stage.SerializeExcelizePointer2[*XLRow](f, addIDs)
		stage.SerializeExcelizePointer2[*XLSheet](f, addIDs)
	}
