...
export const StackType = "github.com/fullstack-lang/gong/lib/gantt/go/models"
...
export class FrontRepoService {
	...
	public connectToWebSocket(GONG__StackPath: string): Observable<FrontRepo> {
		...
		let basePath = 'ws://localhost:8080/api/github.com/fullstack-lang/gong/lib/gantt/go/v1/ws/stage'
