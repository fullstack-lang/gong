...
import (
	...
	"github.com/fullstack-lang/gong/lib/gantt"
...
func ServeStaticFiles(logGINFlag bool) (r *gin.Engine) {
	...
	r.Use(static.Serve("/", EmbedFolder(gantt.NgDistNg, "ng-github.com-fullstack-lang-gong-lib-gantt/dist/ng-github.com-fullstack-lang-gong-lib-gantt/browser")))
