...
func SerializeStage2(stage *Stage, filename string, addIDs bool) {
	...
	f := excelize.NewFile()
	{
		...
		SerializeExcelizePointerToGongstruct2[*Bar](stage, f, addIDs)
		SerializeExcelizePointerToGongstruct2[*Gantt](stage, f, addIDs)
		SerializeExcelizePointerToGongstruct2[*Group](stage, f, addIDs)
		SerializeExcelizePointerToGongstruct2[*Lane](stage, f, addIDs)
		SerializeExcelizePointerToGongstruct2[*LaneUse](stage, f, addIDs)
