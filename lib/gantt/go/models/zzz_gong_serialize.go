...
func (stage *Stage) __gong__buildExcelizeFile(addIDs bool) *excelize.File {
	f := excelize.NewFile()
	{
		...
		}
		{
			...
			stage.SerializeExcelize(f, "Bar", instances, (*Bar)(nil).GongGetFieldHeaders(), addIDs)
		}
		{
			var instances []GongstructIF
			...
			stage.SerializeExcelize(f, "Gantt", instances, (*Gantt)(nil).GongGetFieldHeaders(), addIDs)
		}
		{
			var instances []GongstructIF
		...
		}
		{
			...
			stage.SerializeExcelize(f, "Lane", instances, (*Lane)(nil).GongGetFieldHeaders(), addIDs)
		}
		{
			var instances []GongstructIF
			...
			stage.SerializeExcelize(f, "LaneUse", instances, (*LaneUse)(nil).GongGetFieldHeaders(), addIDs)
		}
		{
			var instances []GongstructIF
			...
			stage.SerializeExcelize(f, "Milestone", instances, (*Milestone)(nil).GongGetFieldHeaders(), addIDs)
		}
	}
