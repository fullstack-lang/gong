...
func SerializeStage(stage *Stage, filename string) {
	...
	{
		// insertion point
		SerializeExcelizePointerToGongstruct[*Arrow](stage, f)
		SerializeExcelizePointerToGongstruct[*Bar](stage, f)
		SerializeExcelizePointerToGongstruct[*Gantt](stage, f)
		SerializeExcelizePointerToGongstruct[*Group](stage, f)
		SerializeExcelizePointerToGongstruct[*Lane](stage, f)
		SerializeExcelizePointerToGongstruct[*LaneUse](stage, f)
		SerializeExcelizePointerToGongstruct[*Milestone](stage, f)
	}
