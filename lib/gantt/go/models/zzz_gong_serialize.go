...
func buildExcelizeFile(stage *Stage, addIDs bool) *excelize.File {
	f := excelize.NewFile()
	{
		...
		stage.SerializeExcelizePointer2[*Bar](f, addIDs)
		stage.SerializeExcelizePointer2[*Gantt](f, addIDs)
		stage.SerializeExcelizePointer2[*Group](f, addIDs)
		stage.SerializeExcelizePointer2[*Lane](f, addIDs)
		stage.SerializeExcelizePointer2[*LaneUse](f, addIDs)
		stage.SerializeExcelizePointer2[*Milestone](f, addIDs)
	}
