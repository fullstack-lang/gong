...
func (arrow *Arrow) GongClean(stage *Stage) (modified bool) {
	...
	// insertion point per field
	modified = stage.CleanPointer(&arrow.From) || modified
	modified = stage.CleanPointer(&arrow.To) || modified
	return
}
...
func (gantt *Gantt) GongClean(stage *Stage) (modified bool) {
	// insertion point per field
	modified = stage.CleanSlice(&gantt.Lanes) || modified
	modified = stage.CleanSlice(&gantt.Milestones) || modified
	modified = stage.CleanSlice(&gantt.Groups) || modified
	modified = stage.CleanSlice(&gantt.Arrows) || modified
	// insertion point per field
	return
}
...
func (group *Group) GongClean(stage *Stage) (modified bool) {
	// insertion point per field
	modified = stage.CleanSlice(&group.GroupLanes) || modified
	// insertion point per field
	return
}
...
func (lane *Lane) GongClean(stage *Stage) (modified bool) {
	// insertion point per field
	modified = stage.CleanSlice(&lane.Bars) || modified
	// insertion point per field
	return
}
...
func (laneuse *LaneUse) GongClean(stage *Stage) (modified bool) {
	// insertion point per field
	// insertion point per field
	modified = stage.CleanPointer(&laneuse.Lane) || modified
	return
}
...
func (milestone *Milestone) GongClean(stage *Stage) (modified bool) {
	// insertion point per field
	modified = stage.CleanSlice(&milestone.LanesToDisplay) || modified
	// insertion point per field
	return
}
