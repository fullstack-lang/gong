...
func (u *ArrowUnmarshaller) Initialize(stage *Stage, instanceName string, preserveOrder bool) (GongstructIF, error) {
	instance := new(Arrow)
...
func (u *BarUnmarshaller) Initialize(stage *Stage, instanceName string, preserveOrder bool) (GongstructIF, error) {
	instance := new(Bar)
	instance.Name = instanceName
	if !preserveOrder {
		instance.Stage(stage)
...
func (u *GanttUnmarshaller) Initialize(stage *Stage, instanceName string, preserveOrder bool) (GongstructIF, error) {
	instance := new(Gantt)
	instance.Name = instanceName
	if !preserveOrder {
		instance.Stage(stage)
...
func (u *LaneUnmarshaller) Initialize(stage *Stage, instanceName string, preserveOrder bool) (GongstructIF, error) {
	instance := new(Lane)
	instance.Name = instanceName
	if !preserveOrder {
		instance.Stage(stage)
...
func (u *LaneUseUnmarshaller) Initialize(stage *Stage, instanceName string, preserveOrder bool) (GongstructIF, error) {
...
func (u *MilestoneUnmarshaller) Initialize(stage *Stage, instanceName string, preserveOrder bool) (GongstructIF, error) {
