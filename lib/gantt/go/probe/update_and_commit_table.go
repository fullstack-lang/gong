...
func updateAndCommitTablePointerToGongstruct[T models.PointerToGongstruct](
	...
	// insertion point
	case *models.Arrow:
		updateAndCommitTable[models.Arrow](probe)
	case *models.Bar:
		updateAndCommitTable[models.Bar](probe)
	case *models.Gantt:
		updateAndCommitTable[models.Gantt](probe)
	case *models.Group:
		updateAndCommitTable[models.Group](probe)
	case *models.Lane:
		updateAndCommitTable[models.Lane](probe)
	case *models.LaneUse:
		updateAndCommitTable[models.LaneUse](probe)
	case *models.Milestone:
		updateAndCommitTable[models.Milestone](probe)
	default:
