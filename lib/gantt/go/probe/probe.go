...
import (
	...
	embeddedgo "github.com/fullstack-lang/gong/lib/gantt/go"
)
...
func NewProbe(
	...
	stageOfInterest.MetaPackageImportPath = "github.com/fullstack-lang/gong/lib/gantt/go/models"
	...
	probe.docStager = prepare.Prepare(
		...
		"github.com/fullstack-lang/gong/lib/gantt/go"+":"+stageOfInterest.GetName(),
...
func (probe *Probe) ExportStageExcel() {
	...
	if probe.fileName == "" {
		probe.fileName = "gantt-" + probe.stageOfInterest.GetName() + ".go"
	}
