...
import (
	...
	"github.com/fullstack-lang/gong/lib/gantt/go/fullstack"
	"github.com/fullstack-lang/gong/lib/gantt/go/models"
	"github.com/fullstack-lang/gong/lib/gantt/go/orm"
	"github.com/fullstack-lang/gong/lib/gantt/go/probe"
...
func (impl *BeforeCommitImplementation) BeforeCommit(stage *models.Stage) {
	...
	stage.Checkout()
	stage.Marshall(file, "github.com/fullstack-lang/gong/lib/gantt/go/models", packageName)
}
...
func NewStack(
	...
	if withProbe {
		if embeddedDiagrams {
			...
			stack.Probe = probe.NewProbe(r, gantt_go.GoModelsDir, gantt_go.GoDiagramsDir,
