									...
									case "JpgImage":
										...
										if !preserveOrder {
											...
											if newOrder, err := ExtractMiddleUint(identifier); err != nil {
												...
												instanceJpgImage.StagePreserveOrder(stage, newOrder)
											}
										}
									...
									case "PngImage":
										...
										if !preserveOrder {
											...
											if newOrder, err := ExtractMiddleUint(identifier); err != nil {
												...
												instancePngImage.StagePreserveOrder(stage, newOrder)
											}
										}
									...
									case "SvgImage":
										...
										if !preserveOrder {
											...
											if newOrder, err := ExtractMiddleUint(identifier); err != nil {
												...
												instanceSvgImage.StagePreserveOrder(stage, newOrder)
											}
										}
