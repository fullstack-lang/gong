...
import (
	...
	"github.com/fullstack-lang/gong/lib/markdown"
...
func ServeStaticFiles(logGINFlag bool) (r *gin.Engine) {
	...
	r.Use(static.Serve("/", EmbedFolder(markdown.NgDistNg, "ng-github.com-fullstack-lang-gong-lib-markdown/dist/ng-github.com-fullstack-lang-gong-lib-markdown/browser")))
