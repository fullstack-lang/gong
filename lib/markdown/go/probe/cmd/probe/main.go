...
import (
	...
	"github.com/fullstack-lang/gong/lib/markdown/go/level1stack"
...
func executeServer() {
	...
	stack := level1stack.NewLevel1Stack("markdown", unmarshallFromCode, marshallOnCommit, true, embeddedDiagrams)
