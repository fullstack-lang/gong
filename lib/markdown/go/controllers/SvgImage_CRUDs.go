...
func (controller *Controller) GetSvgImages(w http.ResponseWriter, r *http.Request) {
	...
	writeJSON(w, http.StatusOK, svgimageAPIs)
}
...
//	Responses:
//	  200: nodeDBResponse
func (controller *Controller) PostSvgImage(w http.ResponseWriter, r *http.Request) {
	...
	if svgimage != nil {
		backRepo.GetStage().AfterCreateFromFront(svgimage)
	}
...
//
//	200: svgimageDBResponse
func (controller *Controller) GetSvgImage(w http.ResponseWriter, r *http.Request) {
	...
	if _, err := db.First(&svgimageDB, r.PathValue("id")); err != nil {
		var returnError GenericError
		returnError.Body.Code = http.StatusBadRequest
		returnError.Body.Message = err.Error()
		log.Println(err.Error())
	...
	writeJSON(w, http.StatusOK, svgimageAPI)
}
...
//
//	200: svgimageDBResponse
func (controller *Controller) DeleteSvgImage(w http.ResponseWriter, r *http.Request) {
	...
	if svgimageStaged != nil {
		backRepo.GetStage().AfterDeleteFromFront(svgimageStaged, svgimageDeleted)
	}
