...
export class CellIntService {
  ...
  constructor(
    ...
    this.cellintsUrl = origin + '/api/github.com/fullstack-lang/gong/lib/table/go/v1/cellints';
  }
  ...
  postFront(cellint: CellInt, Name: string): Observable<CellIntAPI> {
    ...
    return this.http.post<CellIntAPI>(this.cellintsUrl, cellintAPI, httpOptions).pipe(
      tap(_ => {
      }),
