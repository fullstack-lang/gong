...
export class SVGIconService {
  ...
  constructor(
    ...
    this.svgiconsUrl = origin + '/api/github.com/fullstack-lang/gong/lib/table/go/v1/svgicons';
  }
  ...
  postFront(svgicon: SVGIcon, Name: string): Observable<SVGIconAPI> {
    ...
    return this.http.post<SVGIconAPI>(this.svgiconsUrl, svgiconAPI, httpOptions).pipe(
      tap(_ => {
      }),
