...
export class TableService {
  ...
  constructor(
    ...
    this.tablesUrl = origin + '/api/github.com/fullstack-lang/gong/lib/table/go/v1/tables';
  }
  ...
  postFront(table: Table, Name: string): Observable<TableAPI> {
    ...
    return this.http.post<TableAPI>(this.tablesUrl, tableAPI, httpOptions).pipe(
      tap(_ => {
      }),
