...
import (
	...
	"github.com/fullstack-lang/gong/lib/table/go/fullstack"
	"github.com/fullstack-lang/gong/lib/table/go/models"
	"github.com/fullstack-lang/gong/lib/table/go/orm"
	"github.com/fullstack-lang/gong/lib/table/go/probe"
...
func (impl *BeforeCommitImplementation) BeforeCommit(stage *models.Stage) {
	...
	stage.Checkout()
	stage.Marshall(file, "github.com/fullstack-lang/gong/lib/table/go/models", packageName)
}
...
func NewStack(
	...
	if withProbe {
		if embeddedDiagrams {
			...
			stack.Probe = probe.NewProbe(r, table_go.GoModelsDir, table_go.GoDiagramsDir,
