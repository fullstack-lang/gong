...
import (
	...
	"github.com/fullstack-lang/gong/lib/table/go/stack"
	"github.com/fullstack-lang/gong/lib/table/go/static"
...
func executeServer() {
	...
	stack := stack.NewStack(r, "table", unmarshallFromCode, marshallOnCommit, "", embeddedDiagrams, true)
