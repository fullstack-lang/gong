...
import (
	...
	"github.com/fullstack-lang/gong/lib/table/go/level1stack"
...
func executeServer() {
	...
	stack := level1stack.NewLevel1Stack("table", unmarshallFromCode, marshallOnCommit, true, embeddedDiagrams)
