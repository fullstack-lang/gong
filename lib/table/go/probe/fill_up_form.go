...
func FillUpForm(
	...
	case *models.Table:
		...
		BasicFieldtoForm("BulkDeleteButtonTooltip", instanceWithInferedType.BulkDeleteButtonTooltip, instanceWithInferedType, probe.formStage, formGroup,
			false, false, 0, false, 0)
		BasicFieldtoForm("BulkDeleteSelectedRowsIDsJson", instanceWithInferedType.BulkDeleteSelectedRowsIDsJson, instanceWithInferedType, probe.formStage, formGroup,
			false, false, 0, false, 0)
