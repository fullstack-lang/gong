			...
			if isSlicesDelete {
				...
				if ok {
					...
					case "FormDiv":
						...
						// insertion point for slices.Delete field code
						case "FormFields":
							instance := __gong__map_FormDiv[identifier]
							if start < len(instance.FormFields) && end <= len(instance.FormFields) && start < end {
								instance.FormFields = slices.Delete(instance.FormFields, start, end)
							}
						case "CheckBoxs":
							instance := __gong__map_FormDiv[identifier]
							if start < len(instance.CheckBoxs) && end <= len(instance.CheckBoxs) && start < end {
								instance.CheckBoxs = slices.Delete(instance.CheckBoxs, start, end)
							}
						}
					...
					case "FormFieldSelect":
						...
						// insertion point for slices.Delete field code
						case "Options":
							instance := __gong__map_FormFieldSelect[identifier]
							if start < len(instance.Options) && end <= len(instance.Options) && start < end {
								instance.Options = slices.Delete(instance.Options, start, end)
							}
						}
					...
					case "FormGroup":
						...
						// insertion point for slices.Delete field code
						case "FormDivs":
							instance := __gong__map_FormGroup[identifier]
							if start < len(instance.FormDivs) && end <= len(instance.FormDivs) && start < end {
								instance.FormDivs = slices.Delete(instance.FormDivs, start, end)
							}
						}
					...
					case "Row":
						...
						// insertion point for slices.Delete field code
						case "Cells":
							instance := __gong__map_Row[identifier]
							if start < len(instance.Cells) && end <= len(instance.Cells) && start < end {
								instance.Cells = slices.Delete(instance.Cells, start, end)
							}
						}
					case "Table":
						switch fieldName {
						...
						case "DisplayedColumns":
							...
							if start < len(instance.DisplayedColumns) && end <= len(instance.DisplayedColumns) && start < end {
								instance.DisplayedColumns = slices.Delete(instance.DisplayedColumns, start, end)
							}
						case "Rows":
							instance := __gong__map_Table[identifier]
							if start < len(instance.Rows) && end <= len(instance.Rows) && start < end {
								instance.Rows = slices.Delete(instance.Rows, start, end)
							}
						}
					}
				}
									...
									case "Cell":
										...
										if !preserveOrder {
											...
											if newOrder, err := ExtractMiddleUint(identifier); err != nil {
												...
												instanceCell.StagePreserveOrder(stage, newOrder)
											}
										}
									...
									case "CellBoolean":
										...
										if !preserveOrder {
											...
											if newOrder, err := ExtractMiddleUint(identifier); err != nil {
												...
												instanceCellBoolean.StagePreserveOrder(stage, newOrder)
											}
										}
									...
									case "CellFloat64":
										...
										if !preserveOrder {
											...
											if newOrder, err := ExtractMiddleUint(identifier); err != nil {
												...
												instanceCellFloat64.StagePreserveOrder(stage, newOrder)
											}
										}
									...
									case "CellIcon":
										...
										if !preserveOrder {
											...
											if newOrder, err := ExtractMiddleUint(identifier); err != nil {
												...
												instanceCellIcon.StagePreserveOrder(stage, newOrder)
											}
										}
									...
									case "CellInt":
										...
										if !preserveOrder {
											...
											if newOrder, err := ExtractMiddleUint(identifier); err != nil {
												...
												instanceCellInt.StagePreserveOrder(stage, newOrder)
											}
										}
									...
									case "CellString":
										...
										if !preserveOrder {
											...
											if newOrder, err := ExtractMiddleUint(identifier); err != nil {
												...
												instanceCellString.StagePreserveOrder(stage, newOrder)
											}
										}
									...
									case "CheckBox":
										...
										if !preserveOrder {
											...
											if newOrder, err := ExtractMiddleUint(identifier); err != nil {
												...
												instanceCheckBox.StagePreserveOrder(stage, newOrder)
											}
										}
									...
									case "DisplayedColumn":
										...
										if !preserveOrder {
											...
											if newOrder, err := ExtractMiddleUint(identifier); err != nil {
												...
												instanceDisplayedColumn.StagePreserveOrder(stage, newOrder)
											}
										}
									...
									case "FormDiv":
										...
										if !preserveOrder {
											...
											if newOrder, err := ExtractMiddleUint(identifier); err != nil {
												...
												instanceFormDiv.StagePreserveOrder(stage, newOrder)
											}
										}
									...
									case "FormEditAssocButton":
										...
										if !preserveOrder {
											...
											if newOrder, err := ExtractMiddleUint(identifier); err != nil {
												...
												instanceFormEditAssocButton.StagePreserveOrder(stage, newOrder)
											}
										}
									...
									case "FormField":
										...
										if !preserveOrder {
											...
											if newOrder, err := ExtractMiddleUint(identifier); err != nil {
												...
												instanceFormField.StagePreserveOrder(stage, newOrder)
											}
										}
									...
									case "FormFieldDate":
										...
										if !preserveOrder {
											...
											if newOrder, err := ExtractMiddleUint(identifier); err != nil {
												...
												instanceFormFieldDate.StagePreserveOrder(stage, newOrder)
											}
										}
									...
									case "FormFieldDateTime":
										...
										if !preserveOrder {
											...
											if newOrder, err := ExtractMiddleUint(identifier); err != nil {
												...
												instanceFormFieldDateTime.StagePreserveOrder(stage, newOrder)
											}
										}
									...
									case "FormFieldFloat64":
										...
										if !preserveOrder {
											...
											if newOrder, err := ExtractMiddleUint(identifier); err != nil {
												...
												instanceFormFieldFloat64.StagePreserveOrder(stage, newOrder)
											}
										}
									...
									case "FormFieldInt":
										...
										if !preserveOrder {
											...
											if newOrder, err := ExtractMiddleUint(identifier); err != nil {
												...
												instanceFormFieldInt.StagePreserveOrder(stage, newOrder)
											}
										}
									...
									case "FormFieldSelect":
										...
										if !preserveOrder {
											...
											if newOrder, err := ExtractMiddleUint(identifier); err != nil {
												...
												instanceFormFieldSelect.StagePreserveOrder(stage, newOrder)
											}
										}
									...
									case "FormFieldString":
										...
										if !preserveOrder {
											...
											if newOrder, err := ExtractMiddleUint(identifier); err != nil {
												...
												instanceFormFieldString.StagePreserveOrder(stage, newOrder)
											}
										}
									...
									case "FormFieldTime":
										...
										if !preserveOrder {
											...
											if newOrder, err := ExtractMiddleUint(identifier); err != nil {
												...
												instanceFormFieldTime.StagePreserveOrder(stage, newOrder)
											}
										}
									...
									case "FormGroup":
										...
										if !preserveOrder {
											...
											if newOrder, err := ExtractMiddleUint(identifier); err != nil {
												...
												instanceFormGroup.StagePreserveOrder(stage, newOrder)
											}
										}
									...
									case "FormSortAssocButton":
										...
										if !preserveOrder {
											...
											if newOrder, err := ExtractMiddleUint(identifier); err != nil {
												...
												instanceFormSortAssocButton.StagePreserveOrder(stage, newOrder)
											}
										}
									...
									case "Option":
										...
										if !preserveOrder {
											...
											if newOrder, err := ExtractMiddleUint(identifier); err != nil {
												...
												instanceOption.StagePreserveOrder(stage, newOrder)
											}
										}
									...
									case "Row":
										...
										if !preserveOrder {
											...
											if newOrder, err := ExtractMiddleUint(identifier); err != nil {
												...
												instanceRow.StagePreserveOrder(stage, newOrder)
											}
										}
					...
					case "FormDiv":
						...
						case "FormFields":
							...
							if isSlicesInsert && argNb > 1 {
								...
								if instanceToAppend, ok := __gong__map_FormField[identifierOfInstanceToAppend]; ok {
									instanceWhoseFieldIsAppended := __gong__map_FormDiv[identifier]
									if insertIndex <= len(instanceWhoseFieldIsAppended.FormFields) {
										instanceWhoseFieldIsAppended.FormFields = slices.Insert(instanceWhoseFieldIsAppended.FormFields, insertIndex, instanceToAppend)
						...
						case "CheckBoxs":
							...
							if isSlicesInsert && argNb > 1 {
								...
								if instanceToAppend, ok := __gong__map_CheckBox[identifierOfInstanceToAppend]; ok {
									instanceWhoseFieldIsAppended := __gong__map_FormDiv[identifier]
									if insertIndex <= len(instanceWhoseFieldIsAppended.CheckBoxs) {
										instanceWhoseFieldIsAppended.CheckBoxs = slices.Insert(instanceWhoseFieldIsAppended.CheckBoxs, insertIndex, instanceToAppend)
										insertIndex++ // Increment for subsequent elements in the same call
									}
								}
							}
					...
					case "FormFieldSelect":
						...
						case "Options":
							...
							if isSlicesInsert && argNb > 1 {
								...
								if instanceToAppend, ok := __gong__map_Option[identifierOfInstanceToAppend]; ok {
									instanceWhoseFieldIsAppended := __gong__map_FormFieldSelect[identifier]
									if insertIndex <= len(instanceWhoseFieldIsAppended.Options) {
										instanceWhoseFieldIsAppended.Options = slices.Insert(instanceWhoseFieldIsAppended.Options, insertIndex, instanceToAppend)
										insertIndex++ // Increment for subsequent elements in the same call
									}
								}
							}
					...
					case "FormGroup":
						...
						case "FormDivs":
							...
							if isSlicesInsert && argNb > 1 {
								...
								if instanceToAppend, ok := __gong__map_FormDiv[identifierOfInstanceToAppend]; ok {
									instanceWhoseFieldIsAppended := __gong__map_FormGroup[identifier]
									if insertIndex <= len(instanceWhoseFieldIsAppended.FormDivs) {
										instanceWhoseFieldIsAppended.FormDivs = slices.Insert(instanceWhoseFieldIsAppended.FormDivs, insertIndex, instanceToAppend)
										insertIndex++ // Increment for subsequent elements in the same call
									}
								}
							}
					...
					case "Row":
						...
						case "Cells":
							...
							if isSlicesInsert && argNb > 1 {
								...
								if instanceToAppend, ok := __gong__map_Cell[identifierOfInstanceToAppend]; ok {
									instanceWhoseFieldIsAppended := __gong__map_Row[identifier]
									if insertIndex <= len(instanceWhoseFieldIsAppended.Cells) {
										instanceWhoseFieldIsAppended.Cells = slices.Insert(instanceWhoseFieldIsAppended.Cells, insertIndex, instanceToAppend)
										insertIndex++ // Increment for subsequent elements in the same call
									}
								}
							}
					...
					case "Table":
						...
						case "DisplayedColumns":
							...
							if isSlicesInsert && argNb > 1 {
								...
								if instanceToAppend, ok := __gong__map_DisplayedColumn[identifierOfInstanceToAppend]; ok {
									instanceWhoseFieldIsAppended := __gong__map_Table[identifier]
									if insertIndex <= len(instanceWhoseFieldIsAppended.DisplayedColumns) {
										instanceWhoseFieldIsAppended.DisplayedColumns = slices.Insert(instanceWhoseFieldIsAppended.DisplayedColumns, insertIndex, instanceToAppend)
										insertIndex++ // Increment for subsequent elements in the same call
									}
								}
							}
						case "Rows":
							...
							if isSlicesInsert && argNb > 1 {
								...
								if instanceToAppend, ok := __gong__map_Row[identifierOfInstanceToAppend]; ok {
									instanceWhoseFieldIsAppended := __gong__map_Table[identifier]
									if insertIndex <= len(instanceWhoseFieldIsAppended.Rows) {
										instanceWhoseFieldIsAppended.Rows = slices.Insert(instanceWhoseFieldIsAppended.Rows, insertIndex, instanceToAppend)
										insertIndex++ // Increment for subsequent elements in the same call
									}
								}
							}
