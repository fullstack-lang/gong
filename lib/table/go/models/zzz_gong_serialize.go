...
func buildExcelizeFile(stage *Stage, addIDs bool) *excelize.File {
	f := excelize.NewFile()
	{
		...
		stage.SerializeExcelizePointer2[*Cell](f, addIDs)
		stage.SerializeExcelizePointer2[*CellBoolean](f, addIDs)
		stage.SerializeExcelizePointer2[*CellFloat64](f, addIDs)
		stage.SerializeExcelizePointer2[*CellIcon](f, addIDs)
		stage.SerializeExcelizePointer2[*CellInt](f, addIDs)
		stage.SerializeExcelizePointer2[*CellString](f, addIDs)
		stage.SerializeExcelizePointer2[*DisplayedColumn](f, addIDs)
		stage.SerializeExcelizePointer2[*Row](f, addIDs)
		stage.SerializeExcelizePointer2[*SVGIcon](f, addIDs)
