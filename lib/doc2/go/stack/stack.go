...
import (
	...
	"github.com/fullstack-lang/gong/lib/doc2/go/probe"
...
func (impl *BeforeCommitImplementation) BeforeCommit(stage *models.Stage) {
	...
	stage.Checkout()
	stage.Marshall(file, "github.com/fullstack-lang/gong/lib/doc2/go/models", "main")
}
...
func NewStack(
	...
	if withProbe {
		stack.Probe = probe.NewProbe(r, doc2_go.GoModelsDir, doc2_go.GoDiagramsDir,
