		...
		case "GongNoteShapes":
			...
			for classdiagram := range stage.Classdiagrams {
				for _, gongnoteshape_ := range classdiagram.GongNoteShapes {
					res[gongnoteshape_] = classdiagram
				}
			}
			return any(res).(map[*End]*Start)
		}
		...
		case "GongNoteLinkShapes":
			...
			for gongnoteshape := range stage.GongNoteShapes {
				for _, gongnotelinkshape_ := range gongnoteshape.GongNoteLinkShapes {
					res[gongnotelinkshape_] = gongnoteshape
				}
			}
			return any(res).(map[*End]*Start)
		}
...
func GetFields[Type Gongstruct]() (res []string) {
	...
	case Classdiagram:
		res = []string{"Name", "Description", "GongStructShapes", "GongEnumShapes", "GongNoteShapes", "IsInRenameMode", "IsExpanded", "NodeGongStructsIsExpanded", "NodeGongStructNodeExpansionBinaryEncoding", "NodeGongEnumsIsExpanded", "NodeGongEnumNodeExpansionBinaryEncoding", "NodeGongNotesIsExpanded", "NodeGongNoteNodeExpansionBinaryEncoding"}
	case DiagramPackage:
