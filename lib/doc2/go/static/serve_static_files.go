...
import (
	...
	"github.com/fullstack-lang/gong/lib/doc2"
...
func ServeStaticFiles(logGINFlag bool) (r *gin.Engine) {
	...
	r.Use(static.Serve("/", EmbedFolder(doc2.NgDistNg, "ng-github.com-fullstack-lang-gong-lib-doc2/dist/ng-github.com-fullstack-lang-gong-lib-doc2/browser")))
