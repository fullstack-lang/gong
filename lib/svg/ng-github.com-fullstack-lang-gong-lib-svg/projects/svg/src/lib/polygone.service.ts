...
export class PolygoneService {
  ...
  constructor(
    ...
    this.polygonesUrl = origin + '/api/github.com/fullstack-lang/gong/lib/svg/go/v1/polygones';
  }
  ...
  postFront(polygone: Polygone, Name: string): Observable<PolygoneAPI> {
    ...
    return this.http.post<PolygoneAPI>(this.polygonesUrl, polygoneAPI, httpOptions).pipe(
      tap(_ => {
      }),
