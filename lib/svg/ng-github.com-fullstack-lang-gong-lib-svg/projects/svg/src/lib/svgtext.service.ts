...
export class SvgTextService {
  ...
  constructor(
    ...
    this.svgtextsUrl = origin + '/api/github.com/fullstack-lang/gong/lib/svg/go/v1/svgtexts';
  }
  ...
  postFront(svgtext: SvgText, Name: string): Observable<SvgTextAPI> {
    ...
    return this.http.post<SvgTextAPI>(this.svgtextsUrl, svgtextAPI, httpOptions).pipe(
      tap(_ => {
      }),
