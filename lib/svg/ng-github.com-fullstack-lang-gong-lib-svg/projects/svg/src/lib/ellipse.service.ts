...
export class EllipseService {
  ...
  constructor(
    ...
    this.ellipsesUrl = origin + '/api/github.com/fullstack-lang/gong/lib/svg/go/v1/ellipses';
  }
  ...
  postFront(ellipse: Ellipse, Name: string): Observable<EllipseAPI> {
    ...
    return this.http.post<EllipseAPI>(this.ellipsesUrl, ellipseAPI, httpOptions).pipe(
      tap(_ => {
      }),
