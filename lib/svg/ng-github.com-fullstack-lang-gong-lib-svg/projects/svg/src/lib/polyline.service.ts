...
export class PolylineService {
  ...
  constructor(
    ...
    this.polylinesUrl = origin + '/api/github.com/fullstack-lang/gong/lib/svg/go/v1/polylines';
  }
  ...
  updateFrontWithMouseEvent(polyline: Polyline, Name: string, gong__mouseEvent: MouseEvent): Observable<PolylineAPI> {
    let polylineAPI = new PolylineAPI
    CopyPolylineToPolylineAPI(polyline, polylineAPI)
    const id = typeof polylineAPI === 'number' ? polylineAPI : polylineAPI.ID
    const url = `${this.polylinesUrl}/${id}`;
