...
import (
	...
	"github.com/fullstack-lang/gong/lib/svg/go/fullstack"
	"github.com/fullstack-lang/gong/lib/svg/go/models"
	"github.com/fullstack-lang/gong/lib/svg/go/orm"
	"github.com/fullstack-lang/gong/lib/svg/go/probe"
...
func (impl *BeforeCommitImplementation) BeforeCommit(stage *models.Stage) {
	...
	stage.Checkout()
	stage.Marshall(file, "github.com/fullstack-lang/gong/lib/svg/go/models", packageName)
}
...
func NewStack(
	...
	if withProbe {
		if embeddedDiagrams {
			...
			stack.Probe = probe.NewProbe(r, svg_go.GoModelsDir, svg_go.GoDiagramsDir,
