...
import (
	...
	"github.com/fullstack-lang/gong/lib/svg"
...
func ServeStaticFiles(logGINFlag bool) (r *gin.Engine) {
	...
	r.Use(static.Serve("/", EmbedFolder(svg.NgDistNg, "ng-github.com-fullstack-lang-gong-lib-svg/dist/ng-github.com-fullstack-lang-gong-lib-svg/browser")))
