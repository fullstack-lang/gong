...
func (controller *Controller) GetRectAnchoredRects(w http.ResponseWriter, r *http.Request) {
	...
	if len(_values) == 1 {
		...
		if len(value) == 1 {
			stackPath = value[0]
			// log.Println("GetRectAnchoredRects", "Name", stackPath)
		}
	}
	...
	writeJSON(w, http.StatusOK, rectanchoredrectAPIs)
}
...
//	Responses:
//	  200: nodeDBResponse
func (controller *Controller) PostRectAnchoredRect(w http.ResponseWriter, r *http.Request) {
	...
	if len(_values) == 1 {
		...
		if len(value) == 1 {
			stackPath = value[0]
			// log.Println("PostRectAnchoredRects", "Name", stackPath)
		}
	}
	backRepo := controller.Map_BackRepos[stackPath]
	if backRepo == nil {
	...
	writeJSON(w, http.StatusOK, rectanchoredrectDB)
}
...
//
//	200: rectanchoredrectDBResponse
func (controller *Controller) GetRectAnchoredRect(w http.ResponseWriter, r *http.Request) {
	...
	if len(_values) == 1 {
		...
		if len(value) == 1 {
			stackPath = value[0]
			// log.Println("GetRectAnchoredRect", "Name", stackPath)
		}
	}
	backRepo := controller.Map_BackRepos[stackPath]
	if backRepo == nil {
	...
	if _, err := db.First(&rectanchoredrectDB, r.PathValue("id")); err != nil {
		var returnError GenericError
		returnError.Body.Code = http.StatusBadRequest
		returnError.Body.Message = err.Error()
		log.Println(err.Error())
	...
	writeJSON(w, http.StatusOK, rectanchoredrectAPI)
}
...
//
//	200: rectanchoredrectDBResponse
func (controller *Controller) UpdateRectAnchoredRect(w http.ResponseWriter, r *http.Request) {
	...
	_, err := db.First(&rectanchoredrectDB, r.PathValue("id"))
...
//
//	200: rectanchoredrectDBResponse
func (controller *Controller) DeleteRectAnchoredRect(w http.ResponseWriter, r *http.Request) {
	...
	if len(_values) == 1 {
		...
		if len(value) == 1 {
			stackPath = value[0]
			// log.Println("DeleteRectAnchoredRect", "Name", stackPath)
		}
	}
	backRepo := controller.Map_BackRepos[stackPath]
	if backRepo == nil {
