...
func (controller *Controller) GetRectAnchoredPaths(w http.ResponseWriter, r *http.Request) {
	...
	if len(_values) == 1 {
		...
		if len(value) == 1 {
			stackPath = value[0]
			// log.Println("GetRectAnchoredPaths", "Name", stackPath)
		}
	}
	...
	writeJSON(w, http.StatusOK, rectanchoredpathAPIs)
}
...
//	Responses:
//	  200: nodeDBResponse
func (controller *Controller) PostRectAnchoredPath(w http.ResponseWriter, r *http.Request) {
	...
	if len(_values) == 1 {
		...
		if len(value) == 1 {
			stackPath = value[0]
			// log.Println("PostRectAnchoredPaths", "Name", stackPath)
		}
	}
	backRepo := controller.Map_BackRepos[stackPath]
	if backRepo == nil {
	...
	if rectanchoredpath != nil {
		backRepo.GetStage().AfterCreateFromFront(rectanchoredpath)
	}
...
//
//	200: rectanchoredpathDBResponse
func (controller *Controller) GetRectAnchoredPath(w http.ResponseWriter, r *http.Request) {
	...
	if len(_values) == 1 {
		...
		if len(value) == 1 {
			stackPath = value[0]
			// log.Println("GetRectAnchoredPath", "Name", stackPath)
		}
	}
	backRepo := controller.Map_BackRepos[stackPath]
	if backRepo == nil {
	...
	if _, err := db.First(&rectanchoredpathDB, r.PathValue("id")); err != nil {
		var returnError GenericError
		returnError.Body.Code = http.StatusBadRequest
		returnError.Body.Message = err.Error()
		log.Println(err.Error())
	...
	writeJSON(w, http.StatusOK, rectanchoredpathAPI)
}
...
//
//	200: rectanchoredpathDBResponse
func (controller *Controller) DeleteRectAnchoredPath(w http.ResponseWriter, r *http.Request) {
	...
	if len(_values) == 1 {
		...
		if len(value) == 1 {
			stackPath = value[0]
			// log.Println("DeleteRectAnchoredPath", "Name", stackPath)
		}
	}
	backRepo := controller.Map_BackRepos[stackPath]
	if backRepo == nil {
	...
	if rectanchoredpathStaged != nil {
		backRepo.GetStage().AfterDeleteFromFront(rectanchoredpathStaged, rectanchoredpathDeleted)
	}
