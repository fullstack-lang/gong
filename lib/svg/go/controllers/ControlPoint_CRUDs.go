...
func (controller *Controller) GetControlPoints(w http.ResponseWriter, r *http.Request) {
	...
	writeJSON(w, http.StatusOK, controlpointAPIs)
}
...
//	Responses:
//	  200: nodeDBResponse
func (controller *Controller) PostControlPoint(w http.ResponseWriter, r *http.Request) {
	...
	writeJSON(w, http.StatusOK, controlpointDB)
}
...
//
//	200: controlpointDBResponse
func (controller *Controller) GetControlPoint(w http.ResponseWriter, r *http.Request) {
	...
	if _, err := db.First(&controlpointDB, r.PathValue("id")); err != nil {
		var returnError GenericError
		returnError.Body.Code = http.StatusBadRequest
		returnError.Body.Message = err.Error()
		log.Println(err.Error())
	...
	writeJSON(w, http.StatusOK, controlpointAPI)
}
...
//
//	200: controlpointDBResponse
func (controller *Controller) UpdateControlPoint(w http.ResponseWriter, r *http.Request) {
	...
	_, err := db.First(&controlpointDB, r.PathValue("id"))
...
//
//	200: controlpointDBResponse
func (controller *Controller) DeleteControlPoint(w http.ResponseWriter, r *http.Request) {
