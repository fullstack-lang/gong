...
//
//	200: linkDBResponse
func (controller *Controller) GetLinks(w http.ResponseWriter, r *http.Request) {
	...
	writeJSON(w, http.StatusOK, linkAPIs)
}
...
//	Responses:
//	  200: nodeDBResponse
func (controller *Controller) PostLink(w http.ResponseWriter, r *http.Request) {
	...
	if link != nil {
		backRepo.GetStage().AfterCreateFromFront(link)
	}
...
//
//	200: linkDBResponse
func (controller *Controller) GetLink(w http.ResponseWriter, r *http.Request) {
	...
	if _, err := db.First(&linkDB, r.PathValue("id")); err != nil {
		var returnError GenericError
		returnError.Body.Code = http.StatusBadRequest
		returnError.Body.Message = err.Error()
		log.Println(err.Error())
	...
	writeJSON(w, http.StatusOK, linkAPI)
}
...
//
//	200: linkDBResponse
func (controller *Controller) DeleteLink(w http.ResponseWriter, r *http.Request) {
	...
	if linkStaged != nil {
		backRepo.GetStage().AfterDeleteFromFront(linkStaged, linkDeleted)
	}
