...
func (controller *Controller) GetRectLinkLinks(w http.ResponseWriter, r *http.Request) {
	...
	writeJSON(w, http.StatusOK, rectlinklinkAPIs)
}
...
//	Responses:
//	  200: nodeDBResponse
func (controller *Controller) PostRectLinkLink(w http.ResponseWriter, r *http.Request) {
...
//
//	200: rectlinklinkDBResponse
func (controller *Controller) GetRectLinkLink(w http.ResponseWriter, r *http.Request) {
	...
	if _, err := db.First(&rectlinklinkDB, r.PathValue("id")); err != nil {
		var returnError GenericError
		returnError.Body.Code = http.StatusBadRequest
		returnError.Body.Message = err.Error()
		log.Println(err.Error())
	...
	writeJSON(w, http.StatusOK, rectlinklinkAPI)
}
...
//
//	200: rectlinklinkDBResponse
func (controller *Controller) DeleteRectLinkLink(w http.ResponseWriter, r *http.Request) {
