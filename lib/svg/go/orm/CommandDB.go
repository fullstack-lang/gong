...
type CommandDB struct {
	...
	// Declation for basic field commandDB.CommandType
	CommandType_Data sql.NullString
...
type CommandWOP struct {
	...
	CommandType models.CommandType `xlsx:"2"`
...
func (commandDB *CommandDB) CopyBasicFieldsFromCommand(command *models.Command) {
	...
	commandDB.CommandType_Data.String = command.CommandType.ToString()
	commandDB.CommandType_Data.Valid = true
}
...
func (commandDB *CommandDB) CopyBasicFieldsToCommand(command *models.Command) {
	...
	command.Name = commandDB.Name_Data.String
	command.CommandType.FromString(commandDB.CommandType_Data.String)
}
