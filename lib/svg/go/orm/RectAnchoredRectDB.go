...
func (backRepoRectAnchoredRect *BackRepoRectAnchoredRectStruct) CommitPhaseOne(stage *models.Stage) (Error error) {
	...
	sort.Slice(rectanchoredrects, func(i, j int) bool {
		return stage.RectAnchoredRectMap_Staged_Order[rectanchoredrects[i]] < stage.RectAnchoredRectMap_Staged_Order[rectanchoredrects[j]]
	})
...
func (backRepoRectAnchoredRect *BackRepoRectAnchoredRectStruct) CommitPhaseOneInstance(rectanchoredrect *models.RectAnchoredRect) (Error error) {
	...
	_, err := backRepoRectAnchoredRect.db.Create(&rectanchoredrectDB)
	if err != nil {
		log.Fatal(err)
	}
...
func (backRepoRectAnchoredRect *BackRepoRectAnchoredRectStruct) CheckoutPhaseOne() (Error error) {
	...
	_, err := backRepoRectAnchoredRect.db.Find(&rectanchoredrectDBArray)
	if err != nil {
		return err
	}
...
func (backRepo *BackRepoStruct) CheckoutRectAnchoredRect(rectanchoredrect *models.RectAnchoredRect) {
	...
	if _, ok := backRepo.BackRepoRectAnchoredRect.Map_RectAnchoredRectPtr_RectAnchoredRectDBID[rectanchoredrect]; ok {
		...
		if id, ok := backRepo.BackRepoRectAnchoredRect.Map_RectAnchoredRectPtr_RectAnchoredRectDBID[rectanchoredrect]; ok {
			...
			if _, err := backRepo.BackRepoRectAnchoredRect.db.First(&rectanchoredrectDB, id); err != nil {
				log.Fatalln("CheckoutRectAnchoredRect : Problem with getting object with id:", id)
			}
...
func (rectanchoredrectDB *RectAnchoredRectDB) CopyBasicFieldsFromRectAnchoredRect(rectanchoredrect *models.RectAnchoredRect) {
	...
	rectanchoredrectDB.HasToolTip_Data.Bool = rectanchoredrect.HasToolTip
	rectanchoredrectDB.HasToolTip_Data.Valid = true

	rectanchoredrectDB.ToolTipText_Data.String = rectanchoredrect.ToolTipText
	rectanchoredrectDB.ToolTipText_Data.Valid = true
	...
	rectanchoredrectDB.StrokeOpacity_Data.Float64 = rectanchoredrect.StrokeOpacity
	rectanchoredrectDB.StrokeOpacity_Data.Valid = true
...
func (rectanchoredrectDB *RectAnchoredRectDB) CopyBasicFieldsToRectAnchoredRect(rectanchoredrect *models.RectAnchoredRect) {
	...
	rectanchoredrect.HasToolTip = rectanchoredrectDB.HasToolTip_Data.Bool
	rectanchoredrect.ToolTipText = rectanchoredrectDB.ToolTipText_Data.String
	...
	rectanchoredrect.StrokeOpacity = rectanchoredrectDB.StrokeOpacity_Data.Float64
...
func (backRepoRectAnchoredRect *BackRepoRectAnchoredRectStruct) Backup(dirPath string) {
	...
	if err != nil {
		log.Fatal("Cannot json RectAnchoredRect ", filename, " ", err.Error())
	}

	err = ioutil.WriteFile(filename, file, 0644)
	if err != nil {
		log.Fatal("Cannot write the json RectAnchoredRect file", err.Error())
	}
}
...
func (backRepoRectAnchoredRect *BackRepoRectAnchoredRectStruct) RestorePhaseOne(dirPath string) {
	...
	if err != nil {
		log.Fatal("Cannot restore/open the json RectAnchoredRect file", filename, " ", err.Error())
	}
	...
	if err != nil {
		log.Fatal("Cannot restore/unmarshall json RectAnchoredRect file", err.Error())
	}
}
...
func (backRepoRectAnchoredRect *BackRepoRectAnchoredRectStruct) RestorePhaseTwo() {
	...
	for _, rectanchoredrectDB := range backRepoRectAnchoredRect.Map_RectAnchoredRectDBID_RectAnchoredRectDB {
		...
		db, _ := backRepoRectAnchoredRect.db.Model(rectanchoredrectDB)
