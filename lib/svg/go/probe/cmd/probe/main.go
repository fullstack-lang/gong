...
import (
	...
	"github.com/fullstack-lang/gong/lib/svg/go/stack"
	"github.com/fullstack-lang/gong/lib/svg/go/static"
...
func executeServer() {
	...
	stack := stack.NewStack(r, "svg", unmarshallFromCode, marshallOnCommit, "", embeddedDiagrams, true)
