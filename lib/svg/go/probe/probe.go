...
import (
	...
	embeddedgo "github.com/fullstack-lang/gong/lib/svg/go"
)
...
func NewProbe(
	...
	stageOfInterest.MetaPackageImportPath = "github.com/fullstack-lang/gong/lib/svg/go/models"
...
func (probe *Probe) ExportStageExcel() {
	...
	if probe.fileName == "" {
		probe.fileName = "svg-" + probe.stageOfInterest.GetName() + ".go"
	}
