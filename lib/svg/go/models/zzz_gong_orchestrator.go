...
// PointOrchestrator
type PointOrchestrator struct {
}

func (orchestrator *PointOrchestrator) OnAfterUpdate(
	gongsvgStage *Stage,
	stagedPoint, backRepoPoint *Point) {

	stagedPoint.OnAfterUpdate(gongsvgStage, stagedPoint, backRepoPoint)
}
// RectOrchestrator
