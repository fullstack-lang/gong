...
export class FrontRepoService {
	...
	public connectToWebSocket(Name: string): Observable<FrontRepo> {
		...
		console.log("github.com/fullstack-lang/gong/lib/slider/go; connectToWebSocket: started", Name)

		// Check if a connection for this name already exists
		if (this.webSocketConnections.has(Name)) {
			console.log("github.com/fullstack-lang/gong/lib/slider/go; connectToWebSocket: returning existing connection")
		...
		const newConnection$ = new Observable<FrontRepo>(observer => {
			console.log("github.com/fullstack-lang/gong/lib/slider/go; connectToWebSocket: new Observable created")
			...
			const processData = (dataString: string) => {
				console.log("github.com/fullstack-lang/gong/lib/slider/go; connectToWebSocket: processData called")
