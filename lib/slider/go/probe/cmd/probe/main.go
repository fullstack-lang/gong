...
import (
	...
	"github.com/fullstack-lang/gong/lib/slider/go/level1stack"
...
func executeServer() {
	...
	stack := level1stack.NewLevel1Stack("slider", unmarshallFromCode, marshallOnCommit, true, embeddedDiagrams)
