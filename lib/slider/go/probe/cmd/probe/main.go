...
import (
	...
	"github.com/fullstack-lang/gong/lib/slider/go/stack"
	"github.com/fullstack-lang/gong/lib/slider/go/static"
...
func executeServer() {
	...
	stack := stack.NewStack(r, "slider", unmarshallFromCode, marshallOnCommit, "", embeddedDiagrams, true)
