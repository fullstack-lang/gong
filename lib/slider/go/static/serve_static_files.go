...
import (
	...
	"github.com/fullstack-lang/gong/lib/slider"
...
func ServeStaticFiles(logGINFlag bool) (r *gin.Engine) {
	...
	r.Use(static.Serve("/", EmbedFolder(slider.NgDistNg, "ng-github.com-fullstack-lang-gong-lib-slider/dist/ng-github.com-fullstack-lang-gong-lib-slider/browser")))
