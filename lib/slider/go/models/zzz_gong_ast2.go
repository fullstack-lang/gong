...
func (u *CheckboxUnmarshaller) UnmarshallField(stage *Stage, i GongstructIF, fieldName string, valueExpr ast.Expr, identifierMap map[string]GongstructIF) error {
	...
	case "ValueBool":
		instance.ValueBool = GongExtractBool(valueExpr)
	case "LabelForTrue":
		instance.Name = GongExtractString(valueExpr)
	case "LabelForFalse":
		instance.Name = GongExtractString(valueExpr)
...
func (u *GroupUnmarshaller) Initialize(stage *Stage, instanceName string, preserveOrder bool) (GongstructIF, error) {
	instance := new(Group)
	instance.Name = instanceName
	if !preserveOrder {
		instance.Stage(stage)
...
func (u *GroupUnmarshaller) UnmarshallField(stage *Stage, i GongstructIF, fieldName string, valueExpr ast.Expr, identifierMap map[string]GongstructIF) error {
	...
	case "Name":
		instance.Name = GongExtractString(valueExpr)
	case "Percentage":
		instance.Percentage = GongExtractFloat(valueExpr)
	case "Sliders":
		GongUnmarshallSliceOfPointers(&instance.Sliders, valueExpr, identifierMap)
	case "Checkboxes":
		GongUnmarshallSliceOfPointers(&instance.Checkboxes, valueExpr, identifierMap)
	}
	return nil
}
...
func (u *LayoutUnmarshaller) Initialize(stage *Stage, instanceName string, preserveOrder bool) (GongstructIF, error) {
	instance := new(Layout)
	instance.Name = instanceName
	if !preserveOrder {
		instance.Stage(stage)
...
func (u *SliderUnmarshaller) UnmarshallField(stage *Stage, i GongstructIF, fieldName string, valueExpr ast.Expr, identifierMap map[string]GongstructIF) error {
	...
	case "Name":
		instance.Name = GongExtractString(valueExpr)
	case "IsFloat64":
		instance.IsFloat64 = GongExtractBool(valueExpr)
	case "IsInt":
		instance.IsInt = GongExtractBool(valueExpr)
	case "MinInt":
		instance.MinInt = GongExtractInt(valueExpr)
	case "MaxInt":
		instance.MaxInt = GongExtractInt(valueExpr)
	case "StepInt":
		instance.StepInt = GongExtractInt(valueExpr)
	case "ValueInt":
		instance.ValueInt = GongExtractInt(valueExpr)
	case "MinFloat64":
		instance.MinFloat64 = GongExtractFloat(valueExpr)
	case "MaxFloat64":
		instance.MaxFloat64 = GongExtractFloat(valueExpr)
	case "StepFloat64":
