...
import (
	...
	"github.com/fullstack-lang/gong/lib/splitlite/go/fullstack"
	"github.com/fullstack-lang/gong/lib/splitlite/go/models"
	"github.com/fullstack-lang/gong/lib/splitlite/go/orm"
	"github.com/fullstack-lang/gong/lib/splitlite/go/models/probe"

	splitlite_go "github.com/fullstack-lang/gong/lib/splitlite/go"
...
func (impl *BeforeCommitImplementation) BeforeCommit(stage *models.Stage) {
	...
	stage.Marshall(file, "github.com/fullstack-lang/gong/lib/splitlite/go/models", packageName)
}
...
func NewStack(
	...
	if withProbe {
		...
		stack.Probe = probe.NewProbe(
			r,
			splitlite_go.GoModelsDir,
			splitlite_go.GoDiagramsDir,
			embeddedDiagrams,
			stage,
		)
