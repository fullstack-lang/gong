...
import (
	...
	"github.com/fullstack-lang/gong/lib/splitlite/go/stack"
	"github.com/fullstack-lang/gong/lib/splitlite/go/static"
...
func executeServer() {
	...
	stack := stack.NewStack(r, "splitlite", unmarshallFromCode, marshallOnCommit, "", embeddedDiagrams, true)
