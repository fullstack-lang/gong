...
import (
	...
	embeddedgo "github.com/fullstack-lang/gong/lib/splitlite/go"
)
...
func NewProbe(
	...
	stageOfInterest.MetaPackageImportPath = "github.com/fullstack-lang/gong/lib/splitlite/go/models"
	...
	probe.docStager = prepare.PrepareSplitlite(
		...
		"github.com/fullstack-lang/gong/lib/splitlite/go"+":"+stageOfInterest.GetName(),
	...
	probe.splitStage.StageBranch(&splitlite.View{
		Name: "Main view",
...
func (probe *Probe) ExportStageExcel() {
	...
	if probe.fileName == "" {
		probe.fileName = "splitlite-" + probe.stageOfInterest.GetName() + ".go"
	}
