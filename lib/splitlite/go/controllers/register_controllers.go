...
func registerControllers(mux *http.ServeMux) {
	base := "/api/github.com/fullstack-lang/gong/lib/splitlite/go/v1"
...
func (controller *Controller) onWebSocketRequestForBackRepoContent(w http.ResponseWriter, r *http.Request) {
	...
	// log.Println("Stack github.com/fullstack-lang/gong/lib/splitlite/go, onWebSocketRequestForBackRepoContent")
	...
	if backRepo == nil {
		message := "WebSocket Connect, Stack github.com/fullstack-lang/gong/lib/splitlite/go, Unkown stack: \"" + stackPath + "\"\n"
	...
	go func() {
		for {
			...
			if err != nil {
				log.Println("github.com/fullstack-lang/gong/lib/splitlite/go", stackPath, "WS client disconnected:", err)
	...
	if err != nil {
		log.Println("github.com/fullstack-lang/gong/lib/splitlite/go:\n",
		...
		parts := strings.Split("github.com/fullstack-lang/gong/lib/splitlite/go", "/") // Assuming goFilePath holds the path
		component := "unknown"
		if len(parts) > 2 {
...
func (controller *Controller) GetLastCommitFromBackNb(w http.ResponseWriter, r *http.Request) {
	...
	backRepo := controller.Map_BackRepos[stackPath]
	if backRepo == nil {
		message := "Stack github.com/fullstack-lang/gong/lib/splitlite/go, Unkown stack: \"" + stackPath + "\"\n"
...
func (controller *Controller) GetLastPushFromFrontNb(w http.ResponseWriter, r *http.Request) {
	...
	backRepo := controller.Map_BackRepos[stackPath]
	if backRepo == nil {
		message := "GET Stack github.com/fullstack-lang/gong/lib/splitlite/go, Unkown stack: \"" + stackPath + "\"\n"
