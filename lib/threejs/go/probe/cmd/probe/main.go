...
import (
	...
	"github.com/fullstack-lang/gong/lib/threejs/go/stack"
	"github.com/fullstack-lang/gong/lib/threejs/go/static"
...
func executeServer() {
	...
	stack := stack.NewStack(r, "threejs", unmarshallFromCode, marshallOnCommit, "", embeddedDiagrams, true)
