...
//
//	200: curveDBResponse
func (controller *Controller) GetCurves(w http.ResponseWriter, r *http.Request) {
	...
	writeJSON(w, http.StatusOK, curveAPIs)
}
...
//	Responses:
//	  200: nodeDBResponse
func (controller *Controller) PostCurve(w http.ResponseWriter, r *http.Request) {
...
//
//	200: curveDBResponse
func (controller *Controller) GetCurve(w http.ResponseWriter, r *http.Request) {
	...
	if _, err := db.First(&curveDB, r.PathValue("id")); err != nil {
		var returnError GenericError
		returnError.Body.Code = http.StatusBadRequest
		returnError.Body.Message = err.Error()
		log.Println(err.Error())
	...
	writeJSON(w, http.StatusOK, curveAPI)
}
...
//
//	200: curveDBResponse
func (controller *Controller) DeleteCurve(w http.ResponseWriter, r *http.Request) {
