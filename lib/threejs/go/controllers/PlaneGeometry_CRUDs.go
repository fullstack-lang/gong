...
func (controller *Controller) GetPlaneGeometrys(w http.ResponseWriter, r *http.Request) {
	...
	writeJSON(w, http.StatusOK, planegeometryAPIs)
}
...
//	Responses:
//	  200: nodeDBResponse
func (controller *Controller) PostPlaneGeometry(w http.ResponseWriter, r *http.Request) {
...
//
//	200: planegeometryDBResponse
func (controller *Controller) GetPlaneGeometry(w http.ResponseWriter, r *http.Request) {
	...
	if _, err := db.First(&planegeometryDB, r.PathValue("id")); err != nil {
		var returnError GenericError
		returnError.Body.Code = http.StatusBadRequest
		returnError.Body.Message = err.Error()
		log.Println(err.Error())
	...
	writeJSON(w, http.StatusOK, planegeometryAPI)
}
...
//
//	200: planegeometryDBResponse
func (controller *Controller) DeletePlaneGeometry(w http.ResponseWriter, r *http.Request) {
