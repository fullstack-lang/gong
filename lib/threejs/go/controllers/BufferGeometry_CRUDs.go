...
func (controller *Controller) GetBufferGeometrys(w http.ResponseWriter, r *http.Request) {
	...
	writeJSON(w, http.StatusOK, buffergeometryAPIs)
}
...
//	Responses:
//	  200: nodeDBResponse
func (controller *Controller) PostBufferGeometry(w http.ResponseWriter, r *http.Request) {
...
//
//	200: buffergeometryDBResponse
func (controller *Controller) GetBufferGeometry(w http.ResponseWriter, r *http.Request) {
	...
	if _, err := db.First(&buffergeometryDB, r.PathValue("id")); err != nil {
		var returnError GenericError
		returnError.Body.Code = http.StatusBadRequest
		returnError.Body.Message = err.Error()
		log.Println(err.Error())
	...
	writeJSON(w, http.StatusOK, buffergeometryAPI)
}
...
//
//	200: buffergeometryDBResponse
func (controller *Controller) DeleteBufferGeometry(w http.ResponseWriter, r *http.Request) {
