...
func (controller *Controller) GetCanvass(w http.ResponseWriter, r *http.Request) {
	...
	writeJSON(w, http.StatusOK, canvasAPIs)
}
...
//	Responses:
//	  200: nodeDBResponse
func (controller *Controller) PostCanvas(w http.ResponseWriter, r *http.Request) {
...
//
//	200: canvasDBResponse
func (controller *Controller) GetCanvas(w http.ResponseWriter, r *http.Request) {
	...
	if _, err := db.First(&canvasDB, r.PathValue("id")); err != nil {
		var returnError GenericError
		returnError.Body.Code = http.StatusBadRequest
		returnError.Body.Message = err.Error()
		log.Println(err.Error())
	...
	writeJSON(w, http.StatusOK, canvasAPI)
}
...
//
//	200: canvasDBResponse
func (controller *Controller) DeleteCanvas(w http.ResponseWriter, r *http.Request) {
