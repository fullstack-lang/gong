...
import (
	...
	threejs_orm "github.com/fullstack-lang/gong/lib/threejs/go/orm"
...
type Controller struct {
	...
	Map_BackRepos map[string]*threejs_orm.BackRepoStruct
...
func GetController() *Controller {
	doControllerInitOnce.Do(func() {
		_controllerSingloton = &Controller{
			Map_BackRepos: make(map[string]*threejs_orm.BackRepoStruct),
		}
	})
	return _controllerSingloton
}

func (controller *Controller) AddBackRepo(backRepo *threejs_orm.BackRepoStruct, stackPath string) {
