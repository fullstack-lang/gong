...
import (
	...
	"github.com/fullstack-lang/gong/lib/threejs"
...
func ServeStaticFiles(logGINFlag bool) (r *gin.Engine) {
	...
	r.Use(static.Serve("/", EmbedFolder(threejs.NgDistNg, "ng-github.com-fullstack-lang-gong-lib-threejs/dist/ng-github.com-fullstack-lang-gong-lib-threejs/browser")))
