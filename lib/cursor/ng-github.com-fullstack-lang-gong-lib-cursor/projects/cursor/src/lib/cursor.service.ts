...
export class CursorService {
  ...
  constructor(
    ...
    this.cursorsUrl = origin + '/api/github.com/fullstack-lang/gong/lib/cursor/go/v1/cursors';
  }
  ...
  postFront(cursor: Cursor, Name: string): Observable<CursorAPI> {
    ...
    return this.http.post<CursorAPI>(this.cursorsUrl, cursorAPI, httpOptions).pipe(
      tap(_ => {
      }),
