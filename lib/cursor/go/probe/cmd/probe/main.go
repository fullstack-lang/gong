...
import (
	...
	"github.com/fullstack-lang/gong/lib/cursor/go/level1stack"
...
func executeServer() {
	...
	stack := level1stack.NewLevel1Stack("cursor", unmarshallFromCode, marshallOnCommit, true, embeddedDiagrams)
