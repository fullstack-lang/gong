...
import (
	...
	"github.com/fullstack-lang/gong/lib/cursor/go/stack"
	"github.com/fullstack-lang/gong/lib/cursor/go/static"
...
func executeServer() {
	...
	stack := stack.NewStack(r, "cursor", unmarshallFromCode, marshallOnCommit, "", embeddedDiagrams, true)
