...
import (
	...
	embeddedgo "github.com/fullstack-lang/gong/lib/cursor/go"
)
...
func NewProbe(
	...
	stageOfInterest.MetaPackageImportPath = "github.com/fullstack-lang/gong/lib/cursor/go/models"
	...
	probe.docStager = prepare.Prepare(
		...
		"github.com/fullstack-lang/gong/lib/cursor/go"+":"+stageOfInterest.GetName(),
...
func (probe *Probe) ExportStageExcel() {
	...
	if probe.fileName == "" {
		probe.fileName = "cursor-" + probe.stageOfInterest.GetName() + ".go"
	}
