...
func (controller *Controller) GetCursors(w http.ResponseWriter, r *http.Request) {
	...
	if len(_values) == 1 {
		...
		if len(value) == 1 {
			stackPath = value[0]
			// log.Println("GetCursors", "Name", stackPath)
		}
	}
	backRepo := controller.Map_BackRepos[stackPath]
	if backRepo == nil {
		message := "GET Stack github.com/fullstack-lang/gong/lib/cursor/go, Unkown stack: \"" + stackPath + "\"\n"
	...
	writeJSON(w, http.StatusOK, cursorAPIs)
}
...
//	Responses:
//	  200: nodeDBResponse
func (controller *Controller) PostCursor(w http.ResponseWriter, r *http.Request) {
	...
	if len(_values) == 1 {
		...
		if len(value) == 1 {
			stackPath = value[0]
			// log.Println("PostCursors", "Name", stackPath)
		}
	}
	backRepo := controller.Map_BackRepos[stackPath]
	if backRepo == nil {
		message := "Post Stack github.com/fullstack-lang/gong/lib/cursor/go, Unkown stack: \"" + stackPath + "\"\n"
...
//
//	200: cursorDBResponse
func (controller *Controller) GetCursor(w http.ResponseWriter, r *http.Request) {
	...
	if len(_values) == 1 {
		...
		if len(value) == 1 {
			stackPath = value[0]
			// log.Println("GetCursor", "Name", stackPath)
		}
	}
	backRepo := controller.Map_BackRepos[stackPath]
	if backRepo == nil {
		message := "Stack github.com/fullstack-lang/gong/lib/cursor/go, Unkown stack: \"" + stackPath + "\"\n"
	...
	if _, err := db.First(&cursorDB, r.PathValue("id")); err != nil {
		var returnError GenericError
		returnError.Body.Code = http.StatusBadRequest
		returnError.Body.Message = err.Error()
		log.Println(err.Error())
	...
	writeJSON(w, http.StatusOK, cursorAPI)
}
...
func (controller *Controller) UpdateCursor(w http.ResponseWriter, r *http.Request) {
	...
	backRepo := controller.Map_BackRepos[stackPath]
	if backRepo == nil {
		message := "PATCH Stack github.com/fullstack-lang/gong/lib/cursor/go, Unkown stack: \"" + stackPath + "\"\n"
...
//
//	200: cursorDBResponse
func (controller *Controller) DeleteCursor(w http.ResponseWriter, r *http.Request) {
	...
	if len(_values) == 1 {
		...
		if len(value) == 1 {
			stackPath = value[0]
			// log.Println("DeleteCursor", "Name", stackPath)
		}
	}
	backRepo := controller.Map_BackRepos[stackPath]
	if backRepo == nil {
		message := "DELETE Stack github.com/fullstack-lang/gong/lib/cursor/go, Unkown stack: \"" + stackPath + "\"\n"
