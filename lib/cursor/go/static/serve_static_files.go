...
import (
	...
	"github.com/fullstack-lang/gong/lib/cursor"
...
func ServeStaticFiles(logGINFlag bool) (r *gin.Engine) {
	...
	r.Use(static.Serve("/", EmbedFolder(cursor.NgDistNg, "ng-github.com-fullstack-lang-gong-lib-cursor/dist/ng-github.com-fullstack-lang-gong-lib-cursor/browser")))
