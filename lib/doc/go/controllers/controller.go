...
import (
	...
	doc_orm "github.com/fullstack-lang/gong/lib/doc/go/orm"
...
type Controller struct {
	...
	Map_BackRepos map[string]*doc_orm.BackRepoStruct
...
func GetController() *Controller {
	doControllerInitOnce.Do(func() {
		_controllerSingloton = &Controller{
			Map_BackRepos: make(map[string]*doc_orm.BackRepoStruct),
		}
	})
	return _controllerSingloton
}

func (controller *Controller) AddBackRepo(backRepo *doc_orm.BackRepoStruct, stackPath string) {
