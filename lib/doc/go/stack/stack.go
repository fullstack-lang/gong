...
import (
	...
	"github.com/fullstack-lang/gong/lib/doc/go/fullstack"
...
func (impl *BeforeCommitImplementation) BeforeCommit(stage *models.StageStruct) {
	...
	stage.Checkout()
	stage.Marshall(file, "github.com/fullstack-lang/gong/lib/doc/go/models", "main")
}
...
func NewStack(
	...
	if withProbe {
		stack.Probe = probe.NewProbe(r, doc_go.GoModelsDir, doc_go.GoDiagramsDir,
