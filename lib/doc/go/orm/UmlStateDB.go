...
func (backRepoUmlState *BackRepoUmlStateStruct) GetStage() (stage *models.Stage) {
...
func (backRepoUmlState *BackRepoUmlStateStruct) CommitPhaseOne(stage *models.Stage) (Error error) {

	var umlstates []*models.UmlState
	for umlstate := range stage.UmlStates {
		umlstates = append(umlstates, umlstate)
	}

	// Sort by the order stored in Map_Staged_Order.
	sort.Slice(umlstates, func(i, j int) bool {
		return stage.UmlStateMap_Staged_Order[umlstates[i]] < stage.UmlStateMap_Staged_Order[umlstates[j]]
	})

	for _, umlstate := range umlstates {
