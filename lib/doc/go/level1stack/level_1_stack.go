...
import (
	...
	"github.com/fullstack-lang/gong/lib/doc/go/models/probe"

	embeddedgo "github.com/fullstack-lang/gong/lib/doc/go"
...
func (impl *BeforeCommitImplementation) BeforeCommit(stage *models.Stage) {
	...
	stage.MarshallFile(fmt.Sprintf("./%s", filename), "github.com/fullstack-lang/gong/lib/doc/go/models", packageName)
}
