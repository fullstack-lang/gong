...
func (stage *Stage) __gong__buildExcelizeFile(addIDs bool) *excelize.File {
	f := excelize.NewFile()
	{
		// insertion point
		{
			...
			stage.SerializeExcelize(f, "AttributeShape", instances, (*AttributeShape)(nil).GongGetFieldHeaders(), addIDs)
		}
		{
			var instances []GongstructIF
			...
			stage.SerializeExcelize(f, "Classdiagram", instances, (*Classdiagram)(nil).GongGetFieldHeaders(), addIDs)
		}
		{
			var instances []GongstructIF
			...
			stage.SerializeExcelize(f, "DiagramPackage", instances, (*DiagramPackage)(nil).GongGetFieldHeaders(), addIDs)
		}
		{
			var instances []GongstructIF
			...
			stage.SerializeExcelize(f, "GongEnumShape", instances, (*GongEnumShape)(nil).GongGetFieldHeaders(), addIDs)
		}
		{
			var instances []GongstructIF
			...
			stage.SerializeExcelize(f, "GongEnumValueShape", instances, (*GongEnumValueShape)(nil).GongGetFieldHeaders(), addIDs)
		}
		{
			var instances []GongstructIF
			...
			stage.SerializeExcelize(f, "GongNoteLinkShape", instances, (*GongNoteLinkShape)(nil).GongGetFieldHeaders(), addIDs)
		}
		{
			var instances []GongstructIF
			...
			stage.SerializeExcelize(f, "GongNoteShape", instances, (*GongNoteShape)(nil).GongGetFieldHeaders(), addIDs)
		}
		{
			var instances []GongstructIF
			...
			stage.SerializeExcelize(f, "GongStructShape", instances, (*GongStructShape)(nil).GongGetFieldHeaders(), addIDs)
		}
		{
			var instances []GongstructIF
			...
			stage.SerializeExcelize(f, "LinkShape", instances, (*LinkShape)(nil).GongGetFieldHeaders(), addIDs)
		}
	}
