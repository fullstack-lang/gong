...
type Stage struct {
	...
	FieldOrder            uint
	FieldMap_Staged_Order map[*Field]uint
...
func GetStructInstancesByOrderAuto[T PointerToGongstruct](stage *Stage) (res []T) {
	...
	case *DiagramPackage:
		...
		return res
	case *Field:
		tmp := GetStructInstancesByOrder(stage.Fields, stage.FieldMap_Staged_Order)
		...
		for _, v := range tmp {
			// Assert that the element 'v' can be treated as type 'T'.
			// Note: This relies on the constraint that PointerToGongstruct
			// is an interface that *Field implements.
			res = append(res, any(v).(T))
		}
		return res
	case *GongEnumShape:
	...
	case *GongEnumValueEntry:
		tmp := GetStructInstancesByOrder(stage.GongEnumValueEntrys, stage.GongEnumValueEntryMap_Staged_Order)
		...
		for _, v := range tmp {
			// Assert that the element 'v' can be treated as type 'T'.
			// Note: This relies on the constraint that PointerToGongstruct
			// is an interface that *GongEnumValueEntry implements.
			res = append(res, any(v).(T))
		}
		return res
	...
	case *NoteShape:
		...
		return res
	case *NoteShapeLink:
		tmp := GetStructInstancesByOrder(stage.NoteShapeLinks, stage.NoteShapeLinkMap_Staged_Order)
		...
		for _, v := range tmp {
			// Assert that the element 'v' can be treated as type 'T'.
			// Note: This relies on the constraint that PointerToGongstruct
			// is an interface that *NoteShapeLink implements.
			res = append(res, any(v).(T))
		}
		return res
	case *Position:
		tmp := GetStructInstancesByOrder(stage.Positions, stage.PositionMap_Staged_Order)
		...
		return res
	case *UmlState:
		tmp := GetStructInstancesByOrder(stage.UmlStates, stage.UmlStateMap_Staged_Order)
		...
		for _, v := range tmp {
			// Assert that the element 'v' can be treated as type 'T'.
			// Note: This relies on the constraint that PointerToGongstruct
			// is an interface that *UmlState implements.
			res = append(res, any(v).(T))
		}
		return res
	case *Umlsc:
		tmp := GetStructInstancesByOrder(stage.Umlscs, stage.UmlscMap_Staged_Order)
		...
		for _, v := range tmp {
			// Assert that the element 'v' can be treated as type 'T'.
			// Note: This relies on the constraint that PointerToGongstruct
			// is an interface that *Umlsc implements.
			res = append(res, any(v).(T))
		}
		return res
	case *Vertice:
		tmp := GetStructInstancesByOrder(stage.Vertices, stage.VerticeMap_Staged_Order)
		...
		for _, v := range tmp {
			// Assert that the element 'v' can be treated as type 'T'.
			// Note: This relies on the constraint that PointerToGongstruct
			// is an interface that *Vertice implements.
			res = append(res, any(v).(T))
		}
		return res
...
func NewStage(name string) (stage *Stage) {
	...
	stage = &Stage{ // insertion point for array initiatialisation
		...
		FieldMap_Staged_Order: make(map[*Field]uint),
