...
import (
	...
	"github.com/fullstack-lang/gong/lib/doc"
...
func ServeStaticFiles(logGINFlag bool) (r *gin.Engine) {
	...
	r.Use(static.Serve("/", EmbedFolder(doc.NgDistNg, "ng-github.com-fullstack-lang-gong-lib-doc/dist/ng-github.com-fullstack-lang-gong-lib-doc/browser")))
