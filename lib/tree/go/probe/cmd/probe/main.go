...
import (
	...
	"github.com/fullstack-lang/gong/lib/tree/go/stack"
	"github.com/fullstack-lang/gong/lib/tree/go/static"
...
func executeServer() {
	...
	stack := stack.NewStack(r, "tree", unmarshallFromCode, marshallOnCommit, "", embeddedDiagrams, true)
