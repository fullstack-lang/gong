...
//
//	200: menuDBResponse
func (controller *Controller) GetMenus(w http.ResponseWriter, r *http.Request) {
	...
	writeJSON(w, http.StatusOK, menuAPIs)
}
...
//	Responses:
//	  200: nodeDBResponse
func (controller *Controller) PostMenu(w http.ResponseWriter, r *http.Request) {
...
//
//	200: menuDBResponse
func (controller *Controller) GetMenu(w http.ResponseWriter, r *http.Request) {
	...
	if _, err := db.First(&menuDB, r.PathValue("id")); err != nil {
		var returnError GenericError
		returnError.Body.Code = http.StatusBadRequest
		returnError.Body.Message = err.Error()
		log.Println(err.Error())
	...
	writeJSON(w, http.StatusOK, menuAPI)
}
...
//
//	200: menuDBResponse
func (controller *Controller) DeleteMenu(w http.ResponseWriter, r *http.Request) {
