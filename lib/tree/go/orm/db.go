...
func (db *DBLite) Create(instanceDB any) (db.DBInterface, error) {
	if instanceDB == nil {
		return nil, errors.New("github.com/fullstack-lang/gong/lib/tree/go, instanceDB cannot be nil")
	}
	...
	case *TreeDB:
		...
		db.treeDBs[v.ID] = v
	default:
		return nil, errors.New("github.com/fullstack-lang/gong/lib/tree/go, unsupported type in Create")
	}
	return db, nil
}
...
func (db *DBLite) Delete(instanceDB any) (db.DBInterface, error) {
	...
	default:
		return nil, errors.New("github.com/fullstack-lang/gong/lib/tree/go, unsupported type in Delete")
	}
	return db, nil
}
...
func (db *DBLite) Save(instanceDB any) (db.DBInterface, error) {
	...
	case *TreeDB:
		...
		return db, nil
	default:
		return nil, errors.New("github.com/fullstack-lang/gong/lib/tree/go, Save: unsupported type")
	}
}
	...
	case *NodeDB:
		if existing, ok := db.nodeDBs[v.ID]; ok {
			*existing = *v
			...
			return nil, errors.New("db Node github.com/fullstack-lang/gong/lib/tree/go, record not found")
		}
	case *SVGIconDB:
		if existing, ok := db.svgiconDBs[v.ID]; ok {
			*existing = *v
		} else {
			return nil, errors.New("db SVGIcon github.com/fullstack-lang/gong/lib/tree/go, record not found")
		}
	case *TreeDB:
		if existing, ok := db.treeDBs[v.ID]; ok {
			*existing = *v
		} else {
			return nil, errors.New("db Tree github.com/fullstack-lang/gong/lib/tree/go, record not found")
		}
	default:
		return nil, errors.New("github.com/fullstack-lang/gong/lib/tree/go, unsupported type in Updates")
	}
	return db, nil
}
...
func (db *DBLite) Find(instanceDBs any) (db.DBInterface, error) {
	...
	case *[]TreeDB:
		*ptr = make([]TreeDB, 0, len(db.treeDBs))
		...
		return db, nil
	default:
		return nil, errors.New("github.com/fullstack-lang/gong/lib/tree/go, Find: unsupported type")
	}
}
...
func (db *DBLite) First(instanceDB any, conds ...any) (db.DBInterface, error) {
	if len(conds) != 1 {
		return nil, errors.New("github.com/fullstack-lang/gong/lib/tree/go, Do not process when conds is not a single parameter")
	}
	...
	case string:
		...
		if err != nil {
			return nil, errors.New("github.com/fullstack-lang/gong/lib/tree/go, conds[0] is not a string number")
		}
	case uint64:
		i = cond
	case uint:
		i = uint64(cond)
	default:
		return nil, errors.New("github.com/fullstack-lang/gong/lib/tree/go, conds[0] is not a string or uint64")
	}
