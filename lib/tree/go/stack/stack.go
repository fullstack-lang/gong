...
import (
	...
	"github.com/fullstack-lang/gong/lib/tree/go/fullstack"
	"github.com/fullstack-lang/gong/lib/tree/go/models"
	"github.com/fullstack-lang/gong/lib/tree/go/orm"
	"github.com/fullstack-lang/gong/lib/tree/go/probe"
...
func (impl *BeforeCommitImplementation) BeforeCommit(stage *models.Stage) {
	...
	stage.Checkout()
	stage.Marshall(file, "github.com/fullstack-lang/gong/lib/tree/go/models", packageName)
}
...
func NewStack(
	...
	if withProbe {
		if embeddedDiagrams {
			...
			stack.Probe = probe.NewProbe(r, tree_go.GoModelsDir, tree_go.GoDiagramsDir,
