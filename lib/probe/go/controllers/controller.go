...
import (
	...
	probe_orm "github.com/fullstack-lang/gong/lib/probe/go/orm"
...
type Controller struct {
	...
	Map_BackRepos map[string]*probe_orm.BackRepoStruct
...
func GetController() *Controller {
	doControllerInitOnce.Do(func() {
		_controllerSingloton = &Controller{
			Map_BackRepos: make(map[string]*probe_orm.BackRepoStruct),
		}
	})
