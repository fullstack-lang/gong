...
var __gong__map_Probe2 = make(map[string]*Probe2)
						...
						case *ast.CompositeLit:
							...
							case *ast.SelectorExpr:
								...
								if Sel := slcExpr.Sel; Sel != nil {
									...
									case "Probe2":
										instanceProbe2 := new(Probe2)
										instanceProbe2.Name = instanceName
										instanceProbe2.Stage(stage)
										instance = any(instanceProbe2)
										__gong__map_Probe2[identifier] = instanceProbe2
									}
		...
		case *ast.BasicLit, *ast.UnaryExpr, *ast.CompositeLit:
			...
			case "Probe2":
				...
				case "Name":
					...
					__gong__map_Probe2[identifier].Name = fielValue
				}
			}
		case *ast.Ident:
