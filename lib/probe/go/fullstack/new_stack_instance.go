...
import (
	"github.com/fullstack-lang/gong/lib/probe/go/controllers"
	...
	_ "github.com/fullstack-lang/gong/lib/probe/ng-github.com-fullstack-lang-gong-lib-probe"
)
...
func NewStackInstance(
	...
	// add orchestration
	// insertion point
	models.SetOrchestratorOnAfterUpdate[models.Probe2](stage)
