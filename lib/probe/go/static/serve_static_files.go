...
import (
	...
	"github.com/fullstack-lang/gong/lib/probe"
...
func ServeStaticFiles(logGINFlag bool) (r *gin.Engine) {
	...
	r.Use(static.Serve("/", EmbedFolder(probe.NgDistNg, "ng-github.com-fullstack-lang-gong-lib-probe/dist/ng-github.com-fullstack-lang-gong-lib-probe/browser")))
