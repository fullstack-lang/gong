...
import (
	...
	"github.com/fullstack-lang/gong/lib/tone/go/fullstack"
	"github.com/fullstack-lang/gong/lib/tone/go/models"
	"github.com/fullstack-lang/gong/lib/tone/go/orm"
	"github.com/fullstack-lang/gong/lib/tone/go/probe"
...
func (impl *BeforeCommitImplementation) BeforeCommit(stage *models.Stage) {
	...
	stage.Checkout()
	stage.Marshall(file, "github.com/fullstack-lang/gong/lib/tone/go/models", packageName)
}
...
func NewStack(
	...
	if withProbe {
		if embeddedDiagrams {
			...
			stack.Probe = probe.NewProbe(r, tone_go.GoModelsDir, tone_go.GoDiagramsDir,
