...
import (
	...
	"github.com/fullstack-lang/gong/lib/tone"
...
func ServeStaticFiles(logGINFlag bool) (r *gin.Engine) {
	...
	r.Use(static.Serve("/", EmbedFolder(tone.NgDistNg, "ng-github.com-fullstack-lang-gong-lib-tone/dist/ng-github.com-fullstack-lang-gong-lib-tone/browser")))
