...
import (
	...
	"github.com/fullstack-lang/gong/lib/tone/go/stack"
	"github.com/fullstack-lang/gong/lib/tone/go/static"
...
func executeServer() {
	...
	stack := stack.NewStack(r, "tone", unmarshallFromCode, marshallOnCommit, "", embeddedDiagrams, true)
