...
func (u *FreqencyUnmarshaller) Initialize(stage *Stage, instanceName string, preserveOrder bool) (GongstructIF, error) {
...
func (u *PlayerUnmarshaller) Initialize(stage *Stage, instanceName string, preserveOrder bool) (GongstructIF, error) {
	instance := new(Player)
	instance.Name = instanceName
	if !preserveOrder {
		instance.Stage(stage)
