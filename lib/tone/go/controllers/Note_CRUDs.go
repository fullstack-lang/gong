...
//
//	200: noteDBResponse
func (controller *Controller) GetNotes(w http.ResponseWriter, r *http.Request) {
	...
	writeJSON(w, http.StatusOK, noteAPIs)
}
...
//	Responses:
//	  200: nodeDBResponse
func (controller *Controller) PostNote(w http.ResponseWriter, r *http.Request) {
...
//
//	200: noteDBResponse
func (controller *Controller) GetNote(w http.ResponseWriter, r *http.Request) {
	...
	if _, err := db.First(&noteDB, r.PathValue("id")); err != nil {
		var returnError GenericError
		returnError.Body.Code = http.StatusBadRequest
		returnError.Body.Message = err.Error()
		log.Println(err.Error())
	...
	writeJSON(w, http.StatusOK, noteAPI)
}
...
//
//	200: noteDBResponse
func (controller *Controller) DeleteNote(w http.ResponseWriter, r *http.Request) {
