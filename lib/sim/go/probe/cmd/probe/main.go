...
import (
	...
	"github.com/fullstack-lang/gong/lib/sim/go/stack"
	"github.com/fullstack-lang/gong/lib/sim/go/static"
...
func executeServer() {
	...
	stack := stack.NewStack(r, "sim", unmarshallFromCode, marshallOnCommit, "", embeddedDiagrams, true)
