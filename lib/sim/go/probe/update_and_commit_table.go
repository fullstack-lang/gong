...
func updateAndCommitTablePointerToGongstruct[T models.PointerToGongstruct](
	...
	case *models.DummyAgent:
		updateAndCommitTable[models.DummyAgent](probe)
	case *models.Engine:
		updateAndCommitTable[models.Engine](probe)
	case *models.Event:
		updateAndCommitTable[models.Event](probe)
	case *models.Status:
		updateAndCommitTable[models.Status](probe)
	case *models.UpdateState:
		updateAndCommitTable[models.UpdateState](probe)
	default:
