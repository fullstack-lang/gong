...
func (controller *Controller) GetStatuss(w http.ResponseWriter, r *http.Request) {
	...
	writeJSON(w, http.StatusOK, statusAPIs)
}
...
//	Responses:
//	  200: nodeDBResponse
func (controller *Controller) PostStatus(w http.ResponseWriter, r *http.Request) {
...
func (controller *Controller) GetStatus(w http.ResponseWriter, r *http.Request) {
	...
	if _, err := db.First(&statusDB, r.PathValue("id")); err != nil {
		var returnError GenericError
		returnError.Body.Code = http.StatusBadRequest
		returnError.Body.Message = err.Error()
		log.Println(err.Error())
	...
	writeJSON(w, http.StatusOK, statusAPI)
}
...
//
//	200: statusDBResponse
func (controller *Controller) DeleteStatus(w http.ResponseWriter, r *http.Request) {
