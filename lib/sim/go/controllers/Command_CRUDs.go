...
func (controller *Controller) GetCommands(w http.ResponseWriter, r *http.Request) {
	...
	writeJSON(w, http.StatusOK, commandAPIs)
}
...
//	Responses:
//	  200: nodeDBResponse
func (controller *Controller) PostCommand(w http.ResponseWriter, r *http.Request) {
...
//
//	200: commandDBResponse
func (controller *Controller) GetCommand(w http.ResponseWriter, r *http.Request) {
	...
	if _, err := db.First(&commandDB, r.PathValue("id")); err != nil {
		var returnError GenericError
		returnError.Body.Code = http.StatusBadRequest
		returnError.Body.Message = err.Error()
		log.Println(err.Error())
	...
	writeJSON(w, http.StatusOK, commandAPI)
}
...
//
//	200: commandDBResponse
func (controller *Controller) DeleteCommand(w http.ResponseWriter, r *http.Request) {
