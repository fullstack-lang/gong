...
func (backRepoUpdateState *BackRepoUpdateStateStruct) GetStage() (stage *models.Stage) {
...
func (backRepoUpdateState *BackRepoUpdateStateStruct) CommitPhaseOne(stage *models.Stage) (Error error) {
	...
	sort.Slice(updatestates, func(i, j int) bool {
		return stage.UpdateState_stagedOrder[updatestates[i]] < stage.UpdateState_stagedOrder[updatestates[j]]
	})
