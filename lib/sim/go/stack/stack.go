...
import (
	...
	"github.com/fullstack-lang/gong/lib/sim/go/fullstack"
	"github.com/fullstack-lang/gong/lib/sim/go/models"
	"github.com/fullstack-lang/gong/lib/sim/go/orm"
	"github.com/fullstack-lang/gong/lib/sim/go/probe"
...
func (impl *BeforeCommitImplementation) BeforeCommit(stage *models.Stage) {
	...
	stage.Checkout()
	stage.Marshall(file, "github.com/fullstack-lang/gong/lib/sim/go/models", packageName)
}
...
func NewStack(
	...
	if withProbe {
		if embeddedDiagrams {
			...
			stack.Probe = probe.NewProbe(r, sim_go.GoModelsDir, sim_go.GoDiagramsDir,
