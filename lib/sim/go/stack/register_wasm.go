...
func registerWasmSocket(stackPath string, backRepo *orm.BackRepoStruct) {
	...
	fmt.Println("github.com/fullstack-lang/gong/lib/sim/go", "registerWasmSocket", stackPath)

	wasmregistry.Register("github.com/fullstack-lang/gong/lib/sim/go", stackPath, func(callback js.Value) {
		pushState := func() {
