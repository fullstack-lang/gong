...
func (u *CommandUnmarshaller) Initialize(stage *Stage, instanceName string, preserveOrder bool) (GongstructIF, error) {
...
func (u *DummyAgentUnmarshaller) Initialize(stage *Stage, instanceName string, preserveOrder bool) (GongstructIF, error) {
...
func (u *EngineUnmarshaller) Initialize(stage *Stage, instanceName string, preserveOrder bool) (GongstructIF, error) {
	instance := new(Engine)
	instance.Name = instanceName
	if !preserveOrder {
		instance.Stage(stage)
...
func (u *EventUnmarshaller) Initialize(stage *Stage, instanceName string, preserveOrder bool) (GongstructIF, error) {
	instance := new(Event)
	instance.Name = instanceName
	if !preserveOrder {
		instance.Stage(stage)
...
func (u *StatusUnmarshaller) Initialize(stage *Stage, instanceName string, preserveOrder bool) (GongstructIF, error) {
	instance := new(Status)
	instance.Name = instanceName
	if !preserveOrder {
		instance.Stage(stage)
...
func (u *UpdateStateUnmarshaller) Initialize(stage *Stage, instanceName string, preserveOrder bool) (GongstructIF, error) {
