...
func SerializeStage(stage *Stage, filename string) {
	...
	f := excelize.NewFile()
	{
		...
		SerializeExcelizePointerToGongstruct[*DummyAgent](stage, f)
		SerializeExcelizePointerToGongstruct[*Engine](stage, f)
		SerializeExcelizePointerToGongstruct[*Event](stage, f)
		SerializeExcelizePointerToGongstruct[*Status](stage, f)
		SerializeExcelizePointerToGongstruct[*UpdateState](stage, f)
	}
