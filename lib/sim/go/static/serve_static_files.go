...
import (
	...
	"github.com/fullstack-lang/gong/lib/sim"
...
func ServeStaticFiles(logGINFlag bool) (r *gin.Engine) {
	...
	r.Use(static.Serve("/", EmbedFolder(sim.NgDistNg, "ng-github.com-fullstack-lang-gong-lib-sim/dist/ng-github.com-fullstack-lang-gong-lib-sim/browser")))
