...
func registerWasmSocket(stackPath string, backRepo *orm.BackRepoStruct) {
	...
	fmt.Println("github.com/fullstack-lang/gong/lib/load/go", "registerWasmSocket", stackPath)

	wasmregistry.Register("github.com/fullstack-lang/gong/lib/load/go", stackPath, func(callback js.Value) {
		pushState := func() {
