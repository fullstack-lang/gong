...
import (
	...
	"github.com/fullstack-lang/gong/lib/load/go/fullstack"
	"github.com/fullstack-lang/gong/lib/load/go/models"
	"github.com/fullstack-lang/gong/lib/load/go/orm"
	"github.com/fullstack-lang/gong/lib/load/go/models/probe"
...
func (impl *BeforeCommitImplementation) BeforeCommit(stage *models.Stage) {
	...
	stage.Marshall(file, "github.com/fullstack-lang/gong/lib/load/go/models", packageName)
}
