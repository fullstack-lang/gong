...
import (
	...
	"github.com/fullstack-lang/gong/lib/load/go/stack"
	"github.com/fullstack-lang/gong/lib/load/go/static"
...
func executeServer() {
	...
	stack := stack.NewStack(r, "load", unmarshallFromCode, marshallOnCommit, "", embeddedDiagrams, true)
