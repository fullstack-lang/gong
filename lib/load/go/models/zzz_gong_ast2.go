...
func (u *FileToDownloadUnmarshaller) Initialize(stage *Stage, instanceName string, preserveOrder bool) (GongstructIF, error) {
...
type FileToUploadUnmarshaller struct{}

func (u *FileToUploadUnmarshaller) Initialize(stage *Stage, instanceName string, preserveOrder bool) (GongstructIF, error) {
	instance := new(FileToUpload)
	instance.Name = instanceName
	if !preserveOrder {
		instance.Stage(stage)
	} else {
...
func (u *FileToUploadUnmarshaller) UnmarshallField(stage *Stage, i GongstructIF, fieldName string, valueExpr ast.Expr, identifierMap map[string]GongstructIF) error {
	instance := i.(*FileToUpload)
	_ = instance
	switch fieldName {
	// insertion point per field
	case "Name":
