...
func (controller *Controller) GetMessages(w http.ResponseWriter, r *http.Request) {
	...
	writeJSON(w, http.StatusOK, messageAPIs)
}
...
//	Responses:
//	  200: nodeDBResponse
func (controller *Controller) PostMessage(w http.ResponseWriter, r *http.Request) {
...
//
//	200: messageDBResponse
func (controller *Controller) GetMessage(w http.ResponseWriter, r *http.Request) {
	...
	if _, err := db.First(&messageDB, r.PathValue("id")); err != nil {
		var returnError GenericError
		returnError.Body.Code = http.StatusBadRequest
		returnError.Body.Message = err.Error()
		log.Println(err.Error())
	...
	writeJSON(w, http.StatusOK, messageAPI)
}
...
//
//	200: messageDBResponse
func (controller *Controller) DeleteMessage(w http.ResponseWriter, r *http.Request) {
