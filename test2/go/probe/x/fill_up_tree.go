...
func fillUpTree(
	...
	for _, gongStruct := range sliceOfGongStructsSorted {
		...
		case "A":
			...
			set := *x.GetGongstructInstancesSet[x.A](playground.stageOfInterest)
			for _a := range set {
...
type InstanceNodeCallback[T x.Gongstruct] struct {
	Instance       *T
	gongstructName string
	playground     *Playground
}

func NewInstanceNodeCallback[T x.Gongstruct](
	instance *T,
	gongstructName string,
	playground *Playground) (
