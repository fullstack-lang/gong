...
func FormDivBasicFieldToField[TF x.GongtructBasicField](field *TF, formDiv *form.FormDiv) {
...
func FormDivEnumStringFieldToField[TF x.PointerToGongstructEnumStringField](field TF, formDiv *form.FormDiv) {
...
func FormDivEnumIntFieldToField[TF x.PointerToGongstructEnumIntField](field TF, formDiv *form.FormDiv) {
	if value := formDiv.FormFields[0].FormFieldSelect.Value; value != nil {
		if err := (field).FromCodeString(value.GetName()); err != nil {
			log.Println("Unkwnown enum value", value.GetName())
		}
...
func FormDivSelectFieldToField[TF x.PointerToGongstruct](field *TF, stageOfInterest *x.StageStruct, formDiv *form.FormDiv) {

	if formDiv.FormFields[0].FormFieldSelect.Value == nil {
		*field = nil
	} else {
		for _instance := range *x.GetGongstructInstancesSetFromPointerType[TF](stageOfInterest) {
