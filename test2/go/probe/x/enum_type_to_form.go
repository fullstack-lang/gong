...
func EnumTypeStringToForm[T x.PointerToGongstruct, TF x.GongstructEnumStringField](
...
func EnumTypeIntToForm[T x.PointerToGongstruct, TF x.GongstructEnumIntField](
	fieldName string, field TF, instance T, formStage *form.StageStruct, formGroup *form.FormGroup,
) {
	formDiv := (&form.FormDiv{
		Name: fieldName,
