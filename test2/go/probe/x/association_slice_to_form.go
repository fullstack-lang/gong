...
// - one for selection
// - one for sorting
func AssociationSliceToForm[InstanceType x.PointerToGongstruct, FieldType x.PointerToGongstruct](
	fieldName string,
...
type OnAssocEditon[InstanceType x.PointerToGongstruct, FieldType x.PointerToGongstruct] struct {
	instance   InstanceType
	field      *[]FieldType
	fieldName  string
	playground *Playground
...
func NewOnAssocEditon[InstanceType x.PointerToGongstruct, FieldType x.PointerToGongstruct](
	instance InstanceType,
	field *[]FieldType,
	fieldName string,
	playground *Playground,
...
func (onAssocEditon *OnAssocEditon[InstanceType, FieldType]) OnButtonPressed() {
	...
	instanceSet := *x.GetGongstructInstancesSetFromPointerType[FieldType](onAssocEditon.playground.stageOfInterest)
...
func NewTablePickSaver[InstanceType x.PointerToGongstruct, FieldType x.PointerToGongstruct](
	instance InstanceType,
	field *[]FieldType,
	fieldName string,
	playground *Playground,
...
type TablePickSaver[InstanceType x.PointerToGongstruct, FieldType x.PointerToGongstruct] struct {
	instance   InstanceType
	field      *[]FieldType
	fieldName  string
	playground *Playground
...
func (tablePickSaver *TablePickSaver[InstanceType, FieldType]) TableUpdated(
	...
	instanceSet := *x.GetGongstructInstancesSetFromPointerType[FieldType](tablePickSaver.playground.stageOfInterest)
	instanceSlice := make([]FieldType, 0)
	for instance := range instanceSet {
		instanceSlice = append(instanceSlice, instance)
	}
