...
func (nodeImplGongstruct *NodeImplGongstruct) OnAfterUpdate(
	...
	// insertion point
	if nodeImplGongstruct.gongStruct.GetName() == "Dummy" {
		fillUpTable[models.Dummy](nodeImplGongstruct.stageOfInterest, tableStage, nodeImplGongstruct.formStage, nodeImplGongstruct.r, nodeImplGongstruct.backRepoOfInterest)
	}
