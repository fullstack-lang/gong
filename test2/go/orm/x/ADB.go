...
type BackRepoAStruct struct {
	...
	Map_APtr_ADBID map[*x.A]uint

	// stores A according to their gorm ID
	Map_ADBID_APtr map[uint]*x.A
...
func (backRepoA *BackRepoAStruct) GetStage() (stage *x.StageStruct) {
...
func (backRepoA *BackRepoAStruct) GetADBFromAPtr(a *x.A) (aDB *ADB) {
...
func (backRepoA *BackRepoAStruct) CommitPhaseOne(stage *x.StageStruct) (Error error) {
...
// Phase One is the creation of instance in the database if it is not yet done to get the unique ID for each staged instance
func (backRepoA *BackRepoAStruct) CommitPhaseOneInstance(a *x.A) (Error error) {
...
// BackRepoA.CommitPhaseTwoInstance commits {{structname }} of x.A to the BackRepo
// Phase Two is the update of instance with the field in the database
func (backRepoA *BackRepoAStruct) CommitPhaseTwoInstance(backRepo *BackRepoStruct, idx uint, a *x.A) (Error error) {
...
func (backRepoA *BackRepoAStruct) CheckoutPhaseOne() (Error error) {
	...
	aInstancesToBeRemovedFromTheStage := make(map[*x.A]any)
...
func (backRepo *BackRepoStruct) CommitA(a *x.A) {
...
func (backRepo *BackRepoStruct) CheckoutA(a *x.A) {
...
func (aDB *ADB) CopyBasicFieldsFromA(a *x.A) {
...
func (aDB *ADB) CopyBasicFieldsFromA_WOP(a *x.A_WOP) {
	// insertion point for fields commit
...
// CopyBasicFieldsToA
func (aDB *ADB) CopyBasicFieldsToA(a *x.A) {
...
func (aDB *ADB) CopyBasicFieldsToA_WOP(a *x.A_WOP) {
	// insertion point for checkout of basic fields (back repo to stage)
	a.Name = aDB.Name_Data.String
	a.NumberField = int(aDB.NumberField_Data.Int64)
}
...
func (backRepoA *BackRepoAStruct) ResetReversePointersInstance(backRepo *BackRepoStruct, idx uint, astruct *x.A) (Error error) {
