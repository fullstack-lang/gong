...
type BackRepoBStruct struct {
	...
	Map_BPtr_BDBID map[*x.B]uint

	// stores B according to their gorm ID
	Map_BDBID_BPtr map[uint]*x.B
...
func (backRepoB *BackRepoBStruct) GetStage() (stage *x.StageStruct) {
...
func (backRepoB *BackRepoBStruct) GetBDBFromBPtr(b *x.B) (bDB *BDB) {
...
func (backRepoB *BackRepoBStruct) CommitPhaseOne(stage *x.StageStruct) (Error error) {
...
// Phase One is the creation of instance in the database if it is not yet done to get the unique ID for each staged instance
func (backRepoB *BackRepoBStruct) CommitPhaseOneInstance(b *x.B) (Error error) {
...
// BackRepoB.CommitPhaseTwoInstance commits {{structname }} of x.B to the BackRepo
// Phase Two is the update of instance with the field in the database
func (backRepoB *BackRepoBStruct) CommitPhaseTwoInstance(backRepo *BackRepoStruct, idx uint, b *x.B) (Error error) {
...
func (backRepoB *BackRepoBStruct) CheckoutPhaseOne() (Error error) {
	...
	bInstancesToBeRemovedFromTheStage := make(map[*x.B]any)
...
func (backRepoB *BackRepoBStruct) CheckoutPhaseTwoInstance(backRepo *BackRepoStruct, bDB *BDB) (Error error) {
	...
	_ = b // sometimes, there is no code generated. This lines voids the "unused variable" compilation error
...
func (backRepo *BackRepoStruct) CommitB(b *x.B) {
...
func (backRepo *BackRepoStruct) CheckoutB(b *x.B) {
...
func (bDB *BDB) CopyBasicFieldsFromB(b *x.B) {
...
func (bDB *BDB) CopyBasicFieldsFromB_WOP(b *x.B_WOP) {
	// insertion point for fields commit
...
// CopyBasicFieldsToB
func (bDB *BDB) CopyBasicFieldsToB(b *x.B) {
	// insertion point for checkout of basic fields (back repo to stage)
	b.Name = bDB.Name_Data.String
}

// CopyBasicFieldsToB_WOP
func (bDB *BDB) CopyBasicFieldsToB_WOP(b *x.B_WOP) {
	// insertion point for checkout of basic fields (back repo to stage)
	b.Name = bDB.Name_Data.String
}
...
func (backRepoB *BackRepoBStruct) ResetReversePointersInstance(backRepo *BackRepoStruct, idx uint, astruct *x.B) (Error error) {
