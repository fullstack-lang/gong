...
type Controller struct {
	...
	Map_BackRepos map[string]*orm_x.BackRepoStruct
}
...
func GetController() *Controller {
	doControllerInitOnce.Do(func() {
		_controllerSingloton = &Controller{
			Map_BackRepos: make(map[string]*orm_x.BackRepoStruct),
		}
	})
	return _controllerSingloton
}

func (controller *Controller) AddBackRepo(backRepo *orm_x.BackRepoStruct, stackPath string) {
