...
import (
	...
	"github.com/fullstack-lang/gong/test3/go/fullstack"
	"github.com/fullstack-lang/gong/test3/go/models"
	"github.com/fullstack-lang/gong/test3/go/orm"
	"github.com/fullstack-lang/gong/test3/go/probe"

	test3_go "github.com/fullstack-lang/gong/test3/go"
...
func (impl *BeforeCommitImplementation) BeforeCommit(stage *models.StageStruct) {
	...
	stage.Checkout()
	stage.Marshall(file, "github.com/fullstack-lang/gong/test3/go/models", "main")
}
...
func NewStack(
	...
	if withProbe {
		stack.Probe = probe.NewProbe(r, test3_go.GoModelsDir, test3_go.GoDiagramsDir,
