...
func (controller *Controller) onWebSocketRequestForBackRepoContent(c *gin.Context) {
	...
	// log.Println("Stack github.com/fullstack-lang/gong/test3/go, onWebSocketRequestForBackRepoContent, first sent back repo of", stackPath)
	if err != nil {
		...
		default:
			for nbCommitBackRepo := range updateCommitBackRepoNbChannel {
				...
				if err != nil {
					...
					log.Println("github.com/fullstack-lang/gong/test3/go:", stackPath, "sent backRepoData")
				}
			}
		}
	}
