...
func (controller *Controller) onWebSocketRequestForCommitFromBackNb(c *gin.Context) {
	...
	// log.Println("Stack github.com/fullstack-lang/gong/test3/go, onWebSocketRequestForCommitFromBackNb")
...
func (controller *Controller) onWebSocketRequestForBackRepoContent(c *gin.Context) {
	...
	for nbCommitBackRepo := range updateCommitBackRepoNbChannel {
		...
		// log.Println("Stack github.com/fullstack-lang/gong/test3/go, onWebSocketRequestForBackRepoContent, sent back repo of", stackPath)
