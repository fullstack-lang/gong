...
export class GongEnumsTableComponent implements OnInit {
    ...
    this.frontRepoService.pull().subscribe(
      frontRepo => {
        ...
        if (this.mode == TableComponentMode.MANY_MANY_ASSOCIATION_MODE) {
          ...
          let sourceField = sourceInstance[this.dialogData.SourceField as keyof typeof sourceInstance]! as unknown as GongEnumDB[]
  ...
  setEditorRouterOutlet(gongenumID: number) {
    this.router.navigate([{
      outlets: {
        github_com_fullstack_lang_gong_go_editor: ["github_com_fullstack_lang_gong_go-" + "gongenum-detail", gongenumID]
      }
    }]);
  }
  ...
  setPresentationRouterOutlet(gongenumID: number) {
    this.router.navigate([{
      outlets: {
        github_com_fullstack_lang_gong_go_presentation: ["github_com_fullstack_lang_gong_go-" + "gongenum-presentation", gongenumID]
      }
    }]);
  }
