...
import (
	...
	"github.com/fullstack-lang/gong/app/xsd/tests/reqif/go/level1stack"
...
func executeServer() {
	...
	stack := level1stack.NewLevel1Stack("reqif", unmarshallFromCode, marshallOnCommit, true, embeddedDiagrams)
