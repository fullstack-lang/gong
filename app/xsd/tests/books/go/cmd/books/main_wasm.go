...
import (
	...
	"github.com/fullstack-lang/gong/app/xsd/tests/books/go/level1stack"
...
func main() {
	...
	log.Println("Initializing books WASM Backend...")
	...
	stack := level1stack.NewLevel1StackDelta("books", unmarshallFromCode, marshallOnCommit, true, embeddedDiagrams, true)
