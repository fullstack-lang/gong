...
func (stage *Stage) __gong__buildExcelizeFile(addIDs bool) *excelize.File {
	f := excelize.NewFile()
	{
		// insertion point
		{
			...
			stage.SerializeExcelize(f, "BookType", instances, (*BookType)(nil).GongGetFieldHeaders(), addIDs)
		}
		{
			var instances []GongstructIF
			...
			stage.SerializeExcelize(f, "Books", instances, (*Books)(nil).GongGetFieldHeaders(), addIDs)
		}
		{
			var instances []GongstructIF
