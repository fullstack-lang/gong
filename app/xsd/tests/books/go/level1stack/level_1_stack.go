...
import (
	...
	"github.com/fullstack-lang/gong/app/xsd/tests/books/go/models/probe"
...
func (impl *BeforeCommitImplementation) BeforeCommit(stage *models.Stage) {
	...
	stage.MarshallFile(fmt.Sprintf("./%s", filename), "github.com/fullstack-lang/gong/app/xsd/tests/books/go/models", packageName)
}
