...
func NewProbe(
	...
	stageOfInterest.MetaPackageImportPath = "github.com/fullstack-lang/gong/app/xsd/tests/musicxml/go/models"
	...
	probe.docStager = prepare.Prepare(
		...
		"github.com/fullstack-lang/gong/app/xsd/tests/musicxml/go"+":"+stageOfInterest.GetName(),
...
func (probe *Probe) ExportStageExcel() {
	...
	if probe.fileName == "" {
		probe.fileName = "musicxml-" + probe.stageOfInterest.GetName() + ".go"
	}
