...
func (attribute_definition_boolean_renderingFormCallback *ATTRIBUTE_DEFINITION_BOOLEAN_RenderingFormCallback) OnSave() {
	...
	attribute_definition_boolean_renderingFormCallback.probe.ux_tree()
}
...
func (attribute_definition_date_renderingFormCallback *ATTRIBUTE_DEFINITION_DATE_RenderingFormCallback) OnSave() {
	...
	attribute_definition_date_renderingFormCallback.probe.ux_tree()
}
...
func (attribute_definition_enumeration_renderingFormCallback *ATTRIBUTE_DEFINITION_ENUMERATION_RenderingFormCallback) OnSave() {
	...
	attribute_definition_enumeration_renderingFormCallback.probe.ux_tree()
}
...
func (attribute_definition_integer_renderingFormCallback *ATTRIBUTE_DEFINITION_INTEGER_RenderingFormCallback) OnSave() {
	...
	attribute_definition_integer_renderingFormCallback.probe.ux_tree()
}
...
func (attribute_definition_real_renderingFormCallback *ATTRIBUTE_DEFINITION_REAL_RenderingFormCallback) OnSave() {
	...
	attribute_definition_real_renderingFormCallback.probe.ux_tree()
}
...
func (attribute_definition_renderingFormCallback *ATTRIBUTE_DEFINITION_RenderingFormCallback) OnSave() {
	...
	attribute_definition_renderingFormCallback.probe.ux_tree()
}
...
func (attribute_definition_string_renderingFormCallback *ATTRIBUTE_DEFINITION_STRING_RenderingFormCallback) OnSave() {
	...
	attribute_definition_string_renderingFormCallback.probe.ux_tree()
}
...
func (attribute_definition_xhtml_renderingFormCallback *ATTRIBUTE_DEFINITION_XHTML_RenderingFormCallback) OnSave() {
	...
	attribute_definition_xhtml_renderingFormCallback.probe.ux_tree()
}
...
func (embeddedjpgimageFormCallback *EmbeddedJpgImageFormCallback) OnSave() {
	...
	embeddedjpgimageFormCallback.probe.ux_tree()
}
...
func (embeddedpngimageFormCallback *EmbeddedPngImageFormCallback) OnSave() {
	...
	embeddedpngimageFormCallback.probe.ux_tree()
}
...
func (embeddedsvgimageFormCallback *EmbeddedSvgImageFormCallback) OnSave() {
	...
	embeddedsvgimageFormCallback.probe.ux_tree()
}
...
func __gong__New__Map_identifier_boolFormCallback(
	map_identifier_bool *models.Map_identifier_bool,
	probe *Probe,
	formGroup *form.FormGroup,
) (map_identifier_boolFormCallback *Map_identifier_boolFormCallback) {
	map_identifier_boolFormCallback = new(Map_identifier_boolFormCallback)
	map_identifier_boolFormCallback.probe = probe
	map_identifier_boolFormCallback.map_identifier_bool = map_identifier_bool
	map_identifier_boolFormCallback.formGroup = formGroup

	map_identifier_boolFormCallback.CreationMode = (map_identifier_bool == nil)

	return
}

type Map_identifier_boolFormCallback struct {
	map_identifier_bool *models.Map_identifier_bool
...
func (map_identifier_boolFormCallback *Map_identifier_boolFormCallback) OnSave() {
	...
	// checkout formStage to have the form group on the stage synchronized with the
	// back repo (and front repo)
	map_identifier_boolFormCallback.probe.formStage.Checkout()

	if map_identifier_boolFormCallback.map_identifier_bool == nil {
		map_identifier_boolFormCallback.map_identifier_bool = new(models.Map_identifier_bool).Stage(map_identifier_boolFormCallback.probe.stageOfInterest)
	}
	map_identifier_bool_ := map_identifier_boolFormCallback.map_identifier_bool
	_ = map_identifier_bool_

	for _, formDiv := range map_identifier_boolFormCallback.formGroup.FormDivs {
		switch formDiv.Name {
		// insertion point per field
		case "Name":
	...
	// manage the suppress operation
	if map_identifier_boolFormCallback.formGroup.HasSuppressButtonBeenPressed {
		map_identifier_bool_.Unstage(map_identifier_boolFormCallback.probe.stageOfInterest)
	}
	...
	if map_identifier_boolFormCallback.CreationMode || map_identifier_boolFormCallback.formGroup.HasSuppressButtonBeenPressed {
		map_identifier_boolFormCallback.probe.formStage.Reset()
		newFormGroup := (&form.FormGroup{
			Name: FormName,
		}).Stage(map_identifier_boolFormCallback.probe.formStage)
		newFormGroup.OnSave = __gong__New__Map_identifier_boolFormCallback(
			nil,
			map_identifier_boolFormCallback.probe,
			newFormGroup,
		)
		map_identifier_bool := new(models.Map_identifier_bool)
		FillUpForm(map_identifier_bool, newFormGroup, map_identifier_boolFormCallback.probe)
		map_identifier_boolFormCallback.probe.formStage.Commit()
	}

	map_identifier_boolFormCallback.probe.ux_tree()
}
...
func (specification_renderingFormCallback *SPECIFICATION_RenderingFormCallback) OnSave() {
	...
	specification_renderingFormCallback.probe.ux_tree()
}
...
func (spec_object_type_renderingFormCallback *SPEC_OBJECT_TYPE_RenderingFormCallback) OnSave() {
	...
	spec_object_type_renderingFormCallback.probe.ux_tree()
}
...
func (staticwebsiteFormCallback *StaticWebSiteFormCallback) OnSave() {
	...
	for _, formDiv := range staticwebsiteFormCallback.formGroup.FormDivs {
		...
		case "Chapters":
			...
			instanceSet := *staticwebsiteFormCallback.probe.stageOfInterest.GetInstancesSet[*models.StaticWebSiteChapter]()
			...
			for instance := range instanceSet {
				id := staticwebsiteFormCallback.probe.stageOfInterest.GetOrder(
					instance,
				)
				map_id_instances[id] = instance
			}
			...
			map_RowID_ID := GetMap_RowID_ID[*models.StaticWebSiteChapter](staticwebsiteFormCallback.probe.stageOfInterest)
			...
			staticwebsiteFormCallback.probe.UpdateSliceOfPointersCallback(staticwebsite_, "Chapters", &staticwebsite_.Chapters)
	...
	staticwebsiteFormCallback.probe.ux_tree()
}
...
func (staticwebsitechapterFormCallback *StaticWebSiteChapterFormCallback) OnSave() {
	...
	for _, formDiv := range staticwebsitechapterFormCallback.formGroup.FormDivs {
		...
		case "Paragraphs":
			...
			instanceSet := *staticwebsitechapterFormCallback.probe.stageOfInterest.GetInstancesSet[*models.StaticWebSiteParagraph]()
			...
			for instance := range instanceSet {
				id := staticwebsitechapterFormCallback.probe.stageOfInterest.GetOrder(
					instance,
				)
				map_id_instances[id] = instance
			}
			...
			map_RowID_ID := GetMap_RowID_ID[*models.StaticWebSiteParagraph](staticwebsitechapterFormCallback.probe.stageOfInterest)
		...
		case "StaticWebSite:Chapters":
			...
			// 2. Build a map of target StaticWebSite instances by their ID
			map_RowID_ID := GetMap_RowID_ID[*models.StaticWebSite](staticwebsitechapterFormCallback.probe.stageOfInterest)
			targetStaticWebSiteIDs := make(map[uint]bool)
			for _, rowID := range rowIDs {
				if id, ok := map_RowID_ID[int(rowID)]; ok {
					targetStaticWebSiteIDs[id] = true
				} else {
					log.Panic("not a good storage", formDiv.FormEditAssocButton.AssociationStorage, "unknown row id", rowID)
				}
			}

			// 3. Iterate over all StaticWebSite instances and update their Chapters slice
			for _staticwebsite := range *staticwebsitechapterFormCallback.probe.stageOfInterest.GetInstancesSet[*models.StaticWebSite]() {
				id := staticwebsitechapterFormCallback.probe.stageOfInterest.GetOrder(_staticwebsite)
				
				// if StaticWebSite is selected
				if targetStaticWebSiteIDs[id] {
					// ensure staticwebsitechapter_ is in _staticwebsite.Chapters
					found := false
					for _, _b := range _staticwebsite.Chapters {
						if _b == staticwebsitechapter_ {
							found = true
							break
						}
					}
					if !found {
						_staticwebsite.Chapters = append(_staticwebsite.Chapters, staticwebsitechapter_)
						staticwebsitechapterFormCallback.probe.UpdateSliceOfPointersCallback(_staticwebsite, "Chapters", &_staticwebsite.Chapters)
					}
				} else {
					// ensure staticwebsitechapter_ is NOT in _staticwebsite.Chapters
					idx := slices.Index(_staticwebsite.Chapters, staticwebsitechapter_)
					if idx != -1 {
						_staticwebsite.Chapters = slices.Delete(_staticwebsite.Chapters, idx, idx+1)
						staticwebsitechapterFormCallback.probe.UpdateSliceOfPointersCallback(_staticwebsite, "Chapters", &_staticwebsite.Chapters)
					}
				}
			}
	...
	staticwebsitechapterFormCallback.probe.ux_tree()
}
...
func (staticwebsitegeneratedimageFormCallback *StaticWebSiteGeneratedImageFormCallback) OnSave() {
	...
	staticwebsitegeneratedimageFormCallback.probe.ux_tree()
}
...
func (staticwebsiteimageFormCallback *StaticWebSiteImageFormCallback) OnSave() {
	...
	staticwebsiteimageFormCallback.probe.ux_tree()
}
...
func (staticwebsiteparagraphFormCallback *StaticWebSiteParagraphFormCallback) OnSave() {
	...
	for _, formDiv := range staticwebsiteparagraphFormCallback.formGroup.FormDivs {
		...
		case "StaticWebSiteChapter:Paragraphs":
			...
			// 2. Build a map of target StaticWebSiteChapter instances by their ID
			map_RowID_ID := GetMap_RowID_ID[*models.StaticWebSiteChapter](staticwebsiteparagraphFormCallback.probe.stageOfInterest)
			targetStaticWebSiteChapterIDs := make(map[uint]bool)
			for _, rowID := range rowIDs {
				if id, ok := map_RowID_ID[int(rowID)]; ok {
					targetStaticWebSiteChapterIDs[id] = true
				} else {
					log.Panic("not a good storage", formDiv.FormEditAssocButton.AssociationStorage, "unknown row id", rowID)
				}
			}

			// 3. Iterate over all StaticWebSiteChapter instances and update their Paragraphs slice
			for _staticwebsitechapter := range *staticwebsiteparagraphFormCallback.probe.stageOfInterest.GetInstancesSet[*models.StaticWebSiteChapter]() {
				id := staticwebsiteparagraphFormCallback.probe.stageOfInterest.GetOrder(_staticwebsitechapter)
				
				// if StaticWebSiteChapter is selected
				if targetStaticWebSiteChapterIDs[id] {
					// ensure staticwebsiteparagraph_ is in _staticwebsitechapter.Paragraphs
					found := false
					for _, _b := range _staticwebsitechapter.Paragraphs {
						if _b == staticwebsiteparagraph_ {
							found = true
							break
						}
					}
					if !found {
						_staticwebsitechapter.Paragraphs = append(_staticwebsitechapter.Paragraphs, staticwebsiteparagraph_)
						staticwebsiteparagraphFormCallback.probe.UpdateSliceOfPointersCallback(_staticwebsitechapter, "Paragraphs", &_staticwebsitechapter.Paragraphs)
					}
				} else {
					// ensure staticwebsiteparagraph_ is NOT in _staticwebsitechapter.Paragraphs
					idx := slices.Index(_staticwebsitechapter.Paragraphs, staticwebsiteparagraph_)
					if idx != -1 {
						_staticwebsitechapter.Paragraphs = slices.Delete(_staticwebsitechapter.Paragraphs, idx, idx+1)
						staticwebsiteparagraphFormCallback.probe.UpdateSliceOfPointersCallback(_staticwebsitechapter, "Paragraphs", &_staticwebsitechapter.Paragraphs)
					}
				}
			}
	...
	staticwebsiteparagraphFormCallback.probe.ux_tree()
}
