...
func (stageSet *StageSet) MarshallToString(packageName string) (res string, err error) {
	...
	if stageSet.Stage != nil {
		...
		for _, attribute_definition_boolean_rendering := range attribute_definition_boolean_renderingOrdered {
			attribute_definition_boolean_renderingIdent := "__stage_0" + attribute_definition_boolean_rendering.GongGetIdentifier(stageSet.Stage)
			declarations.WriteString(fmt.Sprintf("\n\t%s := (&__stage_0__.ATTRIBUTE_DEFINITION_BOOLEAN_Rendering{Name: %s}).Stage(stageSet.Stage)", attribute_definition_boolean_renderingIdent, __gong__toRawStringLiteral(attribute_definition_boolean_rendering.Name)))
	...
	if stageSet.Stage != nil {
		...
		for _, attribute_definition_date_rendering := range attribute_definition_date_renderingOrdered {
			attribute_definition_date_renderingIdent := "__stage_0" + attribute_definition_date_rendering.GongGetIdentifier(stageSet.Stage)
			declarations.WriteString(fmt.Sprintf("\n\t%s := (&__stage_0__.ATTRIBUTE_DEFINITION_DATE_Rendering{Name: %s}).Stage(stageSet.Stage)", attribute_definition_date_renderingIdent, __gong__toRawStringLiteral(attribute_definition_date_rendering.Name)))
	...
	if stageSet.Stage != nil {
		...
		for _, attribute_definition_enumeration_rendering := range attribute_definition_enumeration_renderingOrdered {
			attribute_definition_enumeration_renderingIdent := "__stage_0" + attribute_definition_enumeration_rendering.GongGetIdentifier(stageSet.Stage)
			declarations.WriteString(fmt.Sprintf("\n\t%s := (&__stage_0__.ATTRIBUTE_DEFINITION_ENUMERATION_Rendering{Name: %s}).Stage(stageSet.Stage)", attribute_definition_enumeration_renderingIdent, __gong__toRawStringLiteral(attribute_definition_enumeration_rendering.Name)))
	...
	if stageSet.Stage != nil {
		...
		for _, attribute_definition_integer_rendering := range attribute_definition_integer_renderingOrdered {
			attribute_definition_integer_renderingIdent := "__stage_0" + attribute_definition_integer_rendering.GongGetIdentifier(stageSet.Stage)
			declarations.WriteString(fmt.Sprintf("\n\t%s := (&__stage_0__.ATTRIBUTE_DEFINITION_INTEGER_Rendering{Name: %s}).Stage(stageSet.Stage)", attribute_definition_integer_renderingIdent, __gong__toRawStringLiteral(attribute_definition_integer_rendering.Name)))
	...
	if stageSet.Stage != nil {
		...
		for _, attribute_definition_real_rendering := range attribute_definition_real_renderingOrdered {
			attribute_definition_real_renderingIdent := "__stage_0" + attribute_definition_real_rendering.GongGetIdentifier(stageSet.Stage)
			declarations.WriteString(fmt.Sprintf("\n\t%s := (&__stage_0__.ATTRIBUTE_DEFINITION_REAL_Rendering{Name: %s}).Stage(stageSet.Stage)", attribute_definition_real_renderingIdent, __gong__toRawStringLiteral(attribute_definition_real_rendering.Name)))
	...
	if stageSet.Stage != nil {
		...
		for _, attribute_definition_rendering := range attribute_definition_renderingOrdered {
			attribute_definition_renderingIdent := "__stage_0" + attribute_definition_rendering.GongGetIdentifier(stageSet.Stage)
			declarations.WriteString(fmt.Sprintf("\n\t%s := (&__stage_0__.ATTRIBUTE_DEFINITION_Rendering{Name: %s}).Stage(stageSet.Stage)", attribute_definition_renderingIdent, __gong__toRawStringLiteral(attribute_definition_rendering.Name)))
	...
	if stageSet.Stage != nil {
		...
		for _, attribute_definition_string_rendering := range attribute_definition_string_renderingOrdered {
			attribute_definition_string_renderingIdent := "__stage_0" + attribute_definition_string_rendering.GongGetIdentifier(stageSet.Stage)
			declarations.WriteString(fmt.Sprintf("\n\t%s := (&__stage_0__.ATTRIBUTE_DEFINITION_STRING_Rendering{Name: %s}).Stage(stageSet.Stage)", attribute_definition_string_renderingIdent, __gong__toRawStringLiteral(attribute_definition_string_rendering.Name)))
	...
	if stageSet.Stage != nil {
		...
		for _, attribute_definition_xhtml_rendering := range attribute_definition_xhtml_renderingOrdered {
			attribute_definition_xhtml_renderingIdent := "__stage_0" + attribute_definition_xhtml_rendering.GongGetIdentifier(stageSet.Stage)
			declarations.WriteString(fmt.Sprintf("\n\t%s := (&__stage_0__.ATTRIBUTE_DEFINITION_XHTML_Rendering{Name: %s}).Stage(stageSet.Stage)", attribute_definition_xhtml_renderingIdent, __gong__toRawStringLiteral(attribute_definition_xhtml_rendering.Name)))
	...
	if stageSet.Stage != nil {
		...
		for _, embeddedjpgimage := range embeddedjpgimageOrdered {
			embeddedjpgimageIdent := "__stage_0" + embeddedjpgimage.GongGetIdentifier(stageSet.Stage)
			declarations.WriteString(fmt.Sprintf("\n\t%s := (&__stage_0__.EmbeddedJpgImage{Name: %s}).Stage(stageSet.Stage)", embeddedjpgimageIdent, __gong__toRawStringLiteral(embeddedjpgimage.Name)))
	...
	if stageSet.Stage != nil {
		...
		for _, embeddedpngimage := range embeddedpngimageOrdered {
			embeddedpngimageIdent := "__stage_0" + embeddedpngimage.GongGetIdentifier(stageSet.Stage)
			declarations.WriteString(fmt.Sprintf("\n\t%s := (&__stage_0__.EmbeddedPngImage{Name: %s}).Stage(stageSet.Stage)", embeddedpngimageIdent, __gong__toRawStringLiteral(embeddedpngimage.Name)))
	...
	if stageSet.Stage != nil {
		...
		for _, embeddedsvgimage := range embeddedsvgimageOrdered {
			embeddedsvgimageIdent := "__stage_0" + embeddedsvgimage.GongGetIdentifier(stageSet.Stage)
			declarations.WriteString(fmt.Sprintf("\n\t%s := (&__stage_0__.EmbeddedSvgImage{Name: %s}).Stage(stageSet.Stage)", embeddedsvgimageIdent, __gong__toRawStringLiteral(embeddedsvgimage.Name)))
	...
	if stageSet.Stage != nil {
		...
		for _, kill := range killOrdered {
			killIdent := "__stage_0" + kill.GongGetIdentifier(stageSet.Stage)
			declarations.WriteString(fmt.Sprintf("\n\t%s := (&__stage_0__.Kill{Name: %s}).Stage(stageSet.Stage)", killIdent, __gong__toRawStringLiteral(kill.Name)))
	...
	if stageSet.Stage != nil {
		...
		for _, map_identifier_bool := range map_identifier_boolOrdered {
			map_identifier_boolIdent := "__stage_0" + map_identifier_bool.GongGetIdentifier(stageSet.Stage)
			declarations.WriteString(fmt.Sprintf("\n\t%s := (&__stage_0__.Map_identifier_bool{Name: %s}).Stage(stageSet.Stage)", map_identifier_boolIdent, __gong__toRawStringLiteral(map_identifier_bool.Name)))
	...
	if stageSet.Stage != nil {
		...
		for _, specification_rendering := range specification_renderingOrdered {
			specification_renderingIdent := "__stage_0" + specification_rendering.GongGetIdentifier(stageSet.Stage)
			declarations.WriteString(fmt.Sprintf("\n\t%s := (&__stage_0__.SPECIFICATION_Rendering{Name: %s}).Stage(stageSet.Stage)", specification_renderingIdent, __gong__toRawStringLiteral(specification_rendering.Name)))
	...
	if stageSet.Stage != nil {
		...
		for _, spec_object_type_rendering := range spec_object_type_renderingOrdered {
			spec_object_type_renderingIdent := "__stage_0" + spec_object_type_rendering.GongGetIdentifier(stageSet.Stage)
			declarations.WriteString(fmt.Sprintf("\n\t%s := (&__stage_0__.SPEC_OBJECT_TYPE_Rendering{Name: %s}).Stage(stageSet.Stage)", spec_object_type_renderingIdent, __gong__toRawStringLiteral(spec_object_type_rendering.Name)))
	...
	if stageSet.Stage != nil {
		...
		for _, staticwebsite := range staticwebsiteOrdered {
			staticwebsiteIdent := "__stage_0" + staticwebsite.GongGetIdentifier(stageSet.Stage)
			declarations.WriteString(fmt.Sprintf("\n\t%s := (&__stage_0__.StaticWebSite{Name: %s}).Stage(stageSet.Stage)", staticwebsiteIdent, __gong__toRawStringLiteral(staticwebsite.Name)))
	...
	if stageSet.Stage != nil {
		...
		for _, staticwebsitechapter := range staticwebsitechapterOrdered {
			staticwebsitechapterIdent := "__stage_0" + staticwebsitechapter.GongGetIdentifier(stageSet.Stage)
			declarations.WriteString(fmt.Sprintf("\n\t%s := (&__stage_0__.StaticWebSiteChapter{Name: %s}).Stage(stageSet.Stage)", staticwebsitechapterIdent, __gong__toRawStringLiteral(staticwebsitechapter.Name)))
	...
	if stageSet.Stage != nil {
		...
		for _, staticwebsitegeneratedimage := range staticwebsitegeneratedimageOrdered {
			staticwebsitegeneratedimageIdent := "__stage_0" + staticwebsitegeneratedimage.GongGetIdentifier(stageSet.Stage)
			declarations.WriteString(fmt.Sprintf("\n\t%s := (&__stage_0__.StaticWebSiteGeneratedImage{Name: %s}).Stage(stageSet.Stage)", staticwebsitegeneratedimageIdent, __gong__toRawStringLiteral(staticwebsitegeneratedimage.Name)))
	...
	if stageSet.Stage != nil {
		...
		for _, staticwebsiteimage := range staticwebsiteimageOrdered {
			staticwebsiteimageIdent := "__stage_0" + staticwebsiteimage.GongGetIdentifier(stageSet.Stage)
			declarations.WriteString(fmt.Sprintf("\n\t%s := (&__stage_0__.StaticWebSiteImage{Name: %s}).Stage(stageSet.Stage)", staticwebsiteimageIdent, __gong__toRawStringLiteral(staticwebsiteimage.Name)))
	...
	if stageSet.Stage != nil {
		...
		for _, staticwebsiteparagraph := range staticwebsiteparagraphOrdered {
			staticwebsiteparagraphIdent := "__stage_0" + staticwebsiteparagraph.GongGetIdentifier(stageSet.Stage)
			declarations.WriteString(fmt.Sprintf("\n\t%s := (&__stage_0__.StaticWebSiteParagraph{Name: %s}).Stage(stageSet.Stage)", staticwebsiteparagraphIdent, __gong__toRawStringLiteral(staticwebsiteparagraph.Name)))
			...
			if staticwebsiteparagraph.Image != nil {
				targetIdent := "__stage_0" + staticwebsiteparagraph.Image.GongGetIdentifier(stageSet.Stage)
...
import (
	...
	__stage_0__ "github.com/fullstack-lang/gong/app/reqif/go/models"
)
