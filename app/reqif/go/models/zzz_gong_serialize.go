...
func buildExcelizeFile(stage *Stage, addIDs bool) *excelize.File {
	f := excelize.NewFile()
	{
		...
		stage.SerializeExcelizePointer2[*ATTRIBUTE_DEFINITION_BOOLEAN_Rendering](f, addIDs)
		stage.SerializeExcelizePointer2[*ATTRIBUTE_DEFINITION_DATE](f, addIDs)
		stage.SerializeExcelizePointer2[*ATTRIBUTE_DEFINITION_DATE_Rendering](f, addIDs)
		stage.SerializeExcelizePointer2[*ATTRIBUTE_DEFINITION_ENUMERATION](f, addIDs)
		stage.SerializeExcelizePointer2[*ATTRIBUTE_DEFINITION_ENUMERATION_Rendering](f, addIDs)
		stage.SerializeExcelizePointer2[*ATTRIBUTE_DEFINITION_INTEGER](f, addIDs)
		stage.SerializeExcelizePointer2[*ATTRIBUTE_DEFINITION_INTEGER_Rendering](f, addIDs)
		stage.SerializeExcelizePointer2[*ATTRIBUTE_DEFINITION_REAL](f, addIDs)
		stage.SerializeExcelizePointer2[*ATTRIBUTE_DEFINITION_REAL_Rendering](f, addIDs)
		stage.SerializeExcelizePointer2[*ATTRIBUTE_DEFINITION_Rendering](f, addIDs)
		stage.SerializeExcelizePointer2[*ATTRIBUTE_DEFINITION_STRING](f, addIDs)
		stage.SerializeExcelizePointer2[*ATTRIBUTE_DEFINITION_STRING_Rendering](f, addIDs)
		stage.SerializeExcelizePointer2[*ATTRIBUTE_DEFINITION_XHTML](f, addIDs)
		stage.SerializeExcelizePointer2[*ATTRIBUTE_DEFINITION_XHTML_Rendering](f, addIDs)
		...
		stage.SerializeExcelizePointer2[*EmbeddedJpgImage](f, addIDs)
		stage.SerializeExcelizePointer2[*EmbeddedPngImage](f, addIDs)
		stage.SerializeExcelizePointer2[*EmbeddedSvgImage](f, addIDs)
		stage.SerializeExcelizePointer2[*Kill](f, addIDs)
		stage.SerializeExcelizePointer2[*Map_identifier_bool](f, addIDs)
		...
		stage.SerializeExcelizePointer2[*SPECIFICATION_Rendering](f, addIDs)
		...
		stage.SerializeExcelizePointer2[*SPEC_OBJECT_TYPE_Rendering](f, addIDs)
		stage.SerializeExcelizePointer2[*SPEC_RELATION](f, addIDs)
		stage.SerializeExcelizePointer2[*SPEC_RELATION_TYPE](f, addIDs)
		stage.SerializeExcelizePointer2[*StaticWebSite](f, addIDs)
		stage.SerializeExcelizePointer2[*StaticWebSiteChapter](f, addIDs)
		stage.SerializeExcelizePointer2[*StaticWebSiteGeneratedImage](f, addIDs)
		stage.SerializeExcelizePointer2[*StaticWebSiteImage](f, addIDs)
		stage.SerializeExcelizePointer2[*StaticWebSiteParagraph](f, addIDs)
