...
func main() {
	...
	originalStrings := []string{
		...
		"你好世界.md",
		"CON.txt",
		"a-very-long-filename-that-will-surely-exceed-the-maximum-allowed-length-and-needs-to-be-truncated-properly-without-breaking-anything-important-in-the-process-of-sanitization-and-making-it-safe-for-all-filesystems-and-operating-systems.log",
	}

	for _, s := range originalStrings {
		sanitized := SanitizeFileName(s, "_")
