...
func (attribute_definition_boolean_rendering *ATTRIBUTE_DEFINITION_BOOLEAN_Rendering) GongAfterCreateFromFront(stage *Stage) {
	if stage.OnAfterATTRIBUTE_DEFINITION_BOOLEAN_RenderingCreateCallback != nil {
		stage.OnAfterATTRIBUTE_DEFINITION_BOOLEAN_RenderingCreateCallback.OnAfterCreate(stage, attribute_definition_boolean_rendering)
	}
}

func (attribute_definition_boolean_rendering *ATTRIBUTE_DEFINITION_BOOLEAN_Rendering) GongOnAfterUpdateFromFront(stage *Stage, front GongstructIF) {
	if stage.OnAfterATTRIBUTE_DEFINITION_BOOLEAN_RenderingUpdateCallback != nil {
		var frontATTRIBUTE_DEFINITION_BOOLEAN_Rendering *ATTRIBUTE_DEFINITION_BOOLEAN_Rendering
		if front != nil {
			frontATTRIBUTE_DEFINITION_BOOLEAN_Rendering, _ = front.(*ATTRIBUTE_DEFINITION_BOOLEAN_Rendering)
		}
		stage.OnAfterATTRIBUTE_DEFINITION_BOOLEAN_RenderingUpdateCallback.OnAfterUpdate(stage, attribute_definition_boolean_rendering, frontATTRIBUTE_DEFINITION_BOOLEAN_Rendering)
	}
}

func (attribute_definition_boolean_rendering *ATTRIBUTE_DEFINITION_BOOLEAN_Rendering) GongAfterDeleteFromFront(stage *Stage, front GongstructIF) {
	if stage.OnAfterATTRIBUTE_DEFINITION_BOOLEAN_RenderingDeleteCallback != nil {
		var frontATTRIBUTE_DEFINITION_BOOLEAN_Rendering *ATTRIBUTE_DEFINITION_BOOLEAN_Rendering
		if front != nil {
			frontATTRIBUTE_DEFINITION_BOOLEAN_Rendering, _ = front.(*ATTRIBUTE_DEFINITION_BOOLEAN_Rendering)
		}
		stage.OnAfterATTRIBUTE_DEFINITION_BOOLEAN_RenderingDeleteCallback.OnAfterDelete(stage, attribute_definition_boolean_rendering, frontATTRIBUTE_DEFINITION_BOOLEAN_Rendering)
	}
}
...
func (attribute_definition_date_rendering *ATTRIBUTE_DEFINITION_DATE_Rendering) GongAfterCreateFromFront(stage *Stage) {
	if stage.OnAfterATTRIBUTE_DEFINITION_DATE_RenderingCreateCallback != nil {
		stage.OnAfterATTRIBUTE_DEFINITION_DATE_RenderingCreateCallback.OnAfterCreate(stage, attribute_definition_date_rendering)
	}
}

func (attribute_definition_date_rendering *ATTRIBUTE_DEFINITION_DATE_Rendering) GongOnAfterUpdateFromFront(stage *Stage, front GongstructIF) {
	if stage.OnAfterATTRIBUTE_DEFINITION_DATE_RenderingUpdateCallback != nil {
		var frontATTRIBUTE_DEFINITION_DATE_Rendering *ATTRIBUTE_DEFINITION_DATE_Rendering
		if front != nil {
			frontATTRIBUTE_DEFINITION_DATE_Rendering, _ = front.(*ATTRIBUTE_DEFINITION_DATE_Rendering)
		}
		stage.OnAfterATTRIBUTE_DEFINITION_DATE_RenderingUpdateCallback.OnAfterUpdate(stage, attribute_definition_date_rendering, frontATTRIBUTE_DEFINITION_DATE_Rendering)
	}
}

func (attribute_definition_date_rendering *ATTRIBUTE_DEFINITION_DATE_Rendering) GongAfterDeleteFromFront(stage *Stage, front GongstructIF) {
	if stage.OnAfterATTRIBUTE_DEFINITION_DATE_RenderingDeleteCallback != nil {
		var frontATTRIBUTE_DEFINITION_DATE_Rendering *ATTRIBUTE_DEFINITION_DATE_Rendering
		if front != nil {
			frontATTRIBUTE_DEFINITION_DATE_Rendering, _ = front.(*ATTRIBUTE_DEFINITION_DATE_Rendering)
		}
		stage.OnAfterATTRIBUTE_DEFINITION_DATE_RenderingDeleteCallback.OnAfterDelete(stage, attribute_definition_date_rendering, frontATTRIBUTE_DEFINITION_DATE_Rendering)
	}
}
...
func (attribute_definition_enumeration_rendering *ATTRIBUTE_DEFINITION_ENUMERATION_Rendering) GongAfterCreateFromFront(stage *Stage) {
	if stage.OnAfterATTRIBUTE_DEFINITION_ENUMERATION_RenderingCreateCallback != nil {
		stage.OnAfterATTRIBUTE_DEFINITION_ENUMERATION_RenderingCreateCallback.OnAfterCreate(stage, attribute_definition_enumeration_rendering)
	}
}

func (attribute_definition_enumeration_rendering *ATTRIBUTE_DEFINITION_ENUMERATION_Rendering) GongOnAfterUpdateFromFront(stage *Stage, front GongstructIF) {
	if stage.OnAfterATTRIBUTE_DEFINITION_ENUMERATION_RenderingUpdateCallback != nil {
		var frontATTRIBUTE_DEFINITION_ENUMERATION_Rendering *ATTRIBUTE_DEFINITION_ENUMERATION_Rendering
		if front != nil {
			frontATTRIBUTE_DEFINITION_ENUMERATION_Rendering, _ = front.(*ATTRIBUTE_DEFINITION_ENUMERATION_Rendering)
		}
		stage.OnAfterATTRIBUTE_DEFINITION_ENUMERATION_RenderingUpdateCallback.OnAfterUpdate(stage, attribute_definition_enumeration_rendering, frontATTRIBUTE_DEFINITION_ENUMERATION_Rendering)
	}
}

func (attribute_definition_enumeration_rendering *ATTRIBUTE_DEFINITION_ENUMERATION_Rendering) GongAfterDeleteFromFront(stage *Stage, front GongstructIF) {
	if stage.OnAfterATTRIBUTE_DEFINITION_ENUMERATION_RenderingDeleteCallback != nil {
		var frontATTRIBUTE_DEFINITION_ENUMERATION_Rendering *ATTRIBUTE_DEFINITION_ENUMERATION_Rendering
		if front != nil {
			frontATTRIBUTE_DEFINITION_ENUMERATION_Rendering, _ = front.(*ATTRIBUTE_DEFINITION_ENUMERATION_Rendering)
		}
		stage.OnAfterATTRIBUTE_DEFINITION_ENUMERATION_RenderingDeleteCallback.OnAfterDelete(stage, attribute_definition_enumeration_rendering, frontATTRIBUTE_DEFINITION_ENUMERATION_Rendering)
	}
}
...
func (attribute_definition_integer_rendering *ATTRIBUTE_DEFINITION_INTEGER_Rendering) GongAfterCreateFromFront(stage *Stage) {
	if stage.OnAfterATTRIBUTE_DEFINITION_INTEGER_RenderingCreateCallback != nil {
		stage.OnAfterATTRIBUTE_DEFINITION_INTEGER_RenderingCreateCallback.OnAfterCreate(stage, attribute_definition_integer_rendering)
	}
}

func (attribute_definition_integer_rendering *ATTRIBUTE_DEFINITION_INTEGER_Rendering) GongOnAfterUpdateFromFront(stage *Stage, front GongstructIF) {
	if stage.OnAfterATTRIBUTE_DEFINITION_INTEGER_RenderingUpdateCallback != nil {
		var frontATTRIBUTE_DEFINITION_INTEGER_Rendering *ATTRIBUTE_DEFINITION_INTEGER_Rendering
		if front != nil {
			frontATTRIBUTE_DEFINITION_INTEGER_Rendering, _ = front.(*ATTRIBUTE_DEFINITION_INTEGER_Rendering)
		}
		stage.OnAfterATTRIBUTE_DEFINITION_INTEGER_RenderingUpdateCallback.OnAfterUpdate(stage, attribute_definition_integer_rendering, frontATTRIBUTE_DEFINITION_INTEGER_Rendering)
	}
}

func (attribute_definition_integer_rendering *ATTRIBUTE_DEFINITION_INTEGER_Rendering) GongAfterDeleteFromFront(stage *Stage, front GongstructIF) {
	if stage.OnAfterATTRIBUTE_DEFINITION_INTEGER_RenderingDeleteCallback != nil {
		var frontATTRIBUTE_DEFINITION_INTEGER_Rendering *ATTRIBUTE_DEFINITION_INTEGER_Rendering
		if front != nil {
			frontATTRIBUTE_DEFINITION_INTEGER_Rendering, _ = front.(*ATTRIBUTE_DEFINITION_INTEGER_Rendering)
		}
		stage.OnAfterATTRIBUTE_DEFINITION_INTEGER_RenderingDeleteCallback.OnAfterDelete(stage, attribute_definition_integer_rendering, frontATTRIBUTE_DEFINITION_INTEGER_Rendering)
	}
}
...
func (attribute_definition_real_rendering *ATTRIBUTE_DEFINITION_REAL_Rendering) GongAfterCreateFromFront(stage *Stage) {
	if stage.OnAfterATTRIBUTE_DEFINITION_REAL_RenderingCreateCallback != nil {
		stage.OnAfterATTRIBUTE_DEFINITION_REAL_RenderingCreateCallback.OnAfterCreate(stage, attribute_definition_real_rendering)
	}
}

func (attribute_definition_real_rendering *ATTRIBUTE_DEFINITION_REAL_Rendering) GongOnAfterUpdateFromFront(stage *Stage, front GongstructIF) {
	if stage.OnAfterATTRIBUTE_DEFINITION_REAL_RenderingUpdateCallback != nil {
		var frontATTRIBUTE_DEFINITION_REAL_Rendering *ATTRIBUTE_DEFINITION_REAL_Rendering
		if front != nil {
			frontATTRIBUTE_DEFINITION_REAL_Rendering, _ = front.(*ATTRIBUTE_DEFINITION_REAL_Rendering)
		}
		stage.OnAfterATTRIBUTE_DEFINITION_REAL_RenderingUpdateCallback.OnAfterUpdate(stage, attribute_definition_real_rendering, frontATTRIBUTE_DEFINITION_REAL_Rendering)
	}
}

func (attribute_definition_real_rendering *ATTRIBUTE_DEFINITION_REAL_Rendering) GongAfterDeleteFromFront(stage *Stage, front GongstructIF) {
	if stage.OnAfterATTRIBUTE_DEFINITION_REAL_RenderingDeleteCallback != nil {
		var frontATTRIBUTE_DEFINITION_REAL_Rendering *ATTRIBUTE_DEFINITION_REAL_Rendering
		if front != nil {
			frontATTRIBUTE_DEFINITION_REAL_Rendering, _ = front.(*ATTRIBUTE_DEFINITION_REAL_Rendering)
		}
		stage.OnAfterATTRIBUTE_DEFINITION_REAL_RenderingDeleteCallback.OnAfterDelete(stage, attribute_definition_real_rendering, frontATTRIBUTE_DEFINITION_REAL_Rendering)
	}
}

func (attribute_definition_rendering *ATTRIBUTE_DEFINITION_Rendering) GongAfterCreateFromFront(stage *Stage) {
	if stage.OnAfterATTRIBUTE_DEFINITION_RenderingCreateCallback != nil {
		stage.OnAfterATTRIBUTE_DEFINITION_RenderingCreateCallback.OnAfterCreate(stage, attribute_definition_rendering)
	}
}

func (attribute_definition_rendering *ATTRIBUTE_DEFINITION_Rendering) GongOnAfterUpdateFromFront(stage *Stage, front GongstructIF) {
	if stage.OnAfterATTRIBUTE_DEFINITION_RenderingUpdateCallback != nil {
		var frontATTRIBUTE_DEFINITION_Rendering *ATTRIBUTE_DEFINITION_Rendering
		if front != nil {
			frontATTRIBUTE_DEFINITION_Rendering, _ = front.(*ATTRIBUTE_DEFINITION_Rendering)
		}
		stage.OnAfterATTRIBUTE_DEFINITION_RenderingUpdateCallback.OnAfterUpdate(stage, attribute_definition_rendering, frontATTRIBUTE_DEFINITION_Rendering)
	}
}

func (attribute_definition_rendering *ATTRIBUTE_DEFINITION_Rendering) GongAfterDeleteFromFront(stage *Stage, front GongstructIF) {
	if stage.OnAfterATTRIBUTE_DEFINITION_RenderingDeleteCallback != nil {
		var frontATTRIBUTE_DEFINITION_Rendering *ATTRIBUTE_DEFINITION_Rendering
		if front != nil {
			frontATTRIBUTE_DEFINITION_Rendering, _ = front.(*ATTRIBUTE_DEFINITION_Rendering)
		}
		stage.OnAfterATTRIBUTE_DEFINITION_RenderingDeleteCallback.OnAfterDelete(stage, attribute_definition_rendering, frontATTRIBUTE_DEFINITION_Rendering)
	}
}
...
func (attribute_definition_string_rendering *ATTRIBUTE_DEFINITION_STRING_Rendering) GongAfterCreateFromFront(stage *Stage) {
	if stage.OnAfterATTRIBUTE_DEFINITION_STRING_RenderingCreateCallback != nil {
		stage.OnAfterATTRIBUTE_DEFINITION_STRING_RenderingCreateCallback.OnAfterCreate(stage, attribute_definition_string_rendering)
	}
}

func (attribute_definition_string_rendering *ATTRIBUTE_DEFINITION_STRING_Rendering) GongOnAfterUpdateFromFront(stage *Stage, front GongstructIF) {
	if stage.OnAfterATTRIBUTE_DEFINITION_STRING_RenderingUpdateCallback != nil {
		var frontATTRIBUTE_DEFINITION_STRING_Rendering *ATTRIBUTE_DEFINITION_STRING_Rendering
		if front != nil {
			frontATTRIBUTE_DEFINITION_STRING_Rendering, _ = front.(*ATTRIBUTE_DEFINITION_STRING_Rendering)
		}
		stage.OnAfterATTRIBUTE_DEFINITION_STRING_RenderingUpdateCallback.OnAfterUpdate(stage, attribute_definition_string_rendering, frontATTRIBUTE_DEFINITION_STRING_Rendering)
	}
}

func (attribute_definition_string_rendering *ATTRIBUTE_DEFINITION_STRING_Rendering) GongAfterDeleteFromFront(stage *Stage, front GongstructIF) {
	if stage.OnAfterATTRIBUTE_DEFINITION_STRING_RenderingDeleteCallback != nil {
		var frontATTRIBUTE_DEFINITION_STRING_Rendering *ATTRIBUTE_DEFINITION_STRING_Rendering
		if front != nil {
			frontATTRIBUTE_DEFINITION_STRING_Rendering, _ = front.(*ATTRIBUTE_DEFINITION_STRING_Rendering)
		}
		stage.OnAfterATTRIBUTE_DEFINITION_STRING_RenderingDeleteCallback.OnAfterDelete(stage, attribute_definition_string_rendering, frontATTRIBUTE_DEFINITION_STRING_Rendering)
	}
}
...
func (attribute_definition_xhtml_rendering *ATTRIBUTE_DEFINITION_XHTML_Rendering) GongAfterCreateFromFront(stage *Stage) {
	if stage.OnAfterATTRIBUTE_DEFINITION_XHTML_RenderingCreateCallback != nil {
		stage.OnAfterATTRIBUTE_DEFINITION_XHTML_RenderingCreateCallback.OnAfterCreate(stage, attribute_definition_xhtml_rendering)
	}
}

func (attribute_definition_xhtml_rendering *ATTRIBUTE_DEFINITION_XHTML_Rendering) GongOnAfterUpdateFromFront(stage *Stage, front GongstructIF) {
	if stage.OnAfterATTRIBUTE_DEFINITION_XHTML_RenderingUpdateCallback != nil {
		var frontATTRIBUTE_DEFINITION_XHTML_Rendering *ATTRIBUTE_DEFINITION_XHTML_Rendering
		if front != nil {
			frontATTRIBUTE_DEFINITION_XHTML_Rendering, _ = front.(*ATTRIBUTE_DEFINITION_XHTML_Rendering)
		}
		stage.OnAfterATTRIBUTE_DEFINITION_XHTML_RenderingUpdateCallback.OnAfterUpdate(stage, attribute_definition_xhtml_rendering, frontATTRIBUTE_DEFINITION_XHTML_Rendering)
	}
}

func (attribute_definition_xhtml_rendering *ATTRIBUTE_DEFINITION_XHTML_Rendering) GongAfterDeleteFromFront(stage *Stage, front GongstructIF) {
	if stage.OnAfterATTRIBUTE_DEFINITION_XHTML_RenderingDeleteCallback != nil {
		var frontATTRIBUTE_DEFINITION_XHTML_Rendering *ATTRIBUTE_DEFINITION_XHTML_Rendering
		if front != nil {
			frontATTRIBUTE_DEFINITION_XHTML_Rendering, _ = front.(*ATTRIBUTE_DEFINITION_XHTML_Rendering)
		}
		stage.OnAfterATTRIBUTE_DEFINITION_XHTML_RenderingDeleteCallback.OnAfterDelete(stage, attribute_definition_xhtml_rendering, frontATTRIBUTE_DEFINITION_XHTML_Rendering)
	}
}
...
func (embeddedjpgimage *EmbeddedJpgImage) GongAfterCreateFromFront(stage *Stage) {
	if stage.OnAfterEmbeddedJpgImageCreateCallback != nil {
		stage.OnAfterEmbeddedJpgImageCreateCallback.OnAfterCreate(stage, embeddedjpgimage)
	}
}

func (embeddedjpgimage *EmbeddedJpgImage) GongOnAfterUpdateFromFront(stage *Stage, front GongstructIF) {
	if stage.OnAfterEmbeddedJpgImageUpdateCallback != nil {
		var frontEmbeddedJpgImage *EmbeddedJpgImage
		if front != nil {
			frontEmbeddedJpgImage, _ = front.(*EmbeddedJpgImage)
		}
		stage.OnAfterEmbeddedJpgImageUpdateCallback.OnAfterUpdate(stage, embeddedjpgimage, frontEmbeddedJpgImage)
	}
}

func (embeddedjpgimage *EmbeddedJpgImage) GongAfterDeleteFromFront(stage *Stage, front GongstructIF) {
	if stage.OnAfterEmbeddedJpgImageDeleteCallback != nil {
		var frontEmbeddedJpgImage *EmbeddedJpgImage
		if front != nil {
			frontEmbeddedJpgImage, _ = front.(*EmbeddedJpgImage)
		}
		stage.OnAfterEmbeddedJpgImageDeleteCallback.OnAfterDelete(stage, embeddedjpgimage, frontEmbeddedJpgImage)
	}
}

func (embeddedpngimage *EmbeddedPngImage) GongAfterCreateFromFront(stage *Stage) {
	if stage.OnAfterEmbeddedPngImageCreateCallback != nil {
		stage.OnAfterEmbeddedPngImageCreateCallback.OnAfterCreate(stage, embeddedpngimage)
	}
}

func (embeddedpngimage *EmbeddedPngImage) GongOnAfterUpdateFromFront(stage *Stage, front GongstructIF) {
	if stage.OnAfterEmbeddedPngImageUpdateCallback != nil {
		var frontEmbeddedPngImage *EmbeddedPngImage
		if front != nil {
			frontEmbeddedPngImage, _ = front.(*EmbeddedPngImage)
		}
		stage.OnAfterEmbeddedPngImageUpdateCallback.OnAfterUpdate(stage, embeddedpngimage, frontEmbeddedPngImage)
	}
}

func (embeddedpngimage *EmbeddedPngImage) GongAfterDeleteFromFront(stage *Stage, front GongstructIF) {
	if stage.OnAfterEmbeddedPngImageDeleteCallback != nil {
		var frontEmbeddedPngImage *EmbeddedPngImage
		if front != nil {
			frontEmbeddedPngImage, _ = front.(*EmbeddedPngImage)
		}
		stage.OnAfterEmbeddedPngImageDeleteCallback.OnAfterDelete(stage, embeddedpngimage, frontEmbeddedPngImage)
	}
}

func (embeddedsvgimage *EmbeddedSvgImage) GongAfterCreateFromFront(stage *Stage) {
	if stage.OnAfterEmbeddedSvgImageCreateCallback != nil {
		stage.OnAfterEmbeddedSvgImageCreateCallback.OnAfterCreate(stage, embeddedsvgimage)
	}
}

func (embeddedsvgimage *EmbeddedSvgImage) GongOnAfterUpdateFromFront(stage *Stage, front GongstructIF) {
	if stage.OnAfterEmbeddedSvgImageUpdateCallback != nil {
		var frontEmbeddedSvgImage *EmbeddedSvgImage
		if front != nil {
			frontEmbeddedSvgImage, _ = front.(*EmbeddedSvgImage)
		}
		stage.OnAfterEmbeddedSvgImageUpdateCallback.OnAfterUpdate(stage, embeddedsvgimage, frontEmbeddedSvgImage)
	}
}

func (embeddedsvgimage *EmbeddedSvgImage) GongAfterDeleteFromFront(stage *Stage, front GongstructIF) {
	if stage.OnAfterEmbeddedSvgImageDeleteCallback != nil {
		var frontEmbeddedSvgImage *EmbeddedSvgImage
		if front != nil {
			frontEmbeddedSvgImage, _ = front.(*EmbeddedSvgImage)
		}
		stage.OnAfterEmbeddedSvgImageDeleteCallback.OnAfterDelete(stage, embeddedsvgimage, frontEmbeddedSvgImage)
	}
}
...
func (map_identifier_bool *Map_identifier_bool) GongAfterCreateFromFront(stage *Stage) {
	if stage.OnAfterMap_identifier_boolCreateCallback != nil {
		stage.OnAfterMap_identifier_boolCreateCallback.OnAfterCreate(stage, map_identifier_bool)
	}
}

func (map_identifier_bool *Map_identifier_bool) GongOnAfterUpdateFromFront(stage *Stage, front GongstructIF) {
	if stage.OnAfterMap_identifier_boolUpdateCallback != nil {
		var frontMap_identifier_bool *Map_identifier_bool
		if front != nil {
			frontMap_identifier_bool, _ = front.(*Map_identifier_bool)
		}
		stage.OnAfterMap_identifier_boolUpdateCallback.OnAfterUpdate(stage, map_identifier_bool, frontMap_identifier_bool)
	}
}

func (map_identifier_bool *Map_identifier_bool) GongAfterDeleteFromFront(stage *Stage, front GongstructIF) {
	if stage.OnAfterMap_identifier_boolDeleteCallback != nil {
		var frontMap_identifier_bool *Map_identifier_bool
		if front != nil {
			frontMap_identifier_bool, _ = front.(*Map_identifier_bool)
		}
		stage.OnAfterMap_identifier_boolDeleteCallback.OnAfterDelete(stage, map_identifier_bool, frontMap_identifier_bool)
	}
}
...
func (specification_rendering *SPECIFICATION_Rendering) GongAfterCreateFromFront(stage *Stage) {
	if stage.OnAfterSPECIFICATION_RenderingCreateCallback != nil {
		stage.OnAfterSPECIFICATION_RenderingCreateCallback.OnAfterCreate(stage, specification_rendering)
	}
}

func (specification_rendering *SPECIFICATION_Rendering) GongOnAfterUpdateFromFront(stage *Stage, front GongstructIF) {
	if stage.OnAfterSPECIFICATION_RenderingUpdateCallback != nil {
		var frontSPECIFICATION_Rendering *SPECIFICATION_Rendering
		if front != nil {
			frontSPECIFICATION_Rendering, _ = front.(*SPECIFICATION_Rendering)
		}
		stage.OnAfterSPECIFICATION_RenderingUpdateCallback.OnAfterUpdate(stage, specification_rendering, frontSPECIFICATION_Rendering)
	}
}

func (specification_rendering *SPECIFICATION_Rendering) GongAfterDeleteFromFront(stage *Stage, front GongstructIF) {
	if stage.OnAfterSPECIFICATION_RenderingDeleteCallback != nil {
		var frontSPECIFICATION_Rendering *SPECIFICATION_Rendering
		if front != nil {
			frontSPECIFICATION_Rendering, _ = front.(*SPECIFICATION_Rendering)
		}
		stage.OnAfterSPECIFICATION_RenderingDeleteCallback.OnAfterDelete(stage, specification_rendering, frontSPECIFICATION_Rendering)
	}
}
...
func (spec_object_type_rendering *SPEC_OBJECT_TYPE_Rendering) GongAfterCreateFromFront(stage *Stage) {
	if stage.OnAfterSPEC_OBJECT_TYPE_RenderingCreateCallback != nil {
		stage.OnAfterSPEC_OBJECT_TYPE_RenderingCreateCallback.OnAfterCreate(stage, spec_object_type_rendering)
	}
}

func (spec_object_type_rendering *SPEC_OBJECT_TYPE_Rendering) GongOnAfterUpdateFromFront(stage *Stage, front GongstructIF) {
	if stage.OnAfterSPEC_OBJECT_TYPE_RenderingUpdateCallback != nil {
		var frontSPEC_OBJECT_TYPE_Rendering *SPEC_OBJECT_TYPE_Rendering
		if front != nil {
			frontSPEC_OBJECT_TYPE_Rendering, _ = front.(*SPEC_OBJECT_TYPE_Rendering)
		}
		stage.OnAfterSPEC_OBJECT_TYPE_RenderingUpdateCallback.OnAfterUpdate(stage, spec_object_type_rendering, frontSPEC_OBJECT_TYPE_Rendering)
	}
}

func (spec_object_type_rendering *SPEC_OBJECT_TYPE_Rendering) GongAfterDeleteFromFront(stage *Stage, front GongstructIF) {
	if stage.OnAfterSPEC_OBJECT_TYPE_RenderingDeleteCallback != nil {
		var frontSPEC_OBJECT_TYPE_Rendering *SPEC_OBJECT_TYPE_Rendering
		if front != nil {
			frontSPEC_OBJECT_TYPE_Rendering, _ = front.(*SPEC_OBJECT_TYPE_Rendering)
		}
		stage.OnAfterSPEC_OBJECT_TYPE_RenderingDeleteCallback.OnAfterDelete(stage, spec_object_type_rendering, frontSPEC_OBJECT_TYPE_Rendering)
	}
}
...
func (staticwebsite *StaticWebSite) GongAfterCreateFromFront(stage *Stage) {
	if stage.OnAfterStaticWebSiteCreateCallback != nil {
		stage.OnAfterStaticWebSiteCreateCallback.OnAfterCreate(stage, staticwebsite)
	}
}

func (staticwebsite *StaticWebSite) GongOnAfterUpdateFromFront(stage *Stage, front GongstructIF) {
	if stage.OnAfterStaticWebSiteUpdateCallback != nil {
		var frontStaticWebSite *StaticWebSite
		if front != nil {
			frontStaticWebSite, _ = front.(*StaticWebSite)
		}
		stage.OnAfterStaticWebSiteUpdateCallback.OnAfterUpdate(stage, staticwebsite, frontStaticWebSite)
	}
}

func (staticwebsite *StaticWebSite) GongAfterDeleteFromFront(stage *Stage, front GongstructIF) {
	if stage.OnAfterStaticWebSiteDeleteCallback != nil {
		var frontStaticWebSite *StaticWebSite
		if front != nil {
			frontStaticWebSite, _ = front.(*StaticWebSite)
		}
		stage.OnAfterStaticWebSiteDeleteCallback.OnAfterDelete(stage, staticwebsite, frontStaticWebSite)
	}
}

func (staticwebsitechapter *StaticWebSiteChapter) GongAfterCreateFromFront(stage *Stage) {
	if stage.OnAfterStaticWebSiteChapterCreateCallback != nil {
		stage.OnAfterStaticWebSiteChapterCreateCallback.OnAfterCreate(stage, staticwebsitechapter)
	}
}

func (staticwebsitechapter *StaticWebSiteChapter) GongOnAfterUpdateFromFront(stage *Stage, front GongstructIF) {
	if stage.OnAfterStaticWebSiteChapterUpdateCallback != nil {
		var frontStaticWebSiteChapter *StaticWebSiteChapter
		if front != nil {
			frontStaticWebSiteChapter, _ = front.(*StaticWebSiteChapter)
		}
		stage.OnAfterStaticWebSiteChapterUpdateCallback.OnAfterUpdate(stage, staticwebsitechapter, frontStaticWebSiteChapter)
	}
}

func (staticwebsitechapter *StaticWebSiteChapter) GongAfterDeleteFromFront(stage *Stage, front GongstructIF) {
	if stage.OnAfterStaticWebSiteChapterDeleteCallback != nil {
		var frontStaticWebSiteChapter *StaticWebSiteChapter
		if front != nil {
			frontStaticWebSiteChapter, _ = front.(*StaticWebSiteChapter)
		}
		stage.OnAfterStaticWebSiteChapterDeleteCallback.OnAfterDelete(stage, staticwebsitechapter, frontStaticWebSiteChapter)
	}
}

func (staticwebsitegeneratedimage *StaticWebSiteGeneratedImage) GongAfterCreateFromFront(stage *Stage) {
	if stage.OnAfterStaticWebSiteGeneratedImageCreateCallback != nil {
		stage.OnAfterStaticWebSiteGeneratedImageCreateCallback.OnAfterCreate(stage, staticwebsitegeneratedimage)
	}
}

func (staticwebsitegeneratedimage *StaticWebSiteGeneratedImage) GongOnAfterUpdateFromFront(stage *Stage, front GongstructIF) {
	if stage.OnAfterStaticWebSiteGeneratedImageUpdateCallback != nil {
		var frontStaticWebSiteGeneratedImage *StaticWebSiteGeneratedImage
		if front != nil {
			frontStaticWebSiteGeneratedImage, _ = front.(*StaticWebSiteGeneratedImage)
		}
		stage.OnAfterStaticWebSiteGeneratedImageUpdateCallback.OnAfterUpdate(stage, staticwebsitegeneratedimage, frontStaticWebSiteGeneratedImage)
	}
}

func (staticwebsitegeneratedimage *StaticWebSiteGeneratedImage) GongAfterDeleteFromFront(stage *Stage, front GongstructIF) {
	if stage.OnAfterStaticWebSiteGeneratedImageDeleteCallback != nil {
		var frontStaticWebSiteGeneratedImage *StaticWebSiteGeneratedImage
		if front != nil {
			frontStaticWebSiteGeneratedImage, _ = front.(*StaticWebSiteGeneratedImage)
		}
		stage.OnAfterStaticWebSiteGeneratedImageDeleteCallback.OnAfterDelete(stage, staticwebsitegeneratedimage, frontStaticWebSiteGeneratedImage)
	}
}

func (staticwebsiteimage *StaticWebSiteImage) GongAfterCreateFromFront(stage *Stage) {
	if stage.OnAfterStaticWebSiteImageCreateCallback != nil {
		stage.OnAfterStaticWebSiteImageCreateCallback.OnAfterCreate(stage, staticwebsiteimage)
	}
}

func (staticwebsiteimage *StaticWebSiteImage) GongOnAfterUpdateFromFront(stage *Stage, front GongstructIF) {
	if stage.OnAfterStaticWebSiteImageUpdateCallback != nil {
		var frontStaticWebSiteImage *StaticWebSiteImage
		if front != nil {
			frontStaticWebSiteImage, _ = front.(*StaticWebSiteImage)
		}
		stage.OnAfterStaticWebSiteImageUpdateCallback.OnAfterUpdate(stage, staticwebsiteimage, frontStaticWebSiteImage)
	}
}

func (staticwebsiteimage *StaticWebSiteImage) GongAfterDeleteFromFront(stage *Stage, front GongstructIF) {
	if stage.OnAfterStaticWebSiteImageDeleteCallback != nil {
		var frontStaticWebSiteImage *StaticWebSiteImage
		if front != nil {
			frontStaticWebSiteImage, _ = front.(*StaticWebSiteImage)
		}
		stage.OnAfterStaticWebSiteImageDeleteCallback.OnAfterDelete(stage, staticwebsiteimage, frontStaticWebSiteImage)
	}
}

func (staticwebsiteparagraph *StaticWebSiteParagraph) GongAfterCreateFromFront(stage *Stage) {
	if stage.OnAfterStaticWebSiteParagraphCreateCallback != nil {
		stage.OnAfterStaticWebSiteParagraphCreateCallback.OnAfterCreate(stage, staticwebsiteparagraph)
	}
}

func (staticwebsiteparagraph *StaticWebSiteParagraph) GongOnAfterUpdateFromFront(stage *Stage, front GongstructIF) {
	if stage.OnAfterStaticWebSiteParagraphUpdateCallback != nil {
		var frontStaticWebSiteParagraph *StaticWebSiteParagraph
		if front != nil {
			frontStaticWebSiteParagraph, _ = front.(*StaticWebSiteParagraph)
		}
		stage.OnAfterStaticWebSiteParagraphUpdateCallback.OnAfterUpdate(stage, staticwebsiteparagraph, frontStaticWebSiteParagraph)
	}
}

func (staticwebsiteparagraph *StaticWebSiteParagraph) GongAfterDeleteFromFront(stage *Stage, front GongstructIF) {
	if stage.OnAfterStaticWebSiteParagraphDeleteCallback != nil {
		var frontStaticWebSiteParagraph *StaticWebSiteParagraph
		if front != nil {
			frontStaticWebSiteParagraph, _ = front.(*StaticWebSiteParagraph)
		}
		stage.OnAfterStaticWebSiteParagraphDeleteCallback.OnAfterDelete(stage, staticwebsiteparagraph, frontStaticWebSiteParagraph)
	}
}
