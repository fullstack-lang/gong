							...
							case *ast.SelectorExpr:
								...
								if Sel := slcExpr.Sel; Sel != nil {
									...
									case "Category1":
										...
										if !preserveOrder {
											...
											if newOrder, err := ExtractMiddleUint(identifier); err != nil {
												...
												instanceCategory1.StagePreserveOrder(stage, newOrder)
											}
										}
									...
									case "Category1Shape":
										...
										if !preserveOrder {
											...
											if newOrder, err := ExtractMiddleUint(identifier); err != nil {
												...
												instanceCategory1Shape.StagePreserveOrder(stage, newOrder)
											}
										}
									...
									case "Category2":
										...
										if !preserveOrder {
											...
											if newOrder, err := ExtractMiddleUint(identifier); err != nil {
												...
												instanceCategory2.StagePreserveOrder(stage, newOrder)
											}
										}
									...
									case "Category2Shape":
										...
										if !preserveOrder {
											...
											if newOrder, err := ExtractMiddleUint(identifier); err != nil {
												...
												instanceCategory2Shape.StagePreserveOrder(stage, newOrder)
											}
										}
									...
									case "Category3":
										...
										if !preserveOrder {
											...
											if newOrder, err := ExtractMiddleUint(identifier); err != nil {
												...
												instanceCategory3.StagePreserveOrder(stage, newOrder)
											}
										}
									...
									case "Category3Shape":
										...
										if !preserveOrder {
											...
											if newOrder, err := ExtractMiddleUint(identifier); err != nil {
												...
												instanceCategory3Shape.StagePreserveOrder(stage, newOrder)
											}
										}
									...
									case "ControlPointShape":
										...
										if !preserveOrder {
											instanceControlPointShape.Stage(stage)
										} else {
											if newOrder, err := ExtractMiddleUint(identifier); err != nil {
												log.Println("UnmarshallGongstructStaging: Problem with parsing identifer", identifier)
												instanceControlPointShape.Stage(stage)
											} else {
												instanceControlPointShape.StagePreserveOrder(stage, newOrder)
											}
										}
										instance = any(instanceControlPointShape)
										__gong__map_ControlPointShape[identifier] = instanceControlPointShape
									case "Desk":
										instanceDesk := new(Desk)
										instanceDesk.Name = instanceName
										if !preserveOrder {
											instanceDesk.Stage(stage)
										} else {
											if newOrder, err := ExtractMiddleUint(identifier); err != nil {
												log.Println("UnmarshallGongstructStaging: Problem with parsing identifer", identifier)
												instanceDesk.Stage(stage)
											} else {
												instanceDesk.StagePreserveOrder(stage, newOrder)
											}
										}
										instance = any(instanceDesk)
										__gong__map_Desk[identifier] = instanceDesk
									case "Diagram":
									...
									case "Influence":
										instanceInfluence := new(Influence)
										instanceInfluence.Name = instanceName
										if !preserveOrder {
											instanceInfluence.Stage(stage)
										} else {
											if newOrder, err := ExtractMiddleUint(identifier); err != nil {
												log.Println("UnmarshallGongstructStaging: Problem with parsing identifer", identifier)
												instanceInfluence.Stage(stage)
											} else {
												instanceInfluence.StagePreserveOrder(stage, newOrder)
											}
										}
										instance = any(instanceInfluence)
										__gong__map_Influence[identifier] = instanceInfluence
									case "InfluenceShape":
										instanceInfluenceShape := new(InfluenceShape)
										instanceInfluenceShape.Name = instanceName
										if !preserveOrder {
											...
											if newOrder, err := ExtractMiddleUint(identifier); err != nil {
												...
												instanceInfluenceShape.StagePreserveOrder(stage, newOrder)
											}
										}
		...
		case *ast.BasicLit, *ast.UnaryExpr, *ast.CompositeLit:
			...
			case "ControlPointShape":
				...
				case "Name":
					// remove first and last char
					fielValue := basicLit.Value[1 : len(basicLit.Value)-1]
					__gong__map_ControlPointShape[identifier].Name = fielValue
				case "X_Relative":
					// convert string to float64
					fielValue, err := strconv.ParseFloat(basicLit.Value, 64)
					if err != nil {
					...
					__gong__map_ControlPointShape[identifier].X_Relative = exprSign * fielValue
				case "Y_Relative":
					// convert string to float64
					fielValue, err := strconv.ParseFloat(basicLit.Value, 64)
					if err != nil {
					...
					__gong__map_ControlPointShape[identifier].Y_Relative = exprSign * fielValue
				}
			case "Desk":
				switch fieldName {
				// insertion point for field dependant code
				case "Name":
					// remove first and last char
					fielValue := basicLit.Value[1 : len(basicLit.Value)-1]
					__gong__map_Desk[identifier].Name = fielValue
				}
			case "Diagram":
				switch fieldName {
				// insertion point for field dependant code
				...
				case "XMargin":
					...
					__gong__map_Diagram[identifier].XMargin = exprSign * fielValue
				case "YMargin":
					// convert string to float64
					fielValue, err := strconv.ParseFloat(basicLit.Value, 64)
					if err != nil {
					...
					__gong__map_Diagram[identifier].YMargin = exprSign * fielValue
				case "Height":
					// convert string to float64
					fielValue, err := strconv.ParseFloat(basicLit.Value, 64)
					if err != nil {
				...
				case "RedColorCode":
					// remove first and last char
					fielValue := basicLit.Value[1 : len(basicLit.Value)-1]
					__gong__map_Diagram[identifier].RedColorCode = fielValue
				case "BackgroundGreyColorCode":
					// remove first and last char
					fielValue := basicLit.Value[1 : len(basicLit.Value)-1]
					__gong__map_Diagram[identifier].BackgroundGreyColorCode = fielValue
				case "GrayColorCode":
					// remove first and last char
					fielValue := basicLit.Value[1 : len(basicLit.Value)-1]
				...
				case "InfluenceArrowSize":
					...
					__gong__map_Diagram[identifier].InfluenceArrowSize = exprSign * fielValue
				case "InfluenceArrowStartOffset":
					...
					__gong__map_Diagram[identifier].InfluenceArrowStartOffset = exprSign * fielValue
				case "InfluenceArrowEndOffset":
					...
					__gong__map_Diagram[identifier].InfluenceArrowEndOffset = exprSign * fielValue
				...
				case "InfluenceDashedLinePattern":
					// remove first and last char
					fielValue := basicLit.Value[1 : len(basicLit.Value)-1]
					__gong__map_Diagram[identifier].InfluenceDashedLinePattern = fielValue
				}
			case "Influence":
				switch fieldName {
				// insertion point for field dependant code
		...
		case *ast.Ident:
			...
			case "ControlPointShape":
				...
				case "IsStartShapeTheClosestShape":
					...
					__gong__map_ControlPointShape[identifier].IsStartShapeTheClosestShape = fielValue
				}
			case "Desk":
				switch fieldName {
				// insertion point for field dependant code
				case "SelectedDiagram":
					targetIdentifier := ident.Name
					__gong__map_Desk[identifier].SelectedDiagram = __gong__map_Diagram[targetIdentifier]
				}
			case "Diagram":
				switch fieldName {
				// insertion point for field dependant code
				case "IsEditable":
					...
					__gong__map_Diagram[identifier].IsEditable = fielValue
				case "IsNodeExpanded":
					// convert string to boolean
					fielValue, err := strconv.ParseBool(ident.Name)
					if err != nil {
				...
				case "IsInfluenceCategoryShown":
					...
					__gong__map_Diagram[identifier].IsInfluenceCategoryShown = fielValue
				}
			case "Influence":
				switch fieldName {
				// insertion point for field dependant code
				...
				case "IsHypothtical":
					...
					__gong__map_Influence[identifier].IsHypothtical = fielValue
				}
			case "InfluenceShape":
				switch fieldName {
				// insertion point for field dependant code
