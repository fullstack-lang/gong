...
func (stage *Stage) ComputeForwardAndBackwardCommits() {
	...
	// parse all reference instances and check if they are still staged
	for ref := range stage.NoteResourceShapes_reference {
		if _, ok := stage.NoteResourceShapes[ref]; !ok {
	...
	// parse all reference instances and check if they are still staged
	for ref := range stage.Resources_reference {
		if _, ok := stage.Resources[ref]; !ok {
	...
	// parse all reference instances and check if they are still staged
	for ref := range stage.ResourceShapes_reference {
		if _, ok := stage.ResourceShapes[ref]; !ok {
	...
	// parse all reference instances and check if they are still staged
	for ref := range stage.ResourceTaskShapes_reference {
		if _, ok := stage.ResourceTaskShapes[ref]; !ok {
...
func (stage *Stage) ComputeReferenceAndOrders() {
	...
	for instance := range stage.NoteResourceShapes {
		stage.NoteResourceShapes_reference[instance] = instance.GongCopy().(*NoteResourceShape)
	...
	for instance := range stage.Resources {
		stage.Resources_reference[instance] = instance.GongCopy().(*Resource)
	...
	for instance := range stage.ResourceShapes {
		stage.ResourceShapes_reference[instance] = instance.GongCopy().(*ResourceShape)
	...
	for instance := range stage.ResourceTaskShapes {
		stage.ResourceTaskShapes_reference[instance] = instance.GongCopy().(*ResourceTaskShape)
...
func (diagram *Diagram) GongMarshallIdentifier(stage *Stage) (decl string) {
	...
	decl = strings.ReplaceAll(decl, "{{GeneratedFieldNameValue}}", fmt.Sprintf("%q", diagram.Name))
	return
}
...
func (note *Note) GongMarshallIdentifier(stage *Stage) (decl string) {
	...
	decl = strings.ReplaceAll(decl, "{{GeneratedFieldNameValue}}", fmt.Sprintf("%q", note.Name))
	return
}
...
func (noteproductshape *NoteProductShape) GongMarshallIdentifier(stage *Stage) (decl string) {
	...
	decl = strings.ReplaceAll(decl, "{{GeneratedFieldNameValue}}", fmt.Sprintf("%q", noteproductshape.Name))
	return
}
...
func (noteresourceshape *NoteResourceShape) GongMarshallIdentifier(stage *Stage) (decl string) {
	...
	decl = strings.ReplaceAll(decl, "{{GeneratedFieldNameValue}}", fmt.Sprintf("%q", noteresourceshape.Name))
	return
}
...
func (noteshape *NoteShape) GongMarshallIdentifier(stage *Stage) (decl string) {
	...
	decl = strings.ReplaceAll(decl, "{{GeneratedFieldNameValue}}", fmt.Sprintf("%q", noteshape.Name))
	return
}
...
func (notetaskshape *NoteTaskShape) GongMarshallIdentifier(stage *Stage) (decl string) {
	...
	decl = strings.ReplaceAll(decl, "{{GeneratedFieldNameValue}}", fmt.Sprintf("%q", notetaskshape.Name))
	return
}
...
func (product *Product) GongMarshallIdentifier(stage *Stage) (decl string) {
	...
	decl = strings.ReplaceAll(decl, "{{GeneratedFieldNameValue}}", fmt.Sprintf("%q", product.Name))
	return
}
...
func (productcompositionshape *ProductCompositionShape) GongMarshallIdentifier(stage *Stage) (decl string) {
	...
	decl = strings.ReplaceAll(decl, "{{GeneratedFieldNameValue}}", fmt.Sprintf("%q", productcompositionshape.Name))
	return
}
...
func (productshape *ProductShape) GongMarshallIdentifier(stage *Stage) (decl string) {
	...
	decl = strings.ReplaceAll(decl, "{{GeneratedFieldNameValue}}", fmt.Sprintf("%q", productshape.Name))
	return
}
...
func (project *Project) GongMarshallIdentifier(stage *Stage) (decl string) {
	...
	decl = strings.ReplaceAll(decl, "{{GeneratedFieldNameValue}}", fmt.Sprintf("%q", project.Name))
	return
}
...
func (resource *Resource) GongMarshallIdentifier(stage *Stage) (decl string) {
	...
	decl = strings.ReplaceAll(decl, "{{GeneratedFieldNameValue}}", fmt.Sprintf("%q", resource.Name))
	return
}
...
func (resourcecompositionshape *ResourceCompositionShape) GongMarshallIdentifier(stage *Stage) (decl string) {
	...
	decl = strings.ReplaceAll(decl, "{{GeneratedFieldNameValue}}", fmt.Sprintf("%q", resourcecompositionshape.Name))
	return
}
...
func (resourceshape *ResourceShape) GongMarshallIdentifier(stage *Stage) (decl string) {
	...
	decl = strings.ReplaceAll(decl, "{{GeneratedFieldNameValue}}", fmt.Sprintf("%q", resourceshape.Name))
	return
}
...
func (resourcetaskshape *ResourceTaskShape) GongMarshallIdentifier(stage *Stage) (decl string) {
	...
	decl = strings.ReplaceAll(decl, "{{GeneratedFieldNameValue}}", fmt.Sprintf("%q", resourcetaskshape.Name))
	return
}
...
func (root *Root) GongMarshallIdentifier(stage *Stage) (decl string) {
	...
	decl = strings.ReplaceAll(decl, "{{GeneratedFieldNameValue}}", fmt.Sprintf("%q", root.Name))
	return
}
...
func (task *Task) GongMarshallIdentifier(stage *Stage) (decl string) {
	...
	decl = strings.ReplaceAll(decl, "{{GeneratedFieldNameValue}}", fmt.Sprintf("%q", task.Name))
	return
}
...
func (taskcompositionshape *TaskCompositionShape) GongMarshallIdentifier(stage *Stage) (decl string) {
	...
	decl = strings.ReplaceAll(decl, "{{GeneratedFieldNameValue}}", fmt.Sprintf("%q", taskcompositionshape.Name))
	return
}
...
func (taskinputshape *TaskInputShape) GongMarshallIdentifier(stage *Stage) (decl string) {
	...
	decl = strings.ReplaceAll(decl, "{{GeneratedFieldNameValue}}", fmt.Sprintf("%q", taskinputshape.Name))
	return
}
...
func (taskoutputshape *TaskOutputShape) GongMarshallIdentifier(stage *Stage) (decl string) {
	...
	decl = strings.ReplaceAll(decl, "{{GeneratedFieldNameValue}}", fmt.Sprintf("%q", taskoutputshape.Name))
	return
}
...
func (taskshape *TaskShape) GongMarshallIdentifier(stage *Stage) (decl string) {
	...
	decl = strings.ReplaceAll(decl, "{{GeneratedFieldNameValue}}", fmt.Sprintf("%q", taskshape.Name))
	return
}
